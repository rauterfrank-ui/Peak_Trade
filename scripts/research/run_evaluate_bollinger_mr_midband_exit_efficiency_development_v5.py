#!/usr/bin/env python3
"""Run exactly one preregistered DEVELOPMENT midband exit-efficiency evaluation (v5).
...
from src.research.bollinger_mr_midband_exit_efficiency_development_evaluation_v5.constants_v5 import (  # noqa: E402
    EVALUATION_RUN_ID,
)
from src.research.bollinger_mr_midband_exit_efficiency_development_evaluation_v5.panel_runner_v5 import (  # noqa: E402
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Evaluate Bollinger/MR midband exit-efficiency (DEVELOPMENT v5, one run)."
    )
    parser.add_argument(
        "--output-dir",
        type=Path,
