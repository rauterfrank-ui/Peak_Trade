#!/usr/bin/env python3
"""Canonical DEVELOPMENT evaluation entry point for
...
Modes:
  ...
  - evaluate: requires machine-checkable authorization + panel execution boundary;
    consumes the single development run slot only after the productive evaluator
    begins on a fully materialized, contract-valid DEVELOPMENT panel.
...
from src.research.volatility_decay_breakout_with_explicit_decay_exit_v1_development_evaluation_v1.constants_v1 import (  # noqa: E402
    EVIDENCE_REL_PATH,
    HYPOTHESIS_ID,
)
from src.research.volatility_decay_breakout_with_explicit_decay_exit_v1_development_evaluation_v1.entry_point_v1 import (  # noqa: E402
    run_dry_validate,
    run_evaluate_fail_closed,
    run_preflight_only,
)
from src.research.volatility_decay_breakout_with_explicit_decay_exit_v1_development_evaluation_v1.guards_v1 import (  # noqa: E402
    GuardError,
)
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description=(
            "VDBX v1 DEVELOPMENT evaluation entry point "
