#!/usr/bin/env python3
"""Run exactly one preregistered DEVELOPMENT evaluation (baseline vs standaside).
...
from src.research.regime_gated_standaside_mr_development_evaluation_v1.panel_runner_v1 import (  # noqa: E402
...
def main() -> int:
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=_REPO / "docs/evidence/evaluate_regime_gated_standaside_mr_development_v1",
    )
    parser.add_argument(
        "--archive-root",
        type=Path,
