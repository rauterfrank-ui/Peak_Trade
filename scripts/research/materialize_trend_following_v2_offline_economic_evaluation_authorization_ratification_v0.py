...
from src.research.trend_following_v2_offline_economic_evaluation_authorization_ratification_v0 import (  # noqa: E402
    CONFIRM_GO,
    CONFIG_REL_PATH,
...
from src.research.trend_following_v2_versioned_research_binding_v0 import (  # noqa: E402
...
FOCUSED_TEST = (
    "tests/research/"
    "test_trend_following_v2_offline_economic_evaluation_authorization_ratification_v0_contract.py"
)
BOUNDARY_TEST = "tests/governance/test_economic_diagnostic_optimization_boundary_guard_v0.py"
EXPECTED_ORIGIN_MAIN = "2369b2f93b1f4b70795b9fcc48395e678c342e4a"
    ...
    *,
    ...
    (bundle_dir / "preflight.txt").write_text(
        "\n".join(
            [
                ...
                f"RESEARCH_SCOPE=trend_following/v2",
                "OFFLINE_ONLY=true",
    ...
    final_report = (
        "\n".join(
            [
                "STATUS=PASS",
                "VERDICT=TREND_FOLLOWING_V2_AUTHORIZATION_RATIFICATION_COMPLETE",
                f"SCOPE={OUTPUT_PREFIX}",
                f"OPERATOR_GO={GO_TOKEN}",
