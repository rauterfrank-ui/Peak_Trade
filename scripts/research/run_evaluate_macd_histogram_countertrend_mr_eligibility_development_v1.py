#!/usr/bin/env python3
"""Run exactly one preregistered DEVELOPMENT evaluation (baseline vs MACD histogram-countertrend gate).
...
from src.research.macd_histogram_countertrend_mr_eligibility_development_evaluation_v1.panel_runner_v1 import (  # noqa: E402
