#!/usr/bin/env python3
"""Canonical DEVELOPMENT evaluation entry point for MOMENTUM_V2_VOL_SCALED v1.
...
This slice wires the productive strategy/evaluator path but does not execute
development evaluation. Generic LIVE/SHADOW/TESTNET/SCHEDULER flags cannot authorize.
"""
...
from src.research.momentum_v2_volatility_scaled_own_instrument_continuation_v1_development_evaluation_v1.constants_v1 import (  # noqa: E402
    EVIDENCE_REL_PATH,
    HYPOTHESIS_ID,
)
from src.research.momentum_v2_volatility_scaled_own_instrument_continuation_v1_development_evaluation_v1.entry_point_v1 import (  # noqa: E402
    run_dry_validate,
    run_evaluate_fail_closed,
    run_preflight_only,
)
from src.research.momentum_v2_volatility_scaled_own_instrument_continuation_v1_development_evaluation_v1.guards_v1 import (  # noqa: E402
    GuardError,
)
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description=(
            "MOMENTUM_V2_VOL_SCALED v1 DEVELOPMENT evaluation entry point "
