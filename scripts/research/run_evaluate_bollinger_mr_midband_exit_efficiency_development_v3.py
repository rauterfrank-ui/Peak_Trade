#!/usr/bin/env python3
"""Run exactly one preregistered DEVELOPMENT midband exit-efficiency evaluation (v3).

Research-only. No holdout. No runtime / orders / productive authority mutation.
Not a rerun of V1 or V2; V1/V2 remain terminal and are not touched by this script.
...
from src.research.bollinger_mr_midband_exit_efficiency_development_evaluation_v3.constants_v3 import (  # noqa: E402
    EVALUATION_RUN_ID,
)
from src.research.bollinger_mr_midband_exit_efficiency_development_evaluation_v3.panel_runner_v3 import (  # noqa: E402
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Evaluate Bollinger/MR midband exit-efficiency (DEVELOPMENT v3, one run)."
    )
    parser.add_argument(
        "--output-dir",
        type=Path,
