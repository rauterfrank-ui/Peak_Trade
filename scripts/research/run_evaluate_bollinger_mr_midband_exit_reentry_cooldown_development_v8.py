...
Future single authorized DEVELOPMENT evaluation (DO NOT run in implementation slice):
  ...
  PYTHONPATH=src:. python3 scripts/research/run_evaluate_bollinger_mr_midband_exit_reentry_cooldown_development_v8.py \\
    --mode evaluate \\
    --authorize-single-development-evaluation BOLLINGER_MR_MIDBAND_EXIT_REENTRY_COOLDOWN_NON_BITCOIN_PERPETUALS_DEVELOPMENT_V8 \\
    --output-dir docs/evidence/evaluate_bollinger_mr_midband_exit_reentry_cooldown_development_v8 \\
...
from src.research.bollinger_mr_midband_exit_reentry_cooldown_development_evaluation_v8.constants_v8 import (  # noqa: E402
    HYPOTHESIS_ID,
)
from src.research.bollinger_mr_midband_exit_reentry_cooldown_development_evaluation_v8.hypothesis_dispatch_v8 import (  # noqa: E402
    resolve_v8_dispatch,
)
from src.research.bollinger_mr_midband_exit_reentry_cooldown_development_evaluation_v8.panel_runner_v8 import (  # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
    ...
    preflight_default = (
        REPO_ROOT / "docs/evidence/preflight_bollinger_mr_midband_exit_reentry_cooldown_v8_wiring"
    )
    evaluate_default = (
        REPO_ROOT
    ...
    resolve_v8_dispatch(HYPOTHESIS_ID)
    ...
    if auth != HYPOTHESIS_ID:
        ...
        print("REASON=V8_EVALUATION_NOT_AUTHORIZED")
