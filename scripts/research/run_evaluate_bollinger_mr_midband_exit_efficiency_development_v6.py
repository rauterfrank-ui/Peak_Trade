#!/usr/bin/env python3
"""Run exactly one preregistered DEVELOPMENT composite exit-efficiency evaluation (v6).

Research-only. No holdout. No runtime / orders / productive authority mutation.
Not a rerun of V1–V5; V1–V5 remain terminal and are not touched by this script.
...
from src.research.bollinger_mr_midband_exit_efficiency_development_evaluation_v6.constants_v6 import (  # noqa: E402
    EVALUATION_RUN_ID,
)
from src.research.bollinger_mr_midband_exit_efficiency_development_evaluation_v6.panel_runner_v6 import (  # noqa: E402
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description=("Evaluate Bollinger/MR composite exit-efficiency (DEVELOPMENT v6, one run).")
    )
    parser.add_argument(
        "--output-dir",
        type=Path,
