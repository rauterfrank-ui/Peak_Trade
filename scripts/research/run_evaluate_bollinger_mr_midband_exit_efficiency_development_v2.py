#!/usr/bin/env python3
"""Run exactly one preregistered DEVELOPMENT midband exit-efficiency evaluation (v2).

Research-only. No holdout. No runtime / orders / productive authority mutation.
Not a rerun of V1; V1 remains terminal and is not touched by this script.
...
from src.research.bollinger_mr_midband_exit_efficiency_development_evaluation_v2.constants_v2 import (  # noqa: E402
    EVALUATION_RUN_ID,
)
from src.research.bollinger_mr_midband_exit_efficiency_development_evaluation_v2.panel_runner_v2 import (  # noqa: E402
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Evaluate Bollinger/MR midband exit-efficiency (DEVELOPMENT v2, one run)."
    )
    parser.add_argument(
        "--output-dir",
        type=Path,
