#!/usr/bin/env python3
"""Fail-closed verifier for Cap 11.8 durable evidence package."""
...
from src.ops.capability_11_8_live_dry_run_order_plan_parity_v1.constants_v1 import (  # noqa: E402
    CAPABILITY_ID,
    EVIDENCE_DIRNAME,
    MANIFEST_FILENAME,
    SUMMARY_FILENAME,
)
from src.ops.capability_11_8_live_dry_run_order_plan_parity_v1.verifier_v1 import (  # noqa: E402
...
def main() -> int:
    ...
    required = [
        ...
        "live_dry_run_order_plan_proof.json",
        "live_order_plan_parity_proof.json",
        "live_order_plan_evidence_ladder_proof.json",
    ...
    live_verify = verify_capability_11_8_v1()
    ...
    checks = {
        ...
        "no_live_order_submit": claims.get("LIVE_ORDER_SUBMIT_PERFORMED_IN_CAPABILITY_11_8")
        is False,
        "no_paper_order_submit": claims.get("PAPER_ORDER_SUBMIT_PERFORMED_IN_CAPABILITY_11_8")
        is False,
        "no_testnet_submit": claims.get("TESTNET_ORDER_SUBMIT_PERFORMED_IN_CAPABILITY_11_8")
        is False,
        "no_credential_load": claims.get("CREDENTIAL_LOAD_PERFORMED_IN_CAPABILITY_11_8") is False,
        "no_auth_consumption": claims.get("AUTHORIZATION_CONSUMPTION_ALLOWED") is False,
        "cap_11_8_started": claims.get("CAPABILITY_11_8_STARTED") is True,
        "dry_run_not_activated": claims.get("LIVE_DRY_RUN_ORDER_PLAN_ACTIVATED") is False,
        "parity_not_activated": claims.get("LIVE_ORDER_PLAN_PARITY_ACTIVATED") is False,
        "no_order_plan_observed_claim": claims.get("LIVE_ORDER_PLAN_OBSERVED") is False,
        "no_cap_11_9": claims.get("CAPABILITY_11_9_STARTED") is False,
        "dashboard_authority_none": claims.get("DASHBOARD_AUTHORITY_EFFECT") == "NONE",
        "dry_run_bound": claims.get("LIVE_DRY_RUN_ORDER_PLAN_CONTRACT_BOUND") is True,
        "parity_bound": claims.get("LIVE_ORDER_PLAN_PARITY_CONTRACT_BOUND") is True,
        "ladder_bound": claims.get("LIVE_ORDER_PLAN_EVIDENCE_LADDER_CONTRACT_BOUND") is True,
        "dry_run_not_contract_activated": claims.get("LIVE_DRY_RUN_ORDER_PLAN_CONTRACT_ACTIVATED")
        is False,
    }
