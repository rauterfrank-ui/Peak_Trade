#!/usr/bin/env python3
"""Generate durable evidence for Cap 11 §11.12.7 kill-switch/emergency proof."""
...
def main() -> int:
    ...
    test_node = (
        "tests/ops/test_capability_11_section_11_12_7_kill_switch_and_emergency_control_proof_v1.py"
    )
    proc = subprocess.run(
    ...
    proof = verification["proofs"]["section_11_12_7"]
    ...
    _write_json(productive / "section_11_12_7_proof.json", proof)
    ...
    _write_json(
        productive / "activation_state.json",
        {
            ...
            "SECTION_11_12_6_PREDECESSOR_BOUND": True,
