#!/usr/bin/env python3
"""Generate durable evidence for Cap 11 §11.12.8 productive Testnet campaign run."""
...
def main() -> int:
    ...
    test_node = "tests/ops/test_capability_11_section_11_12_8_productive_testnet_campaign_run_v1.py"
    proc = subprocess.run(
    ...
    proof = verification["proofs"]["productive_run"]
    ...
    _write_json(productive / "productive_run_proof.json", proof)
