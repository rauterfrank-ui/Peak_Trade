#!/usr/bin/env python3
"""One-shot §11.13.5.Z2G public mark-price GET. No POST. No credentials."""
...
from src.ops.section_11_13_5_live_canary_minimum_exposure_v1.cover_usdc_current_markpx_productive_evidence_v1 import (  # noqa: E402
    EVIDENCE_DIRNAME,
    OWNER_GO,
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--execute-public-markpx-get", action="store_true")
    ...
    if args.owner_go != OWNER_GO:
        ...
        return 2
    if not args.execute_public_markpx_get:
    ...
    adjudication, snapshot, response = collect_current_markpx_public_get_v1(
        transport=transport,
    ...
    if args.persist:
        ...
        persistence = persist_current_markpx_public_get_evidence_v1(
