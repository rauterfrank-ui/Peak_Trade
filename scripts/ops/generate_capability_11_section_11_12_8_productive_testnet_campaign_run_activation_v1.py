#!/usr/bin/env python3
"""Generate durable evidence for Cap 11 §11.12.8 productive Testnet campaign run activation."""
...
def main() -> int:
    ...
    test_node = "tests/ops/test_capability_11_section_11_12_8_productive_testnet_campaign_run_activation_v1.py"
    proc = subprocess.run(
    ...
    proof = verification["proofs"]["productive_run_activation"]
    ...
    _write_json(productive / "productive_run_activation_proof.json", proof)
        ...
        json.dumps(
            {
                ...
                "ACTIVATION_AUTHORIZED": False,
                "SECTION_11_13_STARTED": False,
                "ACTIVATION_SURFACE_PRESENT": True,
            },
            sort_keys=True,
        )
    )
