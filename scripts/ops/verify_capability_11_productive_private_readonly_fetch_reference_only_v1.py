#!/usr/bin/env python3
"""Fail-closed verifier for Cap 11 productive private-readonly fetch reference-only evidence."""
...
from src.ops.capability_11_productive_private_readonly_fetch_reference_only_v1.constants_v1 import (  # noqa: E402
    CAPABILITY_ID,
    EVIDENCE_DIRNAME,
    MANIFEST_FILENAME,
    SUMMARY_FILENAME,
)
from src.ops.capability_11_productive_private_readonly_fetch_reference_only_v1.verifier_v1 import (  # noqa: E402
...
def main() -> int:
    ...
    required = [
        ...
        "reference_only_fetch_proof.json",
        "test_results.json",
        "repository_sha.json",
    ...
    proof = _load(productive / "reference_only_fetch_proof.json")
    live_verify = verify_capability_11_productive_private_readonly_fetch_reference_only_v1()
    ...
    checks = {
        ...
        "admissible_default_false": claims.get("REFERENCE_ONLY_FETCH_ADMISSIBLE_DEFAULT") is False,
        ...
        "fetch_forbidden": proof.get("complete_fetch_still_forbidden") is True,
        "intended_plan_bound": proof.get("intended_fetch_plan_bound") is True,
        "complete_admissible": proof.get("complete_reference_only_fetch_admissible") is True,
        ...
        "mutation_blocked": proof.get("mutation_endpoint_blocked") is True,
    }
