#!/usr/bin/env python3
"""Run bollinger_bands/v1 offline economic evaluation execution v0.
...
Operator GO: GO_BOLLINGER_BANDS_V1_OFFLINE_ECONOMIC_EVALUATION_EXECUTION_V0
"""
...
from src.research.bollinger_bands_v1_offline_economic_evaluation_execution_v0 import (  # noqa: E402
    AUTHORITY_EFFECT,
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "Execute bollinger_bands/v1 offline economic evaluation v0 "
    ...
    try:
        result = run_bollinger_bands_execution_v0(
