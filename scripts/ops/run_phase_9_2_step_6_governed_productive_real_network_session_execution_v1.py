...
from src.ops.phase_9_2_step_6_governed_productive_real_network_session_execution_v1.confirm_token_path_v1 import (  # noqa: E402
    reject_confirm_token_argv_v1,
    reject_confirm_token_env_fallback_v1,
)
from src.ops.phase_9_2_step_6_governed_productive_real_network_session_execution_v1.constants_v1 import (  # noqa: E402
    CAPABILITY_ID,
    NETWORK_SESSION_ALLOWED,
    SESSION_EXECUTION_ALLOWED,
)
from src.ops.phase_9_2_step_6_governed_productive_real_network_session_execution_v1.evidence_v1 import (  # noqa: E402
    materialize_session_execution_implementation_evidence_v1,
)
from src.ops.phase_9_2_step_6_governed_productive_real_network_session_execution_v1.failure_injection_v1 import (  # noqa: E402
    run_step6_session_execution_failure_injection_v1,
)
from src.ops.phase_9_2_step_6_governed_productive_real_network_session_execution_v1.governed_session_execution_v1 import (  # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
    ...
    if NETWORK_SESSION_ALLOWED or SESSION_EXECUTION_ALLOWED:
        payload = {
            "ok": False,
            "blockers": ["PERMANENT_SESSION_ENABLE_MUST_REMAIN_FALSE"],
            "capability_id": CAPABILITY_ID,
        }
        print(json.dumps(payload, sort_keys=True, indent=2 if args.json else None))
        return 2
    ...
    if args.command == "prove-failure-injection":
        payload = run_step6_session_execution_failure_injection_v1(
            expected_repository_sha=sha,
            expected_config_digest=cfg,
        )
        print(json.dumps(payload, sort_keys=True, indent=2 if args.json else None))
    ...
    if args.command == "materialize-evidence":
        payload = materialize_session_execution_implementation_evidence_v1(
            repository_sha=sha,
            config_digest=cfg,
