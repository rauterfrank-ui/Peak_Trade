#!/usr/bin/env python3
"""Offline economic evaluation runner for cross-sectional funding-rate persistence reversal filter v0.
...
- Infrastructure dry-run:
  GO_BOUNDED_CROSS_SECTIONAL_FUNDING_RATE_PERSISTENCE_REVERSAL_FILTER_V0_OFFLINE_ECONOMIC_EVALUATION_INFRASTRUCTURE_COMPLETION_V0
- Full execution:
  GO_CROSS_SECTIONAL_FUNDING_RATE_PERSISTENCE_REVERSAL_FILTER_V0_OFFLINE_ECONOMIC_EVALUATION_EXECUTION_NO_RUNTIME_AUTHORITY_V0
"""
...
from src.research.cross_sectional_funding_rate_persistence_reversal_filter_v0_bound_panel_dataset_materialization_v0 import (  # noqa: E402
    MaterializationTerminalStatus,
    materialize_bound_funding_panel_dataset_v0,
)
from src.research.cross_sectional_funding_rate_persistence_reversal_filter_v0_offline_economic_evaluation_execution_v0 import (  # noqa: E402
...
from src.research.cross_sectional_funding_rate_persistence_reversal_filter_v0_offline_economic_evaluation_infrastructure_readiness_v0 import (  # noqa: E402
    evaluate_persistence_reversal_filter_offline_evaluation_infrastructure_readiness_v0,
...
INFRASTRUCTURE_CONFIRM_GO = INFRASTRUCTURE_GO_TOKEN
...
DEFAULT_STAGING_ROOT = Path(
    "/Users/frnkhrz/Documents/Peak_Trade_runtime_evidence_archive_20260520T161443Z/datasets/admissible_futures/"
    "pit_okx_linear_usdt_non_bitcoin_cross_sectional_pt1h_research_v1/extended_chronological_v1"
)
SCOPE_CLASSIFICATION = "BOUNDED_CROSS_SECTIONAL_FUNDING_RATE_PERSISTENCE_REVERSAL_FILTER_V0_OFFLINE_ECONOMIC_EVALUATION_EXECUTION_V0"
...
def run_infrastructure_dry_run_v0(
    *,
    ...
    readiness = evaluate_persistence_reversal_filter_offline_evaluation_infrastructure_readiness_v0(
        repo_root=_REPO_ROOT,
    ...
    result = run_full_evaluation_entrypoint_dry_run_v1(
        ...
        go_token=INFRASTRUCTURE_CONFIRM_GO,
    )
    payload = {
...
def run_offline_economic_evaluation_execution_v0(
    *,
    ...
    if confirm not in ALLOWED_EXECUTION_GO_TOKENS:
        _die(f"ERR:confirm_go_token_required:{EXECUTION_CONFIRM_GO}|{COMBINED_GO_TOKEN}")
    ...
    bundle_dir = (
        ...
        / "implementation"
        / f"bounded_cross_sectional_funding_rate_persistence_reversal_filter_v0_offline_economic_evaluation_execution_v0_{ts_slug}"
    )
    ...
    (bundle_dir / "SCOPE_AND_GO.txt").write_text(
        "\n".join(
            [
                ...
                f"GO_TOKEN={EXECUTION_CONFIRM_GO}",
...
def main() -> None:
    ...
    if confirm == INFRASTRUCTURE_CONFIRM_GO:
        payload = run_infrastructure_dry_run_v0(
            staging_root=args.staging_root,
            output_json=args.output_json,
        )
    elif confirm in {EXECUTION_CONFIRM_GO, COMBINED_GO_TOKEN}:
        ...
        _die(
            ...
            f"expected_one_of:{INFRASTRUCTURE_CONFIRM_GO}|{EXECUTION_CONFIRM_GO}|{COMBINED_GO_TOKEN}"
        )

    text = json.dumps(payload, indent=2, sort_keys=True) + "\n"
    if args.output_json and confirm != INFRASTRUCTURE_CONFIRM_GO:
