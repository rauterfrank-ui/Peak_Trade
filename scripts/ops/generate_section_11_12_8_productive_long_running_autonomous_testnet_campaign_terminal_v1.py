#!/usr/bin/env python3
"""Generate durable evidence for §11.12.8 terminal productive campaign consumer."""
...
def main() -> int:
    ...
    test_node = (
        "tests/ops/test_section_11_12_8_productive_long_running_"
        "autonomous_testnet_campaign_terminal_v1.py"
    )
    proc = subprocess.run(
    ...
    proof = verification["proofs"]["terminal_consumer"]
    ...
    _write_json(productive / "terminal_consumer_proof.json", proof)
