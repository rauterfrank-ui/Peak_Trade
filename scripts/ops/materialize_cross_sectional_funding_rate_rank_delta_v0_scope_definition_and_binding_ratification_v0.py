#!/usr/bin/env python3
"""Materialize cross-sectional funding-rate rank-delta v0 scope binding ratification v0.
...
Operator GO: GO_CROSS_SECTIONAL_FUNDING_RATE_RANK_DELTA_V0_BINDING_RATIFICATION_NO_EVAL_NO_RUNTIME_AUTHORITY_V0
"""
...
from src.research.cross_sectional_funding_rate_rank_delta_v0_versioned_research_binding_v0 import (  # noqa: E402
...
def run_materialization(
    *,
    ...
    validation = validate_rank_delta_offline_economic_evaluation_scope_ratification_v0(
        ratification,
    ...
    evidence_dir = (
        ...
        / "research"
        / f"cross_sectional_funding_rate_rank_delta_v0_binding_ratification_no_eval_{ts_slug}"
    )
    ...
    (evidence_dir / "SCOPE.md").write_text(
        "\n".join(
            [
                "# Cross-Sectional Funding Rate Rank-Delta v0 Scope Ratification",
                "",
                ...
                "",
                "Material difference: rank_delta vs dual_leg_spread/v1 level spread",
    ...
    (evidence_dir / "MATERIAL_DIFFERENCE_ASSERTION.md").write_text(
        "\n".join(
            [
                ...
                "",
                "| Terminal Surface | Rank-Delta v0 Difference |",
                "|---|---|",
    ...
    payload: dict[str, Any] = {
        "verdict": "CS_FUNDING_RATE_RANK_DELTA_V0_SCOPE_BINDING_RATIFICATION_PASS",
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "Materialize cross-sectional funding-rate rank-delta v0 scope definition "
