#!/usr/bin/env python3
"""CLI for Phase 9.2 Step-6 productive real-network session executor binding.
...
Commands:
  ...
  execute-governed-session      — offline fail-closed in this binding

Permanent NETWORK_SESSION_ALLOWED remains false. This CLI never starts a real
Public-MD network session and never consumes authorization/confirm tokens.

Later separate Owner-GO session (real TTY required, after merge):
...
from src.ops.phase_9_2_step_6_governed_productive_real_network_session_executor_v1.confirm_token_path_v1 import (  # noqa: E402
    reject_confirm_token_argv_v1,
    reject_confirm_token_env_fallback_v1,
)
from src.ops.phase_9_2_step_6_governed_productive_real_network_session_executor_v1.constants_v1 import (  # noqa: E402
    CAPABILITY_ID,
    NETWORK_SESSION_ALLOWED,
)
from src.ops.phase_9_2_step_6_governed_productive_real_network_session_executor_v1.evidence_v1 import (  # noqa: E402
    materialize_productive_executor_binding_evidence_v1,
)
from src.ops.phase_9_2_step_6_governed_productive_real_network_session_executor_v1.failure_injection_v1 import (  # noqa: E402
    run_step6_productive_executor_failure_injection_v1,
)
from src.ops.phase_9_2_step_6_governed_productive_real_network_session_executor_v1.governed_session_execution_v1 import (  # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
    ...
    cfg = _cfg()
    # Ephemeral GO may be passed as --network-session-go or legacy --network-session-allowed.
    network_session_go = bool(args.network_session_go or args.network_session_allowed)
    ...
    if args.command in {"preflight", "prove-binding"}:
        ...
        payload = materialize_productive_executor_binding_evidence_v1(
            repository_sha=sha,
            config_digest=cfg,
        ...
        payload = run_step6_productive_executor_failure_injection_v1(
            expected_repository_sha=sha,
            expected_config_digest=cfg,
        )
