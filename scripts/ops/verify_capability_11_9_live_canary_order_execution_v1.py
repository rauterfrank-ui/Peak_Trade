#!/usr/bin/env python3
"""Fail-closed verifier for Cap 11.9 durable evidence package."""
...
def main() -> int:
    ...
    required = [
        ...
        "live_canary_minimum_exposure_proof.json",
        "live_canary_order_execution_proof.json",
        "live_canary_evidence_ladder_proof.json",
    ...
    live_verify = verify_capability_11_9_v1()
    ...
    checks = {
        ...
        "no_live_order_submit": claims.get("LIVE_ORDER_SUBMIT_PERFORMED_IN_CAPABILITY_11_9")
        is False,
        "no_paper_order_submit": claims.get("PAPER_ORDER_SUBMIT_PERFORMED_IN_CAPABILITY_11_9")
        is False,
        "no_testnet_submit": claims.get("TESTNET_ORDER_SUBMIT_PERFORMED_IN_CAPABILITY_11_9")
        is False,
        "no_live_order_execution": claims.get("LIVE_ORDER_EXECUTION_PERFORMED_IN_CAPABILITY_11_9")
        is False,
        "no_credential_load": claims.get("CREDENTIAL_LOAD_PERFORMED_IN_CAPABILITY_11_9") is False,
        "no_auth_consumption": claims.get("AUTHORIZATION_CONSUMPTION_ALLOWED") is False,
        "cap_11_9_started": claims.get("CAPABILITY_11_9_STARTED") is True,
        "canary_not_activated": claims.get("LIVE_CANARY_EXECUTION_ACTIVATED") is False,
        "exposure_not_activated": claims.get("LIVE_CANARY_MINIMUM_EXPOSURE_ACTIVATED") is False,
        "execution_not_activated": claims.get("LIVE_CANARY_ORDER_EXECUTION_ACTIVATED") is False,
        "no_submit_ack_observed_claim": claims.get("LIVE_SUBMIT_ACK_OBSERVED") is False,
        "no_cap_11_10": claims.get("CAPABILITY_11_10_STARTED") is False,
        "dashboard_authority_none": claims.get("DASHBOARD_AUTHORITY_EFFECT") == "NONE",
        "exposure_bound": claims.get("LIVE_CANARY_MINIMUM_EXPOSURE_CONTRACT_BOUND") is True,
        "execution_bound": claims.get("LIVE_CANARY_ORDER_EXECUTION_CONTRACT_BOUND") is True,
        "ladder_bound": claims.get("LIVE_CANARY_EVIDENCE_LADDER_CONTRACT_BOUND") is True,
        "execution_not_contract_activated": claims.get(
