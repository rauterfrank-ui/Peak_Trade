#!/usr/bin/env python3
"""Offline economic evaluation runner for cross-sectional funding-rate rank-delta v0.
...
- Full execution:
  GO_CROSS_SECTIONAL_FUNDING_RATE_RANK_DELTA_V0_OFFLINE_ECONOMIC_EVALUATION_EXECUTION_NO_RUNTIME_AUTHORITY_V0
"""
...
from src.research.cross_sectional_funding_rate_rank_delta_v0_bound_panel_dataset_materialization_v0 import (  # noqa: E402
...
SCOPE_CLASSIFICATION = (
    "BOUNDED_CROSS_SECTIONAL_FUNDING_RATE_RANK_DELTA_V0_OFFLINE_ECONOMIC_EVALUATION_EXECUTION_V0"
)
...
def run_offline_economic_evaluation_execution_v0(
    *,
    ...
    bundle_dir = (
        ...
        / "implementation"
        / f"bounded_cross_sectional_funding_rate_rank_delta_v0_offline_economic_evaluation_execution_v0_{ts_slug}"
    )
...
def main() -> None:
    ...
    if confirm == INFRASTRUCTURE_CONFIRM_GO:
    ...
    elif confirm == EXECUTION_CONFIRM_GO:
        ...
        _die(
            ...
            f"expected_one_of:{INFRASTRUCTURE_CONFIRM_GO}|{EXECUTION_CONFIRM_GO}"
        )
