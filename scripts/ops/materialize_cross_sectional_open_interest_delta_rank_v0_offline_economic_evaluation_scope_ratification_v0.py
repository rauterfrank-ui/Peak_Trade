...
Operator GO: GO_RATIFY_CROSS_SECTIONAL_OPEN_INTEREST_DELTA_RANK_V0_VERSIONED_OFFLINE_RESEARCH_BINDINGS_NO_EVAL_NO_RUNTIME_AUTHORITY_V0
"""
...
def run_materialization(
    *,
    ...
    evidence_dir = (
        ...
        / "research"
        / f"cs_open_interest_delta_rank_scope_binding_ratification_v0_{ts_slug}"
    )
