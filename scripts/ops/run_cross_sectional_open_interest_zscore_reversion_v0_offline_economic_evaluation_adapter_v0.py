#!/usr/bin/env python3
"""Offline economic evaluation adapter runner for cross_sectional_open_interest_zscore_reversion/v0.

Validates binding, panel contract, and evaluation precheck wiring. Does not execute economic
evaluation. Operator GO:
GO_CROSS_SECTIONAL_OPEN_INTEREST_ZSCORE_REVERSION_V0_SOURCE_EVIDENCE_INTEGRITY_RECONCILIATION_AND_OFFLINE_EVALUATION_ADAPTER_IMPLEMENTATION_V0
"""
...
from src.research.cross_sectional_open_interest_zscore_reversion_v0_offline_economic_evaluation_adapter_v0 import (  # noqa: E402
    AUTHORITY_EFFECT,
    GO_TOKEN,
    RUNTIME_EFFECT,
...
SCOPE_CLASSIFICATION = (
    "CROSS_SECTIONAL_OPEN_INTEREST_ZSCORE_REVERSION_V0_SOURCE_EVIDENCE_INTEGRITY_"
...
def main() -> None:
    ...
    evidence_dir = (
        ...
        / "research"
        / f"cross_sectional_open_interest_zscore_reversion_v0_offline_evaluation_adapter_v0_{ts}"
    )
