#!/usr/bin/env python3
"""Generate durable evidence for Cap 11 §11.12.2 order serialization dry-run."""
...
def main() -> int:
    ...
    test_node = "tests/ops/test_capability_11_section_11_12_2_order_serialization_dry_run_v1.py"
    proc = subprocess.run(
    ...
    proof = verification["proofs"]["section_11_12_2"]
    ...
    _write_json(productive / "section_11_12_2_proof.json", proof)
    ...
    _write_json(
        productive / "activation_state.json",
        {
            ...
            "SECTION_11_12_1_PREDECESSOR_BOUND": True,
