#!/usr/bin/env python3
"""Fail-closed verifier for Cap 11.6 durable evidence package."""
...
def main() -> int:
    ...
    required = [
        ...
        "long_running_campaign_evidence_proof.json",
        "testnet_evidence_closure_proof.json",
        "observability_audit_evidence_proof.json",
    ...
    live_verify = verify_capability_11_6_v1()
    ...
    checks = {
        ...
        "no_testnet_submit": claims.get("TESTNET_ORDER_SUBMIT_PERFORMED_IN_CAPABILITY_11_6")
        is False,
        "no_credential_load": claims.get("CREDENTIAL_LOAD_PERFORMED_IN_CAPABILITY_11_6") is False,
        "no_auth_consumption": claims.get("AUTHORIZATION_CONSUMPTION_ALLOWED") is False,
        "cap_11_6_started": claims.get("CAPABILITY_11_6_LONG_RUNNING_AUTONOMOUS_TESTNET_STARTED")
        is True,
        "campaign_not_activated": claims.get("LONG_RUNNING_AUTONOMOUS_TESTNET_CAMPAIGN_ACTIVATED")
        is False,
        "no_cap_11_7": claims.get("CAPABILITY_11_7_LIVE_PRIVATE_READONLY_STARTED") is False,
        "no_evidence_verified_claim": claims.get("TESTNET_EVIDENCE_VERIFIED") is False,
        ...
        is False,
        "campaign_bound": claims.get("LONG_RUNNING_CAMPAIGN_EVIDENCE_CONTRACT_BOUND") is True,
        "closure_bound": claims.get("TESTNET_EVIDENCE_CLOSURE_CONTRACT_BOUND") is True,
        "observability_bound": claims.get("OBSERVABILITY_AUDIT_EVIDENCE_CONTRACT_BOUND") is True,
        "campaign_not_contract_activated": claims.get(
