#!/usr/bin/env python3
"""Fail-closed verifier for Cap 11.11 durable evidence package."""
...
from src.ops.capability_11_11_live_autonomous_recovery_and_degradation_evidence_v1.constants_v1 import (  # noqa: E402
    CAPABILITY_ID,
    EVIDENCE_DIRNAME,
    MANIFEST_FILENAME,
    SUMMARY_FILENAME,
)
from src.ops.capability_11_11_live_autonomous_recovery_and_degradation_evidence_v1.verifier_v1 import (  # noqa: E402
...
def main() -> int:
    ...
    required = [
        ...
        "live_autonomous_degradation_proof.json",
        "live_autonomous_recovery_proof.json",
        "live_autonomous_recovery_evidence_ladder_proof.json",
        ...
        "capability_11_7_dependency_proof.json",
        "capability_11_8_dependency_proof.json",
        "capability_11_9_dependency_proof.json",
        "capability_11_10_dependency_proof.json",
    ...
    dep_11_7 = _load(productive / "capability_11_7_dependency_proof.json")
    dep_11_8 = _load(productive / "capability_11_8_dependency_proof.json")
    dep_11_9 = _load(productive / "capability_11_9_dependency_proof.json")
    dep_11_10 = _load(productive / "capability_11_10_dependency_proof.json")
    live_verify = verify_capability_11_11_v1()
    ...
    checks = {
        ...
        "cap_11_7_dependency": dep_11_7.get("CAPABILITY_11_7_DEPENDENCY_SATISFIED") is True,
        "cap_11_8_dependency": dep_11_8.get("CAPABILITY_11_8_DEPENDENCY_SATISFIED") is True,
        "cap_11_9_dependency": dep_11_9.get("CAPABILITY_11_9_DEPENDENCY_SATISFIED") is True,
        "cap_11_10_dependency": dep_11_10.get("CAPABILITY_11_10_DEPENDENCY_SATISFIED") is True,
        ...
        "no_live_order_submit": claims.get("LIVE_ORDER_SUBMIT_PERFORMED_IN_CAPABILITY_11_11")
        is False,
        "no_paper_order_submit": claims.get("PAPER_ORDER_SUBMIT_PERFORMED_IN_CAPABILITY_11_11")
        is False,
        "no_testnet_submit": claims.get("TESTNET_ORDER_SUBMIT_PERFORMED_IN_CAPABILITY_11_11")
        is False,
        "no_live_order_execution": claims.get("LIVE_ORDER_EXECUTION_PERFORMED_IN_CAPABILITY_11_11")
        is False,
        "no_credential_load": claims.get("CREDENTIAL_LOAD_PERFORMED_IN_CAPABILITY_11_11") is False,
        "no_auth_consumption": claims.get("AUTHORIZATION_CONSUMPTION_ALLOWED") is False,
        "cap_11_11_started": claims.get("CAPABILITY_11_11_STARTED") is True,
        "degradation_not_activated": claims.get("LIVE_AUTONOMOUS_DEGRADATION_ACTIVATED") is False,
        "recovery_not_activated": claims.get("LIVE_AUTONOMOUS_RECOVERY_ACTIVATED") is False,
        "no_restart_reconstructed_claim": claims.get("LIVE_RESTART_RECONSTRUCTED") is False,
        "no_recovery_observed_claim": claims.get("LIVE_AUTONOMOUS_RECOVERY_OBSERVED") is False,
        "no_cap_11_12": claims.get("CAPABILITY_11_12_STARTED") is False,
        "dashboard_authority_none": claims.get("DASHBOARD_AUTHORITY_EFFECT") == "NONE",
        "degradation_bound": claims.get("LIVE_AUTONOMOUS_DEGRADATION_CONTRACT_BOUND") is True,
        "recovery_bound": claims.get("LIVE_AUTONOMOUS_RECOVERY_CONTRACT_BOUND") is True,
        "ladder_bound": claims.get("LIVE_AUTONOMOUS_RECOVERY_EVIDENCE_LADDER_CONTRACT_BOUND")
        is True,
        "recovery_not_contract_activated": claims.get("LIVE_AUTONOMOUS_RECOVERY_CONTRACT_ACTIVATED")
        is False,
    }
