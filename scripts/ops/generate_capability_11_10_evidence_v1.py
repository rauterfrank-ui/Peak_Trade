#!/usr/bin/env python3
"""Generate durable evidence for Cap 11.10 Live bounded single-future continuity."""
...
from src.ops.capability_11_10_live_bounded_single_future_continuity_v1.dependency_and_ownership_v1 import (  # noqa: E402
...
def main() -> int:
    ...
    test_node = "tests/ops/test_capability_11_10_live_bounded_single_future_continuity_v1.py"
    proc = subprocess.run(
    ...
    verification = verify_capability_11_10_v1()
    ...
    _write_json(
        productive / "live_bounded_single_future_continuity_proof.json",
        verification["proofs"]["live_bounded_single_future_continuity"],
    )
    _write_json(
        productive / "live_bounded_order_lifecycle_continuity_proof.json",
        verification["proofs"]["live_bounded_order_lifecycle_continuity"],
    )
    _write_json(
        productive / "live_bounded_evidence_ladder_proof.json",
        verification["proofs"]["live_bounded_evidence_ladder"],
    )
    _write_json(
