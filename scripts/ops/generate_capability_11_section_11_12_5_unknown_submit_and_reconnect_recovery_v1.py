#!/usr/bin/env python3
"""Generate durable evidence for Cap 11 §11.12.5 unknown-submit/reconnect recovery."""
...
def main() -> int:
    ...
    test_node = (
        "tests/ops/test_capability_11_section_11_12_5_unknown_submit_and_reconnect_recovery_v1.py"
    )
    proc = subprocess.run(
    ...
    proof = verification["proofs"]["section_11_12_5"]
    ...
    _write_json(productive / "section_11_12_5_proof.json", proof)
    ...
    _write_json(
        productive / "activation_state.json",
        {
            ...
            "SECTION_11_12_4_PREDECESSOR_BOUND": True,
