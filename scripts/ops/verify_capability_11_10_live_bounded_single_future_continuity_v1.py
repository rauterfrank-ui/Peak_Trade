#!/usr/bin/env python3
"""Fail-closed verifier for Cap 11.10 durable evidence package."""
...
from src.ops.capability_11_10_live_bounded_single_future_continuity_v1.constants_v1 import (  # noqa: E402
    CAPABILITY_ID,
    EVIDENCE_DIRNAME,
    MANIFEST_FILENAME,
    SUMMARY_FILENAME,
)
from src.ops.capability_11_10_live_bounded_single_future_continuity_v1.verifier_v1 import (  # noqa: E402
...
def main() -> int:
    ...
    required = [
        ...
        "live_bounded_single_future_continuity_proof.json",
        "live_bounded_order_lifecycle_continuity_proof.json",
        "live_bounded_evidence_ladder_proof.json",
    ...
    live_verify = verify_capability_11_10_v1()
    ...
    checks = {
        ...
        "no_live_order_submit": claims.get("LIVE_ORDER_SUBMIT_PERFORMED_IN_CAPABILITY_11_10")
        is False,
        "no_paper_order_submit": claims.get("PAPER_ORDER_SUBMIT_PERFORMED_IN_CAPABILITY_11_10")
        is False,
        "no_testnet_submit": claims.get("TESTNET_ORDER_SUBMIT_PERFORMED_IN_CAPABILITY_11_10")
        is False,
        "no_live_order_execution": claims.get("LIVE_ORDER_EXECUTION_PERFORMED_IN_CAPABILITY_11_10")
        is False,
        "no_credential_load": claims.get("CREDENTIAL_LOAD_PERFORMED_IN_CAPABILITY_11_10") is False,
        "no_auth_consumption": claims.get("AUTHORIZATION_CONSUMPTION_ALLOWED") is False,
        "cap_11_10_started": claims.get("CAPABILITY_11_10_STARTED") is True,
        "bounded_not_activated": claims.get("LIVE_BOUNDED_SINGLE_FUTURE_ACTIVATED") is False,
        "continuity_not_activated": claims.get("LIVE_BOUNDED_SINGLE_FUTURE_CONTINUITY_ACTIVATED")
        is False,
        "lifecycle_not_activated": claims.get("LIVE_BOUNDED_ORDER_LIFECYCLE_CONTINUITY_ACTIVATED")
        is False,
        "no_fill_observed_claim": claims.get("LIVE_FILL_OBSERVED") is False,
        "no_cap_11_11": claims.get("CAPABILITY_11_11_STARTED") is False,
        "dashboard_authority_none": claims.get("DASHBOARD_AUTHORITY_EFFECT") == "NONE",
        "continuity_bound": claims.get("LIVE_BOUNDED_SINGLE_FUTURE_CONTINUITY_CONTRACT_BOUND")
        is True,
        "lifecycle_bound": claims.get("LIVE_BOUNDED_ORDER_LIFECYCLE_CONTINUITY_CONTRACT_BOUND")
        is True,
        "ladder_bound": claims.get("LIVE_BOUNDED_EVIDENCE_LADDER_CONTRACT_BOUND") is True,
        "lifecycle_not_contract_activated": claims.get(
