#!/usr/bin/env python3
"""Generate durable evidence for Cap 11 productive credential-load reference-only."""
...
def main() -> int:
    ...
    test_node = "tests/ops/test_capability_11_productive_credential_load_reference_only_v1.py"
    proc = subprocess.run(
    ...
    verification = verify_capability_11_productive_credential_load_reference_only_v1()
    ...
    _write_json(
        productive / "reference_only_load_proof.json",
        verification["proofs"]["reference_only_load"],
    )
