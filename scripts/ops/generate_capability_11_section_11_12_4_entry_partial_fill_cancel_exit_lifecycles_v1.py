#!/usr/bin/env python3
"""Generate durable evidence for Cap 11 §11.12.4 entry/partial/cancel/exit lifecycles."""
...
def main() -> int:
    ...
    test_node = "tests/ops/test_capability_11_section_11_12_4_entry_partial_fill_cancel_exit_lifecycles_v1.py"
    proc = subprocess.run(
    ...
    proof = verification["proofs"]["section_11_12_4"]
    ...
    _write_json(productive / "section_11_12_4_proof.json", proof)
    ...
    _write_json(
        productive / "activation_state.json",
        {
            ...
            "SECTION_11_12_3_PREDECESSOR_BOUND": True,
