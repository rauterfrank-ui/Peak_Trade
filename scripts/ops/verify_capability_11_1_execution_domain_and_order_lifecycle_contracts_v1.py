#!/usr/bin/env python3
"""Fail-closed verifier for Cap 11.1 durable evidence package."""
...
def main() -> int:
    ...
    required = [
        ...
        "lifecycle_transition_matrix.json",
        "negative_reachability_proof.json",
        "core_logic_parity.json",
        "execution_ports_proof.json",
        "adapter_anti_corruption.json",
        "test_results.json",
        "repository_sha.json",
    ...
    live_verify = verify_capability_11_1_v1()
    ...
    checks = {
        ...
        "simulated_retained": claims.get("SIMULATED_EXECUTION_PORT_RETAINED") is True,
