#!/usr/bin/env python3
"""CLI entrypoint for §11.13.2 LIVE_PRIVATE_READ_ONLY (preflight default; execute opt-in)."""
...
from src.ops.section_11_13_2_live_private_read_only_v1.config_v1 import (  # noqa: E402
    example_incomplete_config_dict_v1,
    load_live_private_ro_config_from_json_file_v1,
)
from src.ops.section_11_13_2_live_private_read_only_v1.constants_v1 import (  # noqa: E402
    OWNER_GO_EXECUTE,
    PACKAGE_MARKER,
)
from src.ops.section_11_13_2_live_private_read_only_v1.owner_input_contract_v1 import (  # noqa: E402
    build_owner_execute_input_contract_v1,
)
from src.ops.section_11_13_2_live_private_read_only_v1.runner_v1 import (  # noqa: E402
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description=(
            "§11.13.2 LIVE_PRIVATE_READ_ONLY runner. Default --preflight performs "
            "zero network and loads no credential material. --execute requires "
    ...
    mode.add_argument(
        ...
        action="store_true",
        help=(
            "Productive LIVE private read-only execute. Requires vault file, "
    ...
    parser.add_argument(
        "--authorized",
        action="store_true",
        help="Set LIVE_PRIVATE_READ_ONLY_AUTHORIZED for auth validation.",
    )
    parser.add_argument(
        "--vault-file",
        type=str,
...
def main(argv: list[str] | None = None) -> int:
    ...
    # Default to preflight when neither flag is set.
    mode = "execute" if execute_mode else "preflight"

    config_obj = load_live_private_ro_config_from_json_file_v1(Path(args.config))
    ...
    except LivePrivateRoRunnerError as exc:
    ...
    # Never echo secret material; runner already redacts.
