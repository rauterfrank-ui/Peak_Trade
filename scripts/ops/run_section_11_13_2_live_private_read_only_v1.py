#!/usr/bin/env python3
"""CLI entrypoint for §11.13.2 LIVE_PRIVATE_READ_ONLY (preflight default; no live execute)."""
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--authorized",
        action="store_true",
        help="Set LIVE_PRIVATE_READ_ONLY_AUTHORIZED for auth validation in preflight.",
    )
    return parser
