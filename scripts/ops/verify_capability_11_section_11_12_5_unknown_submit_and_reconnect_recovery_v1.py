#!/usr/bin/env python3
"""Verify Cap 11 §11.12.5 unknown-submit and reconnect recovery evidence."""
...
from src.ops.capability_11_section_11_12_5_unknown_submit_and_reconnect_recovery_v1.constants_v1 import (  # noqa: E402
    ALLOWED_SECTION_11_12_5_PATHS,
    CAPABILITY_ID,
    EVIDENCE_DIRNAME,
    MANIFEST_FILENAME,
)
from src.ops.capability_11_section_11_12_5_unknown_submit_and_reconnect_recovery_v1.verifier_v1 import (  # noqa: E402
...
def main() -> int:
    ...
    gates = {
        ...
        "recovery_performed": claims.get("UNKNOWN_SUBMIT_AND_RECONNECT_RECOVERY_PERFORMED") is True,
        "cap_11_5_contract_reused": claims.get("CAP_11_5_UNKNOWN_SUBMIT_RECONNECT_CONTRACT_REUSED")
        is True,
        "predecessor_bound": claims.get("SECTION_11_12_4_PREDECESSOR_BOUND") is True,
        ...
        is False,
        "section_11_12_6_not_started": claims.get("SECTION_11_12_6_STARTED") is False,
        ...
        is False,
        "blind_retry_blocked": claims.get("BLIND_RETRY_BLOCKED") is True,
        "reconnect_activation_blocked": claims.get("RECONNECT_ACTIVATION_BLOCKED") is True,
        "paths_completed_match": claims.get("PATHS_COMPLETED")
        == list(ALLOWED_SECTION_11_12_5_PATHS),
    }
