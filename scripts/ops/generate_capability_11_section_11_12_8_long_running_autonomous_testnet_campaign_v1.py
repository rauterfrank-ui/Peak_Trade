#!/usr/bin/env python3
"""Generate durable evidence for Cap 11 §11.12.8 long-running Testnet campaign."""
...
def main() -> int:
    ...
    test_node = "tests/ops/test_capability_11_section_11_12_8_long_running_autonomous_testnet_campaign_v1.py"
    proc = subprocess.run(
    ...
    proof = verification["proofs"]["section_11_12_8"]
    ...
    _write_json(productive / "section_11_12_8_proof.json", proof)
    ...
    _write_json(
        productive / "activation_state.json",
        {
            ...
            "SECTION_11_12_7_PREDECESSOR_BOUND": True,
