#!/usr/bin/env python3
"""Verify Cap 11 §11.12.8 productive Testnet campaign execution evidence."""
...
def main() -> int:
    ...
    gates = {
        ...
        "implemented": claims.get("PRODUCTIVE_TESTNET_CAMPAIGN_EXECUTION_IMPLEMENTED") is True,
        "path_preserved": claims.get("PATH_PREDECESSOR_PRESERVED") is True,
        "path_present": claims.get("PRODUCTIVE_TESTNET_CAMPAIGN_EXECUTION_PATH_PRESENT") is True,
        "path_absent_false": claims.get("PRODUCTIVE_TESTNET_CAMPAIGN_EXECUTION_PATH_ABSENT")
        is False,
