#!/usr/bin/env python3
"""Fail-closed verifier for Cap 11.4 durable evidence package."""
...
from src.ops.capability_11_4_testnet_execution_adapter_and_lifecycle_closure_v1.constants_v1 import (  # noqa: E402
    CAPABILITY_ID,
    EVIDENCE_DIRNAME,
    MANIFEST_FILENAME,
    SUMMARY_FILENAME,
)
from src.ops.capability_11_4_testnet_execution_adapter_and_lifecycle_closure_v1.verifier_v1 import (  # noqa: E402
...
def main() -> int:
    ...
    required = [
        ...
        "testnet_execution_adapter_proof.json",
        "order_serialization_dry_run_proof.json",
        "testnet_lifecycle_closure_proof.json",
        "venue_adapter_anti_corruption_proof.json",
    ...
    live_verify = verify_capability_11_4_v1()
    ...
    checks = {
        ...
        "no_testnet_activation": claims.get("TESTNET_EXECUTION_ADAPTER_ACTIVATED") is False,
        "no_testnet_submit": claims.get("TESTNET_ORDER_SUBMIT_PERFORMED_IN_CAPABILITY_11_4")
        is False,
        "no_credential_load": claims.get("CREDENTIAL_LOAD_PERFORMED_IN_CAPABILITY_11_4") is False,
        "no_auth_consumption": claims.get("AUTHORIZATION_CONSUMPTION_ALLOWED") is False,
        "no_cap_11_5": claims.get("CAPABILITY_11_5_RESTART_RECOVERY_KILL_SWITCH_STARTED") is False,
        "no_testnet_lifecycle_proven_claim": claims.get("TESTNET_ORDER_LIFECYCLE_PROVEN") is False,
        "lifecycle_closure_bound": claims.get("TESTNET_LIFECYCLE_CLOSURE_CONTRACT_BOUND") is True,
        "serialization_dry_run_bound": claims.get("ORDER_SERIALIZATION_DRY_RUN_CONTRACT_BOUND")
        is True,
        "adapter_no_decision_authority": claims.get("VENUE_ADAPTER_DECISION_AUTHORITY") is False,
    }
