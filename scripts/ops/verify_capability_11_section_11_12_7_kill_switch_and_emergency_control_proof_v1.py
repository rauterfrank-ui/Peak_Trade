#!/usr/bin/env python3
"""Verify Cap 11 §11.12.7 kill-switch and emergency control proof evidence."""
...
from src.ops.capability_11_section_11_12_7_kill_switch_and_emergency_control_proof_v1.constants_v1 import (  # noqa: E402
    ALLOWED_SECTION_11_12_7_COMMANDS,
    CAPABILITY_ID,
    EVIDENCE_DIRNAME,
    MANIFEST_FILENAME,
)
from src.ops.capability_11_section_11_12_7_kill_switch_and_emergency_control_proof_v1.verifier_v1 import (  # noqa: E402
...
def main() -> int:
    ...
    gates = {
        ...
        "proof_performed": claims.get("KILL_SWITCH_AND_EMERGENCY_CONTROL_PROOF_PERFORMED") is True,
        "cap_11_5_contract_reused": claims.get(
            "CAP_11_5_KILL_SWITCH_AND_EMERGENCY_CONTROL_CONTRACT_REUSED"
        )
        is True,
        "predecessor_bound": claims.get("SECTION_11_12_6_PREDECESSOR_BOUND") is True,
        ...
        "section_11_12_8_not_started": claims.get("SECTION_11_12_8_STARTED") is False,
        ...
        "risk_increase_blocked": claims.get("RISK_INCREASE_BLOCKED") is True,
        "kill_switch_persisted": claims.get("KILL_SWITCH_PERSISTED") is True,
        "commands_completed_match": claims.get("COMMANDS_COMPLETED")
        == list(ALLOWED_SECTION_11_12_7_COMMANDS),
    }
