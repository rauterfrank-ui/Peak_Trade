#!/usr/bin/env python3
"""Generate durable evidence for Cap 11 §11.12.1 productive private-readonly API."""
...
def main() -> int:
    ...
    test_node = (
        "tests/ops/test_capability_11_section_11_12_1_productive_private_readonly_"
        "api_and_account_identity_v1.py"
    )
    proc = subprocess.run(
    ...
    proof = verification["proofs"]["section_11_12_1"]
    ...
    _write_json(productive / "section_11_12_1_proof.json", proof)
