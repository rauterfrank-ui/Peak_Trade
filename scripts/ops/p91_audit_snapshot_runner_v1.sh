...
pack_archive_root="${ARCHIVE_ROOT_HINT:-/path/to/durable/archive/supervisor_pack_${TS}}"
hint_file="$EVI/P91_POST_STOP_PRIMARY_EVIDENCE_OPERATOR_HINTS.txt"
{
  echo "P91_POST_STOP_PRIMARY_EVIDENCE_OPERATOR_HINTS_v0"
  echo "HINT_ONLY=true"
  echo "WRAPPER_REFERENCED=true"
  echo "WRAPPER_NOT_EXECUTED_BY_P91=true"
  echo "PACK_NOT_EXECUTED_BY_P91=true"
  echo "P79_ARCHIVE_VERIFY_NOT_EXECUTED_BY_P91=true"
  echo "OPERATOR_MUST_RUN_EXPLICITLY=true"
  echo "EVIDENCE_NON_AUTHORIZING=true"
  echo "P91_AUDIT_SNAPSHOT_NOT_POST_STOP_AUTHORITY=true"
  echo "RUNTIME_P79_TICK_MANIFEST_NOT_SECTION_2A_MANIFEST=true"
  echo "timestamp_utc=$TS"
  echo "supervisor_out_dir=$OUT_DIR"
