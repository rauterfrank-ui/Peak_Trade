#!/usr/bin/env python3
"""Generate durable evidence for Cap 11 §11.12.6 restart with open order/position."""
...
def main() -> int:
    ...
    test_node = "tests/ops/test_capability_11_section_11_12_6_restart_with_open_order_and_open_position_v1.py"
    proc = subprocess.run(
    ...
    proof = verification["proofs"]["section_11_12_6"]
    ...
    _write_json(productive / "section_11_12_6_proof.json", proof)
    ...
    _write_json(
        productive / "activation_state.json",
        {
            ...
            "SECTION_11_12_5_PREDECESSOR_BOUND": True,
