#!/usr/bin/env python3
"""Generate durable evidence for Cap 11.2 productive credential-load path binding."""
...
def main() -> int:
    ...
    test_node = "tests/ops/test_capability_11_2_productive_credential_load_path_binding_v1.py"
    proc = subprocess.run(
    ...
    verification = verify_capability_11_2_productive_credential_load_path_binding_v1()
