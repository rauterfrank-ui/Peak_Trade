#!/usr/bin/env python3
"""Fail-closed verifier for Cap 11.12 durable evidence package."""
...
def main() -> int:
    ...
    required = [
        ...
        "autonomy_closure_standard_field_proof.json",
        "fully_autonomous_live_readiness_ratification_proof.json",
        ...
        "capability_11_11_dependency_proof.json",
    ...
    dep_11_11 = _load(productive / "capability_11_11_dependency_proof.json")
    live_verify = verify_capability_11_12_v1()
    ...
    checks = {
        ...
        "cap_11_11_dependency": dep_11_11.get("CAPABILITY_11_11_DEPENDENCY_SATISFIED") is True,
        ...
        "no_live_order_submit": claims.get("LIVE_ORDER_SUBMIT_PERFORMED_IN_CAPABILITY_11_12")
        is False,
        "no_paper_order_submit": claims.get("PAPER_ORDER_SUBMIT_PERFORMED_IN_CAPABILITY_11_12")
        is False,
        "no_testnet_submit": claims.get("TESTNET_ORDER_SUBMIT_PERFORMED_IN_CAPABILITY_11_12")
        is False,
        "no_live_order_execution": claims.get("LIVE_ORDER_EXECUTION_PERFORMED_IN_CAPABILITY_11_12")
        is False,
        "no_credential_load": claims.get("CREDENTIAL_LOAD_PERFORMED_IN_CAPABILITY_11_12") is False,
        "no_auth_consumption": claims.get("AUTHORIZATION_CONSUMPTION_ALLOWED") is False,
        "cap_11_12_started": claims.get("CAPABILITY_11_12_STARTED") is True,
        "not_ready_overclaim": claims.get("FULLY_AUTONOMOUS_LIVE_TRADING_READY") is False,
        "not_active": claims.get("FULLY_AUTONOMOUS_LIVE_TRADING_ACTIVE") is False,
        "no_cap_11_13": claims.get("CAPABILITY_11_13_STARTED") is False,
        "dashboard_authority_none": claims.get("DASHBOARD_AUTHORITY_EFFECT") == "NONE",
        "closure_fields_bound": claims.get("AUTONOMY_CLOSURE_STANDARD_FIELD_CONTRACT_BOUND")
        is True,
        "readiness_bound": claims.get("FULLY_AUTONOMOUS_LIVE_READINESS_RATIFICATION_CONTRACT_BOUND")
        is True,
        "readiness_not_contract_activated": claims.get(
