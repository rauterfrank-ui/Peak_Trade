...
CONFIRM_GO = (
    "GO_RATIFY_CROSS_SECTIONAL_OPEN_INTEREST_ZSCORE_REVERSION_V0_VERSIONED_OFFLINE_"
...
def run_materialization(
    *,
    ...
    evidence_dir = (
        ...
        / "research"
        / f"cs_open_interest_zscore_reversion_scope_binding_ratification_v0_{ts_slug}"
    )
    ...
    payload = {
        "verdict": "CS_OPEN_INTEREST_ZSCORE_REVERSION_SCOPE_BINDING_RATIFICATION_PASS",
