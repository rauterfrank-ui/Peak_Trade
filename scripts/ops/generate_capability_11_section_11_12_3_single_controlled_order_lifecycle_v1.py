#!/usr/bin/env python3
"""Generate durable evidence for Cap 11 §11.12.3 single controlled order lifecycle."""
...
def main() -> int:
    ...
    test_node = (
        "tests/ops/test_capability_11_section_11_12_3_single_controlled_order_lifecycle_v1.py"
    )
    proc = subprocess.run(
    ...
    proof = verification["proofs"]["section_11_12_3"]
    ...
    _write_json(productive / "section_11_12_3_proof.json", proof)
    ...
    _write_json(
        productive / "activation_state.json",
        {
            ...
            "SECTION_11_12_2_PREDECESSOR_BOUND": True,
