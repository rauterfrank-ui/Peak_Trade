...
Operator GO: GO_TRADE_LEDGER_EQUITY_CURVE_PERSISTENCE_OFFLINE_EVALUATION_EXECUTION_V0
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "Execute trade ledger equity curve persistence offline evaluation v0 "
