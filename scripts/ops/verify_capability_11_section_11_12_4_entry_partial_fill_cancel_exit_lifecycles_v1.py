#!/usr/bin/env python3
"""Verify Cap 11 §11.12.4 entry / partial fill / cancel / exit lifecycles evidence."""
...
from src.ops.capability_11_section_11_12_4_entry_partial_fill_cancel_exit_lifecycles_v1.constants_v1 import (  # noqa: E402
    ALLOWED_SECTION_11_12_4_PATHS,
    CAPABILITY_ID,
    EVIDENCE_DIRNAME,
    MANIFEST_FILENAME,
)
from src.ops.capability_11_section_11_12_4_entry_partial_fill_cancel_exit_lifecycles_v1.verifier_v1 import (  # noqa: E402
...
def main() -> int:
    ...
    gates = {
        ...
        "lifecycles_performed": claims.get("ENTRY_PARTIAL_FILL_CANCEL_EXIT_LIFECYCLES_PERFORMED")
        is True,
        "cap_11_4_contract_reused": claims.get(
            "CAP_11_4_ENTRY_PARTIAL_FILL_CANCEL_EXIT_CONTRACT_REUSED"
        )
        is True,
        "predecessor_bound": claims.get("SECTION_11_12_3_PREDECESSOR_BOUND") is True,
        ...
        is False,
        "section_11_12_5_not_started": claims.get("SECTION_11_12_5_STARTED") is False,
        ...
        == list(ALLOWED_SECTION_11_12_4_PATHS),
    }
