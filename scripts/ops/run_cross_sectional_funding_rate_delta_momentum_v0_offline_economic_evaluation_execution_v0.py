...
Operator GO: GO_BOUNDED_CROSS_SECTIONAL_FUNDING_RATE_DELTA_MOMENTUM_V0_OFFLINE_ECONOMIC_EVALUATION_SCOPE_V0
"""
...
SCOPE_CLASSIFICATION = (
    "BOUNDED_CROSS_SECTIONAL_FUNDING_RATE_DELTA_MOMENTUM_V0_OFFLINE_ECONOMIC_EVALUATION_SCOPE_V0"
)
...
def run_offline_economic_evaluation_scope_v0(
    *,
    ...
    bundle_dir = (
        ...
        / "implementation"
        / f"bounded_cross_sectional_funding_rate_delta_momentum_v0_offline_economic_evaluation_scope_v0_{ts_slug}"
    )
    ...
    final_report_lines = [
        "# Cross-Sectional Funding Rate Carry v0 Offline Economic Evaluation Canonical Execution",
        "",
