#!/usr/bin/env python3
"""Generate durable evidence for Cap 11.3 productive private read-only path binding."""
...
def main() -> int:
    ...
    test_node = "tests/ops/test_capability_11_3_productive_private_readonly_path_binding_v1.py"
    proc = subprocess.run(
    ...
    verification = verify_capability_11_3_productive_private_readonly_path_binding_v1()
    ...
    _write_json(productive / "path_binding_proof.json", verification["proofs"]["path_binding"])
