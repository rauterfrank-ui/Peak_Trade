...
# Residual schedule inventory (13 files): 11 active schedule + 2 manual-only (GH-001, GH-002).
...
RESIDUAL_INTENT_LABELS: dict[str, str] = {
    ...
    "residual_all": "13 inventory workflows (11 active schedule + 2 manual-only; read-only)",
}
