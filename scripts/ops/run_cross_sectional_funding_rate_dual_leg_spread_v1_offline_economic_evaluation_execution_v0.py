#!/usr/bin/env python3
"""Canonical offline economic evaluation for cross-sectional funding-rate delta momentum v0.
...
Operator GO: GO_CROSS_SECTIONAL_FUNDING_RATE_DUAL_LEG_SPREAD_V1_OFFLINE_ECONOMIC_EVALUATION_EXECUTION_NO_RUNTIME_AUTHORITY_V0
"""
...
from scripts.ops.materialize_cross_sectional_funding_rate_delta_momentum_v0_bound_panel_funding_dataset_v0 import (  # noqa: E402
    materialize_bound_panel_funding_dataset_v0,
)
from src.research.cross_sectional_funding_rate_dual_leg_spread_v1_bound_panel_dataset_materialization_v0 import (  # noqa: E402
    MaterializationTerminalStatus,
    materialization_result_to_dict,
    materialize_bound_funding_panel_dataset_v1,
)
from src.research.cross_sectional_funding_rate_dual_leg_spread_v1_offline_economic_evaluation_execution_v0 import (  # noqa: E402
    AUTHORITY_EFFECT,
    EXECUTION_VERSION,
...
def run_offline_economic_evaluation_scope_v0(
    *,
    confirm: str,
    ...
    bundle_dir = (
        ...
        / "implementation"
        / f"cross_sectional_funding_rate_dual_leg_spread_v1_offline_economic_evaluation_execution_{ts_slug}"
    )
    ...
    materialization_a = materialize_bound_funding_panel_dataset_v1(
        staging_root,
        period_binding=versioned_binding["period_binding"],
        expected_data_digest=versioned_binding["data_digest"],
    )
    materialization_b = materialize_bound_funding_panel_dataset_v1(
        staging_root,
        period_binding=versioned_binding["period_binding"],
        expected_data_digest=versioned_binding["data_digest"],
    )
    ...
    (bundle_dir / "SCOPE_AND_GO.txt").write_text(
        "\n".join(
            [
                "EXECUTION_SCOPE=FULL_OFFLINE_ECONOMIC_EVALUATION_SCOPE_V0",
    ...
    final_report_lines = [
        "# Cross-Sectional Funding Rate Dual-Leg Spread v1 Offline Economic Evaluation Canonical Execution",
        "",
