#!/usr/bin/env python3
"""Fail-closed verifier for Owner Auth Artifact Testnet credential scope evidence."""
...
def main() -> int:
    ...
    required = [
        ...
        "owner_auth_artifact_proof.json",
        "test_results.json",
        "repository_sha.json",
    ...
    proof = _load(productive / "owner_auth_artifact_proof.json")
    live_verify = (
        verify_capability_11_owner_auth_artifact_testnet_credential_scope_private_network_v1()
    )
    ...
    checks = {
        ...
        "admissible_default_false": claims.get("OWNER_AUTH_ARTIFACT_ADMISSIBLE_DEFAULT") is False,
        ...
        "private_readonly_scope": claims.get("NETWORK_SCOPE_REQUIRED")
        ...
        "complete_admissible": proof.get("complete_artifact_admissible") is True,
        "owner_auth_proof_ok": proof.get("ok") is True,
