...
PR_BOUNDED_FULL_PACKAGE_DDO_CONTRACT_LEDGER_V0_TESTOWNER: str = (
...
PR_BOUNDED_FULL_PACKAGE_DDO_DOUBLE_PLAY_PRODUCER_INPUT_EVIDENCE_CAPTURE_V1_TESTOWNER: str = (
    "tests/learning/test_ddo_double_play_producer_input_evidence_capture_v1.py"
)
PR_BOUNDED_FULL_PACKAGE_DDO_DOUBLE_PLAY_PRODUCER_INPUT_EVIDENCE_CAPTURE_V1_PRODUCTION: str = (
...
PR_BOUNDED_FULL_PACKAGE_DDO_A1_CRASH_DURABILITY_PROOF_OR_EXPLICIT_NONPROVABILITY_CLOSURE_V1_TESTOWNER: str = "tests/learning/test_ddo_a1_crash_durability_proof_or_explicit_nonprovability_closure_v1.py"
...
PR_BOUNDED_FULL_PACKAGE_DDO_A1_HOST_CRASH_DURABILITY_CLOSURE_V1_TESTOWNER: str = (
...
PR_BOUNDED_FULL_PACKAGE_DDO_CONTRACT_LEDGER_V0_TRIGGER_PATHS: frozenset[str] = frozenset(
    {
        ...
        "docs/ops/specs/DDO_DOUBLE_PLAY_PRODUCER_INPUT_EVIDENCE_CAPTURE_V1.md",
        ...
        "src/learning/deterministic_decision_outcome_v0/lineage_v0.py",
        "src/learning/deterministic_decision_outcome_v0/outcome_v0.py",
        "src/learning/deterministic_decision_outcome_v0/promotion_controller_v0.py",
        "src/learning/deterministic_decision_outcome_v0/promotion_records_v0.py",
        "src/learning/deterministic_decision_outcome_v0/reason_codes_v0.py",
        "src/learning/deterministic_decision_outcome_v0/registry_v0.py",
        "src/learning/deterministic_decision_outcome_v0/replay_evaluator_v0.py",
...
PR_BOUNDED_FULL_PACKAGE_DDO_A1_MUTATION_CRITICAL_CONTROL_STATE_STORAGE_V1_TRIGGER_PATHS: frozenset[
...
] = frozenset(
    {
        ...
        "src/learning/mutation_critical_control_state_storage_v1/durability_primitives_v1.py",
        "src/learning/mutation_critical_control_state_storage_v1/host_crash_durability_claim_matrix_v1.py",
        "src/learning/mutation_critical_control_state_storage_v1/host_crash_durability_closure_v1.py",
        "src/learning/mutation_critical_control_state_storage_v1/host_filesystem_capability_v1.py",
        ...
        PR_BOUNDED_FULL_PACKAGE_DDO_A1_HOST_CRASH_DURABILITY_CLOSURE_V1_TESTOWNER,
        ...
        "docs/ops/specs/DDO_A1_HOST_CRASH_DURABILITY_CLOSURE_V1.md",
    }
)
...
PR_BOUNDED_FULL_PACKAGE_COMPARISON_METRIC_INPUT_DURABLE_EVIDENCE_TRIGGER_PATHS: frozenset[str] = (
    frozenset(
        {
...
PR_BOUNDED_FULL_PACKAGE_COMPARISON_METRIC_INPUT_DURABLE_EVIDENCE_TARGETS: tuple[str, ...] = (
    "tests/meta/test_comparison_metric_input_durable_evidence_binding_v1.py",
    "tests/scripts/test_run_comparison_metric_input_durable_evidence_binding_v1.py",
...
PR_BOUNDED_FULL_PACKAGE_COMPARISON_COMPLETION_EVIDENCE_V1_TRIGGER_PATHS: frozenset[str] = frozenset(
    {
        "src/meta/learning_loop/comparison_completion_evidence_v1.py",
        "scripts/run_comparison_completion_evidence_v1.py",
        "tests/meta/test_comparison_completion_evidence_v1.py",
        "tests/scripts/test_run_comparison_completion_evidence_v1.py",
    }
)

PR_BOUNDED_FULL_PACKAGE_COMPARISON_COMPLETION_EVIDENCE_V1_TARGETS: tuple[str, ...] = (
    "tests/meta/test_comparison_completion_evidence_v1.py",
    "tests/scripts/test_run_comparison_completion_evidence_v1.py",
    "tests/meta/test_comparison_checkpoint_v1.py",
    "tests/meta/test_contract_safety_v1.py",
...
PR_BOUNDED_FULL_PACKAGE_COMPARISON_PROMOTION_CANDIDATE_ELIGIBILITY_EVIDENCE_V1_TRIGGER_PATHS: frozenset[
    str
] = frozenset(
    {
        ...
        "tests/meta/comparison_promotion_candidate_eligibility_evidence_v1_fixtures.py",
    }
)

PR_BOUNDED_FULL_PACKAGE_COMPARISON_PROMOTION_CANDIDATE_ELIGIBILITY_EVIDENCE_V1_TARGETS: tuple[
    str, ...
] = (
    "tests/meta/test_comparison_promotion_candidate_eligibility_evidence_v1.py",
    "tests/scripts/test_run_comparison_promotion_candidate_eligibility_evidence_v1.py",
...
PR_BOUNDED_FULL_PACKAGE_COMPARISON_PROMOTION_CANDIDATE_MODEL_PARAMETER_IDENTITY_BINDING_V1_TRIGGER_PATHS: frozenset[
    str
] = frozenset(
    {
        ...
        "tests/meta/comparison_promotion_candidate_model_parameter_identity_binding_v1_fixtures.py",
    }
)

PR_BOUNDED_FULL_PACKAGE_COMPARISON_PROMOTION_CANDIDATE_MODEL_PARAMETER_IDENTITY_BINDING_V1_TARGETS: tuple[
    str, ...
] = (
    "tests/meta/test_comparison_promotion_candidate_model_parameter_identity_binding_v1.py",
    "tests/scripts/test_run_comparison_promotion_candidate_model_parameter_identity_binding_v1.py",
...
PR_BOUNDED_FULL_PACKAGE_COMPARISON_CONFIG_PATCH_MANIFEST_CROSS_DOMAIN_LINEAGE_BINDING_V1_TRIGGER_PATHS: frozenset[
    str
] = frozenset(
    {
        ...
        "tests/meta/comparison_config_patch_manifest_cross_domain_lineage_binding_v1_fixtures.py",
    }
)

PR_BOUNDED_FULL_PACKAGE_COMPARISON_CONFIG_PATCH_MANIFEST_CROSS_DOMAIN_LINEAGE_BINDING_V1_TARGETS: tuple[
    str, ...
] = (
    "tests/meta/test_comparison_config_patch_manifest_cross_domain_lineage_binding_v1.py",
    "tests/scripts/test_run_comparison_config_patch_manifest_cross_domain_lineage_binding_v1.py",
...
PR_BOUNDED_FULL_PACKAGE_COMPARISON_PROMOTION_CANDIDATE_INPUT_V1_TRIGGER_PATHS: frozenset[str] = (
    frozenset(
        {
            ...
            "tests/meta/comparison_promotion_candidate_input_v1_fixtures.py",
        }
    )
)

PR_BOUNDED_FULL_PACKAGE_COMPARISON_PROMOTION_CANDIDATE_INPUT_V1_TARGETS: tuple[str, ...] = (
    "tests/meta/test_comparison_promotion_candidate_input_v1.py",
    "tests/scripts/test_run_comparison_promotion_candidate_input_v1.py",
    "tests/meta/test_comparison_config_patch_manifest_cross_domain_lineage_binding_v1.py",
    "tests/meta/test_comparison_promotion_candidate_model_parameter_identity_binding_v1.py",
...
PR_BOUNDED_FULL_PACKAGE_COMPARISON_ELIGIBILITY_PROMOTION_POLICY_INPUT_BINDING_V1_TRIGGER_PATHS: frozenset[
    str
] = frozenset(
    {
        ...
        "tests/meta/comparison_eligibility_promotion_policy_input_binding_v1_fixtures.py",
    }
)

PR_BOUNDED_FULL_PACKAGE_COMPARISON_ELIGIBILITY_PROMOTION_POLICY_INPUT_BINDING_V1_TARGETS: tuple[
    str, ...
] = (
    "tests/meta/test_comparison_eligibility_promotion_policy_input_binding_v1.py",
    "tests/scripts/test_run_comparison_eligibility_promotion_policy_input_binding_v1.py",
...
PR_BOUNDED_FULL_PACKAGE_COMPARISON_PROMOTION_POLICY_DECISION_V1_TRIGGER_PATHS: frozenset[str] = (
    frozenset(
        {
            ...
            "tests/meta/comparison_promotion_policy_decision_v1_fixtures.py",
        }
    )
)

PR_BOUNDED_FULL_PACKAGE_COMPARISON_PROMOTION_POLICY_DECISION_V1_TARGETS: tuple[str, ...] = (
    "tests/meta/test_comparison_promotion_policy_decision_v1.py",
    "tests/scripts/test_run_comparison_promotion_policy_decision_v1.py",
    "tests/meta/test_comparison_promotion_policy_input_evidence_v1.py",
    "tests/meta/test_comparison_eligibility_promotion_policy_input_binding_v1.py",
...
PR_BOUNDED_FULL_PACKAGE_AI_PROMOTION_ASSESSMENT_V1_TRIGGER_PATHS: frozenset[str] = frozenset(
    {
        "src/meta/learning_loop/ai_promotion_assessment_v1.py",
        "scripts/run_ai_promotion_assessment_v1.py",
        "tests/meta/test_ai_promotion_assessment_v1.py",
        "tests/scripts/test_run_ai_promotion_assessment_v1.py",
        "tests/meta/ai_promotion_assessment_v1_fixtures.py",
    }
)

PR_BOUNDED_FULL_PACKAGE_AI_PROMOTION_ASSESSMENT_V1_TARGETS: tuple[str, ...] = (
    "tests/meta/test_ai_promotion_assessment_v1.py",
    "tests/scripts/test_run_ai_promotion_assessment_v1.py",
    "tests/meta/test_comparison_promotion_policy_decision_v1.py",
    "tests/scripts/test_run_comparison_promotion_policy_decision_v1.py",
...
PR_BOUNDED_FULL_PACKAGE_VERSIONED_STRATEGY_MODEL_PARAMETER_ARTIFACT_V1_TRIGGER_PATHS: frozenset[
    str
] = frozenset(
    {
        "src/meta/learning_loop/versioned_strategy_model_parameter_artifact_v1.py",
        "scripts/run_versioned_strategy_model_parameter_artifact_v1.py",
        ...
        "tests/meta/versioned_strategy_model_parameter_artifact_v1_fixtures.py",
    }
)

PR_BOUNDED_FULL_PACKAGE_VERSIONED_STRATEGY_MODEL_PARAMETER_ARTIFACT_V1_TARGETS: tuple[str, ...] = (
    "tests/meta/test_versioned_strategy_model_parameter_artifact_v1.py",
    "tests/scripts/test_run_versioned_strategy_model_parameter_artifact_v1.py",
    "tests/meta/test_ai_promotion_assessment_v1.py",
    "tests/scripts/test_run_ai_promotion_assessment_v1.py",
...
PR_BOUNDED_FULL_PACKAGE_SECURE_HANDOFF_ENVELOPE_V1_TRIGGER_PATHS: frozenset[str] = frozenset(
    {
        "src/meta/learning_loop/secure_handoff_envelope_v1.py",
        "scripts/run_secure_handoff_envelope_v1.py",
        "tests/meta/test_secure_handoff_envelope_v1.py",
        "tests/scripts/test_run_secure_handoff_envelope_v1.py",
        "tests/meta/secure_handoff_envelope_v1_fixtures.py",
    }
)
...
def resolve_pr_bounded_full_targets(files: list[str]) -> tuple[str, ...]:
    ...
    if (
        normalized
        & PR_BOUNDED_FULL_PACKAGE_COMPARISON_PROMOTION_CANDIDATE_ELIGIBILITY_EVIDENCE_V1_TRIGGER_PATHS
    ):
        for (
            path
        ) in PR_BOUNDED_FULL_PACKAGE_COMPARISON_PROMOTION_CANDIDATE_ELIGIBILITY_EVIDENCE_V1_TARGETS:
            add(path)
    ...
    if (
        normalized
        & PR_BOUNDED_FULL_PACKAGE_COMPARISON_CONFIG_PATCH_MANIFEST_CROSS_DOMAIN_LINEAGE_BINDING_V1_TRIGGER_PATHS
    ):
        for path in PR_BOUNDED_FULL_PACKAGE_COMPARISON_CONFIG_PATCH_MANIFEST_CROSS_DOMAIN_LINEAGE_BINDING_V1_TARGETS:
            add(path)

    if normalized & PR_BOUNDED_FULL_PACKAGE_COMPARISON_PROMOTION_CANDIDATE_INPUT_V1_TRIGGER_PATHS:
        for path in PR_BOUNDED_FULL_PACKAGE_COMPARISON_PROMOTION_CANDIDATE_INPUT_V1_TARGETS:
            add(path)

    if (
        normalized
        & PR_BOUNDED_FULL_PACKAGE_COMPARISON_ELIGIBILITY_PROMOTION_POLICY_INPUT_BINDING_V1_TRIGGER_PATHS
    ):
        for path in (
    ...
    if normalized & PR_BOUNDED_FULL_PACKAGE_COMPARISON_PROMOTION_POLICY_DECISION_V1_TRIGGER_PATHS:
        for path in PR_BOUNDED_FULL_PACKAGE_COMPARISON_PROMOTION_POLICY_DECISION_V1_TARGETS:
            add(path)

    if normalized & PR_BOUNDED_FULL_PACKAGE_AI_PROMOTION_ASSESSMENT_V1_TRIGGER_PATHS:
        for path in PR_BOUNDED_FULL_PACKAGE_AI_PROMOTION_ASSESSMENT_V1_TARGETS:
            add(path)
        ...
        if path.startswith("tests/") and path.endswith(".py"):
            ...
            if path == "scripts/run_promotion_proposal_cycle.py":
                ...
                for candidate in PR_BOUNDED_FULL_PACKAGE_E21_EXPERIMENT_DURABLE_EVIDENCE_TARGETS:
                    add(candidate)
            elif path == "scripts/run_comparison_metric_input_durable_evidence_binding_v1.py":
                for (
                    candidate
                ...
                for (
                    ...
                    add(candidate)
            elif path == "scripts/run_comparison_ssot_result_durable_evidence_binding_v1.py":
                for (
                    candidate
