#!/usr/bin/env python3
"""GET-only STEP-29P fresh venue evidence against eea.okx.com. No POST.

Launch via the canonical interpreter:

  ./scripts/pt scripts/ops/run_full_core_step_29p_fresh_venue_evidence_gets_v1.py ...
  ./scripts/pt -m src.ops.full_core_step_29p_fresh_venue_evidence_v1 ...

Direct PATH python/python3 execution is unsupported.
"""
