# rescue(docs): integrate docs reference-target priority fixes [rescued]
...
## Verification
- Local quality gates (ruff/pytest) wurden ausgeführt bzw. sind unverändert.
- CI: erwartet grün (docs + ops tooling).
- `scripts/ops/verify_docs_reference_targets.sh` validiert erfolgreich.

## Risk
- **Low**: Hauptsächlich Dokumentations-Fixes und Ops-Tooling-Verbesserungen.
- Neue Ignore-Liste für historische Referenzen (legacy docs).
- Background job runner für lang laufende Befehle.
