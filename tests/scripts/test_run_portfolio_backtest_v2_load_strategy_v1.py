...
def test_build_strategy_params_isolated_per_strategy_key() -> None:
    ...
    ma_params = portfolio_v2_script._build_strategy_params_from_config(cfg, MA_CROSSOVER_KEY)
    mom_params = portfolio_v2_script._build_strategy_params_from_config(cfg, MOMENTUM_KEY)
