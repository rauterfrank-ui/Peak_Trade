"""CLI tests for run_comparison_promotion_candidate_model_parameter_identity_binding_v1."""
...
from scripts.run_comparison_promotion_candidate_model_parameter_identity_binding_v1 import (
    EXIT_EVIDENCE_ERROR,
    EXIT_OK,
    EXIT_USAGE_ERROR,
    main,
...
def test_cli_happy_path(tmp_path, ssot_durable_output_dir, capsys) -> None:
    ...
    rc = main(
        [
            ...
            str(eligibility.eligibility_evidence_bundle_dir),
            "--output-dir",
            str(out),
        ]
    )
