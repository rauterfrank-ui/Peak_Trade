"""Contract tests for run_adapter_submission_contract_v1 script."""
...
from scripts.run_adapter_submission_contract_v1 import EXIT_OK, EXIT_USAGE_ERROR, main
...
def test_script_happy_path(tmp_path, ssot_durable_output_dir, capsys) -> None:
    ...
    out = tmp_path / "evidence_root" / "script_adapter_submission"
    rc = main(
        [
    ...
    assert "ADAPTER_SUBMISSION_CONTRACT_VALID" in captured.out
