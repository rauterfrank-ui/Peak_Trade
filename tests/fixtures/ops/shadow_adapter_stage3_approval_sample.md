# Stage-3 Shadow Bounded Dry-Run Execution Approval (Sample Fixture)

**Status:** TEST FIXTURE ONLY — not a live authorization

```
OPERATOR_NAME=Frank
SELECTED_CANDIDATE_NAME=SHADOW_BOUNDED_OBSERVATION_RETENTION_ADAPTER_V0
ADAPTER_DESIGN=cli_adapter_wrapper_composition_v0
