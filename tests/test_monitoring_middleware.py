...
def test_monitor_performance_decorator_success():
    ...
    with patch('src.monitoring.middleware.prometheus_exporter') as mock_exporter:
...
def test_monitor_performance_without_prometheus():
    ...
    # Simulate ImportError for prometheus_exporter
    with patch('src.monitoring.middleware.prometheus_exporter', side_effect=ImportError):
        @monitor_performance("test_operation")
        def test_func():
            return "success"
