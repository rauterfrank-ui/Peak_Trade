...
REFRESHED_AUTHORITY_BUNDLE = (
    "/Users/frnkhrz/Documents/Peak_Trade_runtime_evidence_archive_20260520T161443Z/"
    "planning/csc_rchain_v1_post_ops_gap4_gap5_batch_authority_refresh_and_next_batch_ranking_readonly_v0_20260601T125326Z"
)
...
def test_csc_rchain_v1_grouping_reflection_truth_map_crosslink_v0() -> None:
    ...
    assert "CSC_RCHAIN_V1_ACCEPTED_CANDIDATE_COUNT=172" in truth_map
    ...
    assert "CSC_RCHAIN_V1_ACCEPTED_GROUP_COUNT=17" in truth_map
