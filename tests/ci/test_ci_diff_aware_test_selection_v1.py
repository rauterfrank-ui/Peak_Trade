...
def test_mapping_file_exists() -> None:
    ...
    assert "market_dashboard_focused:" not in text
...
PACKAGE_DDO_CAPTURE_V0_PRODUCTION = "src/learning/deterministic_decision_outcome_v0/capture_v0.py"
...
PACKAGE_DDO_A1_HOST_CRASH_DURABILITY_CLOSURE_V1_TESTOWNER = (
...
def test_selector_ddo_contract_ledger_v0_production_pr_bounded_full_includes_testowner() -> None:
    sel = _run_selector(PACKAGE_DDO_CONTRACT_LEDGER_V0_PRODUCTION)
    assert sel["test_selection_mode"] == "PR_BOUNDED_FULL"
    bounded = _bounded_targets(sel)
    assert PACKAGE_DDO_CONTRACT_LEDGER_V0_TESTOWNER in bounded
    assert PACKAGE_DDO_CONTROL_PLANE_V0_TESTOWNER in bounded
    assert PACKAGE_DDO_CAPTURE_V0_TESTOWNER in bounded
    ...
    assert PACKAGE_DDO_DOUBLE_PLAY_SEMANTIC_REPLAY_PARITY_V1_TESTOWNER in bounded
    assert (
        PACKAGE_DDO_A1_CRASH_DURABILITY_PROOF_OR_EXPLICIT_NONPROVABILITY_CLOSURE_V1_TESTOWNER
        in bounded
    )
...
def test_selector_ddo_capture_v0_production_pr_bounded_full_includes_testowners() -> None:
    sel = _run_selector(PACKAGE_DDO_CAPTURE_V0_PRODUCTION)
    assert sel["test_selection_mode"] == "PR_BOUNDED_FULL"
    bounded = _bounded_targets(sel)
    assert PACKAGE_DDO_CONTRACT_LEDGER_V0_TESTOWNER in bounded
    assert PACKAGE_DDO_CONTROL_PLANE_V0_TESTOWNER in bounded
...
def test_selector_ddo_evaluation_engine_v0_production_pr_bounded_full_includes_testowners() -> None:
    sel = _run_selector(PACKAGE_DDO_EVALUATION_ENGINE_V0_PRODUCTION)
    assert sel["test_selection_mode"] == "PR_BOUNDED_FULL"
    bounded = _bounded_targets(sel)
    assert PACKAGE_DDO_CONTRACT_LEDGER_V0_TESTOWNER in bounded
    assert PACKAGE_DDO_CONTROL_PLANE_V0_TESTOWNER in bounded
...
def test_selector_ddo_learning_validation_shadow_v0_production_pr_bounded_full_includes_testowners() -> (
    None
):
    sel = _run_selector(PACKAGE_DDO_LEARNING_VALIDATION_SHADOW_V0_PRODUCTION)
    assert sel["test_selection_mode"] == "PR_BOUNDED_FULL"
    bounded = _bounded_targets(sel)
    assert PACKAGE_DDO_CONTRACT_LEDGER_V0_TESTOWNER in bounded
    assert PACKAGE_DDO_CONTROL_PLANE_V0_TESTOWNER in bounded
...
def test_selector_ddo_owner_bindings_and_drift_v0_production_pr_bounded_full_includes_testowners() -> (
    None
):
    sel = _run_selector(PACKAGE_DDO_OWNER_BINDINGS_AND_DRIFT_V0_PRODUCTION)
    assert sel["test_selection_mode"] == "PR_BOUNDED_FULL"
    bounded = _bounded_targets(sel)
    assert PACKAGE_DDO_CONTRACT_LEDGER_V0_TESTOWNER in bounded
    assert PACKAGE_DDO_CONTROL_PLANE_V0_TESTOWNER in bounded
...
def test_selector_ddo_double_play_semantic_replay_parity_v1_pr_bounded_full() -> None:
    sel = _run_selector(PACKAGE_DDO_DOUBLE_PLAY_SEMANTIC_REPLAY_PARITY_V1_PRODUCTION)
    assert sel["test_selection_mode"] == "PR_BOUNDED_FULL"
    bounded = _bounded_targets(sel)
    assert PACKAGE_DDO_DOUBLE_PLAY_SEMANTIC_REPLAY_PARITY_V1_TESTOWNER in bounded
...
def test_selector_ddo_contract_ledger_v0_combined_diff_pr_bounded_full_includes_testowner_once() -> (
    ...
    sel = _run_selector(
        PACKAGE_DDO_CONTRACT_LEDGER_V0_PRODUCTION,
        PACKAGE_DDO_CONTRACT_LEDGER_V0_LEDGER,
        PACKAGE_DDO_CAPTURE_V0_PRODUCTION,
        PACKAGE_DDO_EVALUATION_ENGINE_V0_PRODUCTION,
        PACKAGE_DDO_LEARNING_VALIDATION_SHADOW_V0_PRODUCTION,
        PACKAGE_DDO_OWNER_BINDINGS_AND_DRIFT_V0_PRODUCTION,
        PACKAGE_DDO_CURRENT_DOUBLE_PLAY_CAPTURE_PARITY_V1_PRODUCTION,
...
def test_selector_ddo_a1_mutation_critical_control_state_storage_pr_bounded_full() -> None:
    ...
    assert PACKAGE_DDO_A1_HOST_CRASH_DURABILITY_CLOSURE_V1_TESTOWNER in bounded
    assert PACKAGE_DDO_DURABLE_EVIDENCE_STORAGE_OWNER_CONTRACT_V1_TESTOWNER in bounded
    assert (
        PACKAGE_DDO_A1_CRASH_DURABILITY_PROOF_OR_EXPLICIT_NONPROVABILITY_CLOSURE_V1_TESTOWNER
        in bounded
...
PACKAGE_CMP_METRIC_INPUT_DURABLE_BINDING_PRODUCTION = (
    "src/meta/learning_loop/comparison_metric_input_durable_evidence_binding_v1.py"
)
PACKAGE_CMP_METRIC_INPUT_DURABLE_BINDING_SCRIPT = (
    "scripts/run_comparison_metric_input_durable_evidence_binding_v1.py"
)
PACKAGE_CMP_METRIC_INPUT_DURABLE_BINDING_TESTOWNER = (
    "tests/meta/test_comparison_metric_input_durable_evidence_binding_v1.py"
)
PACKAGE_CMP_METRIC_INPUT_DURABLE_BINDING_CLI_TESTOWNER = (
    "tests/scripts/test_run_comparison_metric_input_durable_evidence_binding_v1.py"
)
PACKAGE_CMP_METRIC_INPUT_DURABLE_BINDING_DEPENDENCY_TESTOWNERS = (
...
PACKAGE_CMP_METRIC_INPUT_DURABLE_BINDING_ALL_PRODUCTION = (
    PACKAGE_CMP_METRIC_INPUT_DURABLE_BINDING_PRODUCTION,
    PACKAGE_CMP_METRIC_INPUT_DURABLE_BINDING_SCRIPT,
)
PACKAGE_CMP_METRIC_INPUT_DURABLE_BINDING_ALL_TESTOWNERS = (
    PACKAGE_CMP_METRIC_INPUT_DURABLE_BINDING_TESTOWNER,
    PACKAGE_CMP_METRIC_INPUT_DURABLE_BINDING_CLI_TESTOWNER,
    *PACKAGE_CMP_METRIC_INPUT_DURABLE_BINDING_DEPENDENCY_TESTOWNERS,
)
...
def test_selector_package_cmp_metric_input_durable_binding_production_pr_bounded_full_includes_testowners() -> (
    None
):
    sel = _run_selector(PACKAGE_CMP_METRIC_INPUT_DURABLE_BINDING_PRODUCTION)
    assert sel["test_selection_mode"] == "PR_BOUNDED_FULL"
    bounded = _bounded_targets(sel)
    for path in PACKAGE_CMP_METRIC_INPUT_DURABLE_BINDING_ALL_TESTOWNERS:
        assert path in bounded


def test_selector_package_cmp_metric_input_durable_binding_script_contract_focused_includes_testowners() -> (
    None
):
    sel = _run_selector(PACKAGE_CMP_METRIC_INPUT_DURABLE_BINDING_SCRIPT)
    assert sel["test_selection_mode"] == "CONTRACT_FOCUSED"
    targets = _targets(sel)
    for path in PACKAGE_CMP_METRIC_INPUT_DURABLE_BINDING_ALL_TESTOWNERS:
        assert path in targets
...
def test_selector_package_cmp_metric_input_durable_binding_combined_diff_pr_bounded_full_includes_all_testowners_once() -> (
    None
):
    sel = _run_selector(
        *PACKAGE_CMP_METRIC_INPUT_DURABLE_BINDING_ALL_PRODUCTION,
...
def test_selector_package_cmp_metric_input_durable_binding_full_six_file_diff_pr_bounded_full_not_no_op() -> (
    None
):
    sel = _run_selector(
        PACKAGE_CMP_METRIC_INPUT_DURABLE_BINDING_PRODUCTION,
...
PACKAGE_CMP_SSOT_RESULT_DURABLE_BINDING_PRODUCTION = (
    "src/meta/learning_loop/comparison_ssot_result_durable_evidence_binding_v1.py"
)
PACKAGE_CMP_SSOT_RESULT_DURABLE_BINDING_SCRIPT = (
    "scripts/run_comparison_ssot_result_durable_evidence_binding_v1.py"
)
PACKAGE_CMP_SSOT_RESULT_DURABLE_BINDING_TESTOWNER = (
    "tests/meta/test_comparison_ssot_result_durable_evidence_binding_v1.py"
)
PACKAGE_CMP_SSOT_RESULT_DURABLE_BINDING_CLI_TESTOWNER = (
    "tests/scripts/test_run_comparison_ssot_result_durable_evidence_binding_v1.py"
)
PACKAGE_CMP_SSOT_RESULT_DURABLE_BINDING_DEPENDENCY_TESTOWNERS = (
    "tests/meta/test_comparison_result_manifest_v1.py",
    "tests/meta/test_contract_safety_v1.py",
    "tests/governance/promotion_loop/test_candidate_lineage_manifest_v1_contract.py",
)
PACKAGE_CMP_SSOT_RESULT_DURABLE_BINDING_ALL_PRODUCTION = (
    PACKAGE_CMP_SSOT_RESULT_DURABLE_BINDING_PRODUCTION,
    PACKAGE_CMP_SSOT_RESULT_DURABLE_BINDING_SCRIPT,
)
PACKAGE_CMP_SSOT_RESULT_DURABLE_BINDING_ALL_TESTOWNERS = (
    PACKAGE_CMP_SSOT_RESULT_DURABLE_BINDING_TESTOWNER,
    PACKAGE_CMP_SSOT_RESULT_DURABLE_BINDING_CLI_TESTOWNER,
    *PACKAGE_CMP_SSOT_RESULT_DURABLE_BINDING_DEPENDENCY_TESTOWNERS,
)
...
def test_selector_package_cmp_ssot_result_durable_binding_production_pr_bounded_full_includes_testowners() -> (
    None
):
    sel = _run_selector(PACKAGE_CMP_SSOT_RESULT_DURABLE_BINDING_PRODUCTION)
    assert sel["test_selection_mode"] == "PR_BOUNDED_FULL"
    bounded = _bounded_targets(sel)
    for path in PACKAGE_CMP_SSOT_RESULT_DURABLE_BINDING_ALL_TESTOWNERS:
        assert path in bounded


def test_selector_package_cmp_ssot_result_durable_binding_script_contract_focused_includes_testowners() -> (
    None
):
    sel = _run_selector(PACKAGE_CMP_SSOT_RESULT_DURABLE_BINDING_SCRIPT)
    assert sel["test_selection_mode"] == "CONTRACT_FOCUSED"
    targets = _targets(sel)
    for path in PACKAGE_CMP_SSOT_RESULT_DURABLE_BINDING_ALL_TESTOWNERS:
        assert path in targets
...
def test_selector_package_cmp_ssot_result_durable_binding_combined_diff_pr_bounded_full_includes_all_testowners_once() -> (
    None
):
    sel = _run_selector(
        *PACKAGE_CMP_SSOT_RESULT_DURABLE_BINDING_ALL_PRODUCTION,
...
def test_selector_package_cmp_ssot_result_durable_binding_full_six_file_diff_pr_bounded_full_not_no_op() -> (
    None
):
    sel = _run_selector(
        PACKAGE_CMP_SSOT_RESULT_DURABLE_BINDING_PRODUCTION,
...
PACKAGE_CMP_COMPLETION_EVIDENCE_V1_PRODUCTION = (
    "src/meta/learning_loop/comparison_completion_evidence_v1.py"
)
PACKAGE_CMP_COMPLETION_EVIDENCE_V1_SCRIPT = "scripts/run_comparison_completion_evidence_v1.py"
PACKAGE_CMP_COMPLETION_EVIDENCE_V1_TESTOWNER = (
    "tests/meta/test_comparison_completion_evidence_v1.py"
)
PACKAGE_CMP_COMPLETION_EVIDENCE_V1_CLI_TESTOWNER = (
    "tests/scripts/test_run_comparison_completion_evidence_v1.py"
)
PACKAGE_CMP_COMPLETION_EVIDENCE_V1_DEPENDENCY_TESTOWNERS = (
    "tests/meta/test_comparison_checkpoint_v1.py",
    "tests/meta/test_contract_safety_v1.py",
    "tests/ci/test_ci_diff_aware_test_selection_v1.py",
)
PACKAGE_CMP_COMPLETION_EVIDENCE_V1_ALL_PRODUCTION = (
    PACKAGE_CMP_COMPLETION_EVIDENCE_V1_PRODUCTION,
    PACKAGE_CMP_COMPLETION_EVIDENCE_V1_SCRIPT,
)
PACKAGE_CMP_COMPLETION_EVIDENCE_V1_ALL_TESTOWNERS = (
    PACKAGE_CMP_COMPLETION_EVIDENCE_V1_TESTOWNER,
    PACKAGE_CMP_COMPLETION_EVIDENCE_V1_CLI_TESTOWNER,
    *PACKAGE_CMP_COMPLETION_EVIDENCE_V1_DEPENDENCY_TESTOWNERS,
)

PACKAGE_RESEARCH_VALIDITY_EVIDENCE_V1_PRODUCTION = (
    "src/meta/learning_loop/research_validity_evidence_v1.py"
)
PACKAGE_RESEARCH_VALIDITY_EVIDENCE_V1_SCRIPT = "scripts/run_research_validity_evidence_v1.py"
PACKAGE_RESEARCH_VALIDITY_EVIDENCE_V1_TESTOWNER = "tests/meta/test_research_validity_evidence_v1.py"
PACKAGE_RESEARCH_VALIDITY_EVIDENCE_V1_CLI_TESTOWNER = (
...
PACKAGE_RESEARCH_VALIDITY_EVIDENCE_V1_ALL_PRODUCTION = (
    PACKAGE_RESEARCH_VALIDITY_EVIDENCE_V1_PRODUCTION,
    PACKAGE_RESEARCH_VALIDITY_EVIDENCE_V1_SCRIPT,
)
PACKAGE_RESEARCH_VALIDITY_EVIDENCE_V1_ALL_TESTOWNERS = (
    PACKAGE_RESEARCH_VALIDITY_EVIDENCE_V1_TESTOWNER,
    PACKAGE_RESEARCH_VALIDITY_EVIDENCE_V1_CLI_TESTOWNER,
    *PACKAGE_RESEARCH_VALIDITY_EVIDENCE_V1_DEPENDENCY_TESTOWNERS,
)
...
PACKAGE_CMP_PROMOTION_CANDIDATE_IDENTITY_BINDING_V1_PRODUCTION = (
    "src/meta/learning_loop/comparison_promotion_candidate_identity_binding_v1.py"
)
PACKAGE_CMP_PROMOTION_CANDIDATE_IDENTITY_BINDING_V1_SCRIPT = (
    "scripts/run_comparison_promotion_candidate_identity_binding_v1.py"
)
PACKAGE_CMP_PROMOTION_CANDIDATE_IDENTITY_BINDING_V1_TESTOWNER = (
    "tests/meta/test_comparison_promotion_candidate_identity_binding_v1.py"
)
PACKAGE_CMP_PROMOTION_CANDIDATE_IDENTITY_BINDING_V1_CLI_TESTOWNER = (
    "tests/scripts/test_run_comparison_promotion_candidate_identity_binding_v1.py"
)
PACKAGE_CMP_PROMOTION_CANDIDATE_IDENTITY_BINDING_V1_DEPENDENCY_TESTOWNERS = (
    "tests/meta/test_comparison_completion_promotion_input_binding_v1.py",
    "tests/meta/test_comparison_metric_input_durable_evidence_binding_v1.py",
    "tests/governance/promotion_loop/test_candidate_lineage_manifest_v1_contract.py",
    "tests/meta/test_contract_safety_v1.py",
...
PACKAGE_CMP_PROMOTION_CANDIDATE_IDENTITY_BINDING_V1_ALL_PRODUCTION = (
    PACKAGE_CMP_PROMOTION_CANDIDATE_IDENTITY_BINDING_V1_PRODUCTION,
    PACKAGE_CMP_PROMOTION_CANDIDATE_IDENTITY_BINDING_V1_SCRIPT,
)
PACKAGE_CMP_PROMOTION_CANDIDATE_IDENTITY_BINDING_V1_ALL_TESTOWNERS = (
    PACKAGE_CMP_PROMOTION_CANDIDATE_IDENTITY_BINDING_V1_TESTOWNER,
    PACKAGE_CMP_PROMOTION_CANDIDATE_IDENTITY_BINDING_V1_CLI_TESTOWNER,
    *PACKAGE_CMP_PROMOTION_CANDIDATE_IDENTITY_BINDING_V1_DEPENDENCY_TESTOWNERS,
)
...
def test_selector_package_cmp_completion_evidence_v1_production_pr_bounded_full_includes_testowners() -> (
    None
):
    sel = _run_selector(PACKAGE_CMP_COMPLETION_EVIDENCE_V1_PRODUCTION)
    assert sel["test_selection_mode"] == "PR_BOUNDED_FULL"
    bounded = _bounded_targets(sel)
    for path in PACKAGE_CMP_COMPLETION_EVIDENCE_V1_ALL_TESTOWNERS:
        assert path in bounded


def test_selector_package_cmp_completion_evidence_v1_combined_diff_pr_bounded_full_includes_all_testowners_once() -> (
    None
):
    sel = _run_selector(
        *PACKAGE_CMP_COMPLETION_EVIDENCE_V1_ALL_PRODUCTION,
...
def test_selector_package_research_validity_evidence_v1_production_pr_bounded_full_includes_testowners() -> (
    None
):
    sel = _run_selector(PACKAGE_RESEARCH_VALIDITY_EVIDENCE_V1_PRODUCTION)
    assert sel["test_selection_mode"] == "PR_BOUNDED_FULL"
    bounded = _bounded_targets(sel)
...
def test_selector_package_research_validity_evidence_v1_combined_diff_pr_bounded_full_includes_all_testowners_once() -> (
    None
):
    sel = _run_selector(
        *PACKAGE_RESEARCH_VALIDITY_EVIDENCE_V1_ALL_PRODUCTION,
...
def test_selector_package_cmp_promotion_candidate_identity_binding_v1_production_pr_bounded_full_includes_testowners() -> (
    None
):
    sel = _run_selector(PACKAGE_CMP_PROMOTION_CANDIDATE_IDENTITY_BINDING_V1_PRODUCTION)
    assert sel["test_selection_mode"] == "PR_BOUNDED_FULL"
    bounded = _bounded_targets(sel)
    for path in PACKAGE_CMP_PROMOTION_CANDIDATE_IDENTITY_BINDING_V1_ALL_TESTOWNERS:
        assert path in bounded


def test_selector_package_cmp_promotion_candidate_identity_binding_v1_combined_diff_pr_bounded_full_includes_all_testowners_once() -> (
    None
):
    sel = _run_selector(
        *PACKAGE_CMP_PROMOTION_CANDIDATE_IDENTITY_BINDING_V1_ALL_PRODUCTION,
...
PACKAGE_CMP_PROMOTION_CANDIDATE_ELIGIBILITY_EVIDENCE_V1_PRODUCTION = (
    "src/meta/learning_loop/comparison_promotion_candidate_eligibility_evidence_v1.py"
)
PACKAGE_CMP_PROMOTION_CANDIDATE_ELIGIBILITY_EVIDENCE_V1_SCRIPT = (
    "scripts/run_comparison_promotion_candidate_eligibility_evidence_v1.py"
)
PACKAGE_CMP_PROMOTION_CANDIDATE_ELIGIBILITY_EVIDENCE_V1_TESTOWNER = (
    "tests/meta/test_comparison_promotion_candidate_eligibility_evidence_v1.py"
)
PACKAGE_CMP_PROMOTION_CANDIDATE_ELIGIBILITY_EVIDENCE_V1_CLI_TESTOWNER = (
    "tests/scripts/test_run_comparison_promotion_candidate_eligibility_evidence_v1.py"
)
PACKAGE_CMP_PROMOTION_CANDIDATE_ELIGIBILITY_EVIDENCE_V1_DEPENDENCY_TESTOWNERS = (
    "tests/meta/test_comparison_promotion_candidate_identity_binding_v1.py",
    "tests/meta/test_comparison_completion_promotion_input_binding_v1.py",
    "tests/meta/test_comparison_metric_input_durable_evidence_binding_v1.py",
    "tests/governance/promotion_loop/test_candidate_lineage_manifest_v1_contract.py",
...
PACKAGE_CMP_PROMOTION_CANDIDATE_ELIGIBILITY_EVIDENCE_V1_ALL_PRODUCTION = (
    PACKAGE_CMP_PROMOTION_CANDIDATE_ELIGIBILITY_EVIDENCE_V1_PRODUCTION,
    PACKAGE_CMP_PROMOTION_CANDIDATE_ELIGIBILITY_EVIDENCE_V1_SCRIPT,
)
PACKAGE_CMP_PROMOTION_CANDIDATE_ELIGIBILITY_EVIDENCE_V1_ALL_TESTOWNERS = (
    PACKAGE_CMP_PROMOTION_CANDIDATE_ELIGIBILITY_EVIDENCE_V1_TESTOWNER,
    PACKAGE_CMP_PROMOTION_CANDIDATE_ELIGIBILITY_EVIDENCE_V1_CLI_TESTOWNER,
    *PACKAGE_CMP_PROMOTION_CANDIDATE_ELIGIBILITY_EVIDENCE_V1_DEPENDENCY_TESTOWNERS,
)
...
def test_selector_package_cmp_promotion_candidate_eligibility_evidence_v1_production_pr_bounded_full_includes_testowners() -> (
    None
):
    sel = _run_selector(PACKAGE_CMP_PROMOTION_CANDIDATE_ELIGIBILITY_EVIDENCE_V1_PRODUCTION)
    assert sel["test_selection_mode"] == "PR_BOUNDED_FULL"
    bounded = _bounded_targets(sel)
    for path in PACKAGE_CMP_PROMOTION_CANDIDATE_ELIGIBILITY_EVIDENCE_V1_ALL_TESTOWNERS:
        assert path in bounded


def test_selector_package_cmp_promotion_candidate_eligibility_evidence_v1_combined_diff_pr_bounded_full_includes_all_testowners_once() -> (
    None
):
    sel = _run_selector(
        *PACKAGE_CMP_PROMOTION_CANDIDATE_ELIGIBILITY_EVIDENCE_V1_ALL_PRODUCTION,
...
PACKAGE_CMP_PROMOTION_CANDIDATE_MODEL_PARAMETER_IDENTITY_BINDING_V1_PRODUCTION = (
    "src/meta/learning_loop/comparison_promotion_candidate_model_parameter_identity_binding_v1.py"
)
PACKAGE_CMP_PROMOTION_CANDIDATE_MODEL_PARAMETER_IDENTITY_BINDING_V1_SCRIPT = (
    "scripts/run_comparison_promotion_candidate_model_parameter_identity_binding_v1.py"
)
PACKAGE_CMP_PROMOTION_CANDIDATE_MODEL_PARAMETER_IDENTITY_BINDING_V1_TESTOWNER = (
    "tests/meta/test_comparison_promotion_candidate_model_parameter_identity_binding_v1.py"
)
PACKAGE_CMP_PROMOTION_CANDIDATE_MODEL_PARAMETER_IDENTITY_BINDING_V1_CLI_TESTOWNER = (
    "tests/scripts/test_run_comparison_promotion_candidate_model_parameter_identity_binding_v1.py"
)
PACKAGE_CMP_PROMOTION_CANDIDATE_MODEL_PARAMETER_IDENTITY_BINDING_V1_DEPENDENCY_TESTOWNERS = (
    "tests/meta/test_comparison_promotion_candidate_eligibility_evidence_v1.py",
    "tests/meta/test_comparison_promotion_candidate_identity_binding_v1.py",
    "tests/meta/test_comparison_completion_promotion_input_binding_v1.py",
    "tests/meta/test_comparison_metric_input_durable_evidence_binding_v1.py",
...
PACKAGE_CMP_PROMOTION_CANDIDATE_MODEL_PARAMETER_IDENTITY_BINDING_V1_ALL_PRODUCTION = (
    PACKAGE_CMP_PROMOTION_CANDIDATE_MODEL_PARAMETER_IDENTITY_BINDING_V1_PRODUCTION,
    PACKAGE_CMP_PROMOTION_CANDIDATE_MODEL_PARAMETER_IDENTITY_BINDING_V1_SCRIPT,
)
PACKAGE_CMP_PROMOTION_CANDIDATE_MODEL_PARAMETER_IDENTITY_BINDING_V1_ALL_TESTOWNERS = (
    PACKAGE_CMP_PROMOTION_CANDIDATE_MODEL_PARAMETER_IDENTITY_BINDING_V1_TESTOWNER,
    PACKAGE_CMP_PROMOTION_CANDIDATE_MODEL_PARAMETER_IDENTITY_BINDING_V1_CLI_TESTOWNER,
    *PACKAGE_CMP_PROMOTION_CANDIDATE_MODEL_PARAMETER_IDENTITY_BINDING_V1_DEPENDENCY_TESTOWNERS,
)
...
def test_selector_package_cmp_promotion_candidate_model_parameter_identity_binding_v1_production_pr_bounded_full_includes_testowners() -> (
    None
):
    sel = _run_selector(
        PACKAGE_CMP_PROMOTION_CANDIDATE_MODEL_PARAMETER_IDENTITY_BINDING_V1_PRODUCTION
    ...
    assert sel["test_selection_mode"] == "PR_BOUNDED_FULL"
    bounded = _bounded_targets(sel)
    for path in PACKAGE_CMP_PROMOTION_CANDIDATE_MODEL_PARAMETER_IDENTITY_BINDING_V1_ALL_TESTOWNERS:
        assert path in bounded


def test_selector_package_cmp_promotion_candidate_model_parameter_identity_binding_v1_combined_diff_pr_bounded_full_includes_all_testowners_once() -> (
    None
):
    sel = _run_selector(
        *PACKAGE_CMP_PROMOTION_CANDIDATE_MODEL_PARAMETER_IDENTITY_BINDING_V1_ALL_PRODUCTION,
...
PACKAGE_CMP_CONFIG_PATCH_MANIFEST_CROSS_DOMAIN_LINEAGE_BINDING_V1_SCRIPT = (
    "scripts/run_comparison_config_patch_manifest_cross_domain_lineage_binding_v1.py"
)
PACKAGE_CMP_CONFIG_PATCH_MANIFEST_CROSS_DOMAIN_LINEAGE_BINDING_V1_TESTOWNER = (
    "tests/meta/test_comparison_config_patch_manifest_cross_domain_lineage_binding_v1.py"
)
PACKAGE_CMP_CONFIG_PATCH_MANIFEST_CROSS_DOMAIN_LINEAGE_BINDING_V1_CLI_TESTOWNER = (
    "tests/scripts/test_run_comparison_config_patch_manifest_cross_domain_lineage_binding_v1.py"
)
PACKAGE_CMP_CONFIG_PATCH_MANIFEST_CROSS_DOMAIN_LINEAGE_BINDING_V1_DEPENDENCY_TESTOWNERS = (
    "tests/meta/test_comparison_promotion_candidate_model_parameter_identity_binding_v1.py",
...
PACKAGE_CMP_CONFIG_PATCH_MANIFEST_CROSS_DOMAIN_LINEAGE_BINDING_V1_ALL_PRODUCTION = (
    PACKAGE_CMP_CONFIG_PATCH_MANIFEST_CROSS_DOMAIN_LINEAGE_BINDING_V1_PRODUCTION,
    PACKAGE_CMP_CONFIG_PATCH_MANIFEST_CROSS_DOMAIN_LINEAGE_BINDING_V1_SCRIPT,
)
PACKAGE_CMP_CONFIG_PATCH_MANIFEST_CROSS_DOMAIN_LINEAGE_BINDING_V1_ALL_TESTOWNERS = (
    PACKAGE_CMP_CONFIG_PATCH_MANIFEST_CROSS_DOMAIN_LINEAGE_BINDING_V1_TESTOWNER,
    PACKAGE_CMP_CONFIG_PATCH_MANIFEST_CROSS_DOMAIN_LINEAGE_BINDING_V1_CLI_TESTOWNER,
    *PACKAGE_CMP_CONFIG_PATCH_MANIFEST_CROSS_DOMAIN_LINEAGE_BINDING_V1_DEPENDENCY_TESTOWNERS,
)
...
def test_selector_package_cmp_config_patch_manifest_cross_domain_lineage_binding_v1_combined_diff_pr_bounded_full_includes_all_testowners_once() -> (
    None
):
    sel = _run_selector(
        *PACKAGE_CMP_CONFIG_PATCH_MANIFEST_CROSS_DOMAIN_LINEAGE_BINDING_V1_ALL_PRODUCTION,
...
PACKAGE_CMP_PROMOTION_CANDIDATE_INPUT_V1_PRODUCTION = (
    "src/meta/learning_loop/comparison_promotion_candidate_input_v1.py"
)
PACKAGE_CMP_PROMOTION_CANDIDATE_INPUT_V1_SCRIPT = (
    "scripts/run_comparison_promotion_candidate_input_v1.py"
)
PACKAGE_CMP_PROMOTION_CANDIDATE_INPUT_V1_TESTOWNER = (
    "tests/meta/test_comparison_promotion_candidate_input_v1.py"
)
PACKAGE_CMP_PROMOTION_CANDIDATE_INPUT_V1_CLI_TESTOWNER = (
    "tests/scripts/test_run_comparison_promotion_candidate_input_v1.py"
)
PACKAGE_CMP_PROMOTION_CANDIDATE_INPUT_V1_DEPENDENCY_TESTOWNERS = (
    "tests/meta/test_comparison_config_patch_manifest_cross_domain_lineage_binding_v1.py",
    "tests/meta/test_comparison_promotion_candidate_model_parameter_identity_binding_v1.py",
    "tests/meta/test_comparison_promotion_candidate_eligibility_evidence_v1.py",
    "tests/meta/test_config_patch_manifest_v1_contract.py",
...
PACKAGE_CMP_PROMOTION_CANDIDATE_INPUT_V1_ALL_PRODUCTION = (
    PACKAGE_CMP_PROMOTION_CANDIDATE_INPUT_V1_PRODUCTION,
    PACKAGE_CMP_PROMOTION_CANDIDATE_INPUT_V1_SCRIPT,
)
PACKAGE_CMP_PROMOTION_CANDIDATE_INPUT_V1_ALL_TESTOWNERS = (
    PACKAGE_CMP_PROMOTION_CANDIDATE_INPUT_V1_TESTOWNER,
    PACKAGE_CMP_PROMOTION_CANDIDATE_INPUT_V1_CLI_TESTOWNER,
    *PACKAGE_CMP_PROMOTION_CANDIDATE_INPUT_V1_DEPENDENCY_TESTOWNERS,
)
...
def test_selector_package_cmp_promotion_candidate_input_v1_production_pr_bounded_full_includes_testowners() -> (
    None
):
    sel = _run_selector(PACKAGE_CMP_PROMOTION_CANDIDATE_INPUT_V1_PRODUCTION)
    assert sel["test_selection_mode"] == "PR_BOUNDED_FULL"
    bounded = _bounded_targets(sel)
    for path in PACKAGE_CMP_PROMOTION_CANDIDATE_INPUT_V1_ALL_TESTOWNERS:
        assert path in bounded


def test_selector_package_cmp_promotion_candidate_input_v1_combined_diff_pr_bounded_full_includes_all_testowners_once() -> (
    None
):
    sel = _run_selector(
        *PACKAGE_CMP_PROMOTION_CANDIDATE_INPUT_V1_ALL_PRODUCTION,
...
PACKAGE_CMP_ELIGIBILITY_PROMOTION_POLICY_INPUT_BINDING_V1_PRODUCTION = (
    "src/meta/learning_loop/comparison_eligibility_promotion_policy_input_binding_v1.py"
)
PACKAGE_CMP_ELIGIBILITY_PROMOTION_POLICY_INPUT_BINDING_V1_SCRIPT = (
    "scripts/run_comparison_eligibility_promotion_policy_input_binding_v1.py"
)
PACKAGE_CMP_ELIGIBILITY_PROMOTION_POLICY_INPUT_BINDING_V1_TESTOWNER = (
    "tests/meta/test_comparison_eligibility_promotion_policy_input_binding_v1.py"
)
PACKAGE_CMP_ELIGIBILITY_PROMOTION_POLICY_INPUT_BINDING_V1_CLI_TESTOWNER = (
    "tests/scripts/test_run_comparison_eligibility_promotion_policy_input_binding_v1.py"
)
PACKAGE_CMP_ELIGIBILITY_PROMOTION_POLICY_INPUT_BINDING_V1_DEPENDENCY_TESTOWNERS = (
    "tests/meta/test_comparison_promotion_candidate_input_v1.py",
    "tests/meta/test_comparison_config_patch_manifest_cross_domain_lineage_binding_v1.py",
    "tests/meta/test_comparison_promotion_candidate_model_parameter_identity_binding_v1.py",
    "tests/meta/test_comparison_promotion_candidate_eligibility_evidence_v1.py",
...
PACKAGE_CMP_ELIGIBILITY_PROMOTION_POLICY_INPUT_BINDING_V1_ALL_PRODUCTION = (
    PACKAGE_CMP_ELIGIBILITY_PROMOTION_POLICY_INPUT_BINDING_V1_PRODUCTION,
    PACKAGE_CMP_ELIGIBILITY_PROMOTION_POLICY_INPUT_BINDING_V1_SCRIPT,
)
PACKAGE_CMP_ELIGIBILITY_PROMOTION_POLICY_INPUT_BINDING_V1_ALL_TESTOWNERS = (
    PACKAGE_CMP_ELIGIBILITY_PROMOTION_POLICY_INPUT_BINDING_V1_TESTOWNER,
    PACKAGE_CMP_ELIGIBILITY_PROMOTION_POLICY_INPUT_BINDING_V1_CLI_TESTOWNER,
    *PACKAGE_CMP_ELIGIBILITY_PROMOTION_POLICY_INPUT_BINDING_V1_DEPENDENCY_TESTOWNERS,
)
...
def test_selector_package_cmp_eligibility_promotion_policy_input_binding_v1_production_pr_bounded_full_includes_testowners() -> (
    None
):
    sel = _run_selector(PACKAGE_CMP_ELIGIBILITY_PROMOTION_POLICY_INPUT_BINDING_V1_PRODUCTION)
    assert sel["test_selection_mode"] == "PR_BOUNDED_FULL"
    bounded = _bounded_targets(sel)
...
def test_selector_package_cmp_eligibility_promotion_policy_input_binding_v1_combined_diff_pr_bounded_full_includes_all_testowners_once() -> (
    None
):
    sel = _run_selector(
        *PACKAGE_CMP_ELIGIBILITY_PROMOTION_POLICY_INPUT_BINDING_V1_ALL_PRODUCTION,
...
PACKAGE_CMP_PROMOTION_POLICY_DECISION_V1_PRODUCTION = (
    "src/meta/learning_loop/comparison_promotion_policy_decision_v1.py"
)
PACKAGE_CMP_PROMOTION_POLICY_DECISION_V1_SCRIPT = (
    "scripts/run_comparison_promotion_policy_decision_v1.py"
)
PACKAGE_CMP_PROMOTION_POLICY_DECISION_V1_TESTOWNER = (
    "tests/meta/test_comparison_promotion_policy_decision_v1.py"
)
PACKAGE_CMP_PROMOTION_POLICY_DECISION_V1_CLI_TESTOWNER = (
    "tests/scripts/test_run_comparison_promotion_policy_decision_v1.py"
)
PACKAGE_CMP_PROMOTION_POLICY_DECISION_V1_DEPENDENCY_TESTOWNERS = (
    "tests/meta/test_comparison_promotion_policy_input_evidence_v1.py",
    "tests/meta/test_comparison_eligibility_promotion_policy_input_binding_v1.py",
    "tests/meta/test_comparison_promotion_candidate_input_v1.py",
    "tests/meta/test_comparison_config_patch_manifest_cross_domain_lineage_binding_v1.py",
...
PACKAGE_CMP_PROMOTION_POLICY_DECISION_V1_ALL_PRODUCTION = (
    PACKAGE_CMP_PROMOTION_POLICY_DECISION_V1_PRODUCTION,
    PACKAGE_CMP_PROMOTION_POLICY_DECISION_V1_SCRIPT,
)
PACKAGE_CMP_PROMOTION_POLICY_DECISION_V1_ALL_TESTOWNERS = (
    PACKAGE_CMP_PROMOTION_POLICY_DECISION_V1_TESTOWNER,
    PACKAGE_CMP_PROMOTION_POLICY_DECISION_V1_CLI_TESTOWNER,
    *PACKAGE_CMP_PROMOTION_POLICY_DECISION_V1_DEPENDENCY_TESTOWNERS,
)
...
def test_selector_package_cmp_promotion_policy_decision_v1_production_pr_bounded_full_includes_testowners() -> (
    None
):
    sel = _run_selector(PACKAGE_CMP_PROMOTION_POLICY_DECISION_V1_PRODUCTION)
    assert sel["test_selection_mode"] == "PR_BOUNDED_FULL"
    bounded = _bounded_targets(sel)
    for path in PACKAGE_CMP_PROMOTION_POLICY_DECISION_V1_ALL_TESTOWNERS:
        assert path in bounded


def test_selector_package_cmp_promotion_policy_decision_v1_combined_diff_pr_bounded_full_includes_all_testowners_once() -> (
    None
):
    sel = _run_selector(
        *PACKAGE_CMP_PROMOTION_POLICY_DECISION_V1_ALL_PRODUCTION,
...
PACKAGE_AI_PROMOTION_ASSESSMENT_V1_PRODUCTION = (
...
PACKAGE_AI_PROMOTION_ASSESSMENT_V1_DEPENDENCY_TESTOWNERS = (
    "tests/meta/test_comparison_promotion_policy_decision_v1.py",
    "tests/scripts/test_run_comparison_promotion_policy_decision_v1.py",
    "tests/meta/test_comparison_promotion_policy_input_evidence_v1.py",
    "tests/meta/test_comparison_eligibility_promotion_policy_input_binding_v1.py",
...
PACKAGE_AI_PROMOTION_ASSESSMENT_V1_ALL_PRODUCTION = (
    PACKAGE_AI_PROMOTION_ASSESSMENT_V1_PRODUCTION,
    PACKAGE_AI_PROMOTION_ASSESSMENT_V1_SCRIPT,
)
PACKAGE_AI_PROMOTION_ASSESSMENT_V1_ALL_TESTOWNERS = (
...
def test_selector_package_ai_promotion_assessment_v1_production_pr_bounded_full_includes_testowners() -> (
    None
):
    sel = _run_selector(PACKAGE_AI_PROMOTION_ASSESSMENT_V1_PRODUCTION)
    assert sel["test_selection_mode"] == "PR_BOUNDED_FULL"
    bounded = _bounded_targets(sel)
...
def test_selector_package_ai_promotion_assessment_v1_combined_diff_pr_bounded_full_includes_all_testowners_once() -> (
    None
):
    sel = _run_selector(
        *PACKAGE_AI_PROMOTION_ASSESSMENT_V1_ALL_PRODUCTION,
...
PACKAGE_AUTHORITY_LEASE_AND_REVOCATION_V1_PRODUCTION = (
    "src/meta/learning_loop/authority_lease_and_revocation_v1.py"
)
PACKAGE_AUTHORITY_LEASE_AND_REVOCATION_V1_SCRIPT = (
    "scripts/run_authority_lease_and_revocation_v1.py"
)
PACKAGE_AUTHORITY_LEASE_AND_REVOCATION_V1_TESTOWNER = (
    "tests/meta/test_authority_lease_and_revocation_v1.py"
)
PACKAGE_AUTHORITY_LEASE_AND_REVOCATION_V1_CLI_TESTOWNER = (
    "tests/scripts/test_run_authority_lease_and_revocation_v1.py"
)
PACKAGE_AUTHORITY_LEASE_AND_REVOCATION_V1_DEPENDENCY_TESTOWNERS = (
...
PACKAGE_AUTHORITY_LEASE_AND_REVOCATION_V1_ALL_PRODUCTION = (
    PACKAGE_AUTHORITY_LEASE_AND_REVOCATION_V1_PRODUCTION,
    PACKAGE_AUTHORITY_LEASE_AND_REVOCATION_V1_SCRIPT,
)
PACKAGE_AUTHORITY_LEASE_AND_REVOCATION_V1_ALL_TESTOWNERS = (
    PACKAGE_AUTHORITY_LEASE_AND_REVOCATION_V1_TESTOWNER,
    PACKAGE_AUTHORITY_LEASE_AND_REVOCATION_V1_CLI_TESTOWNER,
    *PACKAGE_AUTHORITY_LEASE_AND_REVOCATION_V1_DEPENDENCY_TESTOWNERS,
)
...
def test_selector_package_authority_lease_and_revocation_v1_production_pr_bounded_full_includes_testowners() -> (
    None
):
    sel = _run_selector(PACKAGE_AUTHORITY_LEASE_AND_REVOCATION_V1_PRODUCTION)
    assert sel["test_selection_mode"] == "PR_BOUNDED_FULL"
    bounded = _bounded_targets(sel)
    for path in PACKAGE_AUTHORITY_LEASE_AND_REVOCATION_V1_ALL_TESTOWNERS:
        assert path in bounded


def test_selector_package_authority_lease_and_revocation_v1_combined_diff_pr_bounded_full_includes_all_testowners_once() -> (
    None
):
    sel = _run_selector(
        *PACKAGE_AUTHORITY_LEASE_AND_REVOCATION_V1_ALL_PRODUCTION,
...
PACKAGE_SECURE_HANDOFF_ENVELOPE_V1_PRODUCTION = (
...
PACKAGE_SECURE_HANDOFF_ENVELOPE_V1_DEPENDENCY_TESTOWNERS = (
    "tests/meta/test_authority_lease_and_revocation_v1.py",
    "tests/scripts/test_run_authority_lease_and_revocation_v1.py",
    "tests/meta/test_handoff_trust_policy_v1.py",
    "tests/scripts/test_run_handoff_trust_policy_v1.py",
...
PACKAGE_SECURE_HANDOFF_ENVELOPE_V1_ALL_PRODUCTION = (
    PACKAGE_SECURE_HANDOFF_ENVELOPE_V1_PRODUCTION,
    PACKAGE_SECURE_HANDOFF_ENVELOPE_V1_SCRIPT,
)
PACKAGE_SECURE_HANDOFF_ENVELOPE_V1_ALL_TESTOWNERS = (
...
def test_selector_package_secure_handoff_envelope_v1_production_pr_bounded_full_includes_testowners() -> (
    None
):
    sel = _run_selector(PACKAGE_SECURE_HANDOFF_ENVELOPE_V1_PRODUCTION)
    assert sel["test_selection_mode"] == "PR_BOUNDED_FULL"
    bounded = _bounded_targets(sel)
...
def test_selector_package_secure_handoff_envelope_v1_combined_diff_pr_bounded_full_includes_all_testowners_once() -> (
    None
):
    sel = _run_selector(
        *PACKAGE_SECURE_HANDOFF_ENVELOPE_V1_ALL_PRODUCTION,
...
PACKAGE_CLOCK_TRUST_AND_EXPIRY_V1_PRODUCTION = "src/meta/learning_loop/clock_trust_and_expiry_v1.py"
PACKAGE_CLOCK_TRUST_AND_EXPIRY_V1_SCRIPT = "scripts/run_clock_trust_and_expiry_v1.py"
PACKAGE_CLOCK_TRUST_AND_EXPIRY_V1_TESTOWNER = "tests/meta/test_clock_trust_and_expiry_v1.py"
PACKAGE_CLOCK_TRUST_AND_EXPIRY_V1_CLI_TESTOWNER = (
    "tests/scripts/test_run_clock_trust_and_expiry_v1.py"
)
PACKAGE_CLOCK_TRUST_AND_EXPIRY_V1_DEPENDENCY_TESTOWNERS = (
    "tests/meta/test_handoff_atomic_claim_consume_v1.py",
    "tests/scripts/test_run_handoff_atomic_claim_consume_v1.py",
    "tests/meta/test_secure_handoff_envelope_v1.py",
    "tests/scripts/test_run_secure_handoff_envelope_v1.py",
...
PACKAGE_CLOCK_TRUST_AND_EXPIRY_V1_ALL_PRODUCTION = (
    PACKAGE_CLOCK_TRUST_AND_EXPIRY_V1_PRODUCTION,
    PACKAGE_CLOCK_TRUST_AND_EXPIRY_V1_SCRIPT,
)
PACKAGE_CLOCK_TRUST_AND_EXPIRY_V1_ALL_TESTOWNERS = (
    PACKAGE_CLOCK_TRUST_AND_EXPIRY_V1_TESTOWNER,
    PACKAGE_CLOCK_TRUST_AND_EXPIRY_V1_CLI_TESTOWNER,
    *PACKAGE_CLOCK_TRUST_AND_EXPIRY_V1_DEPENDENCY_TESTOWNERS,
)


def test_selector_package_clock_trust_and_expiry_v1_production_pr_bounded_full_includes_testowners() -> (
    None
):
    sel = _run_selector(PACKAGE_CLOCK_TRUST_AND_EXPIRY_V1_PRODUCTION)
    assert sel["test_selection_mode"] == "PR_BOUNDED_FULL"
    bounded = _bounded_targets(sel)
    for path in PACKAGE_CLOCK_TRUST_AND_EXPIRY_V1_ALL_TESTOWNERS:
        assert path in bounded


def test_selector_package_clock_trust_and_expiry_v1_combined_diff_pr_bounded_full_includes_all_testowners_once() -> (
    None
):
    sel = _run_selector(
        *PACKAGE_CLOCK_TRUST_AND_EXPIRY_V1_ALL_PRODUCTION,
