...
def test_offline_challenger_keys_and_policy_b_threshold_non_decision() -> None:
    ...
    assert POLICY_B_THRESHOLD_MODE == "VERSIONED_OFFLINE_THRESHOLD_SET_REQUIRED"
...
def test_spec_persists_formula_keys_and_non_decisions() -> None:
    ...
    assert "POLICY_B_THRESHOLD_MODE=VERSIONED_OFFLINE_THRESHOLD_SET_REQUIRED" in spec
