"""
LB-REC-001 — recorded JSON fixtures for ReconciliationEngine (phase 1+2+3+4).
...
def test_lb_rec_001_phase1_fixture_dir_has_cases() -> None:
    ...
    assert len(cases) >= 10, "expected at least ten recorded cases (phase 1–3 + phase 4 slice)"
