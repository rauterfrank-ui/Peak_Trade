...
class TestWorkflowEngine:
    ...
    def test_create_workflow(self):
        ...
        workflow_id = engine.create_workflow(
            name="test_workflow", workflow_type="signal_analysis", parameters={"symbol": "BTC/EUR"}
        )
    ...
    def test_get_workflow_state(self):
        ...
        workflow_id = engine.create_workflow(name="test_workflow", workflow_type="signal_analysis")
    ...
    def test_workflow_metadata(self):
        ...
        workflow_id = engine.create_workflow(
            ...
            parameters={"symbol": "BTC/EUR", "strategy": "ma_crossover", "timeframe": "1h"},
        )
...
class TestWorkflowEngineIntegration:
    ...
    def test_multiple_workflows_execution(self):
        ...
        results = []
        for i in range(3):
            wf_id = engine.create_workflow(name=f"workflow_{i}", workflow_type="signal_analysis")
