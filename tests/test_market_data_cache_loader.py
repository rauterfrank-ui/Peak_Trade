"""
Peak_Trade – Tests fuer Market-data cache loader (Phase 79)
======================================================

Tests fuer den Market-data cache loader mit Data-Quality-Control.
...
Usage:
    pytest tests/test_market_data_cache_loader.py -v
"""
...
@pytest.fixture
def market_data_cache_fixture(tmp_path) -> Path:
    """
...
class TestMarketDataCacheLoaderHappyPath:
    """Tests fuer erfolgreiche Daten-Ladung."""

    def test_load_market_data_cache_window_success(self, market_data_cache_fixture):
        """Gueltige Daten werden korrekt geladen."""
        from src.data.market_data_cache_loader import load_market_data_cache_window

        df, health = load_market_data_cache_window(
            base_path=market_data_cache_fixture,
            market="BTC/EUR",
            timeframe="1h",
            min_bars=500,
            n_bars=600,
    ...
    def test_load_market_data_cache_window_with_lookback_days(self, market_data_cache_fixture):
    ...
    def test_health_lookback_days_actual(self, market_data_cache_fixture):
    ...
    def test_health_to_dict(self, market_data_cache_fixture):
        """MarketDataCacheHealth.to_dict() funktioniert."""
        from src.data.market_data_cache_loader import load_market_data_cache_window
...
class TestMarketDataCacheLoaderMissingFile:
...
class TestMarketDataCacheLoaderTooFewBars:
...
class TestMarketDataCacheLoaderEmptyFile:
...
class TestMarketDataCacheConfig:
    ...
    def test_get_real_market_smokes_config_defaults(self):
        ...
        from src.data.market_data_cache_loader import get_real_market_smokes_config

        # Mit nicht existierender Config -> Defaults
        cfg = get_real_market_smokes_config("nonexistent.toml")

        assert cfg["base_path"] == "data/cache"
        assert cfg["test_base_path"] == "tests/data/market_data_smoke"
    ...
    def test_list_available_cache_files(self, market_data_cache_fixture):
        """list_available_cache_files listet Dateien korrekt auf."""
        from src.data.market_data_cache_loader import list_available_cache_files

        files = list_available_cache_files(market_data_cache_fixture)
...
class TestCheckDataHealthOnly:
    ...
    def test_check_data_health_only_ok(self, market_data_cache_fixture):
        """check_data_health_only gibt OK bei gueltigen Daten."""
        from src.data.market_data_cache_loader import check_data_health_only
...
class TestMarketDataCacheLoaderEdgeCases:
    """Edge-Case-Tests."""

    def test_symbol_slash_replacement(self, market_data_cache_fixture):
        """Symbol mit Slash wird korrekt in Dateiname umgewandelt."""
        from src.data.market_data_cache_loader import _build_cache_path
    ...
    def test_different_timeframes(self, tmp_path):
        ...
        from src.data.market_data_cache_loader import _timeframe_to_hours
    ...
    def test_utc_timezone_handling(self, market_data_cache_fixture):
...
class TestMarketDataCacheIntegration:
    ...
    def test_run_strategy_smoke_tests_with_qc(self, market_data_cache_fixture, tmp_path):
...
[real_market_smokes]
base_path = "{market_data_cache_fixture}"
test_base_path = "{market_data_cache_fixture}"
...
"""
        ...
        assert result.data_source == "market_data_cache"
