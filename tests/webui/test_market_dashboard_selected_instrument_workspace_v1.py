...
def test_empty_ohlcv_explicit_state(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    ws = build_market_selected_instrument_workspace_display_context(
        ...
        governed_top20={"rows": [], "top_n": 20, "stale": False, "stale_reason": "", "data_source": "fixture"},
...
def test_malformed_ohlcv_explicit_state() -> None:
    ws = build_market_selected_instrument_workspace_display_context(
        ...
        f5_dashboard={"gate_enabled": True, "display_status": "builder_error", "f1": {}, "f2": {}, "f3": {}, "f4": {}},
...
def test_stale_ohlcv_explicit_state() -> None:
    ws = build_market_selected_instrument_workspace_display_context(
        ...
        governed_top20={"rows": [], "top_n": 20, "stale": True, "stale_reason": "fixture", "data_source": "x"},
        f5_dashboard={"gate_enabled": True, "display_status": "ready", "f1": {}, "f2": {}, "f3": {}, "f4": {}},
