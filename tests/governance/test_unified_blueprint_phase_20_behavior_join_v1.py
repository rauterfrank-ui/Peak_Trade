"""Governance proof for Unified Blueprint Phase 20 behavior join."""
...
from src.governance.unified_blueprint_phase_20_behavior_join_v1 import (
    ...
    validate_phase_20_authority_invariants,
)
...
def test_phase_20_proof_passes_on_current_repo() -> None:
    assert prove_unified_blueprint_phase_20_behavior_join_v1(repo_root=REPO_ROOT)


def test_phase_20_authority_invariants() -> None:
    doc = _doc()
