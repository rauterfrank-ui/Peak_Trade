...
from src.core.rate_limiter import RateLimiter, TokenBucket, RateLimitConfig, RateLimitError
...
class TestRateLimitConfig:
    ...
    def test_config_creation(self):
        ...
        config = RateLimitConfig(max_requests=100, window_seconds=60, name="test_config")
