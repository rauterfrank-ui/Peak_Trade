...
def test_slot_contains_no_producer_implementation() -> None:
    ...
    assert py_files == [
        ...
        "mapping_boundary_reopen_contract_v1.py",
        "normalization_inclusion_adjudication_v1.py",
        "option_d_ssot_architecture_contract_v1.py",
        "p01_applicability_class_contract_v1.py",
        "p01_applicability_contract_v1.py",
        "p01_application_predicate_identity_contract_v1.py",
        "p01_application_predicate_input_domain_identity_contract_v1.py",
        "p01_embedding_state_contract_v1.py",
        "p01_equity_base_inclusion_contract_v1.py",
        "p01_exact_member_identity_contract_v1.py",
        "p01_governed_reduction_directive_evaluator_v1.py",
        "p01_haircut_reserve_depletion_semantics_contract_v1.py",
        "p01_haircut_reserve_depletion_term_contract_v1.py",
        "p01_member_freshness_inheritance_contract_v1.py",
        "p01_numeric_value_provenance_contract_v1.py",
        "p01_overlap_with_u04_u05_contract_v1.py",
        "p01_reconstruction_semantic_and_algebra_closeout_contract_v1.py",
        "p01_term_set_and_unit_class_contract_v1.py",
        "p01_value_unit_class_contract_v1.py",
        "reconstruction_algebra_contract_v1.py",
        "sample_schema_v1.py",
        "source_acceptance_conjunction_v1.py",
    ...
    event_stream = (SLOT_DIR / "classified_event_stream_acquisition_contract_v1.py").read_text(
        encoding="utf-8"
    )
    assert "def mint" not in event_stream
