"""C1-gated CURRENT_PRODUCTIVE one-cycle owner V2. No venue POST."""
...
from src.ops.governed_productive_account_equity_authority_producer_v1.current_productive_one_runtime_cycle_after_new_finalized_1m_c1_observation_v2 import (
...
SATISFIED_TS_MS = 1_789_524_600_000
...
def test_created_flag_and_standing_post_forbidden() -> None:
    ...
    assert EXPECTED_ORIGIN_MAIN_SHA == "7eb4f04c3f5ffcb7397de40a15d95e0433e5b5a6"
    assert PREVIOUS_C1_VENUE_EVENT_TIME == 1789523160.0
