...
AUTHORITATIVE_NEXT_STEP = "REQUEST_OPERATOR_GO_FOR_POST_NO_PASS_SPARSE_SIGNAL_ZERO_TRADE_OFFLINE_ECONOMIC_EVALUATION_EXECUTION_V0"
...
ORIGIN_MAIN = "a113c6bb667fc38da160637e47f018a5411365a3"
...
class TestRunbookProgressRegistryResolverHygieneV0:
    ...
    def test_post_pr4865_4872_closeout_metadata(self) -> None:
        ...
        assert authoritative_field_value("LAST_VERIFIED_PR") == "4879"
