...
AUTHORITATIVE_NEXT_STEP = "POST_NO_PASS_METRIC_MATERIALIZATION_DIAGNOSTICS_DERIVED_NEXT_RESEARCH_SCOPE_DEFINITION_REQUIRES_OPERATOR_RATIFICATION_V0"
...
ORIGIN_MAIN = "12d2b1b06eea805ed182f45967178eb37190ef7a"
...
class TestRunbookProgressRegistryResolverHygieneV0:
    ...
    def test_post_pr4865_4872_closeout_metadata(self) -> None:
        ...
        assert authoritative_field_value("LAST_VERIFIED_PR") == "4884"
