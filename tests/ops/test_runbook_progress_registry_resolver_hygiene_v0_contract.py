...
AUTHORITATIVE_NEXT_STEP = "POST_NO_PASS_SPARSE_SIGNAL_INCONCLUSIVE_FAILURE_CLASSIFICATION_EXECUTION_REQUIRES_SEPARATE_OPERATOR_GO_V0"
...
ORIGIN_MAIN = "4698b49739976cdc3270922a38fad4b044ae5d26"
...
class TestRunbookProgressRegistryResolverHygieneV0:
    ...
    def test_post_pr4865_4872_closeout_metadata(self) -> None:
        ...
        assert authoritative_field_value("LAST_VERIFIED_PR") == "4880"
