...
def test_real_evaluation_invalidated_without_economic_pass() -> None:
    text = _read_registry()
    section = _step_29m_section(text)
...
def test_real_admissible_futures_evidence_present_not_bound() -> None:
    text = _read_registry()
    section = _step_29m_section(text)
...
def test_operator_input_not_required_after_invalidated_evaluation() -> None:
    text = _read_registry()
    section = _step_29m_section(text)
