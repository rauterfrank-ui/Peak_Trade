...
NEXT_CANONICAL_STEP = (
    "POST_NO_PASS_SPARSE_SIGNAL_INCONCLUSIVE_FAILURE_CLASSIFICATION_EXECUTION_REQUIRES_SEPARATE_OPERATOR_GO_V0"
)
CURRENT_ADMISSIBLE_SCOPE = "POST_NO_PASS_SPARSE_SIGNAL_INCONCLUSIVE_FAILURE_CLASSIFICATION_V0"
CURRENT_ADMISSIBLE_GO_TOKEN = "GO_POST_NO_PASS_SPARSE_SIGNAL_INCONCLUSIVE_FAILURE_CLASSIFICATION_V0"
...
class TestPostNoPassRobustnessFailureNextResearchScopeDefinitionV0Contract:
    ...
    def test_registry_metadata_fields(self) -> None:
        ...
        assert authoritative_field_value("CURRENT_ADMISSIBLE_NEXT_SCOPE_GO_TOKEN") == CURRENT_ADMISSIBLE_GO_TOKEN
        assert (
            _field_value(
                text,
