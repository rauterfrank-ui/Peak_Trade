"""C1-gated CURRENT_PRODUCTIVE one-cycle owner V3. No venue POST."""
...
from src.ops.governed_productive_account_equity_authority_producer_v1.current_productive_one_runtime_cycle_after_new_finalized_1m_c1_observation_v3 import (
...
SATISFIED_TS_MS = 1_789_526_160_000
...
def test_created_flag_and_standing_post_forbidden() -> None:
    ...
    assert EXPECTED_ORIGIN_MAIN_SHA == "1d076b415d1da33e08d7bf2821d14ea25bdf0317"
    assert PREVIOUS_C1_VENUE_EVENT_TIME == 1789525080.0
