"""C1-gated CURRENT_PRODUCTIVE one-cycle owner. No venue POST."""
...
from src.ops.governed_productive_account_equity_authority_producer_v1.current_productive_one_runtime_cycle_after_new_finalized_1m_c1_observation_v1 import (
...
def test_created_flag_and_standing_post_forbidden() -> None:
    assert (
        CURRENT_PRODUCTIVE_ONE_RUNTIME_CYCLE_AFTER_NEW_FINALIZED_1M_C1_OBSERVATION_CREATED is True
    )
...
def test_owner_go_mismatch_fail_closed(tmp_path: Path) -> None:
    with pytest.raises(
        ...
        execute_current_productive_one_runtime_cycle_after_new_finalized_1m_c1_observation_v1(
            ...
            c1_gate_payload=_candles(last_ts_ms=1_789_522_800_000),
        )
