...
def test_constants_and_call_graph_bound() -> None:
    ...
    # (PREEXISTING_CALL_GRAPH_DRIFT_IN_SCOPE=false). Cap 6.2 proves its steps
    ...
    assert CALL_GRAPH_SCOPE_TRANSITION_STEP in CALL_GRAPH_V1
    assert CALL_GRAPH_SCOPE_COMMIT_STEP in CALL_GRAPH_V1
    assert CALL_GRAPH_PREVIOUS_SCOPE_STEP in REQUIRED_CALL_GRAPH
    assert CALL_GRAPH_SCOPE_TRANSITION_STEP in REQUIRED_CALL_GRAPH
    assert CALL_GRAPH_SCOPE_COMMIT_STEP in REQUIRED_CALL_GRAPH
