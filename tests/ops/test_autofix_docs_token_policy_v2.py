...
class TestHeuristics:
    ...
    def test_looks_like_http_endpoint(self):
        ...
        assert looks_like_http_endpoint("PUT /api/v1/items/1")
        assert looks_like_http_endpoint("PATCH /api/v1/items/1")
        assert looks_like_http_endpoint("HEAD /health")
        assert looks_like_http_endpoint("OPTIONS /api/")
