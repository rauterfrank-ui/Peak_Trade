...
def test_position_sizing_normal():
    ...
    req = PositionRequest(equity=10000, entry_price=50000, stop_price=49000, risk_per_trade=0.01)
...
def test_position_sizing_too_small():
    ...
    req = PositionRequest(equity=1000, entry_price=50000, stop_price=49000, risk_per_trade=0.01)
