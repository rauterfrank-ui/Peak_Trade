...
class TestScoreFOMO:
    ...
    def test_low_fomo_on_time_entry_small_move(self):
        ...
        ev = TriggerTrainingPsychEventFeatures(
            ...
            price_max_favorable_pct=0.1,
            price_max_adverse_pct=0.02,
            pnl_vs_ideal_bp=-5.0,
            had_valid_setup=True,
            entered_without_signal=False,
            opposite_to_signal=False,
    ...
    def test_high_fomo_on_late_entry_large_move(self):
        ...
        ev = TriggerTrainingPsychEventFeatures(
            ...
            price_max_favorable_pct=1.0,
            price_max_adverse_pct=0.1,
            pnl_vs_ideal_bp=-30.0,
            had_valid_setup=True,
            entered_without_signal=False,
            opposite_to_signal=False,
            size_violation=False,
...
class TestEdgeCases:
    ...
    def test_all_flags_true(self):
        ...
        ev = TriggerTrainingPsychEventFeatures(
            ...
            price_max_favorable_pct=1.2,
            price_max_adverse_pct=0.5,
            pnl_vs_ideal_bp=-100.0,
            had_valid_setup=False,
            entered_without_signal=True,
            opposite_to_signal=True,
            size_violation=True,
            risk_violation=True,
            recent_loss_streak=10,
            recent_skip_streak=10,
            manually_marked_fomo=True,
            manually_marked_fear=True,
