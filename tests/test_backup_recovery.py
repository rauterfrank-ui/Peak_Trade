...
class TestRecoveryManager:
    ...
    def test_create_backup_with_state(self, recovery_mgr):
        ...
        recovery_mgr.state_snapshot.register_provider(
            "test",
            lambda: {"metric": 123}
        )
    ...
    def test_list_backups(self, recovery_mgr, sample_config):
        ...
        backup_id1 = recovery_mgr.create_backup(
            include_config=True,
            tags=["daily"]
        )
        backup_id2 = recovery_mgr.create_backup(
            include_config=True,
            tags=["weekly"]
        )
...
class TestBackupRecoveryIntegration:
    ...
    def test_complete_backup_restore_workflow(self, tmp_path):
        ...
        recovery.state_snapshot.register_provider(
            "app_state",
            lambda: {"running": True, "version": "1.0"}
        )
