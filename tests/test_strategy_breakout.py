...
class TestBreakoutNewFeatures:
    ...
    def test_separate_lookbacks(self):
        ...
        strategy = BreakoutStrategy(lookback_high=20, lookback_low=15, risk_mode="symmetric")
    ...
    def test_atr_filter(self):
        ...
        strategy_with_filter = BreakoutStrategy(
            lookback_breakout=15, use_atr_filter=True, atr_multiplier=1.0, risk_mode="symmetric"
        )

        # Ohne ATR-Filter
        strategy_no_filter = BreakoutStrategy(
            lookback_breakout=15, use_atr_filter=False, risk_mode="symmetric"
        )
    ...
    def test_risk_mode_long_only(self):
        ...
        strategy = BreakoutStrategy(lookback_breakout=15, risk_mode="long_only")
    ...
    def test_risk_mode_short_only(self):
        ...
        strategy = BreakoutStrategy(lookback_breakout=15, risk_mode="short_only")
    ...
    def test_exit_on_opposite_breakout(self):
        ...
        strategy_exit = BreakoutStrategy(
            lookback_breakout=15, exit_on_opposite_breakout=True, risk_mode="symmetric"
        )

        strategy_no_exit = BreakoutStrategy(
            lookback_breakout=15, exit_on_opposite_breakout=False, risk_mode="symmetric"
        )
    ...
    def test_legacy_side_mapping(self):
        ...
        strategy = BreakoutStrategy(lookback_breakout=15, side="long")
    ...
    def test_atr_filter_without_multiplier(self):
        ...
        strategy = BreakoutStrategy(
            lookback_breakout=15, use_atr_filter=True, atr_multiplier=None, risk_mode="symmetric"
        )
    ...
    def test_long_breakout_scenario(self):
        ...
        strategy = BreakoutStrategy(lookback_breakout=20, risk_mode="long_only")
    ...
    def test_short_breakout_scenario(self):
        ...
        strategy = BreakoutStrategy(lookback_breakout=20, risk_mode="short_only")
