"""Contract tests for funding-rate dual-leg spread v1 full offline economic evaluation runner v0."""
...
from tests.research.test_cross_sectional_funding_rate_dual_leg_spread_v1_offline_economic_evaluation_execution_infrastructure_v0 import (  # noqa: E501
...
def fixture_bound_staging() -> Path:
    tmp = Path(tempfile.mkdtemp(prefix="cs_dual_leg_spread_full_runner_v1_"))
...
def test_ops_runner_module_has_no_runtime_imports() -> None:
    module_path = (
        REPO_ROOT
        / "scripts/ops/run_cross_sectional_funding_rate_dual_leg_spread_v1_offline_economic_evaluation_execution_v0.py"
    )
