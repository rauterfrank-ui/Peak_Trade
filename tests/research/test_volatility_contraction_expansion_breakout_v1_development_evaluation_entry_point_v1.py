"""Contract/unit tests for VCEB v1 development-evaluation entry point."""
...
def test_unauthorized_token_blocks_evaluate_no_run_consumption() -> None:
    ...
    after = read_run_counters(REPO)
    assert after == before
    # Slot already consumed by terminal fail-closed evidence; unauthorized call must not mutate counters.
