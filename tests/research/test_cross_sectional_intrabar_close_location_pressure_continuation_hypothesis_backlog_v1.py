"""Definition-only contract tests for CS intrabar close-location pressure continuation backlog v1."""
...
def test_owner_map_registers_backlog_surface() -> None:
    ...
    assert (
        "CROSS_SECTIONAL_INTRABAR_CLOSE_LOCATION_PRESSURE_CONTINUATION_HYPOTHESIS_BACKLOG_V1"
        in surfaces
    )
    paths = surfaces[
        "CROSS_SECTIONAL_INTRABAR_CLOSE_LOCATION_PRESSURE_CONTINUATION_HYPOTHESIS_BACKLOG_V1"
