"""Contract tests for canonical open MR exit-efficiency hypothesis backlog (post V3 FAIL)."""
...
def test_repo_backlog_all_terminal_v3_fail() -> None:
...
def test_preregistered_empty_and_terminal_entry_shape() -> None:
    ...
    assert "NO_V4_AUTO_CREATE" in backlog["explicit_non_actions"]


def test_governance_doc_mentions_v3_terminal_fail() -> None:
