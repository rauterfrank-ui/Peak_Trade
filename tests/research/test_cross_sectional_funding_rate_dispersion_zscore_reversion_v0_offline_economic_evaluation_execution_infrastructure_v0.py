"""Contract tests for funding-rate dispersion-zscore-reversion execution infrastructure v0."""
...
from src.research.cross_sectional_funding_rate_dispersion_zscore_reversion_v0_offline_economic_evaluation_execution_v0 import (
    AUTHORITY_EFFECT,
    GO_TOKEN,
...
def fixture_bound_staging() -> Path:
    tmp = Path(tempfile.mkdtemp(prefix="cs_dispersion_zscore_reversion_exec_v0_"))
