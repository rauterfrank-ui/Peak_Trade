"""Contract tests for V7 development-evaluation authorization ratification."""
...
def test_missing_ratification_fail_closed(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    monkeypatch.setattr(
        "src.research.bollinger_mr_midband_exit_reentry_cooldown_development_evaluation_authorization_ratification_v7.RATIFICATION_REL_PATH",
...
def test_slot_consumed_blocks_authorization(
    ...
    monkeypatch.setattr(
        "src.research.bollinger_mr_midband_exit_reentry_cooldown_development_evaluation_authorization_ratification_v7.EVAL_EVIDENCE_REL",
...
def test_runner_blocked_when_effective_auth_mocked_false(
    ...
    monkeypatch.setattr(
        "src.research.bollinger_mr_midband_exit_reentry_cooldown_development_evaluation_v7.panel_runner_v7.resolve_effective_evaluation_authorization",
...
def test_go_token_constant() -> None:
    assert GO_TOKEN.startswith("GO_BOLLINGER_MR_MIDBAND_EXIT_REENTRY_COOLDOWN_V7_")
