"""Contract tests for funding-rate persistence reversal filter full offline economic evaluation runner v0."""
...
from src.research.cross_sectional_funding_rate_persistence_reversal_filter_v0_offline_economic_evaluation_execution_v0 import (
...
from tests.research.fixtures.cross_sectional_funding_rate_persistence_reversal_filter_v0.fixture_builder import (
    build_synthetic_ohlcv_panel_v0,
)
from tests.research.test_cross_sectional_funding_rate_persistence_reversal_filter_v0_offline_economic_evaluation_execution_infrastructure_v0 import (  # noqa: E501
...
def fixture_bound_staging() -> Path:
    tmp = Path(tempfile.mkdtemp(prefix="cs_persistence_reversal_filter_full_runner_v0_"))
    return _write_staging_with_funding(tmp)


def test_full_runner_go_token_constants() -> None:
    assert GO_TOKEN == (
        "GO_CROSS_SECTIONAL_FUNDING_RATE_PERSISTENCE_REVERSAL_FILTER_V0_OFFLINE_ECONOMIC_EVALUATION_"
...
def test_full_runner_accepts_combined_go_token(
    bound_staging: Path,
    scope_ratification: dict,
    complete_binding: dict,
) -> None:
...
def test_ops_runner_module_has_no_runtime_imports() -> None:
    module_path = (
        REPO_ROOT
        / "scripts/ops/run_cross_sectional_funding_rate_persistence_reversal_filter_v0_offline_economic_evaluation_execution_v0.py"
    )
...
def test_ops_runner_accepts_execution_go_token_constant() -> None:
    from scripts.ops.run_cross_sectional_funding_rate_persistence_reversal_filter_v0_offline_economic_evaluation_execution_v0 import (  # noqa: E501
