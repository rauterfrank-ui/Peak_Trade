"""Focused tests for VTSR development-evaluation entry path (post DEVELOPMENT_FAIL)."""
...
from src.research.volatility_term_structure_reversion_v1_development_evaluation_v1.entry_point_v1 import (
    run_dry_validate,
    run_preflight_only,
)
...
EVIDENCE = REPO / "docs/evidence/evaluate_volatility_term_structure_reversion_development_v1"
