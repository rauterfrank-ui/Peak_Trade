"""Contract tests for funding-rate persistence reversal filter execution infrastructure v0."""
...
def fixture_bound_staging() -> Path:
    tmp = Path(tempfile.mkdtemp(prefix="cs_persistence_reversal_filter_exec_v0_"))
