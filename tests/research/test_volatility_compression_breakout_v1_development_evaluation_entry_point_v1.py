"""Contract/unit tests for VCB v1 development-evaluation entry point."""
...
def test_owner_registry_and_entry_point_files_bound() -> None:
    ...
    assert "src/research/volatility_compression_breakout_v1_development_evaluation_v1/" in prefixes
...
def test_import_safe_no_dataset_no_runner() -> None:
    ...
    # Re-import must not mutate counters or open datasets.
...
def test_static_ids_and_bindings() -> None:
    assert STRATEGY_IDENTITY == "VOLATILITY_COMPRESSION_BREAKOUT_V1"
