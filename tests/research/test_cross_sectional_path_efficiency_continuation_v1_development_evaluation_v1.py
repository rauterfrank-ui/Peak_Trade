"""Contract tests for CS path-efficiency continuation v1 DEVELOPMENT evaluation."""
...
from src.research.cross_sectional_path_efficiency_continuation_research_program_v1 import (
...
EVIDENCE = (
    REPO / "docs/evidence/evaluate_cross_sectional_path_efficiency_continuation_development_v1"
)
CSRHR = (
    REPO
...
def test_frozen_params_and_scope() -> None:
    ...
    assert compute_strategy_params_digest() == (
        "b8f21f66870a03902dacaedc118e68d242098759d9d7752960a7c9c59493b381"
    )
...
def test_no_second_evaluation_runner_in_evidence_dir() -> None:
    # Exactly one run_slot_claim / summary for the single slot.
