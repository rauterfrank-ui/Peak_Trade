...
def test_repo_decision_packet_create_successor_applied() -> None:
    ...
    assert report["status"] == ("OPERATOR_DECISION_APPLIED_CREATE_SUCCESSOR_VTSR_DEFINITION_ONLY")
...
def test_enumerated_decisions_and_go_tokens() -> None:
    ...
    assert packet["next_admissible_scope"] == (
        "VOLATILITY_TERM_STRUCTURE_REVERSION_V1_STRATEGY_IMPLEMENTATION_ONLY_V1"
    )
