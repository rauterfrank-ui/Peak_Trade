"""Executable-path / panel-boundary tests for VDBX v1 (no real panel or evaluation run)."""
...
from src.research.volatility_decay_breakout_with_explicit_decay_exit_v1_development_evaluation_v1.evaluate_path_v1 import (
    dry_validate_evaluate_path_v1,
    run_authorized_development_evaluation_v1,
)
from src.research.volatility_decay_breakout_with_explicit_decay_exit_v1_development_evaluation_v1.execution_boundary_v1 import (
...
from src.research.volatility_decay_breakout_with_explicit_decay_exit_v1_development_evaluation_v1.time_segments_v1 import (
...
def _fake_handoff(panel: PanelLoadResultV1) -> VdbxTreatmentBaselineWiringHandoffV1:
    ...
    return VdbxTreatmentBaselineWiringHandoffV1(
        treatment=(arm,),
        baseline=(baseline,),
...
def test_fake_boundary_evaluate_writes_slot_claim_then_blocks_reuse(
    tmp_path: Path, monkeypatch: pytest.MonkeyPatch
) -> None:
    before = read_run_counters(REPO)
    assert before["contract_development_run_count"] == 1
    monkeypatch.setattr(
        "src.research.volatility_decay_breakout_with_explicit_decay_exit_v1_development_evaluation_v1.evaluate_path_v1.read_run_counters",
        lambda _repo: {
...
def test_empty_panel_fail_closed_no_slot_claim(
    tmp_path: Path, monkeypatch: pytest.MonkeyPatch
) -> None:
    monkeypatch.setattr(
        "src.research.volatility_decay_breakout_with_explicit_decay_exit_v1_development_evaluation_v1.evaluate_path_v1.read_run_counters",
