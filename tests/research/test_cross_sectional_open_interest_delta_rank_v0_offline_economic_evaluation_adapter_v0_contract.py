...
from src.research.cross_sectional_open_interest_delta_rank_v0_offline_economic_evaluation_adapter_v0 import (
    AUTHORITY_EFFECT,
    GO_TOKEN,
    RUNTIME_EFFECT,
    adapter_result_to_dict,
    materialize_adapter_contract_v0,
    run_cross_sectional_open_interest_delta_rank_v0_offline_economic_evaluation_adapter_v0,
)
...
def fixture_valid_panel_root() -> Path:
    tmp = Path(tempfile.mkdtemp(prefix="cs_oi_delta_rank_adapter_v0_"))
...
def test_canonical_callable_invoked_once(
    ...
    with patch(
        "src.research.cross_sectional_open_interest_delta_rank_v0_offline_economic_evaluation_adapter_v0.run_offline_evaluation_adapter_precheck_v0",
...
def test_no_economic_execution_in_implementation_scope(
    ...
    result = run_cross_sectional_open_interest_delta_rank_v0_offline_economic_evaluation_adapter_v0(
        repo_root=REPO_ROOT,
        materialization_root=valid_panel_root,
...
def test_deterministic_adapter_binding(
    ...
    first = run_cross_sectional_open_interest_delta_rank_v0_offline_economic_evaluation_adapter_v0(
        repo_root=REPO_ROOT,
        materialization_root=valid_panel_root,
    ...
    second = run_cross_sectional_open_interest_delta_rank_v0_offline_economic_evaluation_adapter_v0(
        repo_root=REPO_ROOT,
        materialization_root=valid_panel_root,
