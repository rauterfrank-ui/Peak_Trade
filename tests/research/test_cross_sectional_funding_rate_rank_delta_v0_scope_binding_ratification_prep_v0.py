"""Contract tests for CS funding-rate rank-delta v0 scope binding ratification prep."""
...
GOVERNANCE_DOC = (
    ...
    "CROSS_SECTIONAL_FUNDING_RATE_RANK_DELTA_V0_OFFLINE_ECONOMIC_EVALUATION_BINDING_RATIFICATION_PREP.md"
)


class TestCrossSectionalFundingRateRankDeltaV0ScopeBindingRatificationPrep:
    ...
    def test_governance_doc_exists_and_states_no_eval(self) -> None:
        ...
        assert (
            "rank_delta" in text.lower()
            or "rank-delta" in text.lower()
            or "rank migration" in text.lower()
        )
