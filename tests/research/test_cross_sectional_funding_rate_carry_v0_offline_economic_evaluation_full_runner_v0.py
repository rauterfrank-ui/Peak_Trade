"""Contract tests for funding-rate carry full offline economic evaluation runner v0."""
...
def test_full_runner_executes_six_stages_with_re_run_go_token(
    bound_staging: Path,
...
def test_ops_runner_module_has_no_runtime_imports() -> None:
    module_path = (
        REPO_ROOT
        / "scripts/ops/run_cross_sectional_funding_rate_carry_v0_offline_economic_evaluation_re_run_v0.py"
    )
