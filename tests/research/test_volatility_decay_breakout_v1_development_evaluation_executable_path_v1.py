"""Executable-path / panel-boundary tests for VDB v1 (no real panel or evaluation run)."""
...
def test_import_safe_and_panel_modules_present() -> None:
    ...
    pkg = REPO / "src/research/volatility_decay_breakout_v1_development_evaluation_v1"
...
def test_authorized_reaches_evaluator_handoff_via_fake_boundary_only(
    ...
    assert before["contract_runner_start_count"] == 1
    monkeypatch.setattr(
        "src.research.volatility_decay_breakout_v1_development_evaluation_v1.evaluate_path_v1.read_run_counters",
        lambda _repo: {
...
def test_productive_pnl_evaluator_reused_no_second_truth() -> None:
    ...
    # No VDB-local PnL evaluator module may exist.
    vep_pkg = REPO / "src/research/volatility_decay_breakout_v1_development_evaluation_v1"
