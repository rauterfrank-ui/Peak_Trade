...
LATEST_PANEL_ROOT = Path(
    str(
        located_runtime_evidence_20260520()
        / "research/cross_sectional_open_interest_zscore_reversion_v0_historical_panel_depth_extension_and_rematerialization_implementation_v0_20260712T004937Z/materialization/run_a"
    )
)
ADAPTER_MODULE = (
    REPO_ROOT
