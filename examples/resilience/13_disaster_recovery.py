...
class TradingSystem:
    ...
    def __init__(self, workspace_dir):
        ...
        self.recovery = RecoveryManager(backup_dir=str(self.workspace / "backups"))
        ...
        self.recovery.state_snapshot.register_provider("trading_state", self._get_trading_state)
...
""".strip()
    ...
    def recover_from_disaster(self, backup_id):
        ...
        success = self.recovery.restore_backup(
            backup_id, restore_config=True, restore_state=True, restore_data=True
        )
...
def example_complete_disaster_recovery():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        baseline_backup = system.create_backup(
            description="Baseline backup - healthy system", tags=["baseline", "production"]
        )
        ...
        for i, backup in enumerate(backups, 1):
            ...
            print(
                f"      Type: {backup.backup_type.value}, "
        ...
        operational_backup = system.create_backup(
            description="Operational backup - during trading", tags=["operational", "auto"]
        )
