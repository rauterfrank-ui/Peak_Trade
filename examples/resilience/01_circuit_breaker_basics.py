...
def example_2_decorator_pattern():
    ...
    @circuit_breaker(failure_threshold=2, recovery_timeout=3.0, name="api_breaker")
    def call_api():
        """Simulated API call."""
        call_count[0] += 1
...
def example_4_monitoring_stats():
    ...
    breaker = CircuitBreaker(failure_threshold=3, recovery_timeout=2.0, name="monitored_breaker")
    ...
    for i in range(8):
        ...
        stats = breaker.stats
        print(
            f"      Stats: Success={stats.success_count}, "
