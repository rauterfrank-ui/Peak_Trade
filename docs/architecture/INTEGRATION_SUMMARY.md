...
2. **DeepResearch Runner** (`src/research/deep_research_runner.py`)
   - **Phase 4:** L1 DeepResearch mit `o3-deep-research` API
   - **Priority:** 🟡 MEDIUM (P1)

3. **Trade Plan Advisor** (`src/trading/trade_plan_advisor.py`)
   - **Phase 5:** L3 Intraday Hypothesen (Files only, REC/PROP)
   - **Priority:** 🟡 MEDIUM (P1)

4. **Runbook Generator** (`src/ops/runbook_generator.py`)
