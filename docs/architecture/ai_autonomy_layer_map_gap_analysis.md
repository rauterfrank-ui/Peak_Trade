...
**Erforderlich:**
- Modul: `src/ai_orchestration/multi_model_runner.py`
- SoD Checker: `src/ai_orchestration/sod_checker.py`
...
**Deliverables:**
- `src/ai_orchestration/multi_model_runner.py`
- `src/ai_orchestration/sod_checker.py`
...
- Erstes Evidence Pack: `docs/governance/evidence/EVP_20260115_L2_PILOT.md`
...
**Deliverables:**
- `src/research/deep_research_runner.py`
- Updated `src/governance/policy_critic/critic.py`
- `docs/governance/CODEGATE_LAYER_MAP_INTEGRATION.md`
...
**Deliverables:**
- `src/ops/runbook_generator.py` (L0)
- `src/trading/trade_plan_advisor.py` (L3)
...
**Deliverables:**
- `src/ai_orchestration/model_wrappers/deepseek_r1.py`
...
**Deliverables:**
- `docs/governance/evidence/EVP_20260210_30DAY_PILOT_REPORT.md`
