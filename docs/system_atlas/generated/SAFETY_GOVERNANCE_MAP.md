...
- chain: `RUNTIME_COMPONENT:full_core_live_path_composition_root_v1 -> RUNTIME_COMPONENT:full_core_live_path_venue_translation_v1 -> GATE:full_core_live_path_frozen_pretrade_conjunction_v1 -> GATE:full_core_live_path_execution_boundary_halt_before_wire_v1 -> GATE:full_core_durable_filegate_join_v1 -> GATE:full_core_owner_one_shot_permit_v1 -> GATE:full_core_fresh_pretrade_runtime_get_v1 -> GATE:full_core_live_path_standing_live_gates_v1 -> GATE:full_core_live_path_identity_v1 -> GATE:live_authorized_false`
