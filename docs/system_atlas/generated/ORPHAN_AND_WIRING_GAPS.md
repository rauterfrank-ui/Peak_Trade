...
| GAP_AUTO:NO_CONSUMER:RUNTIME_COMPONENT:p1_negative_completeness_closeout_contract_v1 | DEFINED_BUT_NO_CONSUMER | RUNTIME_COMPONENT:p1_negative_completeness_closeout_contract_v1 | STATUS=OPEN (not proven) |  |
