...
| GAP_AUTO:NO_CONSUMER:CAPABILITY:cap22_robustness_and_stress_v1 | DEFINED_BUT_NO_CONSUMER | CAPABILITY:cap22_robustness_and_stress_v1 | STATUS=OPEN (not proven) |  |
...
| GAP_AUTO:NO_CONSUMER:CAPABILITY:market_intelligence_forecast_calibration_offline_stack_v1 | DEFINED_BUT_NO_CONSUMER | CAPABILITY:market_intelligence_forecast_calibration_offline_stack_v1 | STATUS=OPEN (not proven) |  |
...
| GAP_AUTO:NO_CONSUMER:RUNTIME_COMPONENT:canonical_volatility_max_age_research_stratification_v2_v1 | DEFINED_BUT_NO_CONSUMER | RUNTIME_COMPONENT:canonical_volatility_max_age_research_stratification_v2_v1 | STATUS=OPEN (not proven) |  |
...
| GAP_AUTO:NO_CONSUMER:RUNTIME_COMPONENT:canonical_volatility_numeric_max_age_retained_estimate_late_age_carrier_v1 | DEFINED_BUT_NO_CONSUMER | RUNTIME_COMPONENT:canonical_volatility_numeric_max_age_retained_estimate_late_age_carrier_v1 | STATUS=OPEN (not proven) |  |
| GAP_AUTO:NO_CONSUMER:RUNTIME_COMPONENT:companion_shadow_live_fraction_to_units_input_binding_v1 | DEFINED_BUT_NO_CONSUMER | RUNTIME_COMPONENT:companion_shadow_live_fraction_to_units_input_binding_v1 | STATUS=OPEN (not proven) |  |
...
| GAP_AUTO:NO_CONSUMER:RUNTIME_COMPONENT:f1_m9_real_campaign_activation_and_production_wiring_v1 | DEFINED_BUT_NO_CONSUMER | RUNTIME_COMPONENT:f1_m9_real_campaign_activation_and_production_wiring_v1 | STATUS=OPEN (not proven) |  |
| GAP_AUTO:NO_CONSUMER:RUNTIME_COMPONENT:f1_m9_real_prospective_campaign_execution_enablement_v1 | DEFINED_BUT_NO_CONSUMER | RUNTIME_COMPONENT:f1_m9_real_prospective_campaign_execution_enablement_v1 | STATUS=OPEN (not proven) |  |
...
| GAP_AUTO:NO_CONSUMER:RUNTIME_COMPONENT:learning_representation_offline_evaluation_v1 | DEFINED_BUT_NO_CONSUMER | RUNTIME_COMPONENT:learning_representation_offline_evaluation_v1 | STATUS=OPEN (not proven) |  |
| GAP_AUTO:NO_CONSUMER:RUNTIME_COMPONENT:learning_representation_research_adaptation_plan_v1 | DEFINED_BUT_NO_CONSUMER | RUNTIME_COMPONENT:learning_representation_research_adaptation_plan_v1 | STATUS=OPEN (not proven) |  |
...
| GAP_AUTO:NO_CONSUMER:RUNTIME_COMPONENT:master_v2_double_play_evidence_input_plane_p0_evidence_seam_census_v1 | DEFINED_BUT_NO_CONSUMER | RUNTIME_COMPONENT:master_v2_double_play_evidence_input_plane_p0_evidence_seam_census_v1 | STATUS=OPEN (not proven) |  |
| GAP_AUTO:NO_CONSUMER:RUNTIME_COMPONENT:master_v2_double_play_evidence_input_plane_p1_authority_contracts_and_schemas_v1 | DEFINED_BUT_NO_CONSUMER | RUNTIME_COMPONENT:master_v2_double_play_evidence_input_plane_p1_authority_contracts_and_schemas_v1 | STATUS=OPEN (not proven) |  |
| GAP_AUTO:NO_CONSUMER:RUNTIME_COMPONENT:master_v2_double_play_evidence_input_plane_p2_evidence_adjudicator_runtime_v1 | DEFINED_BUT_NO_CONSUMER | RUNTIME_COMPONENT:master_v2_double_play_evidence_input_plane_p2_evidence_adjudicator_runtime_v1 | STATUS=OPEN (not proven) |  |
...
| GAP_AUTO:NO_CONSUMER:RUNTIME_COMPONENT:meta_to_learning_research_adaptation_input_v1 | DEFINED_BUT_NO_CONSUMER | RUNTIME_COMPONENT:meta_to_learning_research_adaptation_input_v1 | STATUS=OPEN (not proven) |  |
...
| GAP_AUTO:NO_CONSUMER:RUNTIME_COMPONENT:mi_phase_22_incremental_research_evidence_v1 | DEFINED_BUT_NO_CONSUMER | RUNTIME_COMPONENT:mi_phase_22_incremental_research_evidence_v1 | STATUS=OPEN (not proven) |  |
...
| GAP_AUTO:NO_CONSUMER:RUNTIME_COMPONENT:unified_blueprint_d02_loop_b_durable_mi_evidence_store_v1 | DEFINED_BUT_NO_CONSUMER | RUNTIME_COMPONENT:unified_blueprint_d02_loop_b_durable_mi_evidence_store_v1 | STATUS=OPEN (not proven) |  |
| GAP_AUTO:NO_CONSUMER:RUNTIME_COMPONENT:unified_blueprint_phase_10_mi_crossing_multi_cycle_offline_replay_v1 | DEFINED_BUT_NO_CONSUMER | RUNTIME_COMPONENT:unified_blueprint_phase_10_mi_crossing_multi_cycle_offline_replay_v1 | STATUS=OPEN (not proven) |  |
| GAP_AUTO:NO_CONSUMER:RUNTIME_COMPONENT:unified_blueprint_phase_11_surface_portfolio_closure_v1 | DEFINED_BUT_NO_CONSUMER | RUNTIME_COMPONENT:unified_blueprint_phase_11_surface_portfolio_closure_v1 | STATUS=OPEN (not proven) |  |
...
| GAP_AUTO:NO_CONSUMER:RUNTIME_COMPONENT:unified_blueprint_phase_21_learning_integration_v1 | DEFINED_BUT_NO_CONSUMER | RUNTIME_COMPONENT:unified_blueprint_phase_21_learning_integration_v1 | STATUS=OPEN (not proven) |  |
...
| GAP_AUTO:NO_CONSUMER:RUNTIME_COMPONENT:unified_blueprint_phase_26_final_closed_cycle_dod_v1 | DEFINED_BUT_NO_CONSUMER | RUNTIME_COMPONENT:unified_blueprint_phase_26_final_closed_cycle_dod_v1 | STATUS=OPEN (not proven) |  |
...
| GAP_AUTO:NO_CONSUMER:RUNTIME_COMPONENT:v32_d29_f1_m9_explicit_owner_productive_apply_policy_and_authority_edge_v1 | DEFINED_BUT_NO_CONSUMER | RUNTIME_COMPONENT:v32_d29_f1_m9_explicit_owner_productive_apply_policy_and_authority_edge_v1 | STATUS=OPEN (not proven) |  |
