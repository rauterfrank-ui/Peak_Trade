...
| GAP_AUTO:NO_CONSUMER:RUNTIME_COMPONENT:current_productive_account_equity_source_mapping_closure_v1 | DEFINED_BUT_NO_CONSUMER | RUNTIME_COMPONENT:current_productive_account_equity_source_mapping_closure_v1 | STATUS=OPEN (not proven) |  |
