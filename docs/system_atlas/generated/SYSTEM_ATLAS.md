...
Architectural-kind count in this bucket: `155`.
...
Truncated to 40 of `155` architectural-kind rows. Remaining kinds are in [COVERAGE_REPORT.md](COVERAGE_REPORT.md).
