...
Architectural-kind count in this bucket: `124`.
...
Truncated to 40 of `124` architectural-kind rows. Remaining kinds are in [COVERAGE_REPORT.md](COVERAGE_REPORT.md).
