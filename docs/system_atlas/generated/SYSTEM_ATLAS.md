...
Architectural-kind count in this bucket: `102`.
...
Truncated to 40 of `102` architectural-kind rows. Remaining kinds are in [COVERAGE_REPORT.md](COVERAGE_REPORT.md).
