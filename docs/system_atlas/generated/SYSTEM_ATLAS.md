...
Architectural-kind count in this bucket: `92`.
...
Truncated to 40 of `92` architectural-kind rows. Remaining kinds are in [COVERAGE_REPORT.md](COVERAGE_REPORT.md).
