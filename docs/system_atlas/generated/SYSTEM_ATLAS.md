...
Architectural-kind count in this bucket: `122`.
...
Truncated to 40 of `122` architectural-kind rows. Remaining kinds are in [COVERAGE_REPORT.md](COVERAGE_REPORT.md).
