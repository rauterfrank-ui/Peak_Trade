...
Declared gaps: `11`. Auto-detected `DEFINED_BUT_NO_CONSUMER` orphans: `94`. Auto-orphans are coverage notes, not proof of unused code. Drill-down: [ORPHAN_AND_WIRING_GAPS.md](ORPHAN_AND_WIRING_GAPS.md).
