...
Architectural-kind count in this bucket: `97`.
...
Truncated to 40 of `97` architectural-kind rows. Remaining kinds are in [COVERAGE_REPORT.md](COVERAGE_REPORT.md).
