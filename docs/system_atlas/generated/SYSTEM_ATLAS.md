...
Architectural-kind count in this bucket: `151`.
...
Truncated to 40 of `151` architectural-kind rows. Remaining kinds are in [COVERAGE_REPORT.md](COVERAGE_REPORT.md).
