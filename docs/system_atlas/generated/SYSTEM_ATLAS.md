...
Architectural-kind count in this bucket: `75`.
...
Truncated to 40 of `75` architectural-kind rows. Remaining kinds are in [COVERAGE_REPORT.md](COVERAGE_REPORT.md).
...
Declared gaps: `11`. Auto-detected `DEFINED_BUT_NO_CONSUMER` orphans: `71`. Auto-orphans are coverage notes, not proof of unused code. Drill-down: [ORPHAN_AND_WIRING_GAPS.md](ORPHAN_AND_WIRING_GAPS.md).
