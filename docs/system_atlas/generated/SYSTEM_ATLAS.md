...
Architectural-kind count in this bucket: `134`.
...
Truncated to 40 of `134` architectural-kind rows. Remaining kinds are in [COVERAGE_REPORT.md](COVERAGE_REPORT.md).
