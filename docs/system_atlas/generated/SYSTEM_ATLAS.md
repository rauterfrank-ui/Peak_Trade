...
Architectural-kind count in this bucket: `93`.
...
Truncated to 40 of `93` architectural-kind rows. Remaining kinds are in [COVERAGE_REPORT.md](COVERAGE_REPORT.md).
