...
Architectural-kind count in this bucket: `129`.
...
Truncated to 40 of `129` architectural-kind rows. Remaining kinds are in [COVERAGE_REPORT.md](COVERAGE_REPORT.md).
