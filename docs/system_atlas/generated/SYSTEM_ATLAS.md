...
Architectural-kind count in this bucket: `154`.
...
Truncated to 40 of `154` architectural-kind rows. Remaining kinds are in [COVERAGE_REPORT.md](COVERAGE_REPORT.md).
