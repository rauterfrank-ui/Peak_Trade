...
Architectural-kind count in this bucket: `148`.
...
Truncated to 40 of `148` architectural-kind rows. Remaining kinds are in [COVERAGE_REPORT.md](COVERAGE_REPORT.md).
