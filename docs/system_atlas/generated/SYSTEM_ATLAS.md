...
Architectural-kind count in this bucket: `133`.
...
Truncated to 40 of `133` architectural-kind rows. Remaining kinds are in [COVERAGE_REPORT.md](COVERAGE_REPORT.md).
