...
Architectural-kind count in this bucket: `131`.
...
Truncated to 40 of `131` architectural-kind rows. Remaining kinds are in [COVERAGE_REPORT.md](COVERAGE_REPORT.md).
