...
Architectural-kind count in this bucket: `87`.
...
Truncated to 40 of `87` architectural-kind rows. Remaining kinds are in [COVERAGE_REPORT.md](COVERAGE_REPORT.md).
