...
Architectural-kind count in this bucket: `135`.
...
Truncated to 40 of `135` architectural-kind rows. Remaining kinds are in [COVERAGE_REPORT.md](COVERAGE_REPORT.md).
