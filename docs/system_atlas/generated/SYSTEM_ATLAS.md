...
Architectural-kind count in this bucket: `91`.
...
Truncated to 40 of `91` architectural-kind rows. Remaining kinds are in [COVERAGE_REPORT.md](COVERAGE_REPORT.md).
