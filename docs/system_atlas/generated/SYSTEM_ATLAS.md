...
Architectural-kind count in this bucket: `100`.
...
Truncated to 40 of `100` architectural-kind rows. Remaining kinds are in [COVERAGE_REPORT.md](COVERAGE_REPORT.md).
