...
Architectural-kind count in this bucket: `132`.
...
Truncated to 40 of `132` architectural-kind rows. Remaining kinds are in [COVERAGE_REPORT.md](COVERAGE_REPORT.md).
