...
Architectural-kind count in this bucket: `82`.
...
| PHASE:send_time_pass_18_19_21_24 | PHASE | 11.13.5.SEND_TIME_PASS | CURRENT_IMPLEMENTED_NONCANONICAL | STATUS=FORENSIC_RAW |

Truncated to 40 of `82` architectural-kind rows. Remaining kinds are in [COVERAGE_REPORT.md](COVERAGE_REPORT.md).
...
Declared gaps: `11`. Auto-detected `DEFINED_BUT_NO_CONSUMER` orphans: `78`. Auto-orphans are coverage notes, not proof of unused code. Drill-down: [ORPHAN_AND_WIRING_GAPS.md](ORPHAN_AND_WIRING_GAPS.md).
