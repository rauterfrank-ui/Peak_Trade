...
Architectural-kind count in this bucket: `140`.
...
Truncated to 40 of `140` architectural-kind rows. Remaining kinds are in [COVERAGE_REPORT.md](COVERAGE_REPORT.md).
