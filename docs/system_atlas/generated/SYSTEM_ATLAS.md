...
Architectural-kind count in this bucket: `149`.
...
Truncated to 40 of `149` architectural-kind rows. Remaining kinds are in [COVERAGE_REPORT.md](COVERAGE_REPORT.md).
