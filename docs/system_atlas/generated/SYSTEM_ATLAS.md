...
Architectural-kind count in this bucket: `94`.
...
Truncated to 40 of `94` architectural-kind rows. Remaining kinds are in [COVERAGE_REPORT.md](COVERAGE_REPORT.md).
