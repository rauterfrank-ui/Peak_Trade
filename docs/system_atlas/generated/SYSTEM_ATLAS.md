...
Architectural-kind count in this bucket: `125`.
...
Truncated to 40 of `125` architectural-kind rows. Remaining kinds are in [COVERAGE_REPORT.md](COVERAGE_REPORT.md).
