...
Architectural-kind count in this bucket: `136`.
...
Truncated to 40 of `136` architectural-kind rows. Remaining kinds are in [COVERAGE_REPORT.md](COVERAGE_REPORT.md).
