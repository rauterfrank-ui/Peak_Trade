...
Architectural-kind count in this bucket: `95`.
...
Truncated to 40 of `95` architectural-kind rows. Remaining kinds are in [COVERAGE_REPORT.md](COVERAGE_REPORT.md).
