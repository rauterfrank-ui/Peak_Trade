...
Architectural-kind count in this bucket: `137`.
...
Truncated to 40 of `137` architectural-kind rows. Remaining kinds are in [COVERAGE_REPORT.md](COVERAGE_REPORT.md).
