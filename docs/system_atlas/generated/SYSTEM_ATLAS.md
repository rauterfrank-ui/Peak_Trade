...
Architectural-kind count in this bucket: `101`.
...
Truncated to 40 of `101` architectural-kind rows. Remaining kinds are in [COVERAGE_REPORT.md](COVERAGE_REPORT.md).
