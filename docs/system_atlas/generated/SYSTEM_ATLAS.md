...
Architectural-kind count in this bucket: `150`.
...
Truncated to 40 of `150` architectural-kind rows. Remaining kinds are in [COVERAGE_REPORT.md](COVERAGE_REPORT.md).
