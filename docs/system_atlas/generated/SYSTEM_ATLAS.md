...
Architectural-kind count in this bucket: `153`.
...
Truncated to 40 of `153` architectural-kind rows. Remaining kinds are in [COVERAGE_REPORT.md](COVERAGE_REPORT.md).
