...
Architectural-kind count in this bucket: `138`.
...
Truncated to 40 of `138` architectural-kind rows. Remaining kinds are in [COVERAGE_REPORT.md](COVERAGE_REPORT.md).
