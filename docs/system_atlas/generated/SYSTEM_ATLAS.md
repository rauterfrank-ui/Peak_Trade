...
Architectural-kind count in this bucket: `119`.
...
Truncated to 40 of `119` architectural-kind rows. Remaining kinds are in [COVERAGE_REPORT.md](COVERAGE_REPORT.md).
