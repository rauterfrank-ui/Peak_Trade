...
Architectural-kind count in this bucket: `152`.
...
Truncated to 40 of `152` architectural-kind rows. Remaining kinds are in [COVERAGE_REPORT.md](COVERAGE_REPORT.md).
