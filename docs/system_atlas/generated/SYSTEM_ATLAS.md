...
Architectural-kind count in this bucket: `145`.
...
Truncated to 40 of `145` architectural-kind rows. Remaining kinds are in [COVERAGE_REPORT.md](COVERAGE_REPORT.md).
