...
Architectural-kind count in this bucket: `84`.
...
| PHASE:p13_execution_prerequisite_12_exact_flatten_payload | PHASE | 11.13.5.P13 | CURRENT_IMPLEMENTED_NONCANONICAL | STATUS=FORENSIC_RAW |
| PHASE:p16_execution_prerequisite_16_bounded_activation | PHASE | 11.13.5.P16 | CURRENT_IMPLEMENTED_NONCANONICAL | STATUS=FORENSIC_RAW |
...
| PHASE:remaining_execution_path_end_to_end_census | PHASE | 11.13.5.REMAINING_EXECUTION_PATH_END_TO_END_CENSUS | CURRENT_IMPLEMENTED_NONCANONICAL | STATUS=FORENSIC_RAW |

Truncated to 40 of `84` architectural-kind rows. Remaining kinds are in [COVERAGE_REPORT.md](COVERAGE_REPORT.md).
...
Declared gaps: `11`. Auto-detected `DEFINED_BUT_NO_CONSUMER` orphans: `80`. Auto-orphans are coverage notes, not proof of unused code. Drill-down: [ORPHAN_AND_WIRING_GAPS.md](ORPHAN_AND_WIRING_GAPS.md).
