...
Architectural-kind count in this bucket: `118`.
...
Truncated to 40 of `118` architectural-kind rows. Remaining kinds are in [COVERAGE_REPORT.md](COVERAGE_REPORT.md).
