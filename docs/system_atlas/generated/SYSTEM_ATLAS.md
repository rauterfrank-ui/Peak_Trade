...
Declared gaps: `12`. Auto-detected `DEFINED_BUT_NO_CONSUMER` orphans: `140`. Auto-orphans are coverage notes, not proof of unused code. Drill-down: [ORPHAN_AND_WIRING_GAPS.md](ORPHAN_AND_WIRING_GAPS.md).
