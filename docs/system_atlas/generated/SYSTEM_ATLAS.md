...
Architectural-kind count in this bucket: `126`.
...
Truncated to 40 of `126` architectural-kind rows. Remaining kinds are in [COVERAGE_REPORT.md](COVERAGE_REPORT.md).
