...
Architectural-kind count in this bucket: `96`.
...
Truncated to 40 of `96` architectural-kind rows. Remaining kinds are in [COVERAGE_REPORT.md](COVERAGE_REPORT.md).
