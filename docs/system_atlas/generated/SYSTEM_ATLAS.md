...
Architectural-kind count in this bucket: `147`.
...
Truncated to 40 of `147` architectural-kind rows. Remaining kinds are in [COVERAGE_REPORT.md](COVERAGE_REPORT.md).
