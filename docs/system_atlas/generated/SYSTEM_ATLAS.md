...
Architectural-kind count in this bucket: `130`.
...
Truncated to 40 of `130` architectural-kind rows. Remaining kinds are in [COVERAGE_REPORT.md](COVERAGE_REPORT.md).
