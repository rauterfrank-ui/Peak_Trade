...
Architectural-kind count in this bucket: `113`.
...
Truncated to 40 of `113` architectural-kind rows. Remaining kinds are in [COVERAGE_REPORT.md](COVERAGE_REPORT.md).
