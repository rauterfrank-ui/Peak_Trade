...
Architectural-kind count in this bucket: `146`.
...
Truncated to 40 of `146` architectural-kind rows. Remaining kinds are in [COVERAGE_REPORT.md](COVERAGE_REPORT.md).
