...
Architectural-kind count in this bucket: `112`.
...
Truncated to 40 of `112` architectural-kind rows. Remaining kinds are in [COVERAGE_REPORT.md](COVERAGE_REPORT.md).
