...
Architectural-kind count in this bucket: `139`.
...
Truncated to 40 of `139` architectural-kind rows. Remaining kinds are in [COVERAGE_REPORT.md](COVERAGE_REPORT.md).
