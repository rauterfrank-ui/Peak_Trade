...
Architectural-kind count in this bucket: `90`.
...
Truncated to 40 of `90` architectural-kind rows. Remaining kinds are in [COVERAGE_REPORT.md](COVERAGE_REPORT.md).
