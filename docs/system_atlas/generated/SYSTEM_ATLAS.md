...
Architectural-kind count in this bucket: `68`.
...
| PHASE:z2cr | PHASE | 11.13.5.Z2CR | CURRENT_IMPLEMENTED_NONCANONICAL | STATUS=FORENSIC_RAW |
...
| PHASE:z2cw | PHASE | 11.13.5.Z2CW | CURRENT_IMPLEMENTED_NONCANONICAL | STATUS=FORENSIC_RAW |
...
Truncated to 40 of `68` architectural-kind rows. Remaining kinds are in [COVERAGE_REPORT.md](COVERAGE_REPORT.md).
...
Declared gaps: `11`. Auto-detected `DEFINED_BUT_NO_CONSUMER` orphans: `64`. Auto-orphans are coverage notes, not proof of unused code. Drill-down: [ORPHAN_AND_WIRING_GAPS.md](ORPHAN_AND_WIRING_GAPS.md).
