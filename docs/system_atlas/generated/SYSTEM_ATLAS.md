...
Architectural-kind count in this bucket: `121`.
...
Truncated to 40 of `121` architectural-kind rows. Remaining kinds are in [COVERAGE_REPORT.md](COVERAGE_REPORT.md).
