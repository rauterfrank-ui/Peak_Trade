...
- CURRENT-only Master Runbook operational SSOT rewrite and Map of Truth navigation sync (PR 6583). Atlas entity catalog reviewed for runbook/map path coupling. Clean Trading Core CLOSED; remaining core gap NONE. No Live GET/POST authorized by docs. Atlas is not canonical authority.
