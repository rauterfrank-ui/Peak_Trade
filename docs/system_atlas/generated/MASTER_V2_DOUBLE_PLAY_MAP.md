...
| RUNTIME_COMPONENT:master_v2_double_play_evidence_input_plane_p1_authority_contracts_and_schemas_v1 | RUNTIME_COMPONENT | CURRENT_NONCANONICAL | STATUS=FORENSIC_RAW |
| RUNTIME_COMPONENT:master_v2_double_play_evidence_input_plane_p2_evidence_adjudicator_runtime_v1 | RUNTIME_COMPONENT | CURRENT_NONCANONICAL | STATUS=FORENSIC_RAW |
| RUNTIME_COMPONENT:master_v2_double_play_evidence_input_plane_p3_input_creator_binder_runtime_v1 | RUNTIME_COMPONENT | CURRENT_NONCANONICAL | STATUS=FORENSIC_RAW |
...
| --- | --- | --- | --- | --- | --- |
| REL:r_ddo_capture_observes_entry_exit_input | RUNTIME_COMPONENT:ddo_capture_v0 | OBSERVES | RUNTIME_COMPONENT:ddo_double_play_input_evidence_v1 | STATUS=FORENSIC_RAW | src/learning/deterministic_decision_outcome_v0/capture_v0.py,src/learning/deterministic_decision_outcome_v0/double_play_input_evidence_v1.py |
| REL:r_ddo_input_evidence_reads_entry_exit_policy | RUNTIME_COMPONENT:ddo_double_play_input_evidence_v1 | READS | RUNTIME_COMPONENT:dp_entry_exit_policy | STATUS=FORENSIC_RAW | src/learning/deterministic_decision_outcome_v0/double_play_input_evidence_v1.py,src/trading/master_v2/double_play_entry_exit_policy_v0.py |
...
| REL:s_map_navigates_master_v2_double_play_evidence_input_plane_p1_authority_contracts_and_schemas_v1 | NAVIGATION_INDEX:map_of_truth | NAVIGATES_TO | RUNTIME_COMPONENT:master_v2_double_play_evidence_input_plane_p1_authority_contracts_and_schemas_v1 | STATUS=NAVIGATION_ONLY | docs/governance/PEAK_TRADE_MAP_OF_TRUTH.md,docs/governance/MASTER_V2_DOUBLE_PLAY_EVIDENCE_INPUT_PLANE_P1_AUTHORITY_CONTRACTS_V1.md,docs/ops/specs/EVIDENCE_INPUT_PLANE_P1_AUTHORITY_CONTRACTS_AND_SCHEMAS_V1.md |
| REL:s_map_navigates_master_v2_double_play_evidence_input_plane_p2_evidence_adjudicator_runtime_v1 | NAVIGATION_INDEX:map_of_truth | NAVIGATES_TO | RUNTIME_COMPONENT:master_v2_double_play_evidence_input_plane_p2_evidence_adjudicator_runtime_v1 | STATUS=NAVIGATION_ONLY | docs/governance/PEAK_TRADE_MAP_OF_TRUTH.md,docs/governance/MASTER_V2_DOUBLE_PLAY_EVIDENCE_INPUT_PLANE_P2_EVIDENCE_ADJUDICATOR_RUNTIME_V1.md,docs/ops/specs/EVIDENCE_INPUT_PLANE_P2_EVIDENCE_ADJUDICATOR_RUNTIME_V1.md |
| REL:s_map_navigates_master_v2_double_play_evidence_input_plane_p3_input_creator_binder_runtime_v1 | NAVIGATION_INDEX:map_of_truth | NAVIGATES_TO | RUNTIME_COMPONENT:master_v2_double_play_evidence_input_plane_p3_input_creator_binder_runtime_v1 | STATUS=NAVIGATION_ONLY | docs/governance/PEAK_TRADE_MAP_OF_TRUTH.md,docs/governance/MASTER_V2_DOUBLE_PLAY_EVIDENCE_INPUT_PLANE_P3_INPUT_CREATOR_BINDER_RUNTIME_V1.md,docs/ops/specs/EVIDENCE_INPUT_PLANE_P3_INPUT_CREATOR_BINDER_RUNTIME_V1.md |
