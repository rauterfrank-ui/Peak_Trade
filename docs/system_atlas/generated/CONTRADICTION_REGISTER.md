...
- claim_b (CURRENT_IMPLEMENTED): K1 checkout_independent_credential_okx_venue_auth_headers_v1 owns sign_okx_request_v1
- source_b: `src/ops/full_core_live_path_composition_root_v1/checkout_independent_credential_okx_venue_auth_headers_v1.py`
- resolved: `True`
- adjudication: Historical K2 BoundOkxTestnetHttpClientV1 removed; K1 owns the HMAC primitive fail-closed.
