...
PROJECT_NATIVE_TERM_COUNT=94
ACRONYM_COUNT=16
DOD_COUNT=8
SCHEMA_COUNT=18
TERMINOLOGY_COLLISION_COUNT=9
UNRESOLVED_TERM_COUNT=14
GIT_IS_SHALLOW=false
HISTORICAL_FETCH_PERFORMED=true
OKX_HISTORICAL_FEATURE_COUNT=9
HISTORICAL_PROJECT_NATIVE_TERM_COUNT=4
HISTORICAL_WIRING_CHANGE_COUNT=5
...
ATLAS_LOCALLY_RESOLVABLE_UNSEARCHED_COUNT=0
ATLAS_REQUIRES_OWNER_DECISION_COUNT=7
ATLAS_REQUIRES_RUNTIME_OBSERVATION_COUNT=1
ATLAS_REQUIRES_IMPLEMENTATION_CHANGE_COUNT=2
ATLAS_REQUIRES_EXTERNAL_CORPUS_COUNT=0
ATLAS_UNRESOLVED_TERMINOLOGY_COUNT=14
