...
| Risk / Kill-Switch | **D2 erledigt:** Legacy-Adapter entfernt, State-Machine kanonisch (siehe geordnetes Runbook Stufe D2). **Kurzverweise:** [`docs/risk/KILL_SWITCH.md`](../../risk/KILL_SWITCH.md), [`docs/ops/KILL_SWITCH_RUNBOOK.md`](../KILL_SWITCH_RUNBOOK.md). **Iterativ:** weitere historische Risk-Docs nur bei Bedarf — **NO-LIVE** | [`docs/risk/KILL_SWITCH.md`](../../risk/KILL_SWITCH.md) |
