...
**Du gibst:** 1–3 Sätze Ziel (z. B. „Learning Loop Lücken“, „Infostream Härten“, „Kill-Switch- / Risk-Doku-Konsistenz“).
...
| Risk / Kill-Switch | **D2 erledigt:** Legacy-Adapter entfernt, State-Machine kanonisch (siehe geordnetes Runbook Stufe D2). **Kurzverweise:** [`docs/risk/KILL_SWITCH.md`](../../risk/KILL_SWITCH.md), [`README_KILL_SWITCH.md`](../../../README_KILL_SWITCH.md) (D2-Hinweis); Archiv: [`TODO_KILL_SWITCH_ADAPTER_MIGRATION.md`](../../../TODO_KILL_SWITCH_ADAPTER_MIGRATION.md). **Iterativ:** weitere historische Risk-Docs nur bei Bedarf — **NO-LIVE** | [`TODO_KILL_SWITCH_ADAPTER_MIGRATION.md`](../../../TODO_KILL_SWITCH_ADAPTER_MIGRATION.md) |
| Execution / Orders (C1) | **STUB/GAP** laut Stufe C1: **LiveOrderExecutor** nur Dry-Run/Design (kein Live-Exchange-Client); in `paper.py` **ExchangeOrderExecutor**-Stub (`NotImplementedError`). **Abgrenzung:** [`testnet_executor.py`](../../../src/orders/testnet_executor.py) (Testnet/API) ist **separater** Pfad und **keine** C1-Live-Freigabe — **NO-LIVE** | [`RUNBOOK_UNIMPLEMENTED_FEATURES_ORDERED.md`](./RUNBOOK_UNIMPLEMENTED_FEATURES_ORDERED.md) Stufe C1 · [`exchange.py`](../../../src/orders/exchange.py) · [`paper.py`](../../../src/orders/paper.py) · [`testnet_executor.py`](../../../src/orders/testnet_executor.py) |
...
| J1 Forward (Scripts) | Operator-Kurzreferenz **NO-LIVE**; gemeinsamer OHLCV-Loader (Slice 4 Kraken opt-in, ``load_ohlcv``), Forward-CLIs ``--ohlcv-source dummy|kraken``, ``--n-bars``, Portfolio, ``_shared_forward_args``; vollständiger Ersatz aller Dummy-Pfade und weiterer Quellen: weiterhin **STUB** (Stufe J1) | PR #2267 · [`_shared_ohlcv_loader.py`](..&#47;..&#47;..&#47;scripts&#47;_shared_ohlcv_loader.py) · [`_shared_forward_args.py`](..&#47;..&#47;..&#47;scripts&#47;_shared_forward_args.py) · [Forward-Pipeline (Stufe J)](RUNBOOK_UNIMPLEMENTED_FEATURES_ORDERED.md#stufe-j--scripts--demo-daten-operativ-niedrig-priorisiert) · [`test_forward_generate_evaluate_integration_smoke.py`](../../../tests/test_forward_generate_evaluate_integration_smoke.py) · Operator quick reference: [CLI_CHEATSHEET.md](../../CLI_CHEATSHEET.md) (J1 Local OHLCV CSV Source / Forward-Signals; navigation-only, NO-LIVE, no broker/exchange orders, no Paper/Shadow/Evidence mutation, no gate changes). |
| J1 Forward (Demo-Stub) | Offline **Generate→Evaluate** (Dummy); **as_of** wie Integrationssmoke; Ausgabe unter **.ops_local** (Unterordner **forward_dummy_pipeline_demo**, gitignored) — **NO-LIVE**; Operator-Kurzreferenz **§6** | PR #2297 · [`run_forward_dummy_pipeline_demo.sh`](../../../scripts/dev/run_forward_dummy_pipeline_demo.sh) · [Operator-Kurzreferenz (J1)](RUNBOOK_UNIMPLEMENTED_FEATURES_ORDERED.md#operator-kurzreferenz-j1-forward-no-live) · [`test_forward_generate_evaluate_integration_smoke.py`](../../../tests/test_forward_generate_evaluate_integration_smoke.py) · Operator quick reference: [CLI_CHEATSHEET.md](../../CLI_CHEATSHEET.md) (Forward Dummy Pipeline Demo; navigation-only, NO-LIVE, no broker/exchange orders, no Paper/Shadow/Evidence mutation, no gate changes). |
...
| Truth / Docs governance | Repo-Truth-Claims + Docs-Drift-Kaskade für Branch-Protection-Registry; Reference-Targets-Verifier decodiert HTML-Entities vor dem `#`-Anchor-Split (token-policy-sichere Pfade wie `&#47;`) — **NO-LIVE** | PR #2256 / PR #2257 / PR #2321 · [`TRUTH_CORE.md`](../registry/TRUTH_CORE.md) · [`repo_truth_claims.yaml`](../../../config/ops/repo_truth_claims.yaml) · [`verify_docs_reference_targets.sh`](../../../scripts/ops/verify_docs_reference_targets.sh) |
