...
| Terminal layout product tests (historical) | deleted with Market Dashboard product — live guard: `tests/webui/test_market_dashboard_tombstone_v1.py` (`GET &#47;market*` absent / HTTP 404) |
| DOCS_TRUTH_MAP chronicle | `docs/ops/registry/DOCS_TRUTH_MAP.md` (this crosslink section + Änderungsnachweis row) |
