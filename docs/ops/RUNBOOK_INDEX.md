...
| **Professional Trading Dashboard runbook V1** | [market_dashboard/PEAK_TRADE_PROFESSIONAL_TRADING_DASHBOARD_RUNBOOK_V1.md](market_dashboard/PEAK_TRADE_PROFESSIONAL_TRADING_DASHBOARD_RUNBOOK_V1.md) | Bounded plan/boundary authority for Landscape V2 → professional read-only workstation (P0–V program); `AUTHORITY_CLASSIFICATION=PLAN_AND_BOUNDARY_ONLY`; `DASHBOARD_AUTHORITY_EFFECT=NONE`; Master Runbook SSOT preserved; **no** runtime/trading/testnet/live/order/credential authorization; P1 Preview V2 requires separate `OWNER_GO` after P0 merge |
| **Historical legacy product evidence** | [../webui/MARKET_DASHBOARD_REMOVED.md](../webui/MARKET_DASHBOARD_REMOVED.md) | `DOCUMENT_CLASS=HISTORICAL_EVIDENCE_ONLY`; not a current tombstone or negative non-regression contract; Landscape V2 `GET &#47;market` is the current read-only consumer |
...
| Artefakt | Pfad | Rolle |
|----------|------|-------|
| **Canonical Cybersecurity runbook V2.1** | [../runbooks/canonical/PEAK_TRADE_CANONICAL_CYBERSECURITY_RUNBOOK_V2_1.md](../runbooks/canonical/PEAK_TRADE_CANONICAL_CYBERSECURITY_RUNBOOK_V2_1.md) | Phase-aware security architecture + **mandatory** Pre-Live Security Acceptance Gate; `AUTHORITY_CLASSIFICATION=DERIVED_DOMAIN_AUTHORITY_ONLY`; `CYBERSECURITY_RUNBOOK_IS_SSOT=false`; Master §4.8 / §4.8.1 / §11.12.9 / §11.13.1; `PRE_LIVE_CYBERSECURITY_GATE_CONTRACT=MANDATORY`; `PRE_LIVE_CYBERSECURITY_GATE=PASS`; `ELIGIBLE_FOR_LIVE_READINESS_EVALUATION=true`; `SECTION_11_13_LIVE_READINESS_EVALUATION_COMPLETED=true`; `FULLY_AUTONOMOUS_LIVE_TRADING_READY=false`; `FUTURE_IMPLEMENTATION_BOUND_TO_CANONICAL_SECURITY_INVARIANTS=true`; **no** runtime, trading, testnet, live, order or credential authorization effect; Live unauthorized |
...
| **Pre-Flight** | [archives/repo_root_docs/PRE_FLIGHT_CHECKLIST_RUNBOOK_OPS.md](archives/repo_root_docs/PRE_FLIGHT_CHECKLIST_RUNBOOK_OPS.md) | Pre-Flight-Checkliste (Archive-SSOT) |
