...
- Provider mocks: okx/bybit (P107–P109)
...
- Create `src&#47;execution&#47;providers&#47;http_client_v1.py` (interface only) <!-- pt:ref-target-ignore -->
- Create `src&#47;execution&#47;providers&#47;errors_v1.py` (typed exceptions) <!-- pt:ref-target-ignore -->
- Create `src&#47;execution&#47;providers&#47;normalization_v1.py` <!-- pt:ref-target-ignore -->
...
## H) Evidence packs
- Add `scripts&#47;ops&#47;p119_execution_wiring_plan_snapshot_v1.sh` (docs + unit tests + pin) <!-- pt:ref-target-ignore -->
