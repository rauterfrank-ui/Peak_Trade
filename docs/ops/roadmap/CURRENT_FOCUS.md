...
- Branch: **`feat/roadmap-current-focus-post-truth-layer`** — docs-only refresh of **CURRENT_FOCUS** after truth/gates/officer/J1/canary landings
- Topic: **Roadmap anchor — truth & docs governance capability block on record**
- State: Finish Plan **PR 6–8** spine unchanged; **NO-LIVE** default
