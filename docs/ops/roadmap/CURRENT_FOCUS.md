...
- **Chat-led §5 Evidence G2:** [RUNBOOK_CHAT_LED_OPEN_FEATURES.md](../runbooks/RUNBOOK_CHAT_LED_OPEN_FEATURES.md) — Snapshot-Zeile „Evidence (G2)“ (``evidence_pack_generator.py`` und ``test_evidence_pack_generator.py``; Stufe G2 im geordneten Runbook **DONE**); **NO-LIVE**.
...
| 2026-04-12 | Chat-led §5 Evidence G2 snapshot row; `CURRENT_FOCUS` refresh (this file) | `bash scripts/ops/pt_docs_gates_snapshot.sh --changed` |
