...
- [x] **Kill-Switch posture unverändert** (keine Unlocks; keine “break-glass” Änderungen). **Nachweis:** [Governance & Safety Overview](../../GOVERNANCE_AND_SAFETY_OVERVIEW.md), [Kill Switch Runbook](../KILL_SWITCH_RUNBOOK.md), [`risk&#47;KILL_SWITCH_ARCHITECTURE.md`](../../risk/KILL_SWITCH_ARCHITECTURE.md).
...
- [x] **KILL SWITCH**: Drill/Runbook existiert und ist reproduzierbar (snapshot). **Nachweis:** [`docs/ops/KILL_SWITCH_RUNBOOK.md`](../KILL_SWITCH_RUNBOOK.md), [`docs/risk/KILL_SWITCH.md`](../../risk/KILL_SWITCH.md), [`scripts/ops/drill_kill_switch.py`](../../../scripts/ops/drill_kill_switch.py) (siehe [Operator Quickstart (v1.0)](#operator-quickstart-v10--local-verify-snapshot-only)).
...
- [x] **Audit Trail**: Evidence Index / Merge Logs / Status Reports integriert. **Nachweis:** [`docs/ops/EVIDENCE_INDEX.md`](../EVIDENCE_INDEX.md) (Audit‑Pfad), [`docs/ops/README.md`](../../ops/README.md) (Ops-/Evidence‑Navigation), [Workflow Frontdoor](../../WORKFLOW_FRONTDOOR.md) (Evidence/Audit‑Navigation).
