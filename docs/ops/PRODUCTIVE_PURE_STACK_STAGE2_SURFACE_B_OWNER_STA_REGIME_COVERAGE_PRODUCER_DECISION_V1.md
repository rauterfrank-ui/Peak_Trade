...
STATUS=OWNER_STA_AUTHORIZE_DETAIL_FIELDS_COMPLETE_PRODUCER_IMPLEMENTED_STA_OPEN_INPUTS_CLOSED
...
STA_OPEN_INPUTS_CLOSEOUT=docs/ops/PRODUCTIVE_PURE_STACK_STAGE2_SURFACE_B_OWNER_STA_REGIME_COVERAGE_STA_OPEN_INPUTS_CLOSEOUT_V1.md
...
```text
OWNER_STA_AUTHORIZE_DETAIL_FIELDS_COMPLETE_PRODUCER_IMPLEMENTED_STA_OPEN_INPUTS_CLOSED=true
DECISION_STATUS=RATIFIED
OWNER_VALUE=AUTHORIZE_DEDICATED_SURFACE_B_REGIME_COVERAGE_PRODUCER
AUTHORIZE_DETAIL_FIELDS_COMPLETE=true
STA_OPEN_INPUTS_CLOSED=true
...
INV_STA_OPEN_INPUTS_CLOSED=true
...
Closed by `OWNER_STA_REGIME_COVERAGE_STA_OPEN_INPUTS_CLOSEOUT_V1`
(`OWNER_STA_OPEN_INPUTS_CLOSEOUT_GO_BASE_SHA=75ea4dc594a7f27b1fb490477e824a8c0a66d779`):
...
Authorize-detail fields are complete, the dedicated producer is implemented,
and the remaining STA open inputs
(`non_invented_coverage_counts`, `provable_eth_usdt_swap_compatibility`) are
closed under
