...
**Branch:** `docs/ops/pr-93-merge-log`
...
**Branch:** `docs/ops-pr-85-merge-log`
...
scripts/ops/wave3_restore_batch.sh (new, executable)
```

**Impact Assessment:**
- Docs-only: ❌ NO
- Touches scripts: ✅ YES (`scripts/ops/wave3_restore_batch.sh`)
- Touches CI: ❌ NO
- Touches src: ❌ NO
- Touches tests: ❌ NO
- Touches config: ❌ NO
...
**Branch:** `docs/merge-log-pr-350-docs-reference-targets-golden-corpus`
...
**Branch:** `docs/frontdoor-roadmap-runner`
