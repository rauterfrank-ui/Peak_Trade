...
| 6. Lessons / priors / unsafe | Captured **learning** for **future** work | `docs/ops/specs/`, `docs/ops/runbooks/`, MASTER_V2_PROVENANCE_REPLAYABILITY_V1.md | narrative priors, warnings | next experiment, review | **Not** a veto or permit without process. |
...
| 8. Controlled handoff | Explicit package to next review step | signoff and handoff contracts, e.g. MASTER_V2_FIRST_LIVE_PRE_LIVE_SIGNOFF_HANDOFF_PACKET_CONTRACT_V1.md | structured handoff | operator or **external** process | **Handoff** is **not** **signoff** **complete** for **external** authority by itself. |
