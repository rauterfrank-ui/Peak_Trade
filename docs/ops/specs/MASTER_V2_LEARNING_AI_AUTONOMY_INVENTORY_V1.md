...
- BAYESIAN_EVIDENCE_LAYER_V0_DECISION.md
...
| `S3_OFFLINE_RETRAIN_COMPLETE` | Offline retrain artifact (non-live) | L0–L3 | Offline run logs; BAYESIAN_EVIDENCE_LAYER_V0_DECISION.md |
...
| Offline retrain run logs | `S3_OFFLINE_RETRAIN_COMPLETE` | L0–L3; offline evidence owner | BAYESIAN_EVIDENCE_LAYER_V0_DECISION.md | Offline **≠** live path; `ONLINE_LEARNING_TO_LIVE_FORBIDDEN=true` |
...
| Offline retrain run completed | `S3_OFFLINE_RETRAIN_COMPLETE` | §11 S3 row | BAYESIAN_EVIDENCE_LAYER_V0_DECISION.md | Offline **≠** live; drift hint **≠** auto-retrain |
