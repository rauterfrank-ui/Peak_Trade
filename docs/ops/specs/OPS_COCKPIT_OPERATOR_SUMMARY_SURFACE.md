...
- Safety / gating posture observation (aggregate): `build_safety_posture_observation` in `src/ops/safety_posture_observation.py`
...
- Governance / AI boundary observation (aggregate): `build_governance_boundary_observation` in `src/ops/governance_boundary_observation.py`
