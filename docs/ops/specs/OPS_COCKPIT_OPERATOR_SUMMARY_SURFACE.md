...
- Tests: `tests/webui/test_ops_cockpit.py`, `tests/ops/test_safety_posture_observation.py`, `tests/ops/test_run_session_observation.py`, `tests/ops/test_health_drift_observation.py`, `tests/ops/test_exposure_risk_observation.py`, `tests/ops/test_incident_safety_observation.py`, `tests/live/test_session_end_mismatch_reader.py`, `tests/live/test_transfer_ambiguity_reader.py`, `tests/ops/test_p85_result_reader.py`, `tests/ops/test_market_data_cache_observation_reader.py`
