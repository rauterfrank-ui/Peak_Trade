...
PUBLISH_MANIFEST_REQUIRED=cap24_selection_state_publish_manifest_v1.json
DEFAULT_ROOT_EXISTENCE_CONFERS_AUTHORITY=false
VALID_UNTIL_REQUIRED_FOR_CURRENT=true
