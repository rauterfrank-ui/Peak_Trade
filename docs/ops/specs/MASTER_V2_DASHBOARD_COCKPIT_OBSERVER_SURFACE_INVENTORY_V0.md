...
| `docs/ops/market_dashboard/PEAK_TRADE_MARKET_DASHBOARD_LANDSCAPE_MASTER_RUNBOOK_V2.md` | Dashboard / Cockpit | current Landscape V2 read-only consumer planning SSOT | **author** / **reviewer** | **Markdown** | `DASHBOARD_AUTHORITY_EFFECT=NONE`; not a permit by itself |
