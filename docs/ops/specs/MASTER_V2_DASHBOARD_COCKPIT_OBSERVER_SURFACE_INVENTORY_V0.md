...
| `docs/webui/MARKET_DASHBOARD_REMOVED.md` | Dashboard / Cockpit | futures read-only market dashboard (contract) | **author** / **reviewer** | **Markdown** | read-only framing; not a permit by itself |
