...
Use alongside [`RUNBOOK_BOUNDED_PILOT_LIVE_ENTRY.md`](../runbooks/RUNBOOK_BOUNDED_PILOT_LIVE_ENTRY.md) and gate index [§4.3](MASTER_V2_FIRST_LIVE_GATE_STATUS_INDEX_V1.md#43-l3-candidate-prerequisite-pointer-record-g6). L1/L2 captures may **overlap** evidence used to **inform** §3 items 1–2; reuse external objects with clear scope in `artifact_summary` instead of duplicating contradictory handles. Authorization remains external.
