...
- 2026-05-21 — `docs/ops/specs/SCHEDULER_BOUNDARY_HARD_BLOCK_CONTRACT_V0.md` — **Scheduler Boundary Hard-Block Contract v0** (non-dry-run launcher guard via preflight; dry-run remains planning-only); cross-link from taxonomy §7; **kein** Scheduler-Daemon-Start, **kein** Live/Testnet/Broker-Unlock.
