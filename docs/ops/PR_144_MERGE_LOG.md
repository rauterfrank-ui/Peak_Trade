...
- Update `scripts/research_el_karoui_vol_model.py`: `REPORT_PATH` from (planned directory) → (planned directory)
...
## Notes / Follow-ups
- Consider documenting "docs/reports is ignored" policy in (planned)
