...
- evidence-backed operation under explicit guardrails
- operator-ready local launcher path
...
- canonical operator path via local secret launcher
- closeout and handoff standardization

## What Is Allowed Now
- bounded / acceptance runs through the canonical launcher path
- evidence-backed closeouts using the standard templates
- operator use of cheat sheet, runbook, verify checklist, and go/no-go snapshot
