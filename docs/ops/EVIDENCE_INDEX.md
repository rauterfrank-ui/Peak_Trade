...
**Generate new entry:**
```bash
python3 scripts/ops/generate_evidence_entry.py --tag <TAG> --category "<CATEGORY>" --title "<TITLE>"
```
...
|-------------|------|-------|-------------|------------------------------|--------------|-------|
| EV-20260121-EXEWATCH-V04 | 2026-01-21 | ops | [Evidence](evidence/EV_EXECUTION_WATCH_DASHBOARD_V0_4_PASS_20260121T192405Z.md) | Execution Watch Dashboard v0.4 PASS: health endpoint + UI health panel; polling default off; Ping Health single-shot; tail mode unchanged; watch-only/read-only. | Local snapshot: start `python3 -m uvicorn src.webui.app:app --reload --host 127.0.0.1 --port 8000`; verify `GET &#47;execution_watch` and `GET &#47;api&#47;execution&#47;health` (meta.api_version=v0.4, meta.source, meta.read_errors, meta.dataset_stats, meta.last_event_utc). | Risk: LOW (NO-LIVE, read-only). | <!-- ORPHANED_MISSING_TARGET_CONFIRMED: target file absent as of 2026-05-15; retained as historical evidence-index row, not an active readiness proof. -->
| EV-20260116-PR742-DOCS-TOKEN-POLICY-FIX | 2026-01-16 | ops | [PR #742 Merge Log](merge_logs/PR_742_MERGE_LOG.md) | PR #742 merged: watch-only UI v0.1B + read-only API v0 extensions + operator runbook. CI token-policy remediation captured: illustrative inline-code token `live_runs&#47;` encoded as `live_runs&#47;` in `docs&#47;ops&#47;runbooks&#47;RUNBOOK_DASHBOARD_WATCH_ONLY_V01B.md`. | CI Proof (snapshot): `gh pr checks 742` → 0 failing, 0 pending. Local Proof: `python3 scripts&#47;ops&#47;validate_docs_token_policy.py --base origin&#47;main --json docs-token-policy-report.json` → PASS. | Risk: LOW. Artifacts: `docs/ops/merge_logs/PR_742_MERGE_LOG.md`. | <!-- pt:ref-target-ignore -->
...
| EV-20251228-PHASE8A | 2025-12-28 | ops | [PHASE8A_MERGE_LOG.md](archives/repo_root_docs/PHASE8A_MERGE_LOG.md) | Phase 8A: Kupiec POF deduplication complete, single canonical engine established, 138/138 tests passed | Branch: refactor/kupiec-pof-single-engine, delegation tests verify wrapper correctness, zero breaking changes | Ready for merge, risk: VERY LOW (refactor-only) |
| EV-20251228-PHASE8D | 2025-12-28 | ops | [PHASE8D_MERGE_LOG.md](archives/repo_root_docs/PHASE8D_MERGE_LOG.md) | Phase 8D: Traffic Light deduplication complete, binomial-based thresholds, 93/93 tests passed | Canonical engine unchanged, 12 delegation tests, backward compatibility maintained | Ready for merge, risk: VERY LOW, follows Phase 8A pattern |
...
## Historical Merge Logs Archive

**Purpose:** Archive of historical PR merge logs for traceability
...
**PRs 116-161:** [PR_116_MERGE_LOG.md](PR_116_MERGE_LOG.md) · [PR_121_MERGE_LOG.md](PR_121_MERGE_LOG.md) · [PR_136_MERGE_LOG.md](PR_136_MERGE_LOG.md) · [PR_137_MERGE_LOG.md](PR_137_MERGE_LOG.md) · [PR_143_MERGE_LOG.md](PR_143_MERGE_LOG.md) · [PR_144_MERGE_LOG.md](PR_144_MERGE_LOG.md) · [PR_150_MERGE_LOG.md](PR_150_MERGE_LOG.md) · [PR_152_MERGE_LOG.md](PR_152_MERGE_LOG.md) · [PR_154_MERGE_LOG.md](PR_154_MERGE_LOG.md) · [PR_161_MERGE_LOG.md](PR_161_MERGE_LOG.md)

**PRs 180-204:** [PR_180_MERGE_LOG.md](PR_180_MERGE_LOG.md) · [PR_182_MERGE_LOG.md](PR_182_MERGE_LOG.md) · [PR_185_MERGE_LOG.md](PR_185_MERGE_LOG.md) · [PR_186_MERGE_LOG.md](PR_186_MERGE_LOG.md) · [PR_193_MERGE_LOG.md](PR_193_MERGE_LOG.md) · [PR_195_MERGE_LOG.md](PR_195_MERGE_LOG.md) · [PR_197_MERGE_LOG.md](PR_197_MERGE_LOG.md) · [PR_199_MERGE_LOG.md](PR_199_MERGE_LOG.md) · [PR_201_MERGE_LOG.md](PR_201_MERGE_LOG.md) · [PR_204_MERGE_LOG.md](PR_204_MERGE_LOG.md)

**PRs 206-225:** [PR_206_MERGE_LOG.md](PR_206_MERGE_LOG.md) · [PR_209_MERGE_LOG.md](PR_209_MERGE_LOG.md) · [PR_210_MERGE_LOG.md](PR_210_MERGE_LOG.md) · [PR_211_MERGE_LOG.md](PR_211_MERGE_LOG.md) · [PR_212_MERGE_LOG.md](PR_212_MERGE_LOG.md) · [PR_213_MERGE_LOG.md](PR_213_MERGE_LOG.md) · [PR_217_MERGE_LOG.md](PR_217_MERGE_LOG.md) · [PR_218_MERGE_LOG.md](PR_218_MERGE_LOG.md) · [PR_222_MERGE_LOG.md](PR_222_MERGE_LOG.md) · [PR_225_MERGE_LOG.md](PR_225_MERGE_LOG.md)

**PRs 228-279:** [PR_228_MERGE_LOG.md](PR_228_MERGE_LOG.md) · [PR_229_MERGE_LOG.md](PR_229_MERGE_LOG.md) · [PR_240_MERGE_LOG.md](PR_240_MERGE_LOG.md) · [PR_242_MERGE_LOG.md](PR_242_MERGE_LOG.md) · [PR_262_MERGE_LOG.md](PR_262_MERGE_LOG.md) · [PR_265_MERGE_LOG.md](PR_265_MERGE_LOG.md) · [PR_267_MERGE_LOG.md](PR_267_MERGE_LOG.md) · [PR_271_MERGE_LOG.md](PR_271_MERGE_LOG.md) · [PR_278_MERGE_LOG.md](PR_278_MERGE_LOG.md) · [PR_279_MERGE_LOG.md](PR_279_MERGE_LOG.md)

**PRs 280-304:** [PR_280_MERGE_LOG.md](PR_280_MERGE_LOG.md) · [PR_281_MERGE_LOG.md](PR_281_MERGE_LOG.md) · [PR_284_MERGE_LOG.md](PR_284_MERGE_LOG.md) · [PR_285_MERGE_LOG.md](PR_285_MERGE_LOG.md) · [PR_286_MERGE_LOG.md](PR_286_MERGE_LOG.md) · [PR_288_MERGE_LOG.md](PR_288_MERGE_LOG.md) · [PR_290_MERGE_LOG.md](PR_290_MERGE_LOG.md) · [PR_292_MERGE_LOG.md](PR_292_MERGE_LOG.md) · [PR_295_MERGE_LOG.md](PR_295_MERGE_LOG.md) · [PR_304_MERGE_LOG.md](PR_304_MERGE_LOG.md)

**PRs 307-442:** [PR_307_MERGE_LOG.md](PR_307_MERGE_LOG.md) · [PR_309_MERGE_LOG.md](PR_309_MERGE_LOG.md) · [PR_311_MERGE_LOG.md](PR_311_MERGE_LOG.md) · [PR_325_MERGE_LOG.md](PR_325_MERGE_LOG.md) · [PR_409_MERGE_LOG.md](PR_409_MERGE_LOG.md) · [PR_413_MERGE_LOG.md](PR_413_MERGE_LOG.md) · [PR_418_MERGE_LOG.md](PR_418_MERGE_LOG.md) · [PR_424_MERGE_LOG.md](PR_424_MERGE_LOG.md) · [PR_426_MERGE_LOG.md](PR_426_MERGE_LOG.md) · [PR_442_MERGE_LOG.md](PR_442_MERGE_LOG.md)

**PRs 446-481:** [PR_446_MERGE_LOG.md](PR_446_MERGE_LOG.md) · [PR_447_MERGE_LOG.md](PR_447_MERGE_LOG.md) · [PR_448_MERGE_LOG.md](PR_448_MERGE_LOG.md) · [PR_454_MERGE_LOG.md](PR_454_MERGE_LOG.md) · [PR_456_MERGE_LOG.md](PR_456_MERGE_LOG.md) · [PR_458_MERGE_LOG.md](PR_458_MERGE_LOG.md) · [PR_462_MERGE_LOG.md](PR_462_MERGE_LOG.md) · [PR_470_MERGE_LOG.md](PR_470_MERGE_LOG.md) · [PR_479_MERGE_LOG.md](PR_479_MERGE_LOG.md) · [PR_481_MERGE_LOG.md](PR_481_MERGE_LOG.md)

**PRs 482-501:** [PR_482_MERGE_LOG.md](PR_482_MERGE_LOG.md) · [PR_483_MERGE_LOG.md](PR_483_MERGE_LOG.md) · [PR_485_MERGE_LOG.md](PR_485_MERGE_LOG.md) · [PR_486_MERGE_LOG.md](PR_486_MERGE_LOG.md) · [PR_488_MERGE_LOG.md](PR_488_MERGE_LOG.md) · [PR_489_MERGE_LOG.md](PR_489_MERGE_LOG.md) · [PR_491_MERGE_LOG.md](PR_491_MERGE_LOG.md) · [PR_497_MERGE_LOG.md](PR_497_MERGE_LOG.md) · [PR_499_MERGE_LOG.md](PR_499_MERGE_LOG.md) · [PR_501_MERGE_LOG.md](PR_501_MERGE_LOG.md)

**PRs 504-593:** [PR_504_MERGE_LOG.md](PR_504_MERGE_LOG.md) · [PR_506_MERGE_LOG.md](PR_506_MERGE_LOG.md) · [PR_509_MERGE_LOG.md](PR_509_MERGE_LOG.md) · [PR_510_MERGE_LOG.md](PR_510_MERGE_LOG.md) · [PR_512_MERGE_LOG.md](PR_512_MERGE_LOG.md) · [PR_560_MERGE_LOG.md](PR_560_MERGE_LOG.md) · [PR_562_MERGE_LOG.md](PR_562_MERGE_LOG.md) · [PR_566_MERGE_LOG.md](PR_566_MERGE_LOG.md) · [PR_569_MERGE_LOG.md](PR_569_MERGE_LOG.md) · [PR_593_MERGE_LOG.md](PR_593_MERGE_LOG.md)

**PRs 604-649:** [PR_604_MERGE_LOG.md](PR_604_MERGE_LOG.md) · [PR_607_MERGE_LOG.md](PR_607_MERGE_LOG.md) · [PR_610_MERGE_LOG.md](PR_610_MERGE_LOG.md) · [PR_611_MERGE_LOG.md](PR_611_MERGE_LOG.md) · [PR_614_MERGE_LOG.md](PR_614_MERGE_LOG.md) · [PR_640_MERGE_LOG.md](PR_640_MERGE_LOG.md) · [PR_642_MERGE_LOG.md](PR_642_MERGE_LOG.md) · [PR_643_MERGE_LOG.md](PR_643_MERGE_LOG.md) · [PR_645_MERGE_LOG.md](PR_645_MERGE_LOG.md) · [PR_649_MERGE_LOG.md](PR_649_MERGE_LOG.md)
