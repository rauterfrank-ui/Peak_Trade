...
python3 scripts/experiments_explorer.py --limit 10
...
| Readiness | `python3 scripts/check_live_readiness.py` | PASSED |
...
python3 scripts/experiments_explorer.py --run-id <RUN_ID> --export-csv
