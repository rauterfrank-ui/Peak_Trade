...
**Professional Trading Dashboard runbook V1 (Landscape V2 workstation finalization; plan/boundary only; no runtime/trading authorization):**  
[`docs/ops/market_dashboard/PEAK_TRADE_PROFESSIONAL_TRADING_DASHBOARD_RUNBOOK_V1.md`](../ops/market_dashboard/PEAK_TRADE_PROFESSIONAL_TRADING_DASHBOARD_RUNBOOK_V1.md)
