...
| SS-13 | REPO_PRESERVATION_TRANSCRIPT_SUBSET | `90a346c4-5419-436a-9d7f-e2a893c4aad5.jsonl` (tree `forensic&#47;p6_proven_relevant_jsonl_identity_copies_v1&#47;` removed frozen-203; was 170 git files) | NONE | REPO_PRESERVATION_SUBSET | HISTORICAL_RELEVANT_SUBSET | PATH+SHA copies | IDENTITY_COPIES_REMOVED | UNPROVEN |
| SS-14 | HISTORICAL_LOCATOR_ABSENT | Desktop originals formerly recorded in `forensic&#47;post_step32_knowledge_integration_v0&#47;manifests&#47;source_identities.json` (tree removed frozen-203) | NONE | HISTORICAL_LOCATOR | HISTORICAL | PATH_RECORDED_ABSENT_NOT_REASSIGNED | PROBED_ABSENT_IN_DISCOVERY_REGISTRY | N/A |
