...
`MANIFEST_VERIFY_RC=0`; `LIVE_AUTHORIZED=false`). Früheste Restabhängigkeit
ist `LIVE_SHADOW_WITH_EXCHANGE_RECONCILIATION`. Live-Shadow&#47;Canary-Progression
bleibt unstarted; Live bleibt hard-blocked.
`SECTION_11_13_LIVE_ACTIVATION_AUTHORIZED=false`; Live Shadow erfordert
