...
PRODUCTIVE_CANARY_SURFACE_MERGED_TO_ORIGIN_MAIN=false
LIVE_CANARY_MINIMUM_EXPOSURE_EXECUTED=false
LIVE_CANARY_MINIMUM_EXPOSURE_PROVEN=false
LIVE_AUTHORIZED=false
NETWORK_EFFECT=NONE
...
Canonical next pointer after this audit (unchanged economic &#47; permission
blockers; no execute GO implied):
