...
`TESTNET_AUTONOMOUS_RECOVERY_PROVEN` is newly closed. Remaining Cap 11.12 proven
fields stay false (`TESTNET_EVIDENCE_VERIFIED`). Hard stop after this proof. No
automatic progression.
...
Mandatory residual Cap 11.12 closure fields (remaining open after §11.12.9.18;
