...
### 11.2.1.EZ FULL_CORE_CURRENT_PRODUCTIVE_ACCOUNT_EQUITY_SOURCE_MAPPING_CLOSURE
...
Evidence pack:
`evidence/ops/full_core_current_productive_account_equity_source_mapping_closure_v1/20260921T201900Z/`.
Hard stop after persist without separate `OWNER_MERGE_GO`.
