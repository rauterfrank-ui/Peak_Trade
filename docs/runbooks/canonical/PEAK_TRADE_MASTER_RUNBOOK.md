...
The next Owner-GO is the §11.13.5.Z2H-bound productive-evidence token
for remaining unproven COVER_USDC terms after the current ticker
bid&#47;ask observation and **before** funding. This is evidence-chain
