...
TREASURY_PHASE_2_JOIN_SEAM=TREASURY_PHASE_2_READ_ONLY_RECONCILIATION_TO_CAPITAL_ADMISSION_V1
TREASURY_PHASE_2_NETWORK_ALLOWED=false
TREASURY_PHASE_2_MUTATION_AUTHORIZED=false
```
