...
| **RUNBOOK D4 — Ops/Governance Polish**          | `docs&#47;ops&#47;runbooks&#47;RUNBOOK_D4_OPS_GOVERNANCE_POLISH.md`      | v1.0 (Jan 2026) | Templates, Frontdoor Links, Docs Gates, Evidence, Merge Logs, Release Checklist                                                        | Ops / Governance                                           | **Ops, Docs-Gates, Evidence**            | ✅ 2026-ready            |
...
| **Finish C (Pointer) — Broker Adapter + Live‑Ops** | `docs&#47;ops&#47;runbooks&#47;RUNBOOK_FINISH_C_V1_LIVE_BROKER_OPS.md` | v1.0 (Jan 2026) | Einstieg/Pointer in den Finish‑C Track (governance‑first, NO‑LIVE default); detaillierte Runbooks in `docs&#47;ops&#47;runbooks&#47;finish_c&#47;` | Finish‑C Track                                        | **Ops, Governance**                      | ⚠️ Track (NO‑LIVE default) |
