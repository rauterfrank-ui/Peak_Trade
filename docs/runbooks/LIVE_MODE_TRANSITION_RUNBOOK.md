...
> - **Bounded/live-pilot wrapper:** `PT_CONFIRM_TOKEN` and `PT_CONFIRM_TOKEN_EXPECTED` in `scripts/ops/run_live_pilot_session.sh` Details: live_pilot_session_wrapper.md.
