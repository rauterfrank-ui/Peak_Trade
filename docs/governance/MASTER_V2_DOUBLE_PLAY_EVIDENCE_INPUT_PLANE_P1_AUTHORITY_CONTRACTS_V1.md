# Master V2 / Double Play — Evidence & Input Plane P1 Authority Contracts v1

```text
DOCUMENT_CLASS=GOVERNANCE_NAVIGATION
AUTHORITY=NONE
RUNTIME_AUTHORIZATION_EFFECT=NONE
O_002_STATUS=RATIFIED
```

P1 materializes **executable contract/schema owners** for the Evidence & Input Plane after
Owner GO on O-002 (bounded typed L6 admissibility, Option B). This document is navigation only.
...
| P0 census (updated L6/O-002 fields) | [`docs/evidence/master_v2_double_play_evidence_input_plane_p0/l1_l10_evidence_seam_census_v1.json`](../evidence/master_v2_double_play_evidence_input_plane_p0/l1_l10_evidence_seam_census_v1.json) |

**Out of scope (unchanged):** Component A/B runtime, productive binding, D_t formula selection,
O-001 repair, L6–L10 mechanical semantics.
