...
| Feld | Wert |
|---|---|
| `LAST_VERIFIED_ORIGIN_MAIN` | `4dd3e0155e7bbd6d5265b2b0dc334f7f7d71efda` |
| `LAST_VERIFIED_AT` | `2026-07-05T01:47:31Z` |
| `LAST_VERIFIED_SOURCE` | `OKX_FULL_PANEL_CROSS_SECTIONAL_RANKING_STRATEGY_ARCHETYPE_BOUNDED_OFFLINE_ECONOMIC_EVALUATION_V0` |
| `CURRENT_STATE` | `OKX_FULL_PANEL_CROSS_SECTIONAL_RANKING_STRATEGY_ARCHETYPE_OFFLINE_ECONOMIC_EVALUATION_COMPLETE_V0` |
...
| `NEXT_CANONICAL_ACTION` | `NO_RUNTIME_OR_PROMOTION_ACTION` |
