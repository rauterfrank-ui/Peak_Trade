...
| Feld | Wert |
|---|---|
| `LAST_VERIFIED_ORIGIN_MAIN` | `77de907bbf7808ed4cbf8604c7994f7078932b85` |
| `LAST_VERIFIED_AT` | `2026-07-05T21:00:00Z` |
| `LAST_VERIFIED_SOURCE` | `POST_NO_PASS_ROBUSTNESS_FAILURE_NEXT_RESEARCH_SCOPE_DEFINITION_V0` |
| `LAST_VERIFIED_PR` | `4878` |
...
| `NEXT_CANONICAL_ACTION` | `REQUEST_OPERATOR_GO_FOR_POST_NO_PASS_SPARSE_SIGNAL_ZERO_TRADE_VERSIONED_BINDING_RATIFICATION_V0` |
...
| `GLOBAL_RUNBOOK_NEXT_STEP` | `REQUEST_OPERATOR_GO_FOR_POST_NO_PASS_SPARSE_SIGNAL_ZERO_TRADE_VERSIONED_BINDING_RATIFICATION_V0` |
