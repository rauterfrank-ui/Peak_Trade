...
| `HYPOTHESIS_SUBSTRAND_NEXT_STEP` | `OPERATOR_INPUT_REQUIRED_FOR_NEW_RESEARCH_SCOPE_DEFINITION_V0` |
...
| `PIT_UNIVERSE_MANIFEST_REF_STATUS` | `REQUIRED_UNBOUND` |
...
| `STATUS` | `NUMERIC_BOUND_BINDING_INCOMPLETE` |
...
| `DEPENDENCIES` | RUNBOOK_STEP_31F |
| `NEXT_REQUIRED_CONTRACT` | `NONE` |
| `NEXT_CANONICAL_STEP` | `BOUNDED_CROSS_SECTIONAL_UNIVERSE_MANIFEST_BINDING_READ_ONLY_REASSESSMENT_V0` |
| `AUTHORITY_LEVEL` | `NON_AUTHORITIZING` |
| `FUTURES_ONLY` | `true` |
| `BITCOIN_DIRECTION_ALLOWED` | `false` |
| `SPOT_ALLOWED` | `false` |
