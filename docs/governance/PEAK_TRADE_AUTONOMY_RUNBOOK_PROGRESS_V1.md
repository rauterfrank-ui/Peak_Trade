...
| `CURRENT_STATE` | `FINAL_RESEARCH_FLEET_NEW_EVIDENCE_CLASS_SCOPE_DEFINED_V0` |
...
| `NEXT_CANONICAL_ACTION` | `REQUEST_OPERATOR_GO_FOR_BOUNDED_NEW_EVIDENCE_CLASS_OFFLINE_ECONOMIC_EVALUATION_EXECUTION_V0` |
...
| `FINAL_RESEARCH_FLEET_NEW_EVIDENCE_CLASS_SCOPE_V0_EVIDENCE_REF` | `PENDING_POST_MERGE` |
...
| `NEW_EVIDENCE_CLASS_EXECUTION_OWNER_REF` | `src/research/final_research_fleet_okx_full_panel_versioned_binding_and_offline_economic_evaluation_v0.py` |
| `NEW_EVIDENCE_CLASS_EXECUTION_RUNNER_REF` | `scripts/ops/run_final_research_fleet_okx_full_panel_versioned_binding_and_offline_economic_evaluation_v0.py` |
...
| `FINAL_RESEARCH_FLEET_OFFLINE_EVALUATION_COMPLETE` | `false` |
...
| `GLOBAL_RUNBOOK_NEXT_STEP` | `REQUEST_OPERATOR_GO_FOR_BOUNDED_NEW_EVIDENCE_CLASS_OFFLINE_ECONOMIC_EVALUATION_EXECUTION_V0` |
