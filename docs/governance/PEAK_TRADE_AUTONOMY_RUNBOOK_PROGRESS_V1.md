...
| `CURRENT_ADMISSIBLE_NEXT_SCOPE` | `BOUNDED_POST_NO_PASS_FUTURES_RESEARCH_SCOPE_DEFINITION_V0` |
| `CURRENT_ADMISSIBLE_NEXT_SCOPE_GO_TOKEN` | `GO_NEW_RATIFIED_RESEARCH_SCOPE_OR_EVIDENCE_CLASS_SCOPE_DEFINITION_ONLY_V0` |
| `BOUNDED_POST_NO_PASS_FUTURES_RESEARCH_SCOPE_DEFINITION_V0_STATUS` | `SCOPE_DEFINED_NOT_EXECUTED` |
