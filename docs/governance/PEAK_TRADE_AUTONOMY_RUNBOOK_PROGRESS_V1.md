...
| `NEXT_CANONICAL_ACTION` | `REQUEST_OPERATOR_GO_FOR_VERSIONED_FINAL_FLEET_BINDINGS_AND_BOUNDED_OFFLINE_ECONOMIC_EVALUATION_V0` |
...
| `GLOBAL_RUNBOOK_NEXT_STEP` | `REQUEST_OPERATOR_GO_FOR_VERSIONED_FINAL_FLEET_BINDINGS_AND_BOUNDED_OFFLINE_ECONOMIC_EVALUATION_V0` |
