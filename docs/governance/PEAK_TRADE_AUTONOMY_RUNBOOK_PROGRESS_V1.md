...
| Feld | Wert |
|---|---|
| `LAST_VERIFIED_ORIGIN_MAIN` | `f21aadc36c0ee3f5b697ef426da25db5104b9b90` |
| `LAST_VERIFIED_AT` | `2026-07-05T01:35:00Z` |
| `LAST_VERIFIED_SOURCE` | `OKX_FULL_PANEL_CROSS_SECTIONAL_RANKING_STRATEGY_ARCHETYPE_VERSIONED_BINDINGS_MATERIALIZATION_V0` |
| `CURRENT_STATE` | `OKX_FULL_PANEL_CROSS_SECTIONAL_RANKING_STRATEGY_ARCHETYPE_VERSIONED_BINDINGS_MATERIALIZED_V0` |
