...
| Feld | Wert |
|---|---|
| `LAST_VERIFIED_ORIGIN_MAIN` | `5d402362727848eba605fb3da5c593a559b5494b` |
| `LAST_VERIFIED_AT` | `2026-06-29T09:50:00Z` |
| `CURRENT_MAJOR_GAP_PACKAGE` | `MAJOR_GAP_COMPARISON_PROMOTION_POLICY_INPUT_BRIDGE_V0` |
| `NEXT_RUNBOOK_STEP` | `RUNBOOK_STEP_19` |
| `NEXT_CANONICAL_STEP` | `unknown_outcome_recovery` |
