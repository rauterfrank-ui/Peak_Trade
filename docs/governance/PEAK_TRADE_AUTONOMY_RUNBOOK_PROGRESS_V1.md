...
| Feld | Wert |
|---|---|
| `LAST_VERIFIED_ORIGIN_MAIN` | `71bb9ccdcfe8771ac7fc027ecda9fd710d06ab01` |
| `LAST_VERIFIED_AT` | `2026-07-02T23:20:00Z` |
...
| `NEXT_CANONICAL_STEP` | `RUNBOOK_STEP_29R_RUNTIME_REWIRE_V1_IMPLEMENTATION (blocked; ECONOMIC_VALIDITY_OFFLINE_GATE_PASS=false)` |
...
| `CURRENT_ADMISSIBLE_IMPLEMENTATION_SCOPE` | `NONE_UNDER_CURRENT_POLICY` |
| `CURRENT_BLOCKING_POLICY` | `NO_NEW_CANDIDATE_HOLD_AND_ECONOMIC_VALIDITY_OFFLINE_GATE_FAIL` |
...
| `GLOBAL_RUNBOOK_NEXT_STEP` | `RATIFY_VERSIONED_FINAL_FLEET_BINDINGS_AND_OFFLINE_ECONOMIC_EVALUATION_SCOPE` |
| `HYPOTHESIS_SUBSTRAND_NEXT_STEP` | `BOUNDED_CROSS_SECTIONAL_RANKING_SEMANTICS_NUMERIC_BINDING_POLICY_DECISION_READ_ONLY_V0` |
...
| `CROSS_SECTIONAL_RANKING_SEMANTICS_BINDING_RATIFIED` | `false` |
| `CROSS_SECTIONAL_RANKING_SEMANTICS_NUMERIC_VALUES_BOUND` | `false` |
| `CROSS_SECTIONAL_RANKING_SEMANTICS_OVERALL_BINDING_STATUS` | `INCOMPLETE_FAIL_CLOSED` |
...
| `LAST_EVALUATED_STRATEGY_ID` | `ma_crossover` |
...
| `NEXT_EVALUATION_CONFIG_STATUS` | `CLOSED_NO_PENDING_CANDIDATE` |
...
| `COMPLETED_TECHNICALLY_VALID_EVALUATION_COUNT` | `3` |
| `ECONOMIC_POLICY_PASS_COUNT` | `0` |
| `ECONOMIC_POLICY_FAIL_COUNT` | `3` |
...
| `NEXT_CANONICAL_STEP` | `OPERATOR_POLICY_DECISION_REQUIRED_FOR_NEW_RESEARCH_SCOPE` |
...
| `STEP29M_NEW_CANDIDATE_AUTHORIZED` | `false` |
...
| `STATUS` | `SCHEMA_MERGED_BINDING_INCOMPLETE` |
| `CANONICAL_OWNER` | `src&#47;research&#47;cross_sectional_ranking_semantics_binding_v0.py,src&#47;research&#47;cross_sectional_ranking_semantics_binding_validator_v0.py` <!-- pt:ref-target-ignore --> |
| `DEPENDENCIES` | RUNBOOK_STEP_31F |
| `NEXT_REQUIRED_CONTRACT` | `NONE` |
| `NEXT_CANONICAL_STEP` | `BOUNDED_CROSS_SECTIONAL_RANKING_SEMANTICS_NUMERIC_BINDING_POLICY_DECISION_READ_ONLY_V0` |
| `AUTHORITY_LEVEL` | `NON_AUTHORITIZING` |
| `FUTURES_ONLY` | `true` |
| `BITCOIN_DIRECTION_ALLOWED` | `false` |
| `SPOT_ALLOWED` | `false` |
...
| `CONCRETE_CANDIDATE_RATIFIED` | `false` |
| `POLICY_CLASS_RATIFICATION` | `RATIFIED` |
| `CROSS_SECTIONAL_RANKING_SEMANTICS_BINDING_SCHEMA_STATUS` | `MERGED_POST_MERGE_VERIFIED` |
| `CROSS_SECTIONAL_RANKING_SEMANTICS_BINDING_SCHEMA_PR` | `4769` |
| `CROSS_SECTIONAL_RANKING_SEMANTICS_BINDING_SCHEMA_MERGE_COMMIT` | `71bb9ccdcfe8771ac7fc027ecda9fd710d06ab01` |
