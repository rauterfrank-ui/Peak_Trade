...
| `NEXT_CANONICAL_ACTION` | `RATIFY_VERSIONED_FINAL_FLEET_BINDINGS_AND_OFFLINE_ECONOMIC_EVALUATION_SCOPE` |
| `CURRENT_ADMISSIBLE_NEXT_SCOPE` | `NONE_UNTIL_VERSIONED_FLEET_BINDING_RATIFICATION` |
| `CURRENT_ADMISSIBLE_NEXT_SCOPE_GO_TOKEN` | `NONE` |
| `CURRENT_ADMISSIBLE_IMPLEMENTATION_SCOPE` | `NONE_UNTIL_VERSIONED_FLEET_BINDING_RATIFICATION` |
...
| `HYPOTHESIS_SUBSTRAND_NEXT_STEP` | `RATIFY_VERSIONED_FINAL_FLEET_BINDINGS_AND_OFFLINE_ECONOMIC_EVALUATION_SCOPE` |
