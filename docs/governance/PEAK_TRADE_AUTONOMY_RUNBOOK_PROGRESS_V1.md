...
| Feld | Wert |
|---|---|
| `LAST_VERIFIED_ORIGIN_MAIN` | `8624425ee5fdb0f484556803e19d8f3720702636` |
| `LAST_VERIFIED_AT` | `2026-06-29T09:10:00Z` |
| `CURRENT_MAJOR_GAP_PACKAGE` | `MAJOR_GAP_COMPARISON_PROMOTION_POLICY_INPUT_BRIDGE_V0` |
| `NEXT_RUNBOOK_STEP` | `RUNBOOK_STEP_18` |
| `NEXT_CANONICAL_STEP` | `runtime_reconciliation` |
...
| `RUNBOOK_STEP_18_IMPLEMENTED` | `false` |
| `RUNTIME_RECONCILIATION_IMPLEMENTED` | `false` |
