...
| Feld | Wert |
|---|---|
| `LAST_VERIFIED_ORIGIN_MAIN` | `56578b8d4d79616e9260bccc0b5ee0d10a7ca47c` |
| `LAST_VERIFIED_AT` | `2026-06-29T11:01:27Z` |
| `CURRENT_MAJOR_GAP_PACKAGE` | `MAJOR_GAP_COMPARISON_PROMOTION_POLICY_INPUT_BRIDGE_V0` |
| `NEXT_RUNBOOK_STEP` | `RUNBOOK_STEP_20` |
| `NEXT_CANONICAL_STEP` | `adapter_submission_contract` |
