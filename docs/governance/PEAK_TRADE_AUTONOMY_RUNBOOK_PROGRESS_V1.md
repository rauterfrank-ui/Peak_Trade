...
| Feld | Wert |
|---|---|
| `LAST_VERIFIED_ORIGIN_MAIN` | `1a6dac20003b1e9e84aed0f015a1cbb37601d467` |
| `LAST_VERIFIED_AT` | `2026-07-03T12:30:00Z` |
...
| `NEXT_CANONICAL_ACTION` | `EXECUTE_BOUNDED_FINAL_RESEARCH_FLEET_OFFLINE_ECONOMIC_EVALUATION_V0` |
| `CURRENT_ADMISSIBLE_NEXT_SCOPE` | `NONE_UNTIL_SEPARATE_OFFLINE_ECONOMIC_EVALUATION_EXECUTION_GO` |
| `CURRENT_ADMISSIBLE_NEXT_SCOPE_GO_TOKEN` | `NONE` |
| `CURRENT_ADMISSIBLE_IMPLEMENTATION_SCOPE` | `NONE_UNTIL_SEPARATE_OFFLINE_ECONOMIC_EVALUATION_EXECUTION_GO` |
...
| `GLOBAL_RUNBOOK_NEXT_STEP` | `EXECUTE_BOUNDED_FINAL_RESEARCH_FLEET_OFFLINE_ECONOMIC_EVALUATION_V0` |
| `HYPOTHESIS_SUBSTRAND_NEXT_STEP` | `EXECUTE_BOUNDED_FINAL_RESEARCH_FLEET_OFFLINE_ECONOMIC_EVALUATION_V0` |
