...
| `CROSS_SECTIONAL_FUNDING_RATE_CARRY_V0_EVIDENCE_REGISTRY_RECONCILIATION_EVIDENCE_REF` | `PENDING_POST_MERGE` |
...
| `NO_NEW_CANDIDATE_HOLD` | `ACTIVE` |
| `PROGRESS_REGISTRY_CLOSEOUT_PERFORMED` | `PENDING_POST_MERGE` |
