...
| Feld | Wert |
|---|---|
| `LAST_VERIFIED_ORIGIN_MAIN` | `2e354a30803324fee158325fb00fcb0b343ae1dd` |
| `LAST_VERIFIED_AT` | `2026-07-05T14:20:00Z` |
| `LAST_VERIFIED_SOURCE` | `TREND_FOLLOWING_V1_TERMINAL_NEGATIVE_ECONOMIC_EVIDENCE_CLOSEOUT_V0` |
| `CURRENT_STATE` | `TREND_FOLLOWING_V1_TERMINAL_NEGATIVE_ECONOMIC_EVIDENCE_GOVERNANCE_CLOSEOUT_V0` |
