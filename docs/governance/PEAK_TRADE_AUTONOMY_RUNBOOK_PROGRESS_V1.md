...
| Feld | Wert |
|---|---|
| `LAST_VERIFIED_ORIGIN_MAIN` | `cc62dce676b86f88148ae00d8b1120c7258b3df7` |
| `LAST_VERIFIED_AT` | `2026-06-29T22:30:00Z` |
| `CURRENT_MAJOR_GAP_PACKAGE` | `MAJOR_GAP_COMPARISON_PROMOTION_POLICY_INPUT_BRIDGE_V0` |
| `NEXT_RUNBOOK_STEP` | `RUNBOOK_STEP_16` |
| `NEXT_CANONICAL_STEP` | `trading_core_decision_attestation_v1` |
...
| `RUNBOOK_STEP_16_IMPLEMENTED` | `false` |
| `TRADING_CORE_DECISION_ATTESTATION_V1_IMPLEMENTED` | `false` |
