...
| Feld | Wert |
|---|---|
| `LAST_VERIFIED_ORIGIN_MAIN` | `a394c7debe41c3ca07773aa97425422d008e714f` |
| `LAST_VERIFIED_AT` | `2026-07-05T19:48:44Z` |
| `LAST_VERIFIED_SOURCE` | `POST_NO_PASS_ECONOMIC_EVIDENCE_CLOSEOUT_AND_REGISTRY_UPDATE_V0` |
| `LAST_VERIFIED_PR` | `4875` |
...
| `NEXT_CANONICAL_ACTION` | `POST_NO_PASS_ROBUSTNESS_FAILURE_DIAGNOSTICS_EVIDENCE_EXECUTION_REQUIRES_SEPARATE_OPERATOR_GO_V0` |
...
| `POST_NO_PASS_ROBUSTNESS_FAILURE_DIAGNOSTICS_EVIDENCE_CLASS_V0_STATUS` | `SCOPE_DEFINED_NOT_EXECUTED` |
...
| `POST_NO_PASS_ROBUSTNESS_FAILURE_DIAGNOSTICS_EVIDENCE_CLASS_V0_DIAGNOSTICS_EXECUTED` | `false` |
...
| `GLOBAL_RUNBOOK_NEXT_STEP` | `POST_NO_PASS_ROBUSTNESS_FAILURE_DIAGNOSTICS_EVIDENCE_EXECUTION_REQUIRES_SEPARATE_OPERATOR_GO_V0` |
