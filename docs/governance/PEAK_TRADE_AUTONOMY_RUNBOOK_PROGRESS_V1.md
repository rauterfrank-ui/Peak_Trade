...
| Feld | Wert |
|---|---|
| `LAST_VERIFIED_ORIGIN_MAIN` | `bda1e4e92e1352e65fd2f2cf0d3aca9e44328ccc` |
| `LAST_VERIFIED_AT` | `2026-07-05T14:57:36Z` |
| `LAST_VERIFIED_SOURCE` | `MOMENTUM_1H_V1_OFFLINE_ECONOMIC_EVALUATION_EXECUTION_V0` |
| `CURRENT_STATE` | `MOMENTUM_1H_V1_OFFLINE_ECONOMIC_EVALUATION_EXECUTION_V0` |
