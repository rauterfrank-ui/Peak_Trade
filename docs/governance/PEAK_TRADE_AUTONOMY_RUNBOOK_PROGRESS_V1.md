...
| Feld | Wert |
|---|---|
| `LAST_VERIFIED_ORIGIN_MAIN` | `d2633dc2242e3083a471ed601a9511fb3a7ee86b` |
| `LAST_VERIFIED_AT` | `2026-07-04T20:50:00Z` |
| `CURRENT_STATE` | `FINAL_FLEET_OPERATOR_RATIFICATION_PACKET_PREPARED_V0` |
...
| `NEXT_CANONICAL_ACTION` | `OPERATOR_RATIFICATION_REQUIRED_FOR_NEW_VERSIONED_RESEARCH_SCOPE_OR_NEW_VERSIONED_EVIDENCE_CLASS_V0` |
...
| `GLOBAL_RUNBOOK_NEXT_STEP` | `OPERATOR_RATIFICATION_REQUIRED_FOR_NEW_VERSIONED_RESEARCH_SCOPE_OR_NEW_VERSIONED_EVIDENCE_CLASS_V0` |
...
| `FINAL_FLEET_OPERATOR_RATIFICATION_PACKET_STATUS` | `PREPARED_NOT_RATIFIED` |
...
| `FINAL_FLEET_OPERATOR_RATIFICATION_PACKET_EVIDENCE_REF` | `PENDING_POST_MERGE` |
...
| `FINAL_FLEET_OPERATOR_RATIFICATION_PACKET_GO_TOKEN_CONSUMED` | `false` |
