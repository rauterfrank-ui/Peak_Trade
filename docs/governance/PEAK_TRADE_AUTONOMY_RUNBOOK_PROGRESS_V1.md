...
| Feld | Wert |
|---|---|
| `LAST_VERIFIED_ORIGIN_MAIN` | `c9291a2f2d2c7e262793046bd2eee29bcca2d443` |
| `LAST_VERIFIED_AT` | `2026-07-05T02:11:00Z` |
| `LAST_VERIFIED_SOURCE` | `OKX_FULL_PANEL_CROSS_SECTIONAL_RANKING_SIGNAL_DIAGNOSTICS_DECOMPOSITION_EVIDENCE_CLASS_SCOPE_V0` |
| `CURRENT_STATE` | `OKX_FULL_PANEL_CROSS_SECTIONAL_RANKING_SIGNAL_DIAGNOSTICS_DECOMPOSITION_EVIDENCE_CLASS_SCOPE_DEFINED_V0` |
