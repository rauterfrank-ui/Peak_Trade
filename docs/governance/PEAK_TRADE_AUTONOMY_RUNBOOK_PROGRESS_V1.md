...
| `NEXT_CANONICAL_ACTION` | `OPERATOR_INPUT_REQUIRED_FOR_NEW_RESEARCH_SCOPE_DEFINITION_V0` |
...
| `GLOBAL_RUNBOOK_NEXT_STEP` | `OPERATOR_INPUT_REQUIRED_FOR_NEW_RESEARCH_SCOPE_DEFINITION_V0` |
