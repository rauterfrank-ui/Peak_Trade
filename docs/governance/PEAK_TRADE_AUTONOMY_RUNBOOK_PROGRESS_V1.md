...
| Feld | Wert |
|---|---|
| `LAST_VERIFIED_ORIGIN_MAIN` | `9945a3e3d5f382bf46bf0c5fcfac2b1bcbf782e1` |
| `LAST_VERIFIED_AT` | `2026-07-03T14:05:00Z` |
...
| `DEPENDENCIES` | RUNBOOK_STEP_31F |
| `NEXT_REQUIRED_CONTRACT` | `NONE` |
| `NEXT_CANONICAL_STEP` | `NO_FURTHER_CROSS_SECTIONAL_FUNDING_RATE_CARRY_V0_ACTION_UNDER_NO_NEW_CANDIDATE_HOLD` |
| `AUTHORITY_LEVEL` | `NON_AUTHORITIZING` |
| `FUTURES_ONLY` | `true` |
| `BITCOIN_DIRECTION_ALLOWED` | `false` |
| `SPOT_ALLOWED` | `false` |
