...
| Feld | Wert |
|---|---|
| `LAST_VERIFIED_ORIGIN_MAIN` | `0b06e37b2d298b6847da9780a426a9cfdf0d20bd` |
| `LAST_VERIFIED_AT` | `2026-07-05T01:30:00Z` |
| `LAST_VERIFIED_SOURCE` | `OKX_FULL_PANEL_CROSS_SECTIONAL_RANKING_STRATEGY_ARCHETYPE_EVIDENCE_CLASS_SCOPE_DEFINITION_V0` |
| `CURRENT_STATE` | `OKX_FULL_PANEL_CROSS_SECTIONAL_RANKING_STRATEGY_ARCHETYPE_EVIDENCE_CLASS_SCOPE_DEFINED_V0` |
