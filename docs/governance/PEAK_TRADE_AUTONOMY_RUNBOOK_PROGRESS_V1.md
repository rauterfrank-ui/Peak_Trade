...
| Feld | Wert |
|---|---|
| `LAST_VERIFIED_ORIGIN_MAIN` | `92f56df1a12b915437b868d7fff33d3dd078fb82` |
| `LAST_VERIFIED_AT` | `2026-07-05T14:43:00Z` |
| `LAST_VERIFIED_SOURCE` | `MOMENTUM_1H_V1_OFFLINE_ECONOMIC_EVALUATION_SCOPE_AND_BINDING_MATERIALIZATION_V0` |
| `CURRENT_STATE` | `MOMENTUM_1H_V1_OFFLINE_ECONOMIC_EVALUATION_SCOPE_AND_BINDING_MATERIALIZATION_V0` |
...
| `MOMENTUM_1H_V1_EVALUATION_EXECUTION` | `false` |
| `MOMENTUM_1H_V1_EVALUATION_EXECUTION_AUTHORIZED` | `false` |
| `MOMENTUM_1H_V1_EVIDENCE_STATUS` | `SCOPE_DEFINED_NOT_EXECUTED` |
...
| `MOMENTUM_1H_V1_NEXT_REQUIRED_SCOPE` | `MOMENTUM_1H_V1_OFFLINE_ECONOMIC_EVALUATION_EXECUTION_V0` |
