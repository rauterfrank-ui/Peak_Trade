...
| Feld | Wert |
|---|---|
| `LAST_VERIFIED_ORIGIN_MAIN` | `aee7b180bb72b6b2919cb9b074ab0e45a0a763d8` |
| `LAST_VERIFIED_AT` | `2026-06-29T23:45:00Z` |
| `CURRENT_MAJOR_GAP_PACKAGE` | `MAJOR_GAP_COMPARISON_PROMOTION_POLICY_INPUT_BRIDGE_V0` |
| `NEXT_RUNBOOK_STEP` | `RUNBOOK_STEP_17` |
| `NEXT_CANONICAL_STEP` | `semantic_diff_evidence` |
...
| `RUNBOOK_STEP_17_IMPLEMENTED` | `false` |
| `SEMANTIC_DIFF_EVIDENCE_IMPLEMENTED` | `false` |
