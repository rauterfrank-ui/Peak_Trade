...
| Feld | Wert |
|---|---|
| `LAST_VERIFIED_ORIGIN_MAIN` | `a113c6bb667fc38da160637e47f018a5411365a3` |
| `LAST_VERIFIED_AT` | `2026-07-05T21:05:21Z` |
| `LAST_VERIFIED_SOURCE` | `POST_NO_PASS_SPARSE_SIGNAL_ZERO_TRADE_VERSIONED_BINDING_RATIFICATION_V0` |
| `LAST_VERIFIED_PR` | `4879` |
...
| `NEXT_CANONICAL_ACTION` | `REQUEST_OPERATOR_GO_FOR_POST_NO_PASS_SPARSE_SIGNAL_ZERO_TRADE_OFFLINE_ECONOMIC_EVALUATION_EXECUTION_V0` |
...
| `GLOBAL_RUNBOOK_NEXT_STEP` | `REQUEST_OPERATOR_GO_FOR_POST_NO_PASS_SPARSE_SIGNAL_ZERO_TRADE_OFFLINE_ECONOMIC_EVALUATION_EXECUTION_V0` |
