...
| Feld | Wert |
|---|---|
| `LAST_VERIFIED_ORIGIN_MAIN` | `0e88f334d3776b554b68fe941183008047b714c6` |
| `LAST_VERIFIED_AT` | `2026-07-01T14:45:00Z` |
...
| `RUNBOOK_STEP_29O_IMPLEMENTATION_STARTED` | `false` |
| `RUNBOOK_STEP_29O_COMPLETE` | `false` |
...
| `RUNBOOK_STEP_29O_STARTED` | `true` |
| `RUNBOOK_STEP_29O_IMPLEMENTATION_STARTED` | `false` |
| `RUNBOOK_STEP_29O_IMPLEMENTED_SCOPE` | `none` |
| `RUNBOOK_STEP_29O_COMPLETE` | `false` |
...
| `RUNBOOK_STEP_29O_SCOPE_CLASSIFICATION` | `PROGRESS_REGISTRY_START_ONLY` |
...
| `INTENT_COMPATIBILITY_FIREWALL_IMPLEMENTED` | `false` |
...
| `STEP_29O_DEFINED_COMPATIBILITY_CONTRACTS` | `false` |
| `STEP_29O_BLOCKS_IMPLICIT_CROSS_TYPE_CONVERSIONS` | `false` |
