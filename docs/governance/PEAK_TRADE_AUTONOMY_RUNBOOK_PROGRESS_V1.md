...
| Feld | Wert |
|---|---|
| `LAST_VERIFIED_ORIGIN_MAIN` | `03fe56943cae44f03d35ab47d347962da7b2d61a` |
| `LAST_VERIFIED_AT` | `2026-06-29T15:00:00Z` |
| `CURRENT_MAJOR_GAP_PACKAGE` | `MAJOR_GAP_COMPARISON_PROMOTION_POLICY_INPUT_BRIDGE_V0` |
| `NEXT_RUNBOOK_STEP` | `RUNBOOK_STEP_23` |
| `NEXT_CANONICAL_STEP` | `killswitch_writer_fencing_and_independent_read_paths` |
