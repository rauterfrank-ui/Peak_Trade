...
| Feld | Wert |
|---|---|
| `LAST_VERIFIED_ORIGIN_MAIN` | `1cd39a91e48596becb777a10c6e45133d356e7d2` |
| `LAST_VERIFIED_AT` | `2026-06-29T12:16:50Z` |
| `CURRENT_MAJOR_GAP_PACKAGE` | `MAJOR_GAP_COMPARISON_PROMOTION_POLICY_INPUT_BRIDGE_V0` |
| `NEXT_RUNBOOK_STEP` | `RUNBOOK_STEP_21` |
| `NEXT_CANONICAL_STEP` | `venue_capability_snapshot` |
