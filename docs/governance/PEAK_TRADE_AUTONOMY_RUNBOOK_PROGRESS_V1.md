...
| Feld | Wert |
|---|---|
| `LAST_VERIFIED_ORIGIN_MAIN` | `9ee4cd4461c52f2165807e8ed9bf8242af5d25d4` |
| `LAST_VERIFIED_AT` | `2026-06-29T13:00:00Z` |
| `CURRENT_MAJOR_GAP_PACKAGE` | `MAJOR_GAP_COMPARISON_PROMOTION_POLICY_INPUT_BRIDGE_V0` |
| `NEXT_RUNBOOK_STEP` | `RUNBOOK_STEP_22` |
| `NEXT_CANONICAL_STEP` | `independent_pre_trade_safety_kernel` |
