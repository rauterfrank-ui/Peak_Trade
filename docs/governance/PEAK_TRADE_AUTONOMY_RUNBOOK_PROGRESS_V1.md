...
| `NEXT_CANONICAL_ACTION` | `AWAIT_OPERATOR_OFFLINE_EVALUATION_GO_CROSS_SECTIONAL_RELATIVE_STRENGTH_V0` |
| `CURRENT_ADMISSIBLE_NEXT_SCOPE` | `cross_sectional_relative_strength/v0` |
| `CURRENT_ADMISSIBLE_NEXT_SCOPE_GO_TOKEN` | `GO_NEW_RESEARCH_SCOPE_CROSS_SECTIONAL_RELATIVE_STRENGTH_NON_BITCOIN_PERPETUALS_V0` |
...
| `GLOBAL_RUNBOOK_NEXT_STEP` | `AWAIT_OPERATOR_OFFLINE_EVALUATION_GO_CROSS_SECTIONAL_RELATIVE_STRENGTH_V0` |
| `HYPOTHESIS_SUBSTRAND_NEXT_STEP` | `AWAIT_OPERATOR_OFFLINE_EVALUATION_GO_CROSS_SECTIONAL_RELATIVE_STRENGTH_V0` |
| `HYPOTHESIS_SUBSTRAND_NEXT_STEP_READ_ONLY` | `false` |
...
| `CROSS_SECTIONAL_RELATIVE_STRENGTH_V0_ECONOMIC_EVALUATION_EXECUTED` | `false` |
