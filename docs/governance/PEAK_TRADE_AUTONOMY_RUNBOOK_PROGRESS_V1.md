...
| Feld | Wert |
|---|---|
| `LAST_VERIFIED_ORIGIN_MAIN` | `75145a424b794fcf1d13e8b57a8cf4d2c318c475` |
| `LAST_VERIFIED_AT` | `2026-07-05T15:05:00Z` |
| `LAST_VERIFIED_SOURCE` | `FINAL_RESEARCH_FLEET_OFFLINE_ECONOMIC_EVIDENCE_CONVERGENCE_SUMMARY_V0` |
| `CURRENT_STATE` | `FINAL_RESEARCH_FLEET_OFFLINE_ECONOMIC_EVIDENCE_CONVERGENCE_SUMMARY_V0` |
...
| `GLOBAL_RUNBOOK_NEXT_STEP` | `NO_RUNTIME_OR_PROMOTION_ACTION` |
...
| Feld | Wert |
|---|---|
| `REGISTRY_ENTRY_CLASS` | `CURRENT_SCOPE_DEFINITION` |
...
| Feld | Wert |
|---|---|
| `REGISTRY_ENTRY_CLASS` | `CURRENT_OFFLINE_EVALUATION_SCOPE_RATIFICATION` |
| `STATUS` | `SCOPE_DEFINED_NOT_EXECUTED` |
...
| Feld | Wert |
|---|---|
| `REGISTRY_ENTRY_CLASS` | `CURRENT_BINDING_MATERIALIZATION_GAP` |
...
| Feld | Wert |
|---|---|
| `REGISTRY_ENTRY_CLASS` | `EXECUTION_BINDING_MATERIALIZATION_COMPLETE` |
...
| Feld | Wert |
|---|---|
| `REGISTRY_ENTRY_CLASS` | `OFFLINE_EVALUATION_EXECUTION_COMPLETE` |
...
| Feld | Wert |
|---|---|
| `REGISTRY_ENTRY_CLASS` | `NEGATIVE_ECONOMIC_EVIDENCE_GOVERNANCE_CLOSEOUT` |
| `STATUS` | `NEGATIVE_ECONOMIC_EVIDENCE_GOVERNANCE_CLOSEOUT_COMPLETE` |
...
| Feld | Wert |
|---|---|
| `REGISTRY_ENTRY_CLASS` | `OFFLINE_ECONOMIC_EVALUATION_SCOPE_AND_BINDING_MATERIALIZATION` |
| `STATUS` | `SCOPE_DEFINED_NOT_EXECUTED` |
...
| Feld | Wert |
|---|---|
| `REGISTRY_ENTRY_CLASS` | `FLEET_ECONOMIC_EVIDENCE_CONVERGENCE_SUMMARY` |
