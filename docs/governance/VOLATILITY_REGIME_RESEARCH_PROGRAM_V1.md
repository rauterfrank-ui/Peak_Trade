...
- No CSHRVF/VTDC/VTSR/VEFCF/VEPC/VCEB/VDBX/VDB/VEP/VCB retry; no CS-momentum reopen

## Causal claim

Cross-sectional low realized-volatility level rank (CS-RV-rank <= 0.20 for >= 2 bars)
admits a continuation with the short-horizon signed return. Materially distinct from
CSHRVF high-half fade, from own-instrument term-structure (VTSR/VTDC), and from closed
CS return-momentum ranking.
