...
After merge, re-audit for `OBL_B05_CALLER_TO_OWNER_TOPOLOGY_CONTRACT` (separate slice). Authority assignment, rewire, and decommission remain Operator-GO gated.
