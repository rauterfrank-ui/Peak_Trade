...
`STRATEGY_IMPLEMENTATION_PRESENT` — development evaluation executed once; slot consumed (`DEVELOPMENT_FAIL`).
...
`GO_VOLATILITY_REGIME_DECLARE_AWAITING_EXPLICIT_SUCCESSOR_HYPOTHESIS_V1` / `GO_VOLATILITY_REGIME_CLOSE_LANE_NO_FURTHER_RESEARCH_V1` / `GO_VOLATILITY_REGIME_CREATE_SUCCESSOR_HYPOTHESIS_V1`
