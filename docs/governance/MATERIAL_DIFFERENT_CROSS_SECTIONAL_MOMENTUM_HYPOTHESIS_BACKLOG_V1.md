...
- Explicit closeout: `explicit_closeout_decision=false`
- Auto-close: forbidden (`lane_auto_closed=false`)
- Preregistered: exactly one (`preregistered_count_exact=1`)
...
STATUS: OPEN_BACKLOG_DEFINITION_ONLY_ONE_PREREGISTRATION
