...
- id=b05_vs_singular_risk_owner class=CONFLICTING statement=Repo-wide CANONICAL_RISK_SIZING_OWNER remains UNRESOLVED while five parallel productive bypass owners stay reachable; MV2 intent-bound quantity algebra is governance-adjudicated to CRS and STEP-29P admissibility remains a distinct boundary (not CRS quantity). Inventory SSOT archive_historical no longer pins deleted position_sizer_old_backup as a CURRENT tree member (owner-deleted #6580; Atlas genealogy only; not size authority). DIRECT_SUBMISSION_COUNT=4 remains distinct from CANONICAL_BYPASS_COUNT=5. Bypass operator_fate_adjudication vocabulary and SCOPED_OPERATOR_GO decision authority are frozen; all five CURRENT bypass fates remain UNKNOWN (no per-ID adjudication in vocabulary freeze).
