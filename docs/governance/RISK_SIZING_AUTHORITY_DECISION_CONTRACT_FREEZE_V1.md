...
STEP29P_ADMISSIBILITY_MODULE_REF=src.ops.full_core_live_path_composition_root_v1.step_29p_capital_risk_admissibility_v1
...
- `ACCOUNT_EQUITY_AUTHORITY_OWNER=ops.governed_productive_account_equity_authority_producer_v1` (Full-Core track; see [`RISK_SIZING_ACCOUNT_EQUITY_AUTHORITY_OWNER_FULL_CORE_TRACK_RATIFICATION_V1.md`](RISK_SIZING_ACCOUNT_EQUITY_AUTHORITY_OWNER_FULL_CORE_TRACK_RATIFICATION_V1.md))
- `ACCOUNT_EQUITY_AUTHORITY_CHAIN_CLOSED=true
B05_FULL_CORE_AUTHORITY_CHAIN_VERDICT=CLOSED`
- Ratification ≠ governed producer implementation (`GOVERNED_PRODUCER_CREATED=false`)
...
- `REFERENCE_PRICE_AUTHORITY_OWNER=ops.governed_productive_reference_price_authority_producer_v1` (Full-Core track; `price_semantics_class=mark_price`; see [`RISK_SIZING_REFERENCE_PRICE_AUTHORITY_OWNER_FULL_CORE_TRACK_RATIFICATION_V1.md`](RISK_SIZING_REFERENCE_PRICE_AUTHORITY_OWNER_FULL_CORE_TRACK_RATIFICATION_V1.md))
- `REFERENCE_PRICE_AUTHORITY_CHAIN_CLOSED=true`
- Ratification ≠ governed producer implementation (`GOVERNED_PRODUCER_CREATED=false`)
...
- `INSTRUMENT_METADATA_AUTHORITY_OWNER=ops.governed_productive_instrument_metadata_authority_producer_v1` (Full-Core track ratified)
- `INSTRUMENT_METADATA_AUTHORITY_CHAIN_CLOSED=true`
