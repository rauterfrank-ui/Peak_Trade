...
- **[Risk / Sizing Owner Inventory SSOT v1](RISK_SIZING_OWNER_INVENTORY_SSOT_V1.md)** — Repo-weite Risk/Sizing-Inventur: CRS / PositionSizer / `core.position_sizing` klassifiziert; repo-wide canonical `UNRESOLVED`; `PRODUCTIVE_RISK_SIZING_DECISION_OWNER_COUNT=5`; **INVENTORY ONLY — NOT CONSOLIDATED**
