...
FLATTEN_PRICE_BINDING=QUOTE_LOCKED_IMPLEMENTED_CALLER_FRESHNESS_REQUIRED
...
NEXT_CANONICAL_STEP_POINTER=OWNER_GO_REQUIRED_SEPARATE_FOR_ANY_NEXT_OPERATIONAL_OR_ADJUDICATION_STEP_NOT_AUTHORIZED_BY_THIS_PERSIST_Z2AM_FRESHNESS_BINDING_OWNER_RATIFICATION_REQUIRED_NO_CANONICAL_FRESHNESS_DEFAULT_EXTRA_DEVIATION_BOUND_NOT_PROVEN_REQUIRED_LIVE_FLATTEN_UNPROVEN_NO_NUMERIC_INVENTION_NO_LIVE_WIRE_NO_ORDER_COUNT_LIMIT_RAISE_TO_2_NO_RUNTIME_READ_NO_PRODUCTIVE_FLATTEN_NO_GET_NO_ORDER_NO_ALLOWLIST_CANARY_NOT_AUTHORIZED_SUPPORT_CONTACT_NOT_AUTHORIZED
