...
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.14 LIVE_EXECUTION_PATH_REACHABLE_ADJUDICATION | Navigation-only current §11.14 second-field adjudication (`LIVE_EXECUTION_PATH_REACHABLE=true`; `LIVE_PRIVATE_READ_ONLY_PROVEN=false`; later observed/proven fields false; `SECTION_11_14_AUTHORIZED=false`; `SECTION_11_14_COMPLETE=false`; next `SEPARATE_OWNER_GO_FOR_LIVE_PRIVATE_READ_ONLY_PROVEN`; MOT not SSOT) |
| [`docs/ops/specs/SECTION_11_14_LIVE_EXECUTION_PATH_REACHABLE_ADJUDICATION_V1.md`](../ops/specs/SECTION_11_14_LIVE_EXECUTION_PATH_REACHABLE_ADJUDICATION_V1.md) | Derived §11.14 LIVE_EXECUTION_PATH_REACHABLE adjudication spec (non-SSOT; pre-submit reachability; conditional private GET; no POST; later fields remain false) |
