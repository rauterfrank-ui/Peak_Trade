...
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.13.5 PRODUCTIVE_FLATTEN_POST_AND_RECONCILIATION | Navigation-only current flatten-POST persist (`LIVE_FLATTEN_PROVABILITY_PROVEN=false`; `EMPTY_DATA_IS_ZERO=false`; `TARGET_POSITION_ZERO_PROVEN=false`; next `OWNER_MERGE_GO`; MOT not SSOT) |
