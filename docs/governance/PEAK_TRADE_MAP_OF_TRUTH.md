...
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.14 ENVELOPE_REPRICE_OR_FRESHNESS_AT_SEND | Navigation-only current §11.14 envelope reprice or freshness-at-send (`GET_PERFORMED=true`; `GET_CALL_COUNT=7`; `POSITION_VALUE=1`; `QUOTE_BID=0.8185`; `COMPUTED_LIMIT_PX=0.8185`; `OLD_LIMIT_PRICE=0.8343`; `NEW_LIMIT_PRICE=0.8185`; `NEW_ENVELOPE_ID=0a0133a3b82e4a15bf6986605a9a8e6b47b22665b485ff0f570200803f21cdbe`; `REPRICE_EXECUTED=true`; `ENVELOPE_REBUILD_EXECUTED=true`; `ENVELOPE_FRESHNESS_STATUS_AFTER=VALID_WITH_FRESH_GET`; `RECEIPT_ATTACHED=false`; `CURRENT_CANONICAL_BOUNDARY=RECEIPT_MISSING`; `NEXT_OWNER_AUTHORITY_REQUIRED=RECEIPT_HMAC_VS_WIRE_SEND_AUTHORITY_ORDER`; no POST; no HMAC POST; MOT not SSOT) |
| [`docs/ops/specs/SECTION_11_14_ENVELOPE_REPRICE_OR_FRESHNESS_AT_SEND_V1.md`](../ops/specs/SECTION_11_14_ENVELOPE_REPRICE_OR_FRESHNESS_AT_SEND_V1.md) | Derived §11.14 envelope reprice or freshness-at-send spec (non-SSOT; seven producer GETs; envelope rebuilt; no POST) |
