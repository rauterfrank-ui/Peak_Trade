...
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.14 DURABLE_CONSUME_SUCCESS_OBJECT | Navigation-only current §11.14 durable-consume success object (`DURABLE_CONSUME_SUCCESS_OBJECT=PROVEN`; `SUCCESS_OBJECT_TYPE=FlattenProductiveSendSuccessObjectV1`; `DURABLE_CONSUME_GATED_ON_SUCCESS_OBJECT=true`; `CURRENT_CANONICAL_BOUNDARY=RECEIPT_MISSING`; `NEXT_OWNER_AUTHORITY_REQUIRED=RECEIPT_MISSING`; no POST; no HMAC generation; no receipt mint; no live durable consume; MOT not SSOT) |
| [`docs/ops/specs/SECTION_11_14_DURABLE_CONSUME_SUCCESS_OBJECT_V1.md`](../ops/specs/SECTION_11_14_DURABLE_CONSUME_SUCCESS_OBJECT_V1.md) | Derived §11.14 durable-consume success-object spec (non-SSOT; typed success object; COMPLETED consume gated; no POST) |
