...
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.14 RECEIPT_HMAC_VS_WIRE_SEND_AUTHORITY_ORDER | Navigation-only current §11.14 receipt/HMAC vs wire-send-authority order (`Q1_CANONICAL=YES`; `Q2_CANONICAL=NO`; `Q3_CANONICAL=INNER_REPAIR_REQUIRED`; `HMAC_GENERATION_WIRED=false`; `RUNTIME_RECEIPT_MINT_EXECUTED=false`; `RUNTIME_HMAC_EXECUTED=false`; `INNER_REPAIR_IMPLEMENTED=true`; `LEASE_CONSUME_AFTER_LOCAL_PREWIRE_GATES=true`; `CURRENT_CANONICAL_BOUNDARY=RECEIPT_MISSING`; `NEXT_OWNER_AUTHORITY_REQUIRED=DURABLE_CONSUME_SUCCESS_OBJECT`; no POST; no HMAC generation; no receipt mint; MOT not SSOT) |
| [`docs/ops/specs/SECTION_11_14_RECEIPT_HMAC_VS_WIRE_SEND_AUTHORITY_ORDER_V1.md`](../ops/specs/SECTION_11_14_RECEIPT_HMAC_VS_WIRE_SEND_AUTHORITY_ORDER_V1.md) | Derived §11.14 receipt/HMAC vs wire-send-authority order spec (non-SSOT; order decided; inner lease repaired; no POST) |
