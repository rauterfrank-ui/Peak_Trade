...
| MI/Learning Phase 21 Loop A learning integration (conditioned evidence; AUTHORITY=NONE) | `docs/ops/specs/UNIFIED_BLUEPRINT_PHASE_21_LEARNING_INTEGRATION_NORMATIVE_V1.md` / `src/learning/market_intelligence_forecast_calibration_offline_stack_v1/loop_a_conditioned_learning_evidence_v1.py` |
| MI/Learning Phase 22 incremental information research (B0–B5; AUTHORITY=NONE) | `docs/ops/specs/UNIFIED_BLUEPRINT_PHASE_22_INCREMENTAL_RESEARCH_NORMATIVE_V1.md` / `src/learning/market_intelligence_forecast_calibration_offline_stack_v1/phase_22_incremental_research_evidence_v1.py` |
| Meta-Learning Phase 23 dual routing (META_EVIDENCE_V1; AUTHORITY=NONE) | `docs/ops/specs/UNIFIED_BLUEPRINT_PHASE_23_META_DUAL_ROUTING_NORMATIVE_V1.md` / `src/experiments/canonical_meta_evidence_dual_router_v1.py` |
| Loop C Phase 24 representation feedback (bounded plan/eval/next evidence; AUTHORITY=NONE) | `docs/ops/specs/UNIFIED_BLUEPRINT_PHASE_24_REPRESENTATION_FEEDBACK_LOOP_NORMATIVE_V1.md` / `src/learning/market_intelligence_forecast_calibration_offline_stack_v1/phase_24_representation_feedback_loop_evidence_v1.py` |
| Phase 25 DP Attribution (`attribution_evidence_v1`; MARKET_CONTEXT + MV2/DP refs + REALIZED_BEHAVIOR; AUTHORITY=NONE) | `docs/ops/specs/UNIFIED_BLUEPRINT_PHASE_25_DP_ATTRIBUTION_NORMATIVE_V1.md` / `src/learning/market_intelligence_forecast_calibration_offline_stack_v1/phase_25_dp_attribution_evidence_v1.py` |
| Phase 26 Final Closed-Cycle DoD (Loops A/B/C closure matrix + reproof; AUTHORITY=NONE) | `docs/ops/specs/UNIFIED_BLUEPRINT_PHASE_26_FINAL_CLOSED_CYCLE_DOD_NORMATIVE_V1.md` / `src/governance/unified_blueprint_phase_26_final_closed_cycle_dod_v1.py` |
| Master V2 / Double Play decision path | `trading` package / integrated offline trading-logic replay owners (see Master Runbook) |
| Master V2 / Double Play Evidence & Input Plane P0 L1–L10 seam census (navigation; AUTHORITY=NONE) | [`docs/governance/MASTER_V2_DOUBLE_PLAY_EVIDENCE_INPUT_PLANE_P0_EVIDENCE_SEAM_CENSUS_V1.md`](MASTER_V2_DOUBLE_PLAY_EVIDENCE_INPUT_PLANE_P0_EVIDENCE_SEAM_CENSUS_V1.md) / [`docs/evidence/master_v2_double_play_evidence_input_plane_p0/l1_l10_evidence_seam_census_v1.json`](../evidence/master_v2_double_play_evidence_input_plane_p0/l1_l10_evidence_seam_census_v1.json) / [`src/governance/master_v2_double_play_evidence_input_plane_p0_evidence_seam_census_v1.py`](../../src/governance/master_v2_double_play_evidence_input_plane_p0_evidence_seam_census_v1.py) |
| Master V2 / Double Play Evidence & Input Plane P1 authority contracts & schemas (O-002 RATIFIED; contract-only) | [`docs/governance/MASTER_V2_DOUBLE_PLAY_EVIDENCE_INPUT_PLANE_P1_AUTHORITY_CONTRACTS_V1.md`](MASTER_V2_DOUBLE_PLAY_EVIDENCE_INPUT_PLANE_P1_AUTHORITY_CONTRACTS_V1.md) / [`docs/ops/specs/EVIDENCE_INPUT_PLANE_P1_AUTHORITY_CONTRACTS_AND_SCHEMAS_V1.md`](../ops/specs/EVIDENCE_INPUT_PLANE_P1_AUTHORITY_CONTRACTS_AND_SCHEMAS_V1.md) / [`src/governance/master_v2_double_play_evidence_input_plane_p1_authority_contracts_and_schemas_v1/`](../../src/governance/master_v2_double_play_evidence_input_plane_p1_authority_contracts_and_schemas_v1/) |
| Master V2 / Double Play Evidence & Input Plane P2 Component A adjudicator runtime (bounded; not productively reachable) | [`docs/governance/MASTER_V2_DOUBLE_PLAY_EVIDENCE_INPUT_PLANE_P2_EVIDENCE_ADJUDICATOR_RUNTIME_V1.md`](MASTER_V2_DOUBLE_PLAY_EVIDENCE_INPUT_PLANE_P2_EVIDENCE_ADJUDICATOR_RUNTIME_V1.md) / [`docs/ops/specs/EVIDENCE_INPUT_PLANE_P2_EVIDENCE_ADJUDICATOR_RUNTIME_V1.md`](../ops/specs/EVIDENCE_INPUT_PLANE_P2_EVIDENCE_ADJUDICATOR_RUNTIME_V1.md) / [`src/governance/master_v2_double_play_evidence_input_plane_p2_evidence_adjudicator_runtime_v1/`](../../src/governance/master_v2_double_play_evidence_input_plane_p2_evidence_adjudicator_runtime_v1/) |
| Master V2 / Double Play Evidence & Input Plane P3 Component B input creator/binder runtime (bounded; not productively reachable) | [`docs/governance/MASTER_V2_DOUBLE_PLAY_EVIDENCE_INPUT_PLANE_P3_INPUT_CREATOR_BINDER_RUNTIME_V1.md`](MASTER_V2_DOUBLE_PLAY_EVIDENCE_INPUT_PLANE_P3_INPUT_CREATOR_BINDER_RUNTIME_V1.md) / [`docs/ops/specs/EVIDENCE_INPUT_PLANE_P3_INPUT_CREATOR_BINDER_RUNTIME_V1.md`](../ops/specs/EVIDENCE_INPUT_PLANE_P3_INPUT_CREATOR_BINDER_RUNTIME_V1.md) / [`src/governance/master_v2_double_play_evidence_input_plane_p3_input_creator_binder_runtime_v1/`](../../src/governance/master_v2_double_play_evidence_input_plane_p3_input_creator_binder_runtime_v1/) |
