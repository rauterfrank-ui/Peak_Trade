...
| [`docs/ops/specs/DIRECTIONAL_MAPPING_CONTRACT_REPAIR_V1.md`](../ops/specs/DIRECTIONAL_MAPPING_CONTRACT_REPAIR_V1.md) | Directional mapping core contract (docs-only target; runtime unbound; productive SHORT trigger unchanged until later GO; freeze exception unauthorized; MODEL_C runtime unauthorized; ARMED residual unresolved; navigation only) |
...
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.14 LIVE_RESTART_RECONSTRUCTED_ADJUDICATION | Navigation-only current §11.14 restart reconstruction (`LIVE_RESTART_RECONSTRUCTED=false`; `CASE_ADJUDICATION=CASE_LIVE_RESTART_RECONSTRUCTED_FAIL_CLOSED_MISSING_DURABLE_HANDOFF`; criterion bound; no durable Live pre-restart handoff; no GET; no POST; no restart execution; next `OWNER_GO_FOR_LIVE_RESTART_RECONSTRUCTED`; MOT not SSOT) |
| [`docs/ops/specs/SECTION_11_14_LIVE_RESTART_RECONSTRUCTED_ADJUDICATION_V1.md`](../ops/specs/SECTION_11_14_LIVE_RESTART_RECONSTRUCTED_ADJUDICATION_V1.md) | Derived §11.14 LIVE_RESTART_RECONSTRUCTED adjudication spec (non-SSOT; offline fail-closed census; criterion bound; restart false; recovery ineligible) |
