...
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.13.5 PR_6252_MERGE_CLOSEOUT | Navigation-only current post-merge closeout (`PR_6252_STATUS=SQUASH_MERGED`; `G12_STATUS=OPEN`; `TARGET_POSITION_ZERO_PROVEN=false`; `LIVE_FLATTEN_PROVABILITY_PROVEN=false`; `RECOVERY_POSITION_SEMANTICS=CASE_C_EMPTY_DATA_NOT_ZERO`; `SECTION_11_14_AUTHORIZED=false`; next `SEPARATE_OWNER_GO_FOR_G12_POSITION_ZERO_PROOF`; MOT not SSOT) |
