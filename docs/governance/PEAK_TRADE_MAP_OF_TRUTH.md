...
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.14 LIVE_HANDOFF_RESTART_READER_PROVENANCE_AND_CONSUMER_BIND | Navigation-only current §11.14 Live restart reader / provenance / consumer bind (`POS_SEMANTICS=PROVEN`; `NEW_PRODUCER_IMPLEMENTED=true`; `SECTION_11_14_LIVE_HANDOFF_OWNER_CURRENT=SECTION_11_14_LIVE_DURABLE_PRE_RESTART_HANDOFF_OWNER_V1`; `WRITER_BOUND=true`; `READER_BOUND=true`; `RESTART_CONSUMER_BOUND=true`; `PROVENANCE_VALIDATION=CONTRACT_PROVEN`; `FRESHNESS_VALIDATION=PARTIAL`; `COMPLETE_CAPTURE_SEAM=UNPROVEN`; `HOST_CRASH_DURABILITY=UNPROVEN`; `CONTEMPORANEOUS_PEAK_TRADE_PRE_RESTART_HANDOFF_OBSERVED=false`; `LIVE_RESTART_RECONSTRUCTED=false`; `IMPLEMENTATION_AUTHORIZED=false`; no GET; no POST; no restart execution; `OWNER_GO_FOR_LIVE_RESTART_RECONSTRUCTED` remains §11.14 evidence-domain only and is not the productive Live-execution next pointer; MOT not SSOT) |
| [`docs/ops/specs/SECTION_11_14_LIVE_HANDOFF_RESTART_READER_PROVENANCE_AND_CONSUMER_BIND_V1.md`](../ops/specs/SECTION_11_14_LIVE_HANDOFF_RESTART_READER_PROVENANCE_AND_CONSUMER_BIND_V1.md) | Derived §11.14 restart-reader / provenance / consumer-bind spec (non-SSOT; reader bound; consumer bound; provenance contract-proven; freshness partial; complete seam unproven; host-crash unproven; restart false) |
