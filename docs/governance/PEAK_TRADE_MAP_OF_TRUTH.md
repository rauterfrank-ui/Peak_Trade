...
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.14 NETWORK_SESSION_AUTHORIZED_INSTANCE_FLAG | Navigation-only current §11.14 network_session_authorized instance-flag seam (`authorize_network_session_instance_v1` implemented; issued ≠ authorized; bind-level flag remains false; NO_SEND adapter unchanged; no arming; no GET; no POST; no inner.send; `CURRENT_CANONICAL_BOUNDARY=SESSION_NOT_ARMED`; MOT not SSOT) |
| [`docs/ops/specs/SECTION_11_14_NETWORK_SESSION_AUTHORIZED_INSTANCE_FLAG_V1.md`](../ops/specs/SECTION_11_14_NETWORK_SESSION_AUTHORIZED_INSTANCE_FLAG_V1.md) | Derived §11.14 network_session_authorized instance-flag spec (non-SSOT; instance-flag seam only; no arming; no GET; no POST; no inner.send) |
