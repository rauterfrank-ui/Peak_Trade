...
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.14 LIVE_POSITION_RECONCILED_ADJUDICATION | Navigation-only current §11.14 position reconciliation (`LIVE_POSITION_RECONCILED=true`; `CASE_ADJUDICATION=CASE_LIVE_POSITION_RECONCILED_ACCOUNTING_INELIGIBLE`; identity-bound positions GET; no POST; `LIVE_ACCOUNTING_RECONSTRUCTED=false`; next `OWNER_GO_FOR_LIVE_ACCOUNTING_RECONSTRUCTED`; MOT not SSOT) |
| [`docs/ops/specs/SECTION_11_14_LIVE_POSITION_RECONCILED_ADJUDICATION_V1.md`](../ops/specs/SECTION_11_14_LIVE_POSITION_RECONCILED_ADJUDICATION_V1.md) | Derived §11.14 LIVE_POSITION_RECONCILED adjudication spec (non-SSOT; identity-bound private positions GET; position true; accounting ineligible) |
