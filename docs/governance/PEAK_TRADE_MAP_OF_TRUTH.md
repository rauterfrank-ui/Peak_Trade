...
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.14 LIVE_PRIVATE_READ_ONLY_PROVEN_ADJUDICATION | Navigation-only current §11.14 third-field adjudication (`LIVE_PRIVATE_READ_ONLY_PROVEN=true`; `LIVE_ORDER_PLAN_OBSERVED=false`; later observed/proven fields false; `SECTION_11_14_AUTHORIZED=false`; `SECTION_11_14_COMPLETE=false`; next `OWNER_GO_FOR_EXACT_LIVE_MUTATION`; MOT not SSOT) |
| [`docs/ops/specs/SECTION_11_14_LIVE_PRIVATE_READ_ONLY_PROVEN_ADJUDICATION_V1.md`](../ops/specs/SECTION_11_14_LIVE_PRIVATE_READ_ONLY_PROVEN_ADJUDICATION_V1.md) | Derived §11.14 LIVE_PRIVATE_READ_ONLY_PROVEN adjudication spec (non-SSOT; current config+balance private GET; no POST; later fields remain false) |
