...
| [`docs/ops/specs/MF_AUTHORITATIVE_NEXT_ACTIVE_SET_OWNERSHIP_CONTRACT_V1.md`](../ops/specs/MF_AUTHORITATIVE_NEXT_ACTIVE_SET_OWNERSHIP_CONTRACT_V1.md) | Isolated PDF-Step-3 ownership bind for authoritative Next Active Set (`OWNER=ops.mf_membership_rotation_controller_v1`; `ROTATION_POLICY_STATUS=FAIL_CLOSED_UNTIL_PDF_STEP_5`; `POLICY_A_IS_NOT_AUTOMATIC_ACTIVE_SET_POLICY=true`; `N_VALUE` pointer only; consumer unbound; no host join; no Cap-2.3/2.4 rewire; navigation only) |
