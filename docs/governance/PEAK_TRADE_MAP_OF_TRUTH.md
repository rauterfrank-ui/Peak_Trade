...
NEXT_CANONICAL_STEP_POINTER=OWNER_GO_REQUIRED_SEPARATE_FOR_NEW_RUNTIME_STATE_CLASS_ORDER_DERIVED_OR_POSITION_DERIVED_IM_NOTIONALUSD_OR_UPL_EVIDENCE_BOUNDARY_REACHED_NO_CANONICAL_NO_SUBMIT_NO_POSITION_NO_FUNDING_DISCRIMINATOR_REMAINS_RULE_C_UNPROVEN_FACE_VALUE_CONFLICT_UNRESOLVED_COVER_USDC_UNINSTANTIATED_REPEAT_ZERO_EQUITY_NO_POSITION_GETS_HAVE_NO_DISCRIMINATORY_VALUE_SUPPORT_CONTACT_NOT_AUTHORIZED_CANARY_NOT_AUTHORIZED
