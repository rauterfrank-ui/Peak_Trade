...
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.14 LIVE_FEE_OBSERVED_ADJUDICATION | Navigation-only current §11.14 fee observation (`LIVE_FEE_OBSERVED=true`; `CASE_ADJUDICATION=CASE_LIVE_FEE_OBSERVED_POSITION_INELIGIBLE`; identity-bound fills GET; no POST; `LIVE_POSITION_RECONCILED=false`; next `OWNER_GO_FOR_LIVE_POSITION_RECONCILED`; MOT not SSOT) |
| [`docs/ops/specs/SECTION_11_14_LIVE_FEE_OBSERVED_ADJUDICATION_V1.md`](../ops/specs/SECTION_11_14_LIVE_FEE_OBSERVED_ADJUDICATION_V1.md) | Derived §11.14 LIVE_FEE_OBSERVED adjudication spec (non-SSOT; identity-bound private fills GET; fee true; position ineligible) |
