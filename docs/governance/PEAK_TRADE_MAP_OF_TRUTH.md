...
EARLIEST_UNRESOLVED_DEPENDENCY=COVER_USDC_UNINSTANTIATED_AND_FACE_VALUE_CONFLICT_UNRESOLVED_AND_LIVE_FLATTEN_UNPROVEN_AND_FILL_DETERMINISM_UNPROVEN_AND_ZERO_EQUITY_FUNDING_PREREQUISITE_UNSATISFIED_FILLED_POSITION_DERIVED_RUNTIME_PROPOSAL_NOT_PRESENTABLE
EARLIEST_UNRESOLVED_SECTION_POINTER=SECTION_11_13_5_LIVE_CANARY_MINIMUM_EXPOSURE
NEXT_CANONICAL_STEP_POINTER=OWNER_GO_REQUIRED_SEPARATE_FOR_UNRESOLVED_SAFETY_DEPENDENCIES_BEFORE_ANY_FILLED_POSITION_DERIVED_RUNTIME_PROPOSAL_FACE_VALUE_CONFLICT_UNRESOLVED_COVER_USDC_UNINSTANTIATED_FUNDING_PREREQUISITE_UNSATISFIED_LIVE_FLATTEN_UNPROVEN_FILL_DETERMINISM_UNPROVEN_QTY_ONE_NOT_VENUE_ADMISSIBLE_AT_ZERO_EQUITY_RULE_C_UNPROVEN_SUPPORT_CONTACT_NOT_AUTHORIZED_CANARY_NOT_AUTHORIZED
