...
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.13.3 | SSOT LIVE_SHADOW_WITH_EXCHANGE_RECONCILIATION productive execute path ready (`SECTION_11_13_3_PRODUCTIVE_EXECUTE_PATH_READY=true`; `LIVE_SHADOW_WITH_EXCHANGE_RECONCILIATION_PROVEN=false`; Live unauthorized; merge≠execute) |
