...
NEXT_CANONICAL_STEP_POINTER=MERGE_PRE_CANARY_SURFACE_THEN_OWNER_ACTIONS_RESOLVE_TRADE_ATTESTATION_AND_EXCHANGE_TRUTH_ADOPTION_THEN_NEW_OWNER_GO_LIVE_CANARY_MINIMUM_EXPOSURE
