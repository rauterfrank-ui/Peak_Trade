...
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.14 HMAC_GENERATION | Navigation-only current §11.14 typed HMAC/header artifact (`HMAC_GENERATION=PROVEN`; `HMAC_GENERATION_WIRED=true`; `HMAC_GENERATION_ON_SEND_PATH=false`; `FIRST_DENY_AFTER_HMAC_SIGNED_SEND=PRODUCTIVE_NETWORK_SESSION_NOT_AUTHORIZED`; `CURRENT_CANONICAL_BOUNDARY=PRODUCTIVE_NETWORK_SESSION_NOT_AUTHORIZED`; `NEXT_OWNER_AUTHORITY_REQUIRED=PRODUCTIVE_NETWORK_SESSION_NOT_AUTHORIZED`; no GET; no POST; MOT not SSOT) |
| [`docs/ops/specs/SECTION_11_14_HMAC_GENERATION_V1.md`](../ops/specs/SECTION_11_14_HMAC_GENERATION_V1.md) | Derived §11.14 HMAC_GENERATION spec (non-SSOT; typed HMAC artifact; verify not consume; no POST) |
