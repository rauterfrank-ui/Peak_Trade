...
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.14 LIVE_SUBMIT_ACK_OBSERVED_ADJUDICATION | Navigation-only current §11.14 ACK observation (`LIVE_SUBMIT_ACK_OBSERVED=true`; `CASE_ADJUDICATION=CASE_LIVE_SUBMIT_ACK_OBSERVED_FILL_INELIGIBLE`; one POST; no retry; `LIVE_FILL_OBSERVED=false`; `POST_PERFORMED=true`; next `OWNER_GO_FOR_LIVE_FILL_OBSERVED`; MOT not SSOT) |
| [`docs/ops/specs/SECTION_11_14_LIVE_SUBMIT_ACK_OBSERVED_ADJUDICATION_V1.md`](../ops/specs/SECTION_11_14_LIVE_SUBMIT_ACK_OBSERVED_ADJUDICATION_V1.md) | Derived §11.14 LIVE_SUBMIT_ACK_OBSERVED adjudication spec (non-SSOT; exact single live POST; ACK true; fill ineligible) |
