...
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.13.5.Z2B | SSOT OKX ticket `7823581` normal-expiry fee applicability and non-operative 0.01% rate (`AUTHORIZED_SCOPE=OKX_TICKET_7823581_SUPPORT_EVIDENCE_BIND_DOCS_ONLY`; `PRODUCT_SET_MEMBERSHIP=PROVEN`; `TARGET_INSTRUMENT_APPLICABILITY_BTC_USD_UM_XPERP=PROVEN`; `NORMAL_EXPIRY_FEE_RATE_PROVEN=true`; `NORMAL_EXPIRY_FEE_RATE_DECIMAL=0.0001`; `RATE_PROVEN_NON_OPERATIVE=true`; `TIER_INDEPENDENT_FOR_EXPIRY_SETTLEMENT=PROVEN`; `FORCED_LIQUIDATION_DISTINCT_FROM_NORMAL_EXPIRY=PROVEN`; `MONETARY_BASE_STATUS=UNPROVEN`; `API_DELIVERY_0_0003_STATUS=UNPROVEN`; `OPERATIVE_FEE_COMPUTATION_PROVEN=false`; `DELIVERY_RATE_OPERATIVE_VALUE=NONE`; `OPERATIVE_EXPIRY_FEE_RATE=NONE`; `DELIVERY_FEE_TERM_NUMERIC_STATUS=UNINSTANTIATED`; `FULL_OPERATIONAL_RESERVE_COMPOSITION_STATUS=BLOCKED`; `LIVE_AUTHORIZED=false`; no money movement; not execute; historical next pointer superseded by §11.13.5.Z2C) |
...
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.13.5.Z2H | SSOT current ticker bid&#47;ask public GET evidence (`AUTHORIZED_SCOPE=CURRENT_TICKER_BID_ASK_PUBLIC_GET_EVIDENCE_ONLY`; `GET` `&#47;api&#47;v5&#47;market&#47;ticker`; `bidPx=64529.9`; `askPx=64530`; `BID_ASK_TERM_STATUS=OBSERVED_NOT_NORMATIVELY_BOUND`; `SLIPPAGE_RESERVE_NUMERIC_STATUS=UNINSTANTIATED`; `MARKPX_TERM_STATUS=OBSERVED_NOT_NORMATIVELY_BOUND`; `MARKPX_OKX_DELIVERY_FEE_OPERAND_STATUS=UNPROVEN`; `MONETARY_BASE_STATUS=UNPROVEN`; `FX_STATUS=UNPROVEN`; `ROUNDING_STATUS=UNPROVEN`; `COVER_USDC_STATUS=UNINSTANTIATED`; `NUMERIC_FUNDING_AMOUNT_PRODUCED=false`; `EXCHANGE_TRUTH_CHANGED=false`; `QTY_LIMIT=1`; `SCALING_AUTHORIZED=false`; `LIVE_AUTHORIZED=false`; public GET-only; no credentials; no money movement; not execute; parallel 0.0003 vs 0.0001 provenance persist at §11.13.5.Z2I; COVER_USDC next pointer unchanged) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.13.5.Z2I | SSOT delivery `0.0003` versus expiry-settlement `0.0001` provenance adjudication (`AUTHORIZED_SCOPE=DELIVERY_0003_VS_EXPIRY_SETTLEMENT_0001_PROVENANCE_ADJUDICATION_DOCS_ONLY`; `PARALLEL_TO_SECTION_11_13_5_Z2H=true`; `Z2H_CANONICAL_POINTER_REPLACED=false`; `DELIVERY_0003_FIRST_PARTY_STATUS=PROVEN_RAW_FIRST_PARTY_FIELD`; `DELIVERY_0003_EXCHANGE_AUTHORITY=API_TRADE_FEE_DELIVERY_FIELD_ONLY`; `DELIVERY_0003_EXPIRY_SETTLEMENT_RATE_AUTHORITY=NONE`; `EXPIRY_SETTLEMENT_RATE_NORMATIVE=0.0001`; `PROVEN_FIRST_PARTY_RATE_CONTRADICTION_EXISTS=false`; `API_DELIVERY_0003_BLOCKS_EXPIRY_RATE_0001=false`; `OPERATIVE_EXPIRY_SETTLEMENT_RATE=NONE`; `MONETARY_BASE=UNPROVEN`; `SUPPORT_REQUIRED_FOR_0003_VS_0001_RATE_DECISION=false`; `LIVE_AUTHORIZED=false`; no GET; no support; no money movement; not execute) |
...
OWNER_GO_DOCS_ONLY_STATUS=CONSUMED_DOCS_ONLY_0003_VS_0001_PROVENANCE_Z2H_POINTER_UNCHANGED
...
NEXT_CANONICAL_STEP_POINTER=OWNER_GO_REQUIRED_FOR_PRODUCTIVE_EVIDENCE_TO_RESOLVE_REMAINING_UNPROVEN_COVER_USDC_TERMS_AFTER_CURRENT_TICKER_BID_ASK_BEFORE_FUNDING
