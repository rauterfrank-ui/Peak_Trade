...
| [`docs/ops/specs/DDO_DURABLE_EVIDENCE_STORAGE_OWNER_CONTRACT_V1.md`](../ops/specs/DDO_DURABLE_EVIDENCE_STORAGE_OWNER_CONTRACT_V1.md) | Navigation-only DDO durable evidence storage-owner contract (non-SSOT; evidence-domain storage owner; productive host ledger path bound from injected scopes; A1 unattended durability policy defined; A1 runtime authorization adjudicated fail-closed and unauthorized; crash durability unproven; default host remains unbound; no trading authority; no GET; no POST) |
| [`docs/ops/specs/DDO_A1_MUTATION_CRITICAL_CONTROL_STATE_STORAGE_OWNER_CONTRACT_V1.md`](../ops/specs/DDO_A1_MUTATION_CRITICAL_CONTROL_STATE_STORAGE_OWNER_CONTRACT_V1.md) | Navigation-only mutation-critical control-state storage-owner contract (non-SSOT; new isolated WAL owner; not DDO observation ledger; no productive host; host-crash unproven; no GET; no POST) |
| [`docs/ops/specs/DDO_A1_MUTATION_CRITICAL_CONTROL_STATE_DURABLE_STORAGE_IMPLEMENTATION_AND_CRASH_REPROOF_V1.md`](../ops/specs/DDO_A1_MUTATION_CRITICAL_CONTROL_STATE_DURABLE_STORAGE_IMPLEMENTATION_AND_CRASH_REPROOF_V1.md) | Navigation-only mutation-critical control-state durable-storage crash-reproof contract (non-SSOT; reuses bound WAL owner; process-boundary SIGKILL is not host-crash; no GET; no POST) |
...
| [`docs/ops/specs/DDO_DOUBLE_PLAY_PRODUCER_FUNCTION_REPLAY_V1.md`](../ops/specs/DDO_DOUBLE_PLAY_PRODUCER_FUNCTION_REPLAY_V1.md) | Navigation-only DDO Double-Play producer-function replay contract (non-SSOT; REPLAY_CLASS_LETTER=A; REPLAY_CLASS_SEMANTIC=CURRENT_CODE_REPLAY; REPLAY_CLASS_OWNER_TOKEN=A_CURRENT_CODE_REPLAY; no historical parity claim; explicit capture-disabled isolation; in-memory/no-write; offline isolated current-code invocation implemented in tests only; not productive; no GET; no POST) |
| [`docs/ops/specs/PEAK_TRADE_T016_LEARNING_BLUEPRINT_FAMILY_ABSORPTION_AND_PROVENANCE_V1.md`](../ops/specs/PEAK_TRADE_T016_LEARNING_BLUEPRINT_FAMILY_ABSORPTION_AND_PROVENANCE_V1.md) | Navigation-only T016 learning/blueprint family SHA bind and absorption index (non-SSOT; AUTHORITY=NONE; not Master Runbook; no PDF ingest; no archive; no GET; no POST) |
...
| [`docs/ops/specs/FULL_CORE_STEP_29P_RISK_ADMISSIBILITY_PRE_CONSTRUCTION_V1.md`](../ops/specs/FULL_CORE_STEP_29P_RISK_ADMISSIBILITY_PRE_CONSTRUCTION_V1.md) | Navigation-only Full-Core STEP-29P risk-admissibility pre-construction spec (non-SSOT; fresh GET evidence; equity dimension unbound at that persist; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_STEP_29P_ACCOUNT_EQUITY_MAPPING_OWNER_RATIFICATION_V1.md`](../ops/specs/FULL_CORE_STEP_29P_ACCOUNT_EQUITY_MAPPING_OWNER_RATIFICATION_V1.md) | Navigation-only Full-Core STEP-29P equity-mapping Owner-ratification spec (non-SSOT; `MAPPING_PROVEN=false`; no value binding; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_STEP_29P_ACCOUNT_EQUITY_SOURCE_SEMANTIC_MAPPING_RATIFICATION_V1.md`](../ops/specs/FULL_CORE_STEP_29P_ACCOUNT_EQUITY_SOURCE_SEMANTIC_MAPPING_RATIFICATION_V1.md) | Navigation-only Full-Core STEP-29P equity source-semantic mapping ratification spec (non-SSOT; `ADJUDICATION_RESULT=NO_CANONICALLY_VALID_MAPPING_AVAILABLE`; no value binding; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_RUNNING_EQUITY_POLICY_SEMANTICS_RATIFICATION_V1.md`](../ops/specs/FULL_CORE_RUNNING_EQUITY_POLICY_SEMANTICS_RATIFICATION_V1.md) | Navigation-only Full-Core running-equity policy-semantics ratification spec (non-SSOT; P01/U01–U09 `DECIDED`; `MAPPING_PROVEN=false`; no source; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_RUNNING_EQUITY_AUTHORITY_ARCHITECTURE_RATIFICATION_V1.md`](../ops/specs/FULL_CORE_RUNNING_EQUITY_AUTHORITY_ARCHITECTURE_RATIFICATION_V1.md) | Navigation-only Full-Core running-equity future authority-architecture ratification spec (non-SSOT; `ARCHITECTURE_RATIFIED=true`; future classes only; historical `ACCOUNT_EQUITY_AUTHORITY_OWNER=UNRESOLVED` at that persist; `SOURCE_SELECTED=false`; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_ACCOUNT_EQUITY_AUTHORITY_OWNER_CONCRETE_ASSIGNMENT_RATIFICATION_V1.md`](../ops/specs/FULL_CORE_ACCOUNT_EQUITY_AUTHORITY_OWNER_CONCRETE_ASSIGNMENT_RATIFICATION_V1.md) | Navigation-only Full-Core concrete account-equity authority-owner assignment spec (non-SSOT; empty governed slot `ops.governed_productive_account_equity_authority_producer_v1`; `OWNER_ASSIGNMENT_RATIFIED=true`; `SOURCE_SELECTED=false`; `GOVERNED_PRODUCER_CREATED=false`; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_GOVERNED_RUNNING_ACCOUNT_EQUITY_SAMPLE_SCHEMA_V1.md`](../ops/specs/FULL_CORE_GOVERNED_RUNNING_ACCOUNT_EQUITY_SAMPLE_SCHEMA_V1.md) | Navigation-only Full-Core typed `GOVERNED_RUNNING_ACCOUNT_EQUITY_SAMPLE_V1` schema persist spec (non-SSOT; `GOVERNED_RUNNING_ACCOUNT_EQUITY_SAMPLE_SCHEMA_PRESENT=true`; `SOURCE_OBJECT_PRESENT=false`; `SOURCE_SELECTED=false`; `MAPPING_PROVEN=false`; `GOVERNED_PRODUCER_CREATED=false`; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_TYPED_VENUE_WITNESS_OBSERVATION_CONTRACT_V1.md`](../ops/specs/FULL_CORE_TYPED_VENUE_WITNESS_OBSERVATION_CONTRACT_V1.md) | Navigation-only Full-Core typed Trading-Account venue-witness observation contract spec (non-SSOT; `VENUE_WITNESS_SCHEMA_PRESENT=true`; `VENUE_WITNESS_RUNTIME_INSTANCE_PRESENT=false`; `VENUE_WITNESS_SELECTED=false`; `RAW_TO_WITNESS_PROVEN=false`; `SOURCE_SELECTED=false`; `MAPPING_PROVEN=false`; `GOVERNED_PRODUCER_CREATED=false`; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_TYPED_NORMALIZATION_INCLUSION_CONTRACT_V1.md`](../ops/specs/FULL_CORE_TYPED_NORMALIZATION_INCLUSION_CONTRACT_V1.md) | Navigation-only Full-Core typed venue-witness normalization/inclusion adjudication contract spec (non-SSOT; `NORMALIZATION_SCHEMA_PRESENT=true`; `NORMALIZATION_RUNTIME_INSTANCE_PRESENT=false`; `SEMANTIC_MAPPING_PROVEN=false`; `INCLUSION_PROVEN=false`; `SOURCE_SELECTED=false`; `MAPPING_PROVEN=false`; `GOVERNED_PRODUCER_CREATED=false`; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_TYPED_INTERNAL_RECONSTRUCTION_CONTRACT_V1.md`](../ops/specs/FULL_CORE_TYPED_INTERNAL_RECONSTRUCTION_CONTRACT_V1.md) | Navigation-only Full-Core typed internal reconstruction contract spec (non-SSOT; `INTERNAL_RECONSTRUCTION_SCHEMA_PRESENT=true`; `INTERNAL_RECONSTRUCTION_RUNTIME_INSTANCE_PRESENT=false`; `INTERNAL_RECONSTRUCTION_PROVEN=false`; `RECONSTRUCTION_ALGEBRA_COMPLETE=false`; `SOURCE_SELECTED=false`; `MAPPING_PROVEN=false`; `GOVERNED_PRODUCER_CREATED=false`; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_TYPED_RECONSTRUCTION_ALGEBRA_CONTRACT_V1.md`](../ops/specs/FULL_CORE_TYPED_RECONSTRUCTION_ALGEBRA_CONTRACT_V1.md) | Navigation-only Full-Core typed reconstruction algebra contract spec (non-SSOT; `RECONSTRUCTION_ALGEBRA_SCHEMA_PRESENT=true`; `RECONSTRUCTION_ALGEBRA_COMPLETE=false`; `RECONSTRUCTION_ALGEBRA_AUTHORITY_EFFECT=NONE`; `CANONICAL_FORMULA_PROVEN=false`; `SOURCE_SELECTED=false`; `MAPPING_PROVEN=false`; `GOVERNED_PRODUCER_CREATED=false`; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_TYPED_P01_HAIRCUT_RESERVE_DEPLETION_TERM_CONTRACT_V1.md`](../ops/specs/FULL_CORE_TYPED_P01_HAIRCUT_RESERVE_DEPLETION_TERM_CONTRACT_V1.md) | Navigation-only Full-Core typed P01 haircut/reserve/depletion term contract spec (non-SSOT; `P01_TERM_CONTRACT_SCHEMA_PRESENT=true`; `P01_TERM_SEMANTICS_RESOLVED=false`; `P01_HAIRCUT_RESERVE_DEPLETION_UNSPECIFIED_CLOSED=false`; `RECONSTRUCTION_ALGEBRA_COMPLETE=false`; `SOURCE_SELECTED=false`; `MAPPING_PROVEN=false`; `GOVERNED_PRODUCER_CREATED=false`; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_TYPED_P01_TERM_SET_AND_UNIT_CLASS_CONTRACT_V1.md`](../ops/specs/FULL_CORE_TYPED_P01_TERM_SET_AND_UNIT_CLASS_CONTRACT_V1.md) | Navigation-only Full-Core typed P01 term-set and unit-class adjudication spec (non-SSOT; `P01_TERM_SET_AND_UNIT_CLASS_CONTRACT_SCHEMA_PRESENT=true`; `P01_TERM_SET_RESOLVED=false`; `P01_VALUE_UNIT_CLASS_RESOLVED=false`; `P01_TERM_SEMANTICS_RESOLVED=false`; `P01_HAIRCUT_RESERVE_DEPLETION_UNSPECIFIED_CLOSED=false`; `RECONSTRUCTION_ALGEBRA_COMPLETE=false`; `SOURCE_SELECTED=false`; `MAPPING_PROVEN=false`; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_TYPED_P01_APPLICABILITY_CONTRACT_V1.md`](../ops/specs/FULL_CORE_TYPED_P01_APPLICABILITY_CONTRACT_V1.md) | Navigation-only Full-Core typed P01 applicability adjudication spec (non-SSOT; `P01_APPLICABILITY_CONTRACT_SCHEMA_PRESENT=true`; `P01_APPLICABILITY_RESOLVED=false`; `P01_APPLICABILITY_STATUS=UNSPECIFIED_FAIL_CLOSED`; `P01_TERM_SET_RESOLVED=false`; `P01_VALUE_UNIT_CLASS_RESOLVED=false`; `P01_TERM_SEMANTICS_RESOLVED=false`; `P01_HAIRCUT_RESERVE_DEPLETION_UNSPECIFIED_CLOSED=false`; `RECONSTRUCTION_ALGEBRA_COMPLETE=false`; `SOURCE_SELECTED=false`; `MAPPING_PROVEN=false`; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_TYPED_P01_EQUITY_BASE_INCLUSION_CONTRACT_V1.md`](../ops/specs/FULL_CORE_TYPED_P01_EQUITY_BASE_INCLUSION_CONTRACT_V1.md) | Navigation-only Full-Core typed P01 equity-base inclusion adjudication spec (non-SSOT; `P01_EQUITY_BASE_INCLUSION_CONTRACT_SCHEMA_PRESENT=true`; `P01_EQUITY_BASE_INCLUSION_RESOLVED=false`; `P01_EQUITY_BASE_INCLUSION_STATUS=UNRESOLVED`; `P01_APPLICABILITY_RESOLVED=false`; `P01_TERM_SET_RESOLVED=false`; `P01_VALUE_UNIT_CLASS_RESOLVED=false`; `P01_TERM_SEMANTICS_RESOLVED=false`; `P01_HAIRCUT_RESERVE_DEPLETION_UNSPECIFIED_CLOSED=false`; `RECONSTRUCTION_ALGEBRA_COMPLETE=false`; `SOURCE_SELECTED=false`; `MAPPING_PROVEN=false`; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_TYPED_P01_EMBEDDING_STATE_CONTRACT_V1.md`](../ops/specs/FULL_CORE_TYPED_P01_EMBEDDING_STATE_CONTRACT_V1.md) | Navigation-only Full-Core typed P01 broader embedding-state adjudication spec (non-SSOT; `P01_EMBEDDING_STATE_CONTRACT_SCHEMA_PRESENT=true`; `P01_EMBEDDED_STATE_RESOLVED=false`; `P01_EMBEDDED_STATE=UNRESOLVED`; `P01_EQUITY_BASE_INCLUSION_RESOLVED=false`; `P01_APPLICABILITY_RESOLVED=false`; `P01_TERM_SET_RESOLVED=false`; `P01_VALUE_UNIT_CLASS_RESOLVED=false`; `P01_TERM_SEMANTICS_RESOLVED=false`; `P01_HAIRCUT_RESERVE_DEPLETION_UNSPECIFIED_CLOSED=false`; `RECONSTRUCTION_ALGEBRA_COMPLETE=false`; `SOURCE_SELECTED=false`; `MAPPING_PROVEN=false`; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_TYPED_P01_OVERLAP_WITH_U04_U05_CONTRACT_V1.md`](../ops/specs/FULL_CORE_TYPED_P01_OVERLAP_WITH_U04_U05_CONTRACT_V1.md) | Navigation-only Full-Core typed P01 overlap/equivalence adjudication versus U04 and U05 (non-SSOT; `P01_OVERLAP_WITH_U04_U05_CONTRACT_SCHEMA_PRESENT=true`; `P01_U04_OVERLAP_RESOLVED=false`; `P01_U04_OVERLAP_STATE=UNRESOLVED`; `P01_U05_OVERLAP_RESOLVED=false`; `P01_U05_OVERLAP_STATE=UNRESOLVED`; `P01_EMBEDDED_STATE_RESOLVED=false`; `P01_TERM_SET_RESOLVED=false`; `P01_VALUE_UNIT_CLASS_RESOLVED=false`; `P01_TERM_SEMANTICS_RESOLVED=false`; `P01_HAIRCUT_RESERVE_DEPLETION_UNSPECIFIED_CLOSED=false`; `RECONSTRUCTION_ALGEBRA_COMPLETE=false`; `SOURCE_SELECTED=false`; `MAPPING_PROVEN=false`; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_TYPED_P01_NUMERIC_VALUE_PROVENANCE_CONTRACT_V1.md`](../ops/specs/FULL_CORE_TYPED_P01_NUMERIC_VALUE_PROVENANCE_CONTRACT_V1.md) | Navigation-only Full-Core typed P01 numeric value provenance adjudication (non-SSOT; `P01_NUMERIC_VALUE_PROVENANCE_CONTRACT_SCHEMA_PRESENT=true`; `P01_NUMERIC_VALUE_PROVENANCE_RESOLVED=false`; `P01_NUMERIC_VALUE_PROVENANCE_STATUS=UNSPECIFIED`; `P01_NUMERIC_VALUE_SOURCE=UNSPECIFIED`; `P01_NUMERIC_VALUE_TRANSFORMATION=UNSPECIFIED`; `P01_TERM_SET_RESOLVED=false`; `P01_VALUE_UNIT_CLASS_RESOLVED=false`; `P01_TERM_SEMANTICS_RESOLVED=false`; `P01_HAIRCUT_RESERVE_DEPLETION_UNSPECIFIED_CLOSED=false`; `RECONSTRUCTION_ALGEBRA_COMPLETE=false`; `SOURCE_SELECTED=false`; `MAPPING_PROVEN=false`; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_TYPED_P01_MEMBER_FRESHNESS_INHERITANCE_CONTRACT_V1.md`](../ops/specs/FULL_CORE_TYPED_P01_MEMBER_FRESHNESS_INHERITANCE_CONTRACT_V1.md) | Navigation-only Full-Core typed P01 member freshness inheritance adjudication (non-SSOT; `P01_MEMBER_FRESHNESS_INHERITANCE_CONTRACT_SCHEMA_PRESENT=true`; `P01_MEMBER_FRESHNESS_INHERITANCE_RESOLVED=false`; `P01_MEMBER_FRESHNESS_STATUS=UNPROVEN`; `P01_MEMBER_FRESHNESS_RULE=UNSPECIFIED`; `P01_U09_FRESHNESS_RELATION=UNSPECIFIED`; `P01_NUMERIC_VALUE_PROVENANCE_RESOLVED=false`; `P01_TERM_SET_RESOLVED=false`; `P01_VALUE_UNIT_CLASS_RESOLVED=false`; `P01_TERM_SEMANTICS_RESOLVED=false`; `P01_HAIRCUT_RESERVE_DEPLETION_UNSPECIFIED_CLOSED=false`; `RECONSTRUCTION_ALGEBRA_COMPLETE=false`; `SOURCE_SELECTED=false`; `MAPPING_PROVEN=false`; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_TYPED_P01_HAIRCUT_RESERVE_DEPLETION_SEMANTICS_CONTRACT_V1.md`](../ops/specs/FULL_CORE_TYPED_P01_HAIRCUT_RESERVE_DEPLETION_SEMANTICS_CONTRACT_V1.md) | Navigation-only Full-Core typed P01 haircut/reserve/depletion semantics adjudication (non-SSOT; `P01_HAIRCUT_RESERVE_DEPLETION_SEMANTICS_CONTRACT_SCHEMA_PRESENT=true`; `P01_HAIRCUT_SEMANTICS_RESOLVED=false`; `P01_RESERVE_SEMANTICS_RESOLVED=false`; `P01_DEPLETION_SEMANTICS_RESOLVED=false`; `P01_HAIRCUT_ROLE=UNSPECIFIED`; `P01_RESERVE_ROLE=UNSPECIFIED`; `P01_DEPLETION_ROLE=UNSPECIFIED`; `P01_TERM_SEMANTICS_RESOLVED=false`; `P01_HAIRCUT_RESERVE_DEPLETION_UNSPECIFIED_CLOSED=false`; `RECONSTRUCTION_ALGEBRA_COMPLETE=false`; `SOURCE_SELECTED=false`; `MAPPING_PROVEN=false`; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_TYPED_P01_EXACT_MEMBER_IDENTITY_CONTRACT_V1.md`](../ops/specs/FULL_CORE_TYPED_P01_EXACT_MEMBER_IDENTITY_CONTRACT_V1.md) | Navigation-only Full-Core typed P01 exact member identity ratification (non-SSOT; `P01_EXACT_MEMBER_IDENTITY_CONTRACT_SCHEMA_PRESENT=true`; `P01_TERM_SET_RESOLVED=true`; `P01_EXACT_MEMBER_IDENTITY_SET=P01M_GOVERNED_DEPLOYABILITY_CONSERVATISM_REDUCTION`; `P01_EXACT_MEMBER_COUNT=1`; `P01_VALUE_UNIT_CLASS_RESOLVED=false`; `P01_TERM_SEMANTICS_RESOLVED=false`; `P01_HAIRCUT_RESERVE_DEPLETION_UNSPECIFIED_CLOSED=false`; `RECONSTRUCTION_ALGEBRA_COMPLETE=false`; `SOURCE_SELECTED=false`; `MAPPING_PROVEN=false`; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_TYPED_P01_VALUE_UNIT_CLASS_CONTRACT_V1.md`](../ops/specs/FULL_CORE_TYPED_P01_VALUE_UNIT_CLASS_CONTRACT_V1.md) | Navigation-only Full-Core typed P01 value unit class ratification (non-SSOT; `P01_VALUE_UNIT_CLASS_CONTRACT_SCHEMA_PRESENT=true`; `P01_TERM_SET_RESOLVED=true`; `P01_VALUE_UNIT_CLASS_RESOLVED=true`; `P01_VALUE_UNIT_CLASS=ABSOLUTE_MONETARY_REDUCTION_AMOUNT`; `P01_SEMANTIC_DIMENSION=PARENT_EQUITY_DIMENSION_REDUCTION_AMOUNT`; `P01_TERM_SEMANTICS_RESOLVED=false`; `P01_HAIRCUT_RESERVE_DEPLETION_UNSPECIFIED_CLOSED=false`; `RECONSTRUCTION_ALGEBRA_COMPLETE=false`; `SOURCE_SELECTED=false`; `MAPPING_PROVEN=false`; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_TYPED_P01_APPLICABILITY_CLASS_CONTRACT_V1.md`](../ops/specs/FULL_CORE_TYPED_P01_APPLICABILITY_CLASS_CONTRACT_V1.md) | Navigation-only Full-Core typed P01 applicability class ratification (non-SSOT; `P01_APPLICABILITY_CLASS_CONTRACT_SCHEMA_PRESENT=true`; `P01_APPLICABILITY_CLASS_RESOLVED=true`; `P01_APPLICABILITY_CLASS=GOVERNED_CONDITIONAL`; `P01_APPLICABILITY_STATE_MODEL=APPLIES_DOES_NOT_APPLY_UNKNOWN_FAIL_CLOSED`; `P01_APPLICATION_PREDICATE_RESOLVED=false`; `P01_APPLICATION_PREDICATE=UNSPECIFIED_FAIL_CLOSED`; `P01_APPLICABILITY_RESOLVED=false`; `P01_TERM_SET_RESOLVED=true`; `P01_VALUE_UNIT_CLASS_RESOLVED=true`; `P01_TERM_SEMANTICS_RESOLVED=false`; `P01_HAIRCUT_RESERVE_DEPLETION_UNSPECIFIED_CLOSED=false`; `RECONSTRUCTION_ALGEBRA_COMPLETE=false`; `SOURCE_SELECTED=false`; `MAPPING_PROVEN=false`; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_TYPED_P01_APPLICATION_PREDICATE_IDENTITY_CONTRACT_V1.md`](../ops/specs/FULL_CORE_TYPED_P01_APPLICATION_PREDICATE_IDENTITY_CONTRACT_V1.md) | Navigation-only Full-Core typed P01 application-predicate identity and boundary ratification (non-SSOT; `P01_APPLICATION_PREDICATE_IDENTITY_CONTRACT_SCHEMA_PRESENT=true`; `P01_APPLICATION_PREDICATE_IDENTITY_RESOLVED=true`; `P01_APPLICATION_PREDICATE_MODEL=TYPED_GOVERNED_APPLICABILITY_DECISION_V1`; `P01_APPLICABILITY_DECISION_STATE_MODEL=APPLIES_DOES_NOT_APPLY_UNKNOWN_FAIL_CLOSED`; `P01_APPLICATION_PREDICATE_RESOLVED=false`; `P01_APPLICATION_PREDICATE=UNSPECIFIED_FAIL_CLOSED`; `P01_APPLICATION_PREDICATE_INPUT_DOMAIN_RESOLVED=false`; `P01_APPLICATION_TRUE_RULE_RESOLVED=false`; `P01_APPLICATION_FALSE_RULE_RESOLVED=false`; `P01_APPLICABILITY_CLASS_RESOLVED=true`; `P01_TERM_SET_RESOLVED=true`; `P01_VALUE_UNIT_CLASS_RESOLVED=true`; `P01_TERM_SEMANTICS_RESOLVED=false`; `P01_HAIRCUT_RESERVE_DEPLETION_UNSPECIFIED_CLOSED=false`; `RECONSTRUCTION_ALGEBRA_COMPLETE=false`; `SOURCE_SELECTED=false`; `MAPPING_PROVEN=false`; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_TYPED_P01_APPLICATION_PREDICATE_INPUT_DOMAIN_IDENTITY_CONTRACT_V1.md`](../ops/specs/FULL_CORE_TYPED_P01_APPLICATION_PREDICATE_INPUT_DOMAIN_IDENTITY_CONTRACT_V1.md) | Navigation-only Full-Core typed P01 application-predicate input-domain identity and boundary ratification (non-SSOT; `P01_APPLICATION_PREDICATE_INPUT_DOMAIN_IDENTITY_CONTRACT_SCHEMA_PRESENT=true`; `P01_PREDICATE_INPUT_DOMAIN_IDENTITY_RESOLVED=true`; `P01_PREDICATE_INPUT_DOMAIN_BOUNDARY_RESOLVED=true`; `P01_PREDICATE_INPUT_DOMAIN_CLASS=TYPED_GOVERNED_P01_RECONSTRUCTION_CONTEXT_V1`; `P01_APPLICATION_PREDICATE_INPUT_DOMAIN_RESOLVED=false`; `P01_PREDICATE_CONCRETE_INPUT_MEMBERS_RESOLVED=false`; `P01_APPLICATION_TRUE_RULE_RESOLVED=false`; `P01_APPLICATION_FALSE_RULE_RESOLVED=false`; `P01_TERM_SEMANTICS_RESOLVED=false`; `P01_HAIRCUT_RESERVE_DEPLETION_UNSPECIFIED_CLOSED=false`; `RECONSTRUCTION_ALGEBRA_COMPLETE=false`; `SOURCE_SELECTED=false`; `MAPPING_PROVEN=false`; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_TYPED_P01_RECONSTRUCTION_SEMANTIC_AND_ALGEBRA_CLOSEOUT_CONTRACT_V1.md`](../ops/specs/FULL_CORE_TYPED_P01_RECONSTRUCTION_SEMANTIC_AND_ALGEBRA_CLOSEOUT_CONTRACT_V1.md) | Navigation-only Full-Core typed P01 reconstruction semantic and algebra closeout (non-SSOT; `P01_RECONSTRUCTION_SEMANTIC_AND_ALGEBRA_CLOSEOUT_CONTRACT_SCHEMA_PRESENT=true`; `P01_PREDICATE_INPUT_MEMBER=GOVERNED_P01_REDUCTION_DIRECTIVE_V1`; `P01_PREDICATE_CONCRETE_INPUT_MEMBERS_RESOLVED=true`; `P01_APPLICATION_TRUE_RULE_RESOLVED=true`; `P01_APPLICATION_FALSE_RULE_RESOLVED=true`; `P01_PRODUCT_SEMANTICS_COMPLETE=true`; `P01_RECONSTRUCTION_ALGEBRA_CONTRACT_COMPLETE=true`; `P01_PRODUCTIVE_EXTERNAL_SOURCE_MAPPING_RESOLVED=false`; `P01_INPUT_FRESHNESS_RULE_RESOLVED=false`; `RECONSTRUCTION_ALGEBRA_COMPLETE=false`; `SOURCE_SELECTED=false`; `MAPPING_PROVEN=false`; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_EQUITY_RECOVERY_PR1_GOVERNANCE_REOPEN_AND_CANDIDATE_CENSUS_V1.md`](../ops/specs/FULL_CORE_EQUITY_RECOVERY_PR1_GOVERNANCE_REOPEN_AND_CANDIDATE_CENSUS_V1.md) | Navigation-only Full-Core C17+ source-generation/reopen mechanism and read-only candidate census (non-SSOT; `NEW_SOURCE_GENERATION_MECHANISM_RATIFIED=true`; `MAPPING_REOPEN_MECHANISM_EXISTS=true`; `MAPPING_BOUNDARY_CURRENTLY_OPEN=false`; `C01_C16_REJECTION_STILL_BINDING=true`; `C17_CREATED=false`; `SOURCE_SELECTED=false`; `MAPPING_PROVEN=false`; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_OPTION_D_SSOT_CHECKPOINT_EVENT_TAXONOMY_AND_EQ_RECONCILIATION_TARGET_CONTRACTS_V1.md`](../ops/specs/FULL_CORE_OPTION_D_SSOT_CHECKPOINT_EVENT_TAXONOMY_AND_EQ_RECONCILIATION_TARGET_CONTRACTS_V1.md) | Navigation-only Full-Core OPTION_D SSOT, checkpoint, event-taxonomy, and fresh-eq reconciliation-target contracts (non-SSOT; `OPTION_D_SSOT_PERSISTED=true`; `RAW_EQ_SOURCE_AUTHORITY=false`; `EQ_RECONCILIATION_TARGET_ONLY=true`; `CHECKPOINT_CAN_MINT_EQUITY=false`; `UNCLASSIFIED_EVENT_FAIL_CLOSED=true`; `C17_CREATED=false`; `EVENT_ACQUISITION_CREATED=false`; `RECONSTRUCTION_ENGINE_CREATED=false`; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_D4_BOUND_ACCOUNT_IDENTITY_CONTRACT_V1.md`](../ops/specs/FULL_CORE_D4_BOUND_ACCOUNT_IDENTITY_CONTRACT_V1.md) | Navigation-only Full-Core D4 bound account-identity contract (non-SSOT; `BOUND_ACCOUNT_IDENTITY_PROVEN=true`; `BOUND_ACCOUNT_IDENTITY_CONTRACT_SCHEMA_PRESENT=true`; `BOUND_ACCOUNT_IDENTITY_RUNTIME_INSTANCE_PRESENT=false`; `BOUND_ACCOUNT_CONCRETE_UID_OBSERVED=false`; `BOUND_ACCOUNT_IDENTITY_FROM_ENV_FORBIDDEN=true`; `BOUND_ACCOUNT_IDENTITY_FROM_CREDENTIAL_FORBIDDEN=true`; `BOUND_ACCOUNT_IDENTITY_IMPLICIT_DEFAULT_FORBIDDEN=true`; `C17_CREATED=false`; `EVENT_ACQUISITION_CREATED=false`; `RECONSTRUCTION_ENGINE_CREATED=false`; `MAPPING_PROVEN=false`; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_D5_CHECKPOINT_OBSERVATION_ACQUISITION_V1.md`](../ops/specs/FULL_CORE_D5_CHECKPOINT_OBSERVATION_ACQUISITION_V1.md) | Navigation-only Full-Core D5 checkpoint-observation acquisition contract (non-SSOT; `CHECKPOINT_OBSERVATION_ACQUISITION_CREATED=true`; `CHECKPOINT_OBSERVATION_PROVEN=true`; `CHECKPOINT_OBSERVATION_RUNTIME_INSTANCE_PRESENT=false`; `CHECKPOINT_OBSERVATION_NETWORK_GET_AUTHORIZED=false`; `CHECKPOINT_CAN_MINT_EQUITY=false`; `RECONSTRUCTED_EQUITY_CREATED=false`; `EVENT_ACQUISITION_CREATED=false`; `C17_CREATED=false`; `SOURCE_SELECTED=false`; `MAPPING_PROVEN=false`; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_D6_COMPLETE_CLASSIFIED_EVENT_STREAM_ACQUISITION_V1.md`](../ops/specs/FULL_CORE_D6_COMPLETE_CLASSIFIED_EVENT_STREAM_ACQUISITION_V1.md) | Navigation-only Full-Core D6 classified event-stream acquisition contract (non-SSOT; `EVENT_ACQUISITION_CREATED=true`; `COMPLETE_EVENT_STREAM_PROVEN=false`; `EVENT_ACQUISITION_RUNTIME_INSTANCE_PRESENT=false`; `EVENT_ACQUISITION_NETWORK_GET_AUTHORIZED=false`; `RECONSTRUCTION_ENGINE_CREATED=false`; `C17_CREATED=false`; `SOURCE_SELECTED=false`; `MAPPING_PROVEN=false`; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_D6_CLASSIFIED_KIND_SET_AND_EVENT_SOURCE_SEAM_V1.md`](../ops/specs/FULL_CORE_D6_CLASSIFIED_KIND_SET_AND_EVENT_SOURCE_SEAM_V1.md) | Navigation-only Full-Core D6 classified kind-set and event-source seam census (non-SSOT; `KIND_SET_RESOLVED=false`; `RATIFIED_CLASSIFIED_EVENT_KIND_SET=EMPTY_FAIL_CLOSED`; `AUTHORIZED_PRODUCTIVE_EVENT_SOURCE_SEAM_PRESENT=false`; `D6_COMPLETENESS_PRECONDITIONS_PROVEN=false`; `COMPLETE_EVENT_STREAM_PROVEN=false`; `EVENT_KIND_SOURCE_SEAM_SELECTED=false`; `SOURCE_SELECTED=false`; `RAW_EQ_SOURCE_AUTHORITY=false`; `MAPPING_PROVEN=false`; `C17_CREATED=false`; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_D6_EQUITY_STOCK_NECESSARY_KIND_SET_CLOSEOUT_V1.md`](../ops/specs/FULL_CORE_D6_EQUITY_STOCK_NECESSARY_KIND_SET_CLOSEOUT_V1.md) | Navigation-only Full-Core D6 Mini-Slice 1 EQUITY_STOCK necessary kind-set closeout (non-SSOT; `KIND_SET_CLOSEOUT_CREATED=true`; `KIND_SET_RESOLVED=false`; `MS1_KIND_SET_FULLY_CLOSED=false`; `MS2_AUTHORIZED=false`; `UNKNOWN_NECESSARY_CLASS_REMAINS=true`; `NAMED_REMAINING_UNKNOWN_NECESSARY_CLASSES=U05_LIABILITY_AS_CLASSIFIED_EQUITY_STOCK_KIND,U06_FEE_AS_CLASSIFIED_EQUITY_STOCK_KIND,RESIDUAL_UNNAMED_NECESSARY_EQUITY_STOCK_EVENT_CLASS`; `AUTHORIZED_PRODUCTIVE_EVENT_SOURCE_SEAM_PRESENT=false`; `C17_CREATED=false`; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_D6_NAMED_REMAINING_UNKNOWN_KIND_SET_EVIDENCE_PERSIST_V1.md`](../ops/specs/FULL_CORE_D6_NAMED_REMAINING_UNKNOWN_KIND_SET_EVIDENCE_PERSIST_V1.md) | Navigation-only Full-Core D6 named remaining-unknown kind-set evidence persist (non-SSOT; `KIND_SET_EVIDENCE_PERSIST_CREATED=true`; `U05_KIND_DECISION=REMAIN_UNKNOWN`; `U06_KIND_DECISION=REMAIN_UNKNOWN`; `RESIDUAL_KIND_DECISION=REMAIN_UNKNOWN`; `KIND_SET_RESOLVED=false`; `MS1_KIND_SET_FULLY_CLOSED=false`; `MS2_AUTHORIZED=false`; `RESIDUAL_COMPLETENESS_PROVEN=false`; `AUTHORIZED_PRODUCTIVE_EVENT_SOURCE_SEAM_PRESENT=false`; `C17_CREATED=false`; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_D6_SCOPED_READ_ONLY_OBSERVATION_BOUNDARY_V1.md`](../ops/specs/FULL_CORE_D6_SCOPED_READ_ONLY_OBSERVATION_BOUNDARY_V1.md) | Navigation-only Full-Core D6 scoped read-only observation-boundary contract (non-SSOT; `OBSERVATION_BOUNDARY_CONTRACT_CREATED=true`; `OBSERVATION_EXECUTED=false`; `OBSERVATION_EXECUTION_AUTHORIZED=false`; `U05_KIND_DECISION=REMAIN_UNKNOWN`; `U06_KIND_DECISION=REMAIN_UNKNOWN`; `RESIDUAL_KIND_DECISION=REMAIN_UNKNOWN`; `KIND_SET_RESOLVED=false`; `MS1_KIND_SET_FULLY_CLOSED=false`; `MS2_AUTHORIZED=false`; `D6_FULLY_CLOSED=false`; `D7_AUTHORIZED=false`; `PATH_B=SELECTED_BUT_BLOCKED_ON_NEW_AUTHORIZATION`; `ATLAS_AUTHORITY=NONE`; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_D6_PATH_B_CLASS_C_PACKAGE_1_TRADING_ACCOUNT_OBSERVATION_RULES_V1.md`](../ops/specs/FULL_CORE_D6_PATH_B_CLASS_C_PACKAGE_1_TRADING_ACCOUNT_OBSERVATION_RULES_V1.md) | Navigation-only Full-Core D6 PATH_B CLASS_C PACKAGE_1 trading-account observation rules (non-SSOT; `PACKAGE_1_PERSISTED=true`; `PATH_B_PREAUTHORIZATION_READY=true`; `EXECUTION_READY=false`; `OBSERVATION_EXECUTED=false`; `D4_RULE_PERSISTED=true`; `BALANCE_RULE_PERSISTED=true`; `EMPTY_COVERAGE_RULE_PERSISTED=true`; `EMBEDDING_RULE_PERSISTED=true`; `KIND_SET_RESOLVED=false`; `MS2_AUTHORIZED=false`; `D6_FULLY_CLOSED=false`; `D7_AUTHORIZED=false`; `C01_REHABILITATION_FORBIDDEN=true`; `ATLAS_AUTHORITY=NONE`; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_D6_PATH_B_PACKAGE_1_D4_RUNTIME_BINDING_AND_D5_WINDOW_CONTRACT_V1.md`](../ops/specs/FULL_CORE_D6_PATH_B_PACKAGE_1_D4_RUNTIME_BINDING_AND_D5_WINDOW_CONTRACT_V1.md) | Navigation-only Full-Core D6 PATH_B PACKAGE_1 D4 runtime binding and D5 window contract (non-SSOT; `D4_RUNTIME_BINDING_CONTRACT_PRESENT=true`; `BOUND_ACCOUNT_IDENTITY_RUNTIME_INSTANCE_PRESENT=false`; `D4_CONCRETE_UID_CORROBORATED=false`; `D5_WINDOW_BINDING_CONTRACT_PRESENT=true`; `CHECKPOINT_OBSERVATION_WINDOW_RUNTIME_INSTANCE_PRESENT=false`; `OBSERVATION_S0_RUNTIME_PAYLOADS_PRESENT=false`; `OBSERVATION_EXECUTED=false`; `KIND_SET_RESOLVED=false`; `MS2_AUTHORIZED=false`; `D7_AUTHORIZED=false`; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_D6_PATH_B_D4_D5_GENESIS_REBASELINE_V1.md`](../ops/specs/FULL_CORE_D6_PATH_B_D4_D5_GENESIS_REBASELINE_V1.md) | Navigation-only Full-Core D6 PATH_B D4/D5 genesis rebaseline (non-SSOT; `GENESIS_REBASELINE_SELECTED_BY_OWNER=true`; `LEGACY_D4_D5_RUNTIME_CHAIN=NOT_RECONSTRUCTED`; `HISTORICAL_CONTINUITY_CLAIMED=false`; `HISTORICAL_COMPLETENESS_CLAIMED=false`; `D4_GENESIS_BOOTSTRAP_SOURCE=FRESH_AUTHENTICATED_ACCOUNT_CONFIG`; `D4_RUNTIME_INSTANCE_PRESENT=true`; `D5_RUNTIME_INSTANCE_PRESENT=true`; `BOUND_ACCOUNT_IDENTITY_RESOLVED=true`; `OBSERVATION_S0_PREREQUISITES_SATISFIED=true`; `OBSERVATION_EXECUTED=false`; `KIND_SET_RESOLVED=false`; `MS2_AUTHORIZED=false`; `D7_AUTHORIZED=false`; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_D6_PATH_B_PACKAGE_1_OBSERVATION_EXECUTION_V1.md`](../ops/specs/FULL_CORE_D6_PATH_B_PACKAGE_1_OBSERVATION_EXECUTION_V1.md) | Navigation-only Full-Core D6 PATH_B CLASS_C PACKAGE_1 Observation S1–S5 execution (non-SSOT; `AUTHORIZED_GET_SURFACE_COUNT=5`; `D4_IDENTITY_MINTED=false`; `RAW_EQ_SOURCE_AUTHORITY=false`; `S6_EXECUTED=false`; `KIND_SET_RESOLVED=false`; `MS2_AUTHORIZED=false`; `D6_FULLY_CLOSED=false`; `D7_AUTHORIZED=false`; `ATLAS_AUTHORITY=NONE`; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_D6_PATH_B_PACKAGE_1_S6_MAPPING_CLASSIFICATION_V1.md`](../ops/specs/FULL_CORE_D6_PATH_B_PACKAGE_1_S6_MAPPING_CLASSIFICATION_V1.md) | Navigation-only Full-Core D6 PATH_B PACKAGE_1 S6 mapping/classification (non-SSOT; `S6_EXECUTED=true`; `SEALED_INPUT_ONLY=true`; `OBSERVED_KIND_SET=EMPTY_FAIL_CLOSED`; `KIND_SET_RESOLVED=false`; `MAPPING_PERSISTED=false`; `MAPPING_COVERAGE_STATUS=FAIL_CLOSED_NO_RATIFIED_KIND`; `D4_IDENTITY_MINTED=false`; `RAW_EQ_SOURCE_AUTHORITY=false`; `MS2_AUTHORIZED=false`; `D6_FULLY_CLOSED=false`; `D7_AUTHORIZED=false`; `ATLAS_AUTHORITY=NONE`; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_D6_ACCOUNT_EQUITY_SOURCE_MAPPING_RATIFICATION_WORKPACKAGE_V1.md`](../ops/specs/FULL_CORE_D6_ACCOUNT_EQUITY_SOURCE_MAPPING_RATIFICATION_WORKPACKAGE_V1.md) | Navigation-only Full-Core D6 account-equity source-mapping ratification (non-SSOT; `MAPPING_PERSISTED=true`; `MAPPING_COVERAGE_STATUS=PARTIAL_FAIL_CLOSED_NO_RATIFIED_SOURCE_KIND`; `RATIFIED_SOURCE_KINDS=NONE`; `KIND_SET_RESOLVED=false`; `RAW_EQ_SOURCE_AUTHORITY=false`; `U05_KIND_DECISION=REMAIN_UNKNOWN`; `U06_KIND_DECISION=REMAIN_UNKNOWN`; `RESIDUAL_KIND_DECISION=REMAIN_UNKNOWN`; `MS2_AUTHORIZED=false`; `D6_FULLY_CLOSED=false`; `D7_AUTHORIZED=false`; `ATLAS_AUTHORITY=NONE`; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_D6_SOURCE_MAPPING_AND_COMPLETE_EVENT_STREAM_ACQUISITION_V1.md`](../ops/specs/FULL_CORE_D6_SOURCE_MAPPING_AND_COMPLETE_EVENT_STREAM_ACQUISITION_V1.md) | Navigation-only Full-Core D6 source-mapping and classified event-stream acquisition (non-SSOT; `RATIFIED_SOURCE_KINDS=NONE`; `KIND_SET_RESOLVED=false`; `EARLIEST_REMAINING_D6_BLOCKER=NAMED_REMAINING_UNKNOWN_NECESSARY_EQUITY_STOCK_KIND_SET`; `RAW_EQ_SOURCE_AUTHORITY=false`; `COMPLETE_CLASSIFIED_EVENT_STREAM_PROVEN=false`; `MS2_AUTHORIZED=false`; `D6_FULLY_CLOSED=false`; `D7_AUTHORIZED=false`; `ATLAS_AUTHORITY=NONE`; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_D6_F12_F13_F16_F17_F18_NECESSARY_EQUITY_STOCK_KIND_RESOLUTION_V1.md`](../ops/specs/FULL_CORE_D6_F12_F13_F16_F17_F18_NECESSARY_EQUITY_STOCK_KIND_RESOLUTION_V1.md) | Navigation-only Full-Core D6 F12/F13/F16/F17/F18 necessary EQUITY_STOCK kind resolution (non-SSOT; `F12_DECISION=REMAIN_UNKNOWN`; `F13_DECISION=REMAIN_UNKNOWN`; `F16_DECISION=REMAIN_UNKNOWN`; `F17_DECISION=REMAIN_UNKNOWN`; `F18_DECISION=REMAIN_UNKNOWN`; `KIND_SET_RESOLVED=false`; `EARLIEST_REMAINING_D6_BLOCKER=F12_F13_RESOLUTION_REQUIRES_NONZERO_LIABILITY_STOCK_PRIMARY_EVIDENCE_OR_RATIFIED_EQ_IDENTITY`; `RAW_EQ_SOURCE_AUTHORITY=false`; `COMPLETE_CLASSIFIED_EVENT_STREAM_PROVEN=false`; `MS2_AUTHORIZED=false`; `D6_FULLY_CLOSED=false`; `D7_AUTHORIZED=false`; `ATLAS_AUTHORITY=NONE`; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_D6_F12_F13_PRIMARY_LIABILITY_STOCK_OBSERVATION_V1.md`](../ops/specs/FULL_CORE_D6_F12_F13_PRIMARY_LIABILITY_STOCK_OBSERVATION_V1.md) | Navigation-only Full-Core D6 F12/F13 primary liability-stock observation (non-SSOT; `GET_COUNT=1`; `POST_COUNT=0`; `NONZERO_LIABILITY_OBSERVED=false`; `F12_DECISION=REMAIN_UNKNOWN`; `F13_DECISION=REMAIN_UNKNOWN`; `F16_DECISION=REMAIN_UNKNOWN`; `KIND_SET_RESOLVED=false`; `EARLIEST_REMAINING_D6_BLOCKER=F12_F13_REMAIN_UNKNOWN_AFTER_AUTHORIZED_FRESH_BALANCE_GET_EMPTY_OR_ZERO_DOES_NOT_PROVE_ABSENCE`; `RAW_EQ_SOURCE_AUTHORITY=false`; `COMPLETE_CLASSIFIED_EVENT_STREAM_PROVEN=false`; `MS2_AUTHORIZED=false`; `D6_FULLY_CLOSED=false`; `D7_AUTHORIZED=false`; `ATLAS_AUTHORITY=NONE`; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_D6_EQ_IDENTITY_AND_F12_F13_LIABILITY_STOCK_KIND_RATIFICATION_V1.md`](../ops/specs/FULL_CORE_D6_EQ_IDENTITY_AND_F12_F13_LIABILITY_STOCK_KIND_RATIFICATION_V1.md) | Navigation-only Full-Core D6 eq-identity and F12/F13/U05 liability-stock kind ratification (non-SSOT; `RATIFIED_EQ_IDENTITY=NONE`; `F12_DECISION=REMAIN_UNKNOWN`; `F13_DECISION=REMAIN_UNKNOWN`; `U05_KIND_DECISION=REMAIN_UNKNOWN`; `F16_DECISION=REMAIN_UNKNOWN`; `KIND_SET_RESOLVED=false`; `EARLIEST_REMAINING_D6_BLOCKER=F12_F13_REMAIN_UNKNOWN_AFTER_EQ_IDENTITY_NONE_AND_AUTHORIZED_FRESH_BALANCE_GET_EMPTY_OR_ZERO_DOES_NOT_PROVE_ABSENCE`; `RAW_EQ_SOURCE_AUTHORITY=false`; `LEGACY_STRUCTURE_RESTORED=false`; `SEMANTIC_SALVAGE_RULE_APPLIED=true`; `MS2_AUTHORIZED=false`; `D6_FULLY_CLOSED=false`; `D7_AUTHORIZED=false`; `ATLAS_AUTHORITY=NONE`; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_D6_F12_F13_KIND_SET_REMAINING_UNKNOWN_PIN_AND_REOPEN_GATE_V1.md`](../ops/specs/FULL_CORE_D6_F12_F13_KIND_SET_REMAINING_UNKNOWN_PIN_AND_REOPEN_GATE_V1.md) | Navigation-only Full-Core D6 F12/F13 KIND_SET remaining-unknown pin and reopen-gate persist (non-SSOT; `CURRENTLY_DECISION_CAPABLE_EVIDENCE_CLASSES_FOR_F12_F13=NONE`; `UNKNOWN_IS_DURABLE_BUT_NOT_D6_CLOSEOUT=true`; `GATE_A_EXECUTED=false`; `GATE_B_EXECUTED=false`; `F12_DECISION=REMAIN_UNKNOWN`; `F13_DECISION=REMAIN_UNKNOWN`; `U05_KIND_DECISION=REMAIN_UNKNOWN`; `KIND_SET_RESOLVED=false`; `EARLIEST_REMAINING_D6_BLOCKER=F12_F13_REMAIN_UNKNOWN_NO_CURRENTLY_DECISION_CAPABLE_EVIDENCE_CLASS_AFTER_BH_AND_BI`; `RAW_EQ_SOURCE_AUTHORITY=false`; `MS2_AUTHORIZED=false`; `D6_FULLY_CLOSED=false`; `D7_AUTHORIZED=false`; `ATLAS_AUTHORITY=NONE`; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_D6_BJ_SEMANTICS_BOUNDED_IMPLEMENTATION_WP1.md`](../ops/specs/FULL_CORE_D6_BJ_SEMANTICS_BOUNDED_IMPLEMENTATION_WP1.md) | Navigation-only Full-Core D6 BJ remaining-unknown kind semantics layer (non-SSOT; `F12_STATUS=UNRESOLVED`; `F13_STATUS=UNRESOLVED`; `U05_STATUS=UNRESOLVED`; `F16_STATUS=UNRESOLVED`; `F17_STATUS=UNRESOLVED`; `F18_STATUS=UNRESOLVED`; `KIND_SET=EMPTY_FAIL_CLOSED`; `KIND_SET_RESOLVED=false`; `GATE_A_EXECUTED=false`; `GATE_B_EXECUTED=false`; `VENUE_GET_COUNT=0`; `UNKNOWN_SEMANTICS_INVENTED=false`; `MS2_AUTHORIZED=false`; `D6_FULLY_CLOSED=false`; `D7_AUTHORIZED=false`; `ATLAS_AUTHORITY=NONE`; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_D6_BK_BOUNDED_IMPLEMENTATION_WP1.md`](../ops/specs/FULL_CORE_D6_BK_BOUNDED_IMPLEMENTATION_WP1.md) | Navigation-only Full-Core D6 BK consumption of sealed BJ remaining-unknown kind semantics (non-SSOT; `F12_STATUS=UNRESOLVED`; `F13_STATUS=UNRESOLVED`; `U05_STATUS=UNRESOLVED`; `F16_STATUS=UNRESOLVED`; `F17_STATUS=UNRESOLVED`; `F18_STATUS=UNRESOLVED`; `CONSUMPTION_ADMITTED=false`; `KIND_SET=EMPTY_FAIL_CLOSED`; `KIND_SET_RESOLVED=false`; `GATE_A_EXECUTED=false`; `GATE_B_EXECUTED=false`; `VENUE_GET_COUNT=0`; `VENUE_POST_COUNT=0`; `UNKNOWN_SEMANTICS_INVENTED=false`; `BJ_CONTRACT_REUSED=true`; `MS2_AUTHORIZED=false`; `D6_FULLY_CLOSED=false`; `D7_AUTHORIZED=false`; `ATLAS_AUTHORITY=NONE`; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_LIVE_CRITICAL_PATH_NEXT_BLOCKER_BOUNDED_WP1.md`](../ops/specs/FULL_CORE_LIVE_CRITICAL_PATH_NEXT_BLOCKER_BOUNDED_WP1.md) | Navigation-only Full-Core live-critical-path next-blocker persist (non-SSOT; `LIVE_CRITICAL_DEFINITION_CLASS=NEW_CANONICAL_DEFINITION`; `LIVE_CRITICAL_KIND_SET=EMPTY_FAIL_CLOSED`; `LIVE_CRITICAL_KIND_SET_RESOLVED=false`; `HISTORICAL_UNKNOWN_ON_CRITICAL_PATH=false`; `EARLIEST_LIVE_CRITICAL_PATH_BLOCKER=NO_OWNER_RATIFIED_NEW_CANONICAL_LIVE_EQUITY_STOCK_SOURCE_KIND`; `KINDS_INVENTED_THIS_GO=false`; `GATE_A_EXECUTED=false`; `GATE_B_EXECUTED=false`; `VENUE_GET_COUNT=0`; `VENUE_POST_COUNT=0`; `MS2_AUTHORIZED=false`; `D6_FULLY_CLOSED=false`; `D7_AUTHORIZED=false`; `ATLAS_AUTHORITY=NONE`; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_LIVE_EQUITY_STOCK_KIND_SET_NEW_CANONICAL_DEFINITION_WP1.md`](../ops/specs/FULL_CORE_LIVE_EQUITY_STOCK_KIND_SET_NEW_CANONICAL_DEFINITION_WP1.md) | Navigation-only Full-Core live EQUITY_STOCK KIND_SET NEW_CANONICAL_DEFINITION (non-SSOT; `NEW_CANONICAL_DEFINITION=true`; `LEGACY_SEMANTICS_RECONSTRUCTED=false`; `LIVE_EQUITY_STOCK_KIND_SET=EMPTY_FAIL_CLOSED`; `LIVE_EQUITY_STOCK_KIND_SET_RESOLVED=false`; `KIND_SET_MEMBERS=NONE`; `EARLIEST_LIVE_CRITICAL_PATH_BLOCKER=NO_ELIGIBLE_TODAY_LIVE_EQUITY_STOCK_SOURCE_KIND_AFTER_NEW_CANONICAL_DEFINITION`; `KINDS_INVENTED_THIS_GO=false`; `GATE_A_EXECUTED=false`; `GATE_B_EXECUTED=false`; `VENUE_GET_COUNT=0`; `VENUE_POST_COUNT=0`; `MS2_AUTHORIZED=false`; `D6_FULLY_CLOSED=false`; `D7_AUTHORIZED=false`; `ATLAS_AUTHORITY=NONE`; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_LIVE_EQUITY_STOCK_CHECKPOINT_STOCK_VALUE_CONTRACT_WP1.md`](../ops/specs/FULL_CORE_LIVE_EQUITY_STOCK_CHECKPOINT_STOCK_VALUE_CONTRACT_WP1.md) | Navigation-only Full-Core live EQUITY_STOCK checkpoint stock-value contract (non-SSOT; `NEW_CANONICAL_DEFINITION=true`; `LEGACY_SEMANTICS_RECONSTRUCTED=false`; `CHECKPOINT_MINTS_EQUITY=false`; `VENUE_EQ_SOURCE_AUTHORITY=false`; `STOCK_VALUE_CONTRACT_DEFINED=true`; `INITIAL_STOCK_ANCHOR_STATUS=ABSENT`; `LIVE_EQUITY_STOCK_KIND_SET=EMPTY_FAIL_CLOSED`; `EARLIEST_LIVE_CRITICAL_PATH_BLOCKER=BOOTSTRAP_STOCK_PROVENANCE_ABSENT`; `KINDS_INVENTED_THIS_GO=false`; `GATE_A_EXECUTED=false`; `GATE_B_EXECUTED=false`; `VENUE_GET_COUNT=0`; `VENUE_POST_COUNT=0`; `MS2_AUTHORIZED=false`; `D6_FULLY_CLOSED=false`; `D7_AUTHORIZED=false`; `ATLAS_AUTHORITY=NONE`; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_LIVE_EQUITY_STOCK_BOOTSTRAP_STOCK_PROVENANCE_WP1.md`](../ops/specs/FULL_CORE_LIVE_EQUITY_STOCK_BOOTSTRAP_STOCK_PROVENANCE_WP1.md) | Navigation-only Full-Core live EQUITY_STOCK bootstrap stock provenance (non-SSOT; `NEW_CANONICAL_DEFINITION=true`; `LEGACY_SEMANTICS_RECONSTRUCTED=false`; `CHECKPOINT_MINTS_EQUITY=false`; `VENUE_EQ_SOURCE_AUTHORITY=false`; `BOOTSTRAP_PROVENANCE_CONTRACT_DEFINED=true`; `BOOTSTRAP_PROVENANCE_FINDING=NO_PROVABLE_INITIAL_STOCK_ANCHOR`; `ACQUISITION_SEAM_STATUS=SEAM_DEFINED_PROOF_ABSENT`; `INITIAL_STOCK_ANCHOR_STATUS=ABSENT`; `LIVE_EQUITY_STOCK_KIND_SET=EMPTY_FAIL_CLOSED`; `EARLIEST_LIVE_CRITICAL_PATH_BLOCKER=BOOTSTRAP_STOCK_EXTERNAL_FORENSIC_PROOF_ABSENT`; `KINDS_INVENTED_THIS_GO=false`; `GATE_A_EXECUTED=false`; `GATE_B_EXECUTED=false`; `VENUE_GET_COUNT=0`; `VENUE_POST_COUNT=0`; `MS2_AUTHORIZED=false`; `D6_FULLY_CLOSED=false`; `D7_AUTHORIZED=false`; `ATLAS_AUTHORITY=NONE`; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_LIVE_EQUITY_STOCK_BOOTSTRAP_STOCK_ACQUISITION_WP1.md`](../ops/specs/FULL_CORE_LIVE_EQUITY_STOCK_BOOTSTRAP_STOCK_ACQUISITION_WP1.md) | Navigation-only Full-Core live EQUITY_STOCK bootstrap stock acquisition (non-SSOT; `NEW_CANONICAL_DEFINITION=true`; `LEGACY_SEMANTICS_RECONSTRUCTED=false`; `CHECKPOINT_MINTS_EQUITY=false`; `VENUE_EQ_SOURCE_AUTHORITY=false`; `ACQUISITION_CONTRACT_DEFINED=true`; `ACQUISITION_CONTRACT_STATUS=DEFINED_FAIL_CLOSED`; `FORENSIC_ARTIFACT_PRESENT=false`; `CANDIDATE_VALIDATION_STATUS=NOT_ACQUIRED`; `INITIAL_STOCK_ANCHOR_STATUS=ABSENT`; `RATIFICATION_PERFORMED=false`; `LIVE_EQUITY_STOCK_KIND_SET=EMPTY_FAIL_CLOSED`; `EARLIEST_LIVE_CRITICAL_PATH_BLOCKER=EXTERNAL_FORENSIC_ARTIFACT_REQUIRED`; `KINDS_INVENTED_THIS_GO=false`; `GATE_A_EXECUTED=false`; `GATE_B_EXECUTED=false`; `VENUE_GET_COUNT=0`; `VENUE_POST_COUNT=0`; `MS2_AUTHORIZED=false`; `D6_FULLY_CLOSED=false`; `D7_AUTHORIZED=false`; `ATLAS_AUTHORITY=NONE`; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_LIVE_EQUITY_STOCK_OWNER_SUPPLIED_BOOTSTRAP_ARTIFACT_WP1.md`](../ops/specs/FULL_CORE_LIVE_EQUITY_STOCK_OWNER_SUPPLIED_BOOTSTRAP_ARTIFACT_WP1.md) | Navigation-only Full-Core live EQUITY_STOCK owner-supplied bootstrap artifact ingest (non-SSOT; `NEW_CANONICAL_DEFINITION=true`; `LEGACY_SEMANTICS_RECONSTRUCTED=false`; `CHECKPOINT_MINTS_EQUITY=false`; `VENUE_EQ_SOURCE_AUTHORITY=false`; `BQ_CONTRACT_REUSED=true`; `FORENSIC_ARTIFACT_PRESENT=false`; `CANDIDATE_VALIDATION_STATUS=INCOMPLETE`; `INITIAL_STOCK_CANDIDATE_STATUS=ABSENT`; `INITIAL_STOCK_ANCHOR_STATUS=ABSENT`; `RATIFICATION_STATUS=RATIFICATION_AUTHORITY_ABSENT`; `LIVE_EQUITY_STOCK_KIND_SET=EMPTY_FAIL_CLOSED`; `EARLIEST_LIVE_CRITICAL_PATH_BLOCKER=EXTERNAL_FORENSIC_ARTIFACT_REQUIRED`; `KINDS_INVENTED_THIS_GO=false`; `GATE_A_EXECUTED=false`; `GATE_B_EXECUTED=false`; `VENUE_GET_COUNT=0`; `VENUE_POST_COUNT=0`; `MS2_AUTHORIZED=false`; `D6_FULLY_CLOSED=false`; `D7_AUTHORIZED=false`; `ATLAS_AUTHORITY=NONE`; Cap 11.1 construction remains forbidden) |
...
| [`docs/ops/specs/MASTER_V2_CAPABILITY_2_2_PRODUCTIVE_FUTURES_RANKING_PRODUCER_V1.md`](../ops/specs/MASTER_V2_CAPABILITY_2_2_PRODUCTIVE_FUTURES_RANKING_PRODUCER_V1.md) | Cap 2.2 ranking (`CANDIDATE_CONTEXT_ONLY`; not selection; current productive input remains Cap 2.1 only) |
| [`docs/ops/specs/CAP22_ECONOMIC_MD_INPUT_AND_DUAL_INPUT_CONTRACT_V1.md`](../ops/specs/CAP22_ECONOMIC_MD_INPUT_AND_DUAL_INPUT_CONTRACT_V1.md) | Cap 2.2 future economic-MD dual-input architecture (`CAP22_INPUT_MODEL=DUAL_AUTHORITATIVE_INPUTS_WITH_SEPARATE_ROLES`; separate Economic-MD-Input capability authorized; producer implemented not wired; Cap 2.1 remains eligibility-only; Cap 2.2 remains ranking owner not network owner; MVR volatility+spread input kinds only; score formula unratified; `ECONOMIC_RANK_ACTIVATED=false`; PDF Step 5 remains `UNRESOLVED`; rotation fail-closed; PDF Step 7 forbidden; no host join; navigation only) |
| [`docs/ops/specs/CAP22_OFFLINE_POLICY_CANDIDATES_AND_EVIDENCE_CONTRACT_V1.md`](../ops/specs/CAP22_OFFLINE_POLICY_CANDIDATES_AND_EVIDENCE_CONTRACT_V1.md) | Cap 2.2 offline policy candidates and evidence contract (`RECOMMENDED_PRIMARY_BASELINE=VOLATILITY_RANK_ONLY` baseline-only; recommended offline challengers gate/ratio/lex; multiplicative and additive deferred; Pareto rejected as TOP20 owner; MVR kinds remain volatility + same-cycle bid/ask; no extra raw inputs required; score formula and weights unratified; `ECONOMIC_MD_PRODUCER_IMPLEMENTED=true`; `ECONOMIC_MD_PRODUCER_PRODUCTIVELY_SCHEDULED=false`; `ECONOMIC_RANK_ACTIVATED=false`; PDF Step 5 remains `UNRESOLVED`; rotation fail-closed; PDF Step 7 forbidden; no host join; navigation only) |
| [`docs/ops/specs/CAP22_OFFLINE_MVR_SPREAD_DEFINITION_ZERO_HANDLING_AND_CHALLENGER_ORDER_V1.md`](../ops/specs/CAP22_OFFLINE_MVR_SPREAD_DEFINITION_ZERO_HANDLING_AND_CHALLENGER_ORDER_V1.md) | Cap 2.2 offline MVR spread definition and comparison keys (`SPREAD_FORMULA_ID=RELATIVE_BID_ASK_SPREAD_OVER_MID_V1`; identity same-cycle aggregator; exact zero valid/raw and `NOT_RANKABLE_FOR_POLICY_C` only; near-zero and Policy-B threshold set unratified; offline challenger A is `VOLATILITY_RANK_ONLY` not anti-churn Policy A; no challenger wins; `ECONOMIC_RANK_ACTIVATED=false`; PDF Step 5 remains `UNRESOLVED`; rotation fail-closed; PDF Step 7 forbidden; no host join; navigation only) |
| [`docs/ops/specs/CAP22_OFFLINE_MVR_THRESHOLD_SET_AND_EVIDENCE_HARNESS_V1.md`](../ops/specs/CAP22_OFFLINE_MVR_THRESHOLD_SET_AND_EVIDENCE_HARNESS_V1.md) | Cap 2.2 offline MVR injected Policy-B threshold set and deterministic evidence harness (`POLICY_B_THRESHOLD_MODE=VERSIONED_OFFLINE_THRESHOLD_SET`; `POLICY_B_THRESHOLD_SET_RATIFIED=false`; TEST_ONLY_NON_CANONICAL grid; offline fixture/replay evidence only; no walk-forward; no policy winner; no productive ranking activation; PDF Step 5 remains `UNRESOLVED`; rotation fail-closed; PDF Step 7 forbidden; no host join; navigation only) |
| [`docs/ops/specs/CAP22_HISTORICAL_EVIDENCE_TIME_SEMANTICS_V1.md`](../ops/specs/CAP22_HISTORICAL_EVIDENCE_TIME_SEMANTICS_V1.md) | Cap 2.2 offline historical evidence time semantics (`RANKING_CADENCE_ID=PT1M_15_MINUTE_ANCHORS_V1`; forward labels 15m/30m/60m/120m; replay floor `MIN_90D_PLUS_AVAILABLE_VALID_HISTORY_V1`; walk-forward modes ratified not executed; friction-adjusted opportunity unratified; no historical evidence generated; no productive ranking activation; PDF Step 5 remains `UNRESOLVED`; rotation fail-closed; PDF Step 7 forbidden; no host join; navigation only) |
| [`docs/ops/specs/CAP22_APPEND_ONLY_15M_PIT_PERSISTENCE_AND_COLLECTION_CONTRACTS_V1.md`](../ops/specs/CAP22_APPEND_ONLY_15M_PIT_PERSISTENCE_AND_COLLECTION_CONTRACTS_V1.md) | Cap 2.2 WP1 append-only 15m PIT persistence and collection contracts (`COLLECTION_CADENCE_ID=PT1M_15_MINUTE_ANCHORS_V1`; Cap-2.1 and Economic-MD at-T seams; exact T binding; no scheduler; `CAP22_PROSPECTIVE_COLLECTION_CONTRACTS_IMPLEMENTED=true`; `CAP22_PROSPECTIVE_COLLECTION_STARTED=false`; `CAP22_90D_EVIDENCE_CLOCK_STARTED=false`; no historical evidence generated; no productive ranking activation; PDF Step 5 remains `UNRESOLVED`; rotation fail-closed; PDF Step 7 forbidden; no host join; navigation only) |
| [`docs/ops/specs/CAPABILITY_PERSISTED_MULTI_INSTRUMENT_ECONOMIC_MD_INPUT_V1.md`](../ops/specs/CAPABILITY_PERSISTED_MULTI_INSTRUMENT_ECONOMIC_MD_INPUT_V1.md) | Cap 2.2 Economic-MD MVR raw-input producer (`IMPLEMENTED_NOT_WIRED`; standalone/offline invokable; not productively scheduled; no ranking/selection/Policy A/execution; current Cap 2.2 productive ranking remains Cap-2.1-only; PDF Step 5 remains `UNRESOLVED`; rotation fail-closed; PDF Step 7 forbidden; no host join; navigation only) |
| [`docs/ops/specs/MF_SELECTION_CONTEXT_BOUNDARY_CONTRACT_V1.md`](../ops/specs/MF_SELECTION_CONTEXT_BOUNDARY_CONTRACT_V1.md) | Isolated MF-selection domain boundary (`NON_AUTHORITATIVE_MEMBERSHIP_CONTEXT_ONLY`; `HARD_DOMAIN_END`; `INTEGRATION_STATUS=NOT_IN_SCOPE`; `AUTHORITY_EFFECT=NONE`; not selection; not host input; navigation only) |
| [`docs/ops/specs/MF_SELECTOR_CONSUMPTION_AND_ANTI_CHURN_OWNERSHIP_CONTRACT_V1.md`](../ops/specs/MF_SELECTOR_CONSUMPTION_AND_ANTI_CHURN_OWNERSHIP_CONTRACT_V1.md) | Isolated MF selector consumption and anti-churn ownership persist (`SELECTOR_ROLE=PROPOSE_MEMBERSHIP_FROM_TOP20_CANDIDATE_CONTEXT`; `ANTI_CHURN_OWNER=SELECTOR`; `ROTATION_ROLE=MEMBERSHIP_DIFF_ONLY`; `SELECTOR_STATE_OWNER=NONE_FOR_MEMBERSHIP_IDENTITY`; OD04 closed as ownership principle in the semantics contract; `AUTHORITY_EFFECT=NONE`; not selection; not host input; `N_VALUE=5` pointer to semantics §1.3; navigation only) |
| [`docs/ops/specs/MF_SELECTION_AND_ANTI_CHURN_SEMANTICS_CONTRACT_V1.md`](../ops/specs/MF_SELECTION_AND_ANTI_CHURN_SEMANTICS_CONTRACT_V1.md) | Isolated MF selection and anti-churn mechanism semantics (`AT_MOST_N` closed; Cap-2.2 order consumed as membership order; `OPEN_DECISION_01` closed as Owner-policy ceiling `N_VALUE=5`; OD04 closed as ownership principle only; OD05 closed as `NO_INDEPENDENT_PENDING_STATE_REQUIRED` for the current isolated MF model; OD06 closed as permission-only `ALLOWED` while G13 remains closed; permission is not artifact existence; membership-context artifact semantic identity bound as information classes only; artifact existence class bound as required durable non-authoritative membership-context artifact; schema, writer, reader, durability, provenance, and lifecycle bound in §1.18; first bootstrap instance `mca_bf0255a6007432e2` proven; historical census class `NO_INSTANCE_PROOF_FOUND_BUT_CREATION_NOT_YET_AUTHORIZED`; current census `BOOTSTRAP_INSTANCE_PROOF_FOUND`; `UNPROVEN` is not `ABSENT`; `CREATION_AUTHORIZED` true as permission-bit only; `MATERIALIZATION_AUTHORITY_GRANTED` true as grant only; `OPEN_DECISION_07` closed in §1.6 as `CLOSED_ROTATION_DELTAS_DERIVED_IDENTITY`; `rotation_deltas` derived not durable canonical state; anti-churn POLICY_A ratified in §1.17; isolated selector and membership-diff rotation bound in §1.19; deterministic previous-to-current replay bound in §1.20; isolated MF target complete; productive integration not complete; `RUNTIME_AUTHORIZED=false`; no host join; no second ranker; `AUTHORITY_EFFECT=NONE`; cooldown/turnover unratified; navigation only) |
| [`docs/ops/specs/MF_RANKING_UNIVERSE_AND_SINGLE_EGRESS_BOUNDARY_CONTRACT_V1.md`](../ops/specs/MF_RANKING_UNIVERSE_AND_SINGLE_EGRESS_BOUNDARY_CONTRACT_V1.md) | Isolated ranking-universe family isolation and single-egress invariant (`ISOLATED_RANKING_UNIVERSE`; `SINGLE_EGRESS_REQUIRED`; handoff definition owned by the WP-MF-05 contract; downstream must not re-rank; existing execution/risk/eligibility gates may block; `N_VALUE=5` pointer to semantics §1.3; `CAP23_IMPORTED=false`; `AUTHORITY_EFFECT=NONE`; navigation only) |
| [`docs/ops/specs/MF_CANONICAL_SINGLE_EGRESS_AUTHORITY_HANDOFF_CONTRACT_V1.md`](../ops/specs/MF_CANONICAL_SINGLE_EGRESS_AUTHORITY_HANDOFF_CONTRACT_V1.md) | Canonical single-egress authority-handoff definition (`AUTHORITY_HANDOFF_STATUS=DEFINED_CONSUMER_UNBOUND`; `CONSUMER_IDENTITY_STATUS=UNBOUND`; intended semantic object named by the PDF-Step-3 ownership contract; envelope is not an Active-Set DTO; no host join; no Cap-2.3/2.4 rewire; `AUTHORITY_EFFECT=NONE`; navigation only) |
| [`docs/ops/specs/MF_AUTHORITATIVE_NEXT_ACTIVE_SET_OWNERSHIP_CONTRACT_V1.md`](../ops/specs/MF_AUTHORITATIVE_NEXT_ACTIVE_SET_OWNERSHIP_CONTRACT_V1.md) | Isolated PDF-Step-3 ownership bind for authoritative Next Active Set (`OWNER=ops.mf_membership_rotation_controller_v1`; `PDF_STEP_4_ANTI_CHURN_CENSUS=CLOSED` inventory only; `CENSUS_CLASS=INVENTORY_ONLY_NO_POLICY_CHOICE`; census close is not policy ratification; `AS05_D01_STATUS=CLOSED` as `ADOPT_POLICY_A_UNCHANGED_FOR_ACTIVE_SET`; `AS05_D02_STATUS=CLOSED` as `NAME_EVALUATE_POLICY_A_V1_AS_PURE_ANTI_CHURN_EVALUATOR_FOR_AUTHORITATIVE_NEXT_ACTIVE_SET`; `EVALUATOR_COMPONENT=src.ops.mf_membership_selector_and_rotation_runtime_contract_v1.evaluate_policy_a_v1`; `EVALUATOR_AUTHORITY=POLICY_A_ADMISSION_OR_NON_ADMISSION_ONLY`; `POLICY_REUSE_DOES_NOT_TRANSFER_AUTHORITY=true`; `EVALUATOR_REUSE_DOES_NOT_TRANSFER_AUTHORITY=true`; `SELECTOR_OWNER_IDENTITY_IS_NOT_ACTIVE_SET_EVALUATOR_AUTHORITY=true`; `AS05_D03_STATUS=CLOSED` as `EXTEND_OD05_NO_INDEPENDENT_PENDING_TO_ACTIVE_SET`; `OD05_SCOPE_REUSE_DOES_NOT_TRANSFER_AUTHORITY=true`; `PDF_STEP_5_ANTI_CHURN_OWNER_RATIFICATION=UNRESOLVED`; `OWNER_DECISION_SURFACE_STATUS=D01_D02_D03_RATIFIED_STEP_5_UNRESOLVED`; D03 close is not Step-5 close; `ACTIVE_SET_POLICY_ADOPTION=ADOPT_POLICY_A_UNCHANGED_FOR_ACTIVE_SET`; `ROTATION_POLICY_STATUS=FAIL_CLOSED_UNTIL_PDF_STEP_5`; `POLICY_A_IS_NOT_AUTOMATIC_ACTIVE_SET_POLICY=true`; `N_VALUE` pointer only; consumer unbound; no host join; no Cap-2.3/2.4 rewire; navigation only) |
...
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.14 LIVE_RESTART_RECONSTRUCTED_EXHAUSTIVE_OFFLINE_CENSUS | Navigation-only historical §11.14 restart exhaustive census (`LIVE_RESTART_RECONSTRUCTED=false`; `CASE_ADJUDICATION=CASE_LIVE_RESTART_RECONSTRUCTED_FAIL_CLOSED_MISSING_DURABLE_HANDOFF`; `CASE_B_NOT_PROVEN_CONTRACT_CLOSED=true`; no identity-bound Live durable_state; future persist-first Owner-GO specified not executed; no GET; no POST; no restart execution; successor `11.14.LIVE_RESTART_HANDOFF_OWNER_BIND_AND_RETROACTIVE_SYNTHESIS_REFUSAL`; MOT not SSOT) |
| [`docs/ops/specs/SECTION_11_14_LIVE_RESTART_RECONSTRUCTED_EXHAUSTIVE_OFFLINE_CENSUS_V1.md`](../ops/specs/SECTION_11_14_LIVE_RESTART_RECONSTRUCTED_EXHAUSTIVE_OFFLINE_CENSUS_V1.md) | Derived historical §11.14 LIVE_RESTART_RECONSTRUCTED exhaustive offline census spec (non-SSOT; criterion bound; restart false; future GO specified not executed under that GO) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.14 LIVE_RESTART_HANDOFF_OWNER_BIND_AND_RETROACTIVE_SYNTHESIS_REFUSAL | Navigation-only historical §11.14 Live restart handoff owner bind (`LIVE_RESTART_RECONSTRUCTED=false`; `SECTION_11_14_LIVE_HANDOFF_OWNER_CURRENT=NONE`; `RETROACTIVE_HANDOFF_SYNTHESIS_ALLOWED=false`; historical identity `UNPROVABLE_WITHOUT_CONTEMPORANEOUS_CAPTURE`; no GET; no POST; no restart execution; successor `11.14.LIVE_HANDOFF_REQUIRED_FIELD_CAPTURE_SEAM_POS_AND_OWNER_VACANCY_CONTRACT`; MOT not SSOT) |
| [`docs/ops/specs/SECTION_11_14_LIVE_RESTART_HANDOFF_OWNER_BIND_AND_RETROACTIVE_SYNTHESIS_REFUSAL_V1.md`](../ops/specs/SECTION_11_14_LIVE_RESTART_HANDOFF_OWNER_BIND_AND_RETROACTIVE_SYNTHESIS_REFUSAL_V1.md) | Derived historical §11.14 Live restart handoff owner-bind and retroactive-synthesis-refusal spec (non-SSOT; owner NONE; restart false; retroactive synthesis refused) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.14 LIVE_HANDOFF_REQUIRED_FIELD_CAPTURE_SEAM_POS_AND_OWNER_VACANCY_CONTRACT | Navigation-only historical §11.14 required-field capture-seam and owner-vacancy contract (`POS_SEMANTICS=UNPROVEN`; `COMPLETE_CAPTURE_SEAM=UNPROVEN`; `SECTION_11_14_LIVE_HANDOFF_OWNER_CURRENT=NONE`; vacancy contract bound not minted; no productive writer/reader join; no GET; no POST; no restart execution; successor `11.14.LIVE_DURABLE_PRE_RESTART_HANDOFF_OWNER_AND_CAPTURE_ARCHITECTURE_ADJUDICATION`; MOT not SSOT) |
| [`docs/ops/specs/SECTION_11_14_LIVE_HANDOFF_REQUIRED_FIELD_CAPTURE_SEAM_POS_AND_OWNER_VACANCY_CONTRACT_V1.md`](../ops/specs/SECTION_11_14_LIVE_HANDOFF_REQUIRED_FIELD_CAPTURE_SEAM_POS_AND_OWNER_VACANCY_CONTRACT_V1.md) | Derived historical §11.14 required-field capture-seam and owner-vacancy spec (non-SSOT; pos unproven; capture seam unproven; vacancy bound; owner NONE) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.14 LIVE_DURABLE_PRE_RESTART_HANDOFF_OWNER_AND_CAPTURE_ARCHITECTURE_ADJUDICATION | Navigation-only historical §11.14 Live durable pre-restart handoff owner and capture architecture adjudication (`POS_SEMANTICS=UNPROVEN`; `COMPLETE_CAPTURE_SEAM=UNPROVEN`; `SECTION_11_14_LIVE_HANDOFF_OWNER_CURRENT=NONE`; proposed first owner eligible as logical ID not productively bound; architecture DAG bound; no productive writer/reader/storage mint; `ARCHITECTURE_ADJUDICATION_COMPLETE=true`; `IMPLEMENTATION_AUTHORIZED=false`; no GET; no POST; no restart execution; successor `11.14.LIVE_HANDOFF_POS_SEMANTICS_CANONICAL_BINDING`; MOT not SSOT) |
| [`docs/ops/specs/SECTION_11_14_LIVE_DURABLE_PRE_RESTART_HANDOFF_OWNER_AND_CAPTURE_ARCHITECTURE_ADJUDICATION_V1.md`](../ops/specs/SECTION_11_14_LIVE_DURABLE_PRE_RESTART_HANDOFF_OWNER_AND_CAPTURE_ARCHITECTURE_ADJUDICATION_V1.md) | Derived historical §11.14 owner/capture architecture adjudication spec (non-SSOT; pos unproven; capture seam unproven; owner NONE; implementation unauthorized) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.14 LIVE_HANDOFF_POS_SEMANTICS_CANONICAL_BINDING | Navigation-only historical §11.14 Live handoff pos-semantics canonical binding (`POS_SEMANTICS=UNPROVEN` at that consumed GO; `POS_SEMANTICS_CAN_BE_BOUND_FROM_EXISTING_AUTHORITY=false`; `NEW_CONTEMPORANEOUS_POS_PRODUCER_REQUIRED=true`; `POS_ACCEPTABLE_PRODUCER_COUNT=0`; `COMPLETE_CAPTURE_SEAM=UNPROVEN`; `SECTION_11_14_LIVE_HANDOFF_OWNER_CURRENT=NONE`; no productive writer/reader/storage mint; `IMPLEMENTATION_AUTHORIZED=false`; no GET; no POST; no restart execution; successor `11.14.LIVE_HANDOFF_POS_PRODUCER_SEMANTICS_AND_CONTRACT`; MOT not SSOT) |
| [`docs/ops/specs/SECTION_11_14_LIVE_HANDOFF_POS_SEMANTICS_CANONICAL_BINDING_V1.md`](../ops/specs/SECTION_11_14_LIVE_HANDOFF_POS_SEMANTICS_CANONICAL_BINDING_V1.md) | Derived historical §11.14 pos-semantics canonical binding spec (non-SSOT; unique meaning unproven at that GO; zero acceptable producers; new contemporaneous producer required; implementation unauthorized) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.14 LIVE_HANDOFF_POS_PRODUCER_SEMANTICS_AND_CONTRACT | Navigation-only historical §11.14 Live handoff pos producer semantics and contract (`POS_SEMANTICS=PROVEN` at that consumed GO; unique meaning/unit/sign Owner-bound; `NEW_PRODUCER_CONTRACT_DEFINED=true`; `NEW_PRODUCER_IMPLEMENTED=false`; `COMPLETE_CAPTURE_SEAM=UNPROVEN`; `COMPLETE_CAPTURE_SEAM_CAN_NOW_BE_ADJUDICATED=true`; `SECTION_11_14_LIVE_HANDOFF_OWNER_CURRENT=NONE`; no productive writer/reader/storage mint; `IMPLEMENTATION_AUTHORIZED=false`; no GET; no POST; no restart execution; successor `11.14.LIVE_HANDOFF_COMPLETE_CAPTURE_SEAM_PROOF`; MOT not SSOT) |
| [`docs/ops/specs/SECTION_11_14_LIVE_HANDOFF_POS_PRODUCER_SEMANTICS_AND_CONTRACT_V1.md`](../ops/specs/SECTION_11_14_LIVE_HANDOFF_POS_PRODUCER_SEMANTICS_AND_CONTRACT_V1.md) | Derived historical §11.14 pos producer-semantics and contract spec (non-SSOT; unique meaning proven; producer contract-only; implementation unauthorized) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.14 LIVE_HANDOFF_COMPLETE_CAPTURE_SEAM_PROOF | Navigation-only historical §11.14 Live handoff complete-capture-seam proof (`POS_SEMANTICS=PROVEN` at that consumed GO; `NEW_PRODUCER_IMPLEMENTED=false`; `COMPLETE_CAPTURE_SEAM=UNPROVEN`; `COMPLETE_CAPTURE_SEAM_PROOF_STATUS=CLOSED_UNPROVEN_NO_INVENTION`; `CAPTURE_TRIGGER_STATUS=REQUIRED_WINDOW_BOUND_PRODUCTIVE_TRIGGER_UNBOUND`; `SECTION_11_14_LIVE_HANDOFF_OWNER_CURRENT=NONE`; no productive writer/reader/storage mint; `IMPLEMENTATION_AUTHORIZED=false`; no GET; no POST; no restart execution; successor `11.14.LIVE_HANDOFF_POS_PRODUCER_CAPTURE_RECORD_OWNER_AND_WRITER_IMPLEMENTATION`; MOT not SSOT) |
| [`docs/ops/specs/SECTION_11_14_LIVE_HANDOFF_COMPLETE_CAPTURE_SEAM_PROOF_V1.md`](../ops/specs/SECTION_11_14_LIVE_HANDOFF_COMPLETE_CAPTURE_SEAM_PROOF_V1.md) | Derived historical §11.14 complete-capture-seam proof spec (non-SSOT; seam unproven without invention; implementation unauthorized at that GO) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.14 LIVE_HANDOFF_POS_PRODUCER_CAPTURE_RECORD_OWNER_AND_WRITER_IMPLEMENTATION | Navigation-only historical §11.14 Live S05 producer / owner / writer implementation (`POS_SEMANTICS=PROVEN`; `NEW_PRODUCER_IMPLEMENTED=true`; `SECTION_11_14_LIVE_HANDOFF_OWNER_CURRENT=SECTION_11_14_LIVE_DURABLE_PRE_RESTART_HANDOFF_OWNER_V1`; `WRITER_BOUND=true`; `READER_BOUND=false` at that consumed GO; `COMPLETE_CAPTURE_SEAM=UNPROVEN`; `HOST_CRASH_DURABILITY=UNPROVEN`; `LIVE_RESTART_RECONSTRUCTED=false`; `IMPLEMENTATION_AUTHORIZED=false`; no GET; no POST; no restart execution; successor `11.14.LIVE_HANDOFF_RESTART_READER_PROVENANCE_AND_CONSUMER_BIND`; MOT not SSOT) |
| [`docs/ops/specs/SECTION_11_14_LIVE_HANDOFF_POS_PRODUCER_CAPTURE_RECORD_OWNER_AND_WRITER_IMPLEMENTATION_V1.md`](../ops/specs/SECTION_11_14_LIVE_HANDOFF_POS_PRODUCER_CAPTURE_RECORD_OWNER_AND_WRITER_IMPLEMENTATION_V1.md) | Derived historical §11.14 S05 producer / owner / writer implementation spec (non-SSOT; producer implemented; owner minted; writer bound; reader unbound at that GO; complete seam unproven; host-crash unproven) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.14 LIVE_HANDOFF_RESTART_READER_PROVENANCE_AND_CONSUMER_BIND | Navigation-only historical §11.14 Live restart reader / provenance / consumer bind (`POS_SEMANTICS=PROVEN`; `NEW_PRODUCER_IMPLEMENTED=true`; `SECTION_11_14_LIVE_HANDOFF_OWNER_CURRENT=SECTION_11_14_LIVE_DURABLE_PRE_RESTART_HANDOFF_OWNER_V1`; `WRITER_BOUND=true`; `READER_BOUND=true`; `RESTART_CONSUMER_BOUND=true`; `PROVENANCE_VALIDATION=CONTRACT_PROVEN`; `FRESHNESS_VALIDATION=PARTIAL`; `COMPLETE_CAPTURE_SEAM=UNPROVEN`; `HOST_CRASH_DURABILITY=UNPROVEN`; `CONTEMPORANEOUS_PEAK_TRADE_PRE_RESTART_HANDOFF_OBSERVED=false`; `LIVE_RESTART_RECONSTRUCTED=false`; `IMPLEMENTATION_AUTHORIZED=false`; no GET; no POST; no restart execution; successor `11.14.LIVE_RESTART_RECONSTRUCTED_CONTEMPORANEOUS_PRE_RESTART_OBSERVATION`; MOT not SSOT) |
| [`docs/ops/specs/SECTION_11_14_LIVE_HANDOFF_RESTART_READER_PROVENANCE_AND_CONSUMER_BIND_V1.md`](../ops/specs/SECTION_11_14_LIVE_HANDOFF_RESTART_READER_PROVENANCE_AND_CONSUMER_BIND_V1.md) | Derived historical §11.14 restart-reader / provenance / consumer-bind spec (non-SSOT; reader bound; consumer bound; provenance contract-proven; freshness partial; complete seam unproven; host-crash unproven; restart false) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.14 LIVE_RESTART_RECONSTRUCTED_CONTEMPORANEOUS_PRE_RESTART_OBSERVATION | Navigation-only historical §11.14 contemporaneous pre-restart observability prove-or-refute (`OBSERVATION_STATUS=CLOSED_REFUTED`; `READ_BACK_RESULT=MISSING_HANDOFF`; `AUTHORIZED_NON_LIVE_RUNTIME_SURFACE_PRESENT=false`; `COMPLETE_CAPTURE_SEAM=UNPROVEN`; `HOST_CRASH_DURABILITY=UNPROVEN`; `CONTEMPORANEOUS_PEAK_TRADE_PRE_RESTART_HANDOFF_OBSERVED=false`; `LIVE_RESTART_RECONSTRUCTED=false`; `IMPLEMENTATION_AUTHORIZED=false`; no GET; no POST; no productive handoff write; no restart execution; successor `11.14.LIVE_HANDOFF_FUTURE_AUTHORIZED_CONTEMPORANEOUS_CAPTURE_WINDOW`; MOT not SSOT) |
| [`docs/ops/specs/SECTION_11_14_LIVE_RESTART_RECONSTRUCTED_CONTEMPORANEOUS_PRE_RESTART_OBSERVATION_V1.md`](../ops/specs/SECTION_11_14_LIVE_RESTART_RECONSTRUCTED_CONTEMPORANEOUS_PRE_RESTART_OBSERVATION_V1.md) | Derived historical §11.14 contemporaneous pre-restart observability spec (non-SSOT; observability closed-refuted; read-back missing; complete seam unproven; host-crash unproven; restart false) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.14 LIVE_HANDOFF_FUTURE_AUTHORIZED_CONTEMPORANEOUS_CAPTURE_WINDOW | Navigation-only historical §11.14 future-authorized contemporaneous capture-window adjudication (`PRODUCTIVE_CAPTURE_OWNER_STATUS=ABSENT`; `PRODUCTIVE_CAPTURE_HOOK_STATUS=ABSENT`; `CAPTURE_WINDOW_ORDERING=UNPROVEN`; `MINIMUM_FUTURE_CAPTURE_WINDOW_SURFACE=UNPROVEN`; `PRODUCTIVE_BINDING_ALLOWED_IN_THIS_WORKPACKAGE=false`; `COMPLETE_CAPTURE_SEAM=UNPROVEN`; `HOST_CRASH_DURABILITY=UNPROVEN`; `CONTEMPORANEOUS_PEAK_TRADE_PRE_RESTART_HANDOFF_OBSERVED=false`; `LIVE_RESTART_RECONSTRUCTED=false`; `IMPLEMENTATION_AUTHORIZED=false`; no GET; no POST; no productive handoff write; no restart execution; no productive runtime join; successor `11.14.LIVE_HANDOFF_PRODUCTIVE_CAPTURE_OWNER_AND_LIFECYCLE_HOOK_BINDING`; MOT not SSOT) |
| [`docs/ops/specs/SECTION_11_14_LIVE_HANDOFF_FUTURE_AUTHORIZED_CONTEMPORANEOUS_CAPTURE_WINDOW_V1.md`](../ops/specs/SECTION_11_14_LIVE_HANDOFF_FUTURE_AUTHORIZED_CONTEMPORANEOUS_CAPTURE_WINDOW_V1.md) | Derived historical §11.14 future-authorized contemporaneous capture-window spec (non-SSOT; owner absent; hook absent; window ordering unproven; surface unproven; no runtime join; complete seam unproven; host-crash unproven; restart false) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.14 LIVE_HANDOFF_PRODUCTIVE_CAPTURE_OWNER_AND_LIFECYCLE_HOOK_BINDING | Navigation-only historical §11.14 productive capture-owner and lifecycle-hook binding adjudication (`PRODUCTIVE_CAPTURE_OWNER_STATUS=REFUTED`; `PRODUCTIVE_LIFECYCLE_HOOK_STATUS=REFUTED`; `AUTHORIZED_RUNTIME_SURFACE=NONE`; `AUTHORIZED_RUNTIME_SURFACE_PROVEN=false`; `BINDING_CASE=CASE_B`; `MINIMAL_FAIL_CLOSED_BINDING_ALLOWED=false`; `PRODUCTIVE_BINDING_IMPLEMENTED=false`; `COMPLETE_CAPTURE_SEAM=UNPROVEN`; `HOST_CRASH_DURABILITY=UNPROVEN`; `CONTEMPORANEOUS_PEAK_TRADE_PRE_RESTART_HANDOFF_OBSERVED=false`; `LIVE_RESTART_RECONSTRUCTED=false`; `IMPLEMENTATION_AUTHORIZED=false`; no GET; no POST; no productive handoff write; no restart execution; no productive runtime join; successor `11.14.LIVE_HANDOFF_CREATE_PRODUCTIVE_CAPTURE_OWNER_AND_LIFECYCLE_HOOK`; MOT not SSOT) |
| [`docs/ops/specs/SECTION_11_14_LIVE_HANDOFF_PRODUCTIVE_CAPTURE_OWNER_AND_LIFECYCLE_HOOK_BINDING_V1.md`](../ops/specs/SECTION_11_14_LIVE_HANDOFF_PRODUCTIVE_CAPTURE_OWNER_AND_LIFECYCLE_HOOK_BINDING_V1.md) | Derived historical §11.14 productive capture-owner and lifecycle-hook binding spec (non-SSOT; unique owner refuted; unique hook refuted; authorized surface none; CASE_B no productive binding; complete seam unproven; host-crash unproven; restart false) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.14 LIVE_HANDOFF_CREATE_PRODUCTIVE_CAPTURE_OWNER_AND_LIFECYCLE_HOOK | Navigation-only historical §11.14 create productive capture-owner and lifecycle-hook persist (`PRODUCTIVE_CAPTURE_OWNER=SECTION_11_14_LIVE_PRODUCTIVE_CAPTURE_OWNER_V1`; `PRODUCTIVE_CAPTURE_OWNER_UNIQUE=true`; `PRODUCTIVE_LIFECYCLE_HOOK=run_capture_hook_after_bound_fill_before_restart_v1`; `PRODUCTIVE_LIFECYCLE_HOOK_UNIQUE=true`; `STRUCTURAL_RUNTIME_BINDING_PROVEN=true`; `CURRENT_RUNTIME_EXECUTION_AUTHORIZED=false`; `AUTHORIZED_RUNTIME_SURFACE=NONE`; `BINDING_CASE=CASE_A_CREATED`; `PRODUCTIVE_BINDING_IMPLEMENTED=true`; `COMPLETE_CAPTURE_SEAM=UNPROVEN`; `HOST_CRASH_DURABILITY=UNPROVEN`; `CONTEMPORANEOUS_PEAK_TRADE_PRE_RESTART_HANDOFF_OBSERVED=false`; `LIVE_RESTART_RECONSTRUCTED=false`; `IMPLEMENTATION_AUTHORIZED=true`; no GET; no POST; no productive handoff write during persist; no restart execution; successor `11.14.LIVE_HANDOFF_COMPLETE_CONTEMPORANEOUS_CAPTURE_SEAM_AND_REQUIRED_FIELD_PROVENANCE`; MOT not SSOT) |
| [`docs/ops/specs/SECTION_11_14_LIVE_HANDOFF_CREATE_PRODUCTIVE_CAPTURE_OWNER_AND_LIFECYCLE_HOOK_V1.md`](../ops/specs/SECTION_11_14_LIVE_HANDOFF_CREATE_PRODUCTIVE_CAPTURE_OWNER_AND_LIFECYCLE_HOOK_V1.md) | Derived historical §11.14 create productive capture-owner and lifecycle-hook spec (non-SSOT; unique owner created; unique hook created; structural binding proven; runtime execution unauthorized; complete seam unproven; host-crash unproven; restart false) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.14 LIVE_HANDOFF_COMPLETE_CONTEMPORANEOUS_CAPTURE_SEAM_AND_REQUIRED_FIELD_PROVENANCE | Navigation-only historical §11.14 complete contemporaneous capture-seam acceptance contract and required-field provenance persist (`COMPLETE_CAPTURE_SEAM=UNPROVEN`; `COMPLETE_CAPTURE_SEAM_ACCEPTANCE_CONTRACT_BOUND=true`; `REQUIRED_FIELD_PROVENANCE_MATRIX_BOUND=true`; `PROVEN_FAIL_CLOSED_FIELD_COUNT=5`; `PROVEN_COMPLETE_FIELD_COUNT=0`; `CONTEMPORANEOUS_PRODUCTIVE_CAPTURE_EXECUTED=false`; `STRUCTURAL_RUNTIME_BINDING_PROVEN=true`; `CURRENT_RUNTIME_EXECUTION_AUTHORIZED=false`; `AUTHORIZED_RUNTIME_SURFACE=NONE`; `PARTIAL_CAPTURE_ALLOWED=false`; `HOST_CRASH_DURABILITY=UNPROVEN`; `CONTEMPORANEOUS_PEAK_TRADE_PRE_RESTART_HANDOFF_OBSERVED=false`; `LIVE_RESTART_RECONSTRUCTED=false`; `IMPLEMENTATION_AUTHORIZED=true`; no GET; no POST; no productive capture executed; no restart execution; successor `11.14.LIVE_HANDOFF_PRODUCTIVE_CAPTURE_HOOK_CALLER_BINDING_AND_OFFLINE_CALL_PATH_PROOF`; MOT not SSOT) |
| [`docs/ops/specs/SECTION_11_14_LIVE_HANDOFF_COMPLETE_CONTEMPORANEOUS_CAPTURE_SEAM_AND_REQUIRED_FIELD_PROVENANCE_V1.md`](../ops/specs/SECTION_11_14_LIVE_HANDOFF_COMPLETE_CONTEMPORANEOUS_CAPTURE_SEAM_AND_REQUIRED_FIELD_PROVENANCE_V1.md) | Derived historical §11.14 complete contemporaneous capture-seam and required-field provenance spec (non-SSOT; acceptance contract bound; required-field provenance bound; complete seam unproven; no productive capture executed; host-crash unproven; restart false) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.14 LIVE_HANDOFF_PRODUCTIVE_CAPTURE_HOOK_CALLER_BINDING_AND_OFFLINE_CALL_PATH_PROOF | Navigation-only historical §11.14 unique productive capture-hook caller binding and offline call-path proof (`PRODUCTIVE_HOOK_CALLER=call_pre_restart_handoff_capture_after_bound_fill_v1`; `PRODUCTIVE_HOOK_CALLER_BINDING_PROVEN=true`; `PRODUCTIVE_CALL_PATH_OFFLINE_PROOF=true`; `PRODUCTIVE_LIFECYCLE_EVENT=REQUIRED_WINDOW_HANDOFF_COMMIT_AFTER_BOUND_FILL_BEFORE_RESTART`; `COMPLETE_CAPTURE_SEAM=UNPROVEN`; `PROVENANCE_VALIDATED_CONTEMPORANEOUS_NO_BACKFILL=false`; `CONTEMPORANEOUS_PRODUCTIVE_CAPTURE_EXECUTED=false`; `STRUCTURAL_RUNTIME_BINDING_PROVEN=true`; `CURRENT_RUNTIME_EXECUTION_AUTHORIZED=false`; `AUTHORIZED_RUNTIME_SURFACE=NONE`; `HOST_CRASH_DURABILITY=UNPROVEN`; `LIVE_RESTART_RECONSTRUCTED=false`; `IMPLEMENTATION_AUTHORIZED=true`; no GET; no POST; no productive capture executed; no restart execution; successor `11.14.LIVE_HANDOFF_COMPLETE_CAPTURE_SEAM_REQUIRED_FIELD_PROVENANCE_AND_NO_BACKFILL_CONTRACT`; MOT not SSOT) |
| [`docs/ops/specs/SECTION_11_14_LIVE_HANDOFF_PRODUCTIVE_CAPTURE_HOOK_CALLER_BINDING_AND_OFFLINE_CALL_PATH_PROOF_V1.md`](../ops/specs/SECTION_11_14_LIVE_HANDOFF_PRODUCTIVE_CAPTURE_HOOK_CALLER_BINDING_AND_OFFLINE_CALL_PATH_PROOF_V1.md) | Derived historical §11.14 productive capture-hook caller binding and offline call-path proof spec (non-SSOT; unique productive caller bound; offline call path proven; complete seam unproven; no productive capture executed; host-crash unproven; restart false) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.14 LIVE_HANDOFF_COMPLETE_CAPTURE_SEAM_REQUIRED_FIELD_PROVENANCE_AND_NO_BACKFILL_CONTRACT | Navigation-only historical §11.14 complete capture-seam required-field provenance and no-backfill contract (`COMPLETE_CAPTURE_SEAM=PROVEN` offline contract only; `REQUIRED_FIELD_PROVENANCE_COMPLETE=true`; `NO_BACKFILL_CONTRACT_PROVEN=true`; `PROVENANCE_VALIDATED_CONTEMPORANEOUS_NO_BACKFILL=true`; `LEGACY_READABLE_IS_NOT_CONTEMPORANEOUS_VALID=true`; `CONTEMPORANEOUS_PRODUCTIVE_CAPTURE_EXECUTED=false`; `STRUCTURAL_RUNTIME_BINDING_PROVEN=true`; `CURRENT_RUNTIME_EXECUTION_AUTHORIZED=false`; `AUTHORIZED_RUNTIME_SURFACE=NONE`; `HOST_CRASH_DURABILITY=UNPROVEN`; `LIVE_RESTART_RECONSTRUCTED=false`; `IMPLEMENTATION_AUTHORIZED=true`; no GET; no POST; no productive capture executed; no restart execution; successor `11.14.LIVE_HANDOFF_CONTEMPORANEOUS_CAPTURE_RUNTIME_SURFACE_AND_NON_EXECUTION_AUTHORIZATION_BOUNDARY`; MOT not SSOT) |
| [`docs/ops/specs/SECTION_11_14_LIVE_HANDOFF_COMPLETE_CAPTURE_SEAM_REQUIRED_FIELD_PROVENANCE_AND_NO_BACKFILL_CONTRACT_V1.md`](../ops/specs/SECTION_11_14_LIVE_HANDOFF_COMPLETE_CAPTURE_SEAM_REQUIRED_FIELD_PROVENANCE_AND_NO_BACKFILL_CONTRACT_V1.md) | Derived historical §11.14 complete capture-seam required-field provenance and no-backfill contract spec (non-SSOT; complete seam proven offline; required-field provenance complete; no-backfill proven; no productive capture executed; host-crash unproven; restart false) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.14 LIVE_HANDOFF_CONTEMPORANEOUS_CAPTURE_RUNTIME_SURFACE_AND_NON_EXECUTION_AUTHORIZATION_BOUNDARY | Navigation-only historical §11.14 contemporaneous capture runtime surface and non-execution authorization boundary (`CONTEMPORANEOUS_CAPTURE_RUNTIME_SURFACE=PROVEN`; `CONTEMPORANEOUS_CAPTURE_SIDE_EFFECT_BOUNDARY=PROVEN`; `CONTEMPORANEOUS_CAPTURE_CAN_BE_ISOLATED_FROM_LIVE_EXECUTION=false`; `CONTEMPORANEOUS_CAPTURE_EXECUTION_PRECONDITIONS_COMPLETE=true`; `MINIMAL_FUTURE_AUTHORIZED_ENTRYPOINT=NONE_CAPTURE_ONLY`; `UNAVOIDABLE_EXTERNAL_EFFECTS=LIVE_IDENTITY_BOUND_VENUE_FILL`; `COMPLETE_CAPTURE_SEAM=PROVEN`; `PROVENANCE_VALIDATED_CONTEMPORANEOUS_NO_BACKFILL=true`; `CONTEMPORANEOUS_PRODUCTIVE_CAPTURE_EXECUTED=false`; `CURRENT_RUNTIME_EXECUTION_AUTHORIZED=false`; `AUTHORIZED_RUNTIME_SURFACE=NONE`; `HOST_CRASH_DURABILITY=UNPROVEN`; `LIVE_RESTART_RECONSTRUCTED=false`; `IMPLEMENTATION_AUTHORIZED=true`; no GET; no POST; no productive capture executed; no restart execution; successor `11.14.LIVE_HANDOFF_CONTEMPORANEOUS_PRE_RESTART_CAPTURE_OBSERVATION_AND_NON_EXECUTION_PROOF`; MOT not SSOT) |
| [`docs/ops/specs/SECTION_11_14_LIVE_HANDOFF_CONTEMPORANEOUS_CAPTURE_RUNTIME_SURFACE_AND_NON_EXECUTION_AUTHORIZATION_BOUNDARY_V1.md`](../ops/specs/SECTION_11_14_LIVE_HANDOFF_CONTEMPORANEOUS_CAPTURE_RUNTIME_SURFACE_AND_NON_EXECUTION_AUTHORIZATION_BOUNDARY_V1.md) | Derived historical §11.14 contemporaneous capture runtime surface and non-execution authorization boundary spec (non-SSOT; runtime surface proven; isolation from live execution false; no productive capture executed; host-crash unproven; restart false) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.14 LIVE_HANDOFF_CONTEMPORANEOUS_PRE_RESTART_CAPTURE_OBSERVATION_AND_NON_EXECUTION_PROOF | Navigation-only historical §11.14 contemporaneous PRE-RESTART capture observation and non-execution proof (`CONTEMPORANEOUS_PRE_RESTART_CAPTURE_OBSERVATION=NOT_EXECUTED`; `CONTEMPORANEOUS_CAPTURE_CAN_BE_ISOLATED_FROM_LIVE_EXECUTION=false`; `AUTHORIZATION_MATRIX_STATUS=COMPLETE`; `NON_CAPTURE_SIDE_EFFECTS_AUTHORIZED=false`; `CONTEMPORANEOUS_PRODUCTIVE_CAPTURE_EXECUTED=false`; `BACKFILL_USED=false`; `RETROACTIVE_SYNTHESIS_USED=false`; `OWNER_GO_IS_NOT_GATE_BYPASS=true`; `CURRENT_RUNTIME_EXECUTION_AUTHORIZED=false`; `AUTHORIZED_RUNTIME_SURFACE=NONE`; `HOST_CRASH_DURABILITY=UNPROVEN`; `LIVE_RESTART_RECONSTRUCTED=false`; `IMPLEMENTATION_AUTHORIZED=true`; no GET; no POST; no productive capture executed; no restart execution; successor `11.14.LIVE_HANDOFF_LIVE_IDENTITY_BOUND_VENUE_FILL_READINESS_AND_EXACT_EXECUTION_CONTRACT`; MOT not SSOT) |
| [`docs/ops/specs/SECTION_11_14_LIVE_HANDOFF_CONTEMPORANEOUS_PRE_RESTART_CAPTURE_OBSERVATION_AND_NON_EXECUTION_PROOF_V1.md`](../ops/specs/SECTION_11_14_LIVE_HANDOFF_CONTEMPORANEOUS_PRE_RESTART_CAPTURE_OBSERVATION_AND_NON_EXECUTION_PROOF_V1.md) | Derived historical §11.14 contemporaneous PRE-RESTART capture observation and non-execution proof spec (non-SSOT; observation not executed; isolation from live execution false; no productive capture executed; host-crash unproven; restart false) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.14 LIVE_HANDOFF_LIVE_IDENTITY_BOUND_VENUE_FILL_READINESS_AND_EXACT_EXECUTION_CONTRACT | Navigation-only historical §11.14 LIVE_IDENTITY_BOUND_VENUE_FILL readiness and exact execution contract (`LIVE_FILL_READINESS_MATRIX_STATUS=COMPLETE`; `LIVE_FILL_READINESS=false`; `MINIMAL_ECONOMIC_ACTION_CONTRACT_STATUS=BLOCKED`; `LIVE_FILL_EXECUTION_AUTHORIZED=false`; `LIVE_FILL_EXECUTED=false`; `CONTEMPORANEOUS_PRE_RESTART_CAPTURE_OBSERVATION=NOT_EXECUTED`; `CONTEMPORANEOUS_PRODUCTIVE_CAPTURE_EXECUTED=false`; `OWNER_GO_IS_NOT_GATE_BYPASS=true`; `CURRENT_RUNTIME_EXECUTION_AUTHORIZED=false`; `AUTHORIZED_RUNTIME_SURFACE=NONE`; `HOST_CRASH_DURABILITY=UNPROVEN`; `LIVE_RESTART_RECONSTRUCTED=false`; `IMPLEMENTATION_AUTHORIZED=true`; no GET; no POST; no submit; no wire send; no position mutation; no restart execution; successor `11.14.LIVE_HANDOFF_EXACT_SINGLE_LIVE_IDENTITY_BOUND_VENUE_FILL_THEN_CONTEMPORANEOUS_PRE_RESTART_CAPTURE`; MOT not SSOT) |
| [`docs/ops/specs/SECTION_11_14_LIVE_HANDOFF_LIVE_IDENTITY_BOUND_VENUE_FILL_READINESS_AND_EXACT_EXECUTION_CONTRACT_V1.md`](../ops/specs/SECTION_11_14_LIVE_HANDOFF_LIVE_IDENTITY_BOUND_VENUE_FILL_READINESS_AND_EXACT_EXECUTION_CONTRACT_V1.md) | Derived historical §11.14 LIVE_IDENTITY_BOUND_VENUE_FILL readiness and exact execution contract spec (non-SSOT; readiness matrix complete; live fill readiness false; economic contract blocked; no execution; host-crash unproven; restart false) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.14 LIVE_HANDOFF_EXACT_SINGLE_LIVE_IDENTITY_BOUND_VENUE_FILL_THEN_CONTEMPORANEOUS_PRE_RESTART_CAPTURE | Navigation-only historical §11.14 exact-single identity-bound venue-fill then contemporaneous PRE-RESTART capture (`TERMINAL_STATE=CODE_GAP_FOUND`; `CODE_CHANGE_REQUIRED=true`; `LIVE_FILL_READINESS=false`; `EXACT_ECONOMIC_ACTION_CONTRACT_STATUS=BLOCKED`; `LIVE_SUBMIT_EXECUTED=false`; `WIRE_SEND_EXECUTED=false`; `POSITION_MUTATION_EXECUTED=false`; `CONTEMPORANEOUS_PRODUCTIVE_CAPTURE_EXECUTED=false`; `OWNER_GO_IS_NOT_GATE_BYPASS=true`; `CURRENT_RUNTIME_EXECUTION_AUTHORIZED=false`; `AUTHORIZED_RUNTIME_SURFACE=NONE`; `HOST_CRASH_DURABILITY=UNPROVEN`; `LIVE_RESTART_RECONSTRUCTED=false`; `IMPLEMENTATION_AUTHORIZED=true`; no GET; no POST; no submit; no wire send; no position mutation; no restart execution; repair merge not authorized; `OWNER_GO_FOR_LIVE_RESTART_RECONSTRUCTED` remains §11.14 evidence-domain only; successor `11.14.LIVE_HANDOFF_STANDING_FEE_SLIPPAGE_AND_COMPLETE_NON_EXECUTING_EXACT_SINGLE_FILL_EXECUTION_ENVELOPE`; MOT not SSOT) |
| [`docs/ops/specs/SECTION_11_14_LIVE_HANDOFF_EXACT_SINGLE_LIVE_IDENTITY_BOUND_VENUE_FILL_THEN_CONTEMPORANEOUS_PRE_RESTART_CAPTURE_V1.md`](../ops/specs/SECTION_11_14_LIVE_HANDOFF_EXACT_SINGLE_LIVE_IDENTITY_BOUND_VENUE_FILL_THEN_CONTEMPORANEOUS_PRE_RESTART_CAPTURE_V1.md) | Derived historical §11.14 exact-single identity-bound venue-fill then contemporaneous PRE-RESTART capture spec (non-SSOT; code-gap found; invocation-scoped capture seam repaired; live fill readiness false; economic contract blocked; no execution; host-crash unproven; restart false) |
| [`docs/ops/specs/SECTION_11_14_LIVE_HANDOFF_CURRENT_ORIGIN_MAIN_BOUND_GET_ONLY_PRETRADE_ACCOUNT_NETWORK_AND_INSTRUMENT_READINESS_V1.md`](../ops/specs/SECTION_11_14_LIVE_HANDOFF_CURRENT_ORIGIN_MAIN_BOUND_GET_ONLY_PRETRADE_ACCOUNT_NETWORK_AND_INSTRUMENT_READINESS_V1.md) | Derived §11.14 current-origin/main bound GET-only pretrade readiness spec (non-SSOT; GET-only; no POST; no submit; no Owner-GO consumption; no Live/canary arming mutation; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.14 LIVE_HANDOFF_STANDING_FEE_SLIPPAGE_AND_COMPLETE_NON_EXECUTING_EXACT_SINGLE_FILL_EXECUTION_ENVELOPE | Navigation-only historical §11.14 standing fee/slippage bind and non-executing exact execution envelope (`CURRENT_STANDING_FEE_POLICY_BOUND=true`; `CURRENT_STANDING_SLIPPAGE_POLICY_BOUND=true`; `OWNER_EXECUTION_AUTHORIZED=false`; `LIVE_EXECUTION_AUTHORIZED=false`; `LIVE_SUBMIT_EXECUTED=false`; `WIRE_SEND_EXECUTED=false`; `POSITION_MUTATION_EXECUTED=false`; `CONTEMPORANEOUS_PRODUCTIVE_CAPTURE_EXECUTED=false`; `RESTART_EXECUTED=false`; `LIVE_FILL_READINESS=false`; `EARLIEST_UNRESOLVED_DEPENDENCY=OWNER_EXECUTION_AUTHORIZED`; no POST; no submit; no wire send; no restart execution; successor `11.14.LIVE_HANDOFF_EXACT_FEE_RESTART_DURABILITY_AND_PRE_EXECUTION_READINESS_CLOSURE`; MOT not SSOT) |
| [`docs/ops/specs/SECTION_11_14_LIVE_HANDOFF_STANDING_FEE_SLIPPAGE_AND_COMPLETE_NON_EXECUTING_EXACT_SINGLE_FILL_EXECUTION_ENVELOPE_V1.md`](../ops/specs/SECTION_11_14_LIVE_HANDOFF_STANDING_FEE_SLIPPAGE_AND_COMPLETE_NON_EXECUTING_EXACT_SINGLE_FILL_EXECUTION_ENVELOPE_V1.md) | Derived historical §11.14 standing fee/slippage and non-executing exact execution envelope spec (non-SSOT; standing policies bound; technical envelope may complete; Owner/Live execution remain false; no POST; no submit) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.14 LIVE_HANDOFF_EXACT_FEE_RESTART_DURABILITY_AND_PRE_EXECUTION_READINESS_CLOSURE | Navigation-only historical §11.14 exact-fee / restart / durability / pre-execution-readiness forensic closure (`EXACT_OKX_FEE_FORMULA_UNPROVEN=true`; `BOUNDED_FEE_ENVELOPE_PROVEN=false`; `LIVE_RESTART_STATIC_RECONSTRUCTION_PROVEN=true`; `LIVE_RESTART_EMPIRICAL_RECONSTRUCTION_PROVEN=false`; `LIVE_RESTART_RECONSTRUCTED=false`; `HOST_CRASH_DURABILITY=UNPROVEN`; `TECHNICAL_PRE_EXECUTION_READINESS=false`; `OWNER_EXECUTION_AUTHORIZED=false`; `CANARY_AUTHORIZED_EXACT_FIELD=INDETERMINATE_ABSENT`; `POST_ALLOWED_EXACT_FIELD=INDETERMINATE_ABSENT`; no GET; no POST; no submit; no restart execution; no crash test; successor `11.14.CURRENT_ORIGIN_MAIN_8605BF_GET_ONLY_TRADE_FEE_AND_STALE_PRETRADE_PREDICATE_REFRESH`; MOT not SSOT) |
| [`docs/ops/specs/SECTION_11_14_LIVE_HANDOFF_EXACT_FEE_RESTART_DURABILITY_AND_PRE_EXECUTION_READINESS_CLOSURE_V1.md`](../ops/specs/SECTION_11_14_LIVE_HANDOFF_EXACT_FEE_RESTART_DURABILITY_AND_PRE_EXECUTION_READINESS_CLOSURE_V1.md) | Derived historical §11.14 exact-fee / restart / durability / pre-execution-readiness forensic closure spec (non-SSOT; exact formula unproven; bounded numeric envelope unproven; static restart fail-closed proven; empirical restart false; host-crash unproven; Owner execution false; no GET; no POST) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.14 CURRENT_ORIGIN_MAIN_8605BF_GET_ONLY_TRADE_FEE_AND_STALE_PRETRADE_PREDICATE_REFRESH | Navigation-only historical §11.14 GET-only SUI trade-fee and stale pretrade refresh (`GET_PERFORMED=true`; `TRADE_FEE_GET_PERFORMED=true`; `TRADE_FEE_OKX_CODE=0`; `CURRENT_ACCOUNT_FEE_RATE_OBSERVED=true`; `BOUNDED_FEE_ENVELOPE_CURRENT_NUMERIC_PROVEN=true`; `EXACT_OKX_FEE_FORMULA_UNPROVEN=true`; `TECHNICAL_PRE_EXECUTION_READINESS=true`; `OWNER_EXECUTION_AUTHORIZED=false`; GET-only; no POST; no submit; no restart; no crash test; successor `11.14.LIVE_HANDOFF_EXACT_SINGLE_LIVE_FILL_REQUIRES_SEPARATE_OWNER_EXECUTION_GO`; MOT not SSOT) |
| [`docs/ops/specs/SECTION_11_14_CURRENT_ORIGIN_MAIN_8605BF_GET_ONLY_TRADE_FEE_AND_STALE_PRETRADE_PREDICATE_REFRESH_V1.md`](../ops/specs/SECTION_11_14_CURRENT_ORIGIN_MAIN_8605BF_GET_ONLY_TRADE_FEE_AND_STALE_PRETRADE_PREDICATE_REFRESH_V1.md) | Derived historical §11.14 current-origin/main GET-only trade-fee and stale pretrade refresh spec (non-SSOT; GET-only; current SUI family rates observed; OEM formula unproven; technical pre-execution true; Owner execution false; no POST) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.14 LIVE_HANDOFF_EXACT_SINGLE_LIVE_FILL_REQUIRES_SEPARATE_OWNER_EXECUTION_GO | Navigation-only historical §11.14 exact-single live fill Owner Execution GO consumption (`OWNER_EXECUTION_GO_STATUS=CONSUMED_NO_SUBMIT`; `GET_PERFORMED=true`; `pos=1` observed not flat; `MAX_POSITIONS_GATE_PASS=false`; `EXECUTION_DECISION=NO_EXECUTION`; `SUBMIT_ATTEMPT_COUNT=0`; `LIVE_SUBMIT_EXECUTED=false`; `OWNER_EXECUTION_AUTHORIZED=false`; no POST; no flatten; no restart; successor `11.14.CURRENT_SUI_XPERP_POS_1_FLATTEN_AUTHORITY_AND_PRE_EXECUTION_REPAIR`; MOT not SSOT) |
| [`docs/ops/specs/SECTION_11_14_LIVE_HANDOFF_EXACT_SINGLE_LIVE_FILL_REQUIRES_SEPARATE_OWNER_EXECUTION_GO_V1.md`](../ops/specs/SECTION_11_14_LIVE_HANDOFF_EXACT_SINGLE_LIVE_FILL_REQUIRES_SEPARATE_OWNER_EXECUTION_GO_V1.md) | Derived historical §11.14 exact-single live fill Owner Execution GO spec (non-SSOT; GO consumed no-submit; pos=1 blocked canary ENTRY; no POST; no standing Live-gate mutation) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.14 CURRENT_SUI_XPERP_POS_1_FLATTEN_AUTHORITY_AND_PRE_EXECUTION_REPAIR | Navigation-only current §11.14 flatten authority and pre-execution repair (`FLATTEN_GO_CONTRACT_DEFINED=true`; `OWNER_FLATTEN_GO_PRESENT=false`; `FLATTEN_AUTHORIZED=false`; `OWNER_EXECUTION_AUTHORIZED=false`; GET-only SELL preflight; current-SHA wrapper fail-closed; no POST; no flatten; `VENUE_REDUCE_ONLY_NO_FLIP=UNPROVEN`; `HOST_CRASH_DURABILITY=UNPROVEN`; MOT not SSOT) |
| [`docs/ops/specs/SECTION_11_14_CURRENT_SUI_XPERP_POS_1_FLATTEN_AUTHORITY_AND_PRE_EXECUTION_REPAIR_V1.md`](../ops/specs/SECTION_11_14_CURRENT_SUI_XPERP_POS_1_FLATTEN_AUTHORITY_AND_PRE_EXECUTION_REPAIR_V1.md) | Derived §11.14 current pos=1 flatten authority and pre-execution repair spec (non-SSOT; Flatten-GO schema only; no token issued; GET-only SELL; no POST; no flatten) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.14 PRODUCTIVE_WIRE_SEND_OWNER_CONTRACT_AND_ORCHESTRATOR_SPEC | Navigation-only historical §11.14 productive wire-send Owner contract and orchestrator spec (`OWNER_PRODUCTIVE_WIRE_SEND_AUTHORITY_V1` defined; persist `ISSUED=false`; orchestrator not implemented in that persist; successor `11.14.PRODUCTIVE_SEND_ORCHESTRATOR_AND_SEND_CAPABLE_BIND_IMPLEMENTATION`; MOT not SSOT) |
| [`docs/ops/specs/SECTION_11_14_PRODUCTIVE_WIRE_SEND_OWNER_CONTRACT_AND_ORCHESTRATOR_SPEC_V1.md`](../ops/specs/SECTION_11_14_PRODUCTIVE_WIRE_SEND_OWNER_CONTRACT_AND_ORCHESTRATOR_SPEC_V1.md) | Derived §11.14 productive wire-send Owner contract and orchestrator spec (non-SSOT; schema only; not issued; no producer; no send; no POST) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.14 PRODUCTIVE_SEND_ORCHESTRATOR_AND_SEND_CAPABLE_BIND_IMPLEMENTATION | Navigation-only historical §11.14 productive send orchestrator and send-capable bind implementation (`verify_owner_productive_wire_send_authority_v1` implemented; `ProductiveWireSendOrchestratorV1` implemented; `ProductiveTransportBindSendCapableV1` implemented; `ProductiveFlattenSubmitSendAdapterV1` implemented; NO_SEND adapter unchanged; no POST; no inner.send; historical `CURRENT_CANONICAL_BOUNDARY=PRODUCTIVE_NETWORK_SESSION_NOT_AUTHORIZED`; successor `11.14.NETWORK_SESSION_AUTHORIZED_INSTANCE_FLAG`; MOT not SSOT) |
| [`docs/ops/specs/SECTION_11_14_PRODUCTIVE_SEND_ORCHESTRATOR_AND_SEND_CAPABLE_BIND_IMPLEMENTATION_V1.md`](../ops/specs/SECTION_11_14_PRODUCTIVE_SEND_ORCHESTRATOR_AND_SEND_CAPABLE_BIND_IMPLEMENTATION_V1.md) | Derived historical §11.14 productive send orchestrator and send-capable bind implementation spec (non-SSOT; evaluator/orchestrator/bind/adapter implemented; no arming; no GET; no POST; no inner.send) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.14 NETWORK_SESSION_AUTHORIZED_INSTANCE_FLAG | Navigation-only historical §11.14 network_session_authorized instance-flag seam (`authorize_network_session_instance_v1` implemented; issued ≠ authorized; bind-level flag remains false; NO_SEND adapter unchanged; no arming in that persist; no GET; no POST; no inner.send; historical `CURRENT_CANONICAL_BOUNDARY=SESSION_NOT_ARMED`; successor `11.14.SESSION_ARMING`; MOT not SSOT) |
| [`docs/ops/specs/SECTION_11_14_NETWORK_SESSION_AUTHORIZED_INSTANCE_FLAG_V1.md`](../ops/specs/SECTION_11_14_NETWORK_SESSION_AUTHORIZED_INSTANCE_FLAG_V1.md) | Derived historical §11.14 network_session_authorized instance-flag spec (non-SSOT; instance-flag seam only; no arming; no GET; no POST; no inner.send) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.14 SESSION_ARMING | Navigation-only historical §11.14 bound session-arming seam (`arm_productive_session_v1` implemented; `SESSION_ARMING_STANDING` remains false; no send_permitted in that persist; NO_SEND adapter unchanged; no GET; no POST; no inner.send; historical `CURRENT_CANONICAL_BOUNDARY=SEND_PERMITTED_FALSE`; successor `11.14.SEND_PERMITTED`; MOT not SSOT) |
| [`docs/ops/specs/SECTION_11_14_SESSION_ARMING_V1.md`](../ops/specs/SECTION_11_14_SESSION_ARMING_V1.md) | Derived historical §11.14 bound session-arming spec (non-SSOT; adapter.session_armed seam only; no send_permitted; no GET; no POST; no inner.send) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.14 SEND_PERMITTED | Navigation-only historical §11.14 bound send_permitted seam (`permit_productive_send_v1` implemented; bind-level send_permitted remains false; NO_SEND adapter unchanged; no GET; no POST; no inner.send in that persist; historical `CURRENT_CANONICAL_BOUNDARY=INNER_SEND_NOT_INVOKED_IN_THIS_IMPLEMENTATION`; successor `11.14.INNER_SEND_INVOCATION_SEAM`; MOT not SSOT) |
| [`docs/ops/specs/SECTION_11_14_SEND_PERMITTED_V1.md`](../ops/specs/SECTION_11_14_SEND_PERMITTED_V1.md) | Derived historical §11.14 bound send_permitted spec (non-SSOT; adapter.send_permitted seam only; no inner.send; no GET; no POST) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.14 INNER_SEND_INVOCATION_SEAM | Navigation-only historical §11.14 fake inner.send invocation seam (`post` → `LiveCanaryHttpRequestV1` → `RecordingFakeProductiveSendInnerV1.send`; productive transport send refused in that persist; NO_SEND adapter unchanged; no GET; no HTTP POST; historical `CURRENT_CANONICAL_BOUNDARY=PRODUCTIVE_INNER_SEND_EXECUTION_NOT_AUTHORIZED`; successor `11.14.PRODUCTIVE_INNER_SEND_FAIL_CLOSED_RECEIPT_BOUNDARY`; MOT not SSOT) |
| [`docs/ops/specs/SECTION_11_14_INNER_SEND_INVOCATION_SEAM_V1.md`](../ops/specs/SECTION_11_14_INNER_SEND_INVOCATION_SEAM_V1.md) | Derived historical §11.14 fake inner.send invocation-seam spec (non-SSOT; fake send only; no productive inner.send in that persist; no GET; no POST) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.14 PRODUCTIVE_INNER_SEND_FAIL_CLOSED_RECEIPT_BOUNDARY | Navigation-only historical §11.14 productive inner.send fail-closed receipt boundary (`AuthenticatedGatedProductiveFlattenTransportV1.send` invoked; `FIRST_DENY=RECEIPT_MISSING`; no GET; no HTTP POST; no HMAC mint; no receipt mint; historical `CURRENT_CANONICAL_BOUNDARY=RECEIPT_MISSING`; successor `11.14.FLATTEN_PRE_SEND_RECEIPT_AUTHORITY_AND_BINDING`; MOT not SSOT) |
| [`docs/ops/specs/SECTION_11_14_PRODUCTIVE_INNER_SEND_FAIL_CLOSED_RECEIPT_BOUNDARY_V1.md`](../ops/specs/SECTION_11_14_PRODUCTIVE_INNER_SEND_FAIL_CLOSED_RECEIPT_BOUNDARY_V1.md) | Derived historical §11.14 productive inner.send fail-closed receipt-boundary spec (non-SSOT; productive send invoked; `RECEIPT_MISSING`; no GET; no POST) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.14 FLATTEN_PRE_SEND_RECEIPT_AUTHORITY_AND_BINDING | Navigation-only historical §11.14 flatten pre-send receipt authority adjudication (`RECEIPT_AUTHORITY_SCHEMA_STATUS=DEFINED`; producer/consumer match; `RECEIPT_MINTED=false`; historical `OPEN_GATE_ORDER_BLOCKER=FRESH_PRE_SUBMIT_GET`; historical `CURRENT_CANONICAL_BOUNDARY=RECEIPT_MISSING`; no GET in that persist; successor `11.14.FRESH_PRE_SUBMIT_GET_AND_FRESHNESS_ADJUDICATION`; MOT not SSOT) |
| [`docs/ops/specs/SECTION_11_14_FLATTEN_PRE_SEND_RECEIPT_AUTHORITY_AND_BINDING_V1.md`](../ops/specs/SECTION_11_14_FLATTEN_PRE_SEND_RECEIPT_AUTHORITY_AND_BINDING_V1.md) | Derived historical §11.14 flatten pre-send receipt authority spec (non-SSOT; schema defined; mint blocked by open gate order; no GET in that persist; no POST) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.14 FRESH_PRE_SUBMIT_GET_AND_FRESHNESS_ADJUDICATION | Navigation-only historical §11.14 Fresh Pre-Submit GET and freshness adjudication (`GET_PERFORMED=true`; `GET_CALL_COUNT=4`; historical `POSITION_VALUE=1`; historical `QUOTE_BID=0.8121`; historical `ENVELOPE_FRESHNESS_STATUS=REPRICE_REQUIRED`; historical `REPRICE_EXECUTED=false`; `RECEIPT_ATTACHED=false`; historical `CURRENT_CANONICAL_BOUNDARY=RECEIPT_MISSING`; historical `NEXT_OWNER_AUTHORITY_REQUIRED=ENVELOPE_REPRICE_OR_FRESHNESS_AT_SEND`; no POST; no HMAC POST; MOT not SSOT) |
| [`docs/ops/specs/SECTION_11_14_FRESH_PRE_SUBMIT_GET_AND_FRESHNESS_ADJUDICATION_V1.md`](../ops/specs/SECTION_11_14_FRESH_PRE_SUBMIT_GET_AND_FRESHNESS_ADJUDICATION_V1.md) | Derived historical §11.14 Fresh Pre-Submit GET and freshness spec (non-SSOT; four required GETs; reprice required not executed in that persist; no POST) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.14 ENVELOPE_REPRICE_OR_FRESHNESS_AT_SEND | Navigation-only historical §11.14 envelope reprice or freshness-at-send (`GET_PERFORMED=true`; `GET_CALL_COUNT=7`; historical `POSITION_VALUE=1`; historical `QUOTE_BID=0.8185`; historical `COMPUTED_LIMIT_PX=0.8185`; historical `OLD_LIMIT_PRICE=0.8343`; historical `NEW_LIMIT_PRICE=0.8185`; historical `NEW_ENVELOPE_ID=0a0133a3b82e4a15bf6986605a9a8e6b47b22665b485ff0f570200803f21cdbe`; historical `REPRICE_EXECUTED=true`; historical `ENVELOPE_REBUILD_EXECUTED=true`; historical `ENVELOPE_FRESHNESS_STATUS_AFTER=VALID_WITH_FRESH_GET`; `RECEIPT_ATTACHED=false`; historical `CURRENT_CANONICAL_BOUNDARY=RECEIPT_MISSING`; historical `NEXT_OWNER_AUTHORITY_REQUIRED=RECEIPT_HMAC_VS_WIRE_SEND_AUTHORITY_ORDER`; no POST; no HMAC POST; MOT not SSOT) |
| [`docs/ops/specs/SECTION_11_14_ENVELOPE_REPRICE_OR_FRESHNESS_AT_SEND_V1.md`](../ops/specs/SECTION_11_14_ENVELOPE_REPRICE_OR_FRESHNESS_AT_SEND_V1.md) | Derived historical §11.14 envelope reprice or freshness-at-send spec (non-SSOT; seven producer GETs; envelope rebuilt in that persist; no POST) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.14 RECEIPT_HMAC_VS_WIRE_SEND_AUTHORITY_ORDER | Navigation-only historical §11.14 receipt/HMAC vs wire-send-authority order (`Q1_CANONICAL=YES`; `Q2_CANONICAL=NO`; `Q3_CANONICAL=INNER_REPAIR_REQUIRED`; `HMAC_GENERATION_WIRED=false`; `RUNTIME_RECEIPT_MINT_EXECUTED=false`; `RUNTIME_HMAC_EXECUTED=false`; `INNER_REPAIR_IMPLEMENTED=true`; `LEASE_CONSUME_AFTER_LOCAL_PREWIRE_GATES=true`; historical `CURRENT_CANONICAL_BOUNDARY=RECEIPT_MISSING`; historical `NEXT_OWNER_AUTHORITY_REQUIRED=DURABLE_CONSUME_SUCCESS_OBJECT`; no POST; no HMAC generation; no receipt mint; MOT not SSOT) |
| [`docs/ops/specs/SECTION_11_14_RECEIPT_HMAC_VS_WIRE_SEND_AUTHORITY_ORDER_V1.md`](../ops/specs/SECTION_11_14_RECEIPT_HMAC_VS_WIRE_SEND_AUTHORITY_ORDER_V1.md) | Derived historical §11.14 receipt/HMAC vs wire-send-authority order spec (non-SSOT; order decided; inner lease repaired; no POST) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.14 DURABLE_CONSUME_SUCCESS_OBJECT | Navigation-only historical §11.14 durable-consume success object (`DURABLE_CONSUME_SUCCESS_OBJECT=PROVEN`; `SUCCESS_OBJECT_TYPE=FlattenProductiveSendSuccessObjectV1`; `DURABLE_CONSUME_GATED_ON_SUCCESS_OBJECT=true`; historical `CURRENT_CANONICAL_BOUNDARY=RECEIPT_MISSING`; historical `NEXT_OWNER_AUTHORITY_REQUIRED=RECEIPT_MISSING`; no POST; no HMAC generation; no receipt mint in that persist; successor `11.14.RECEIPT_MISSING`; MOT not SSOT) |
| [`docs/ops/specs/SECTION_11_14_DURABLE_CONSUME_SUCCESS_OBJECT_V1.md`](../ops/specs/SECTION_11_14_DURABLE_CONSUME_SUCCESS_OBJECT_V1.md) | Derived historical §11.14 durable-consume success-object spec (non-SSOT; typed success object; COMPLETED consume gated; no POST) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.14 RECEIPT_MISSING | Navigation-only historical §11.14 attachable pre-send receipt mint (`RECEIPT_MISSING=PROVEN`; `RUNTIME_RECEIPT_MINT_EXECUTED=true`; `FIRST_DENY_AFTER_ATTACHED_RECEIPT=UNSIGNED_PRODUCTIVE_HEADERS`; historical `CURRENT_CANONICAL_BOUNDARY=UNSIGNED_PRODUCTIVE_HEADERS`; historical `NEXT_OWNER_AUTHORITY_REQUIRED=HMAC_GENERATION`; no HMAC generation in that persist; successor `11.14.HMAC_GENERATION`; MOT not SSOT) |
| [`docs/ops/specs/SECTION_11_14_RECEIPT_MISSING_V1.md`](../ops/specs/SECTION_11_14_RECEIPT_MISSING_V1.md) | Derived historical §11.14 RECEIPT_MISSING spec (non-SSOT; attachable mint; one-shot attach; unsigned headers deny; no POST) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.14 HMAC_GENERATION | Navigation-only historical §11.14 typed HMAC/header artifact (`HMAC_GENERATION=PROVEN`; `HMAC_GENERATION_WIRED=true`; `HMAC_GENERATION_ON_SEND_PATH=false`; `FIRST_DENY_AFTER_HMAC_SIGNED_SEND=PRODUCTIVE_NETWORK_SESSION_NOT_AUTHORIZED`; historical `CURRENT_CANONICAL_BOUNDARY=PRODUCTIVE_NETWORK_SESSION_NOT_AUTHORIZED`; historical `NEXT_OWNER_AUTHORITY_REQUIRED=PRODUCTIVE_NETWORK_SESSION_NOT_AUTHORIZED`; successor `11.14.PRODUCTIVE_NETWORK_SESSION_NOT_AUTHORIZED`; no GET; no POST; MOT not SSOT) |
| [`docs/ops/specs/SECTION_11_14_HMAC_GENERATION_V1.md`](../ops/specs/SECTION_11_14_HMAC_GENERATION_V1.md) | Derived historical §11.14 HMAC_GENERATION spec (non-SSOT; typed HMAC artifact; verify not consume; no POST) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.14 PRODUCTIVE_NETWORK_SESSION_NOT_AUTHORIZED | Navigation-only current §11.14 HMAC-signed Owner network-session bind (`PRODUCTIVE_NETWORK_SESSION_NOT_AUTHORIZED=PROVEN_BOUND`; `HMAC_SIGNED_NETWORK_SESSION_BIND_IMPLEMENTED=true`; `NETWORK_SESSION_HOST_BINDING=eea.okx.com`; `CURRENT_CANONICAL_BOUNDARY=SEND_LEASE_NOT_CONSUMED`; `NEXT_OWNER_AUTHORITY_REQUIRED=WIRE_SEND`; no GET; no POST; no lease consume; MOT not SSOT) |
| [`docs/ops/specs/SECTION_11_14_PRODUCTIVE_NETWORK_SESSION_NOT_AUTHORIZED_V1.md`](../ops/specs/SECTION_11_14_PRODUCTIVE_NETWORK_SESSION_NOT_AUTHORIZED_V1.md) | Derived §11.14 PRODUCTIVE_NETWORK_SESSION_NOT_AUTHORIZED spec (non-SSOT; HMAC-path session bind; verify not consume; no POST) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.14 PRE_LEASE_DDO_OBSERVATION | Navigation-only additive §11.14 observation-only DDO pre-lease send-intent bind (`DDO_OBSERVATION_ONLY=true`; `PRE_LEASE_DDO_OBSERVATION_IMPLEMENTED=true`; `PRE_LEASE_DDO_OBSERVATION_SEAM=section_11_14.flatten_pre_lease_send_intent`; `CURRENT_CANONICAL_BOUNDARY=SEND_LEASE_NOT_CONSUMED`; `EARLIEST_UNRESOLVED_RUNTIME_GATE=SEND_LEASE_CONSUME`; no GET; no POST; no lease consume; MOT not SSOT) |
| [`docs/ops/specs/SECTION_11_14_PRE_LEASE_DDO_OBSERVATION_V1.md`](../ops/specs/SECTION_11_14_PRE_LEASE_DDO_OBSERVATION_V1.md) | Derived §11.14 PRE_LEASE_DDO_OBSERVATION spec (non-SSOT; observation-only pre-lease DDO hook; no POST; no durable ledger bind) |
...
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.2 TREASURY_PHASE_1_OFFLINE_CONTRACTS | Navigation-only pointer to Treasury Phase-1 offline contracts (`TREASURY_PHASE_1_STATUS=CLOSED_OFFLINE_CONTRACTS`; `TREASURY_PHASE_2_STATUS=NOT_STARTED`; `VENUE_IDEMPOTENCY_GUARANTEE=NOT_PROVEN`; `PL_TF_002_STATUS=FROZEN_PENDING_NETWORK_EVIDENCE`; `LIVE_ENABLED=false`; `EARLIEST_UNRESOLVED_FULL_CORE_DEPENDENCY=LIVE_ENABLED`; no GET; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.O FULL_CORE_LIVE_ENABLED_STANDING_ADMISSION_SEAM | Navigation-only pointer to Full-Core LIVE_ENABLED standing admission seam (`LIVE_ENABLED_STANDING_ADMISSION_SEAM_IMPLEMENTED=true`; `LIVE_ENABLED_DEFAULT=false`; `LIVE_ENABLED_TRUE_IS_NOT_AUTOMATIC_ADMISSION=true`; `LIVE_ENABLED=false`; `EARLIEST_UNRESOLVED_FULL_CORE_DEPENDENCY=LIVE_ARMED`; Host-Join vs LIVE_ARMED vs LiveExecutionPort order open; no GET; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.P FULL_CORE_LIVE_ADMISSION_TO_PRE_WIRE_BOUNDARY | Navigation-only pointer to Full-Core pre-wire admission closure (`LIVE_ARMED_STANDING_ADMISSION_SEAM_IMPLEMENTED=true`; `WIRE_SEND_PERMITTED_STANDING_ADMISSION_SEAM_IMPLEMENTED=true`; `FULL_CORE_HOST_STANDING_PREDICATE_JOIN_IMPLEMENTED=true`; `LIVE_EXECUTION_PORT_CONSTRUCTIBLE=false`; `EARLIEST_UNRESOLVED_FULL_CORE_DEPENDENCY=LIVE_VENUE_CAPITAL_NOT_ADMITTED_TO_STEP_29P`; Cap-7.2 Host remains SimulatedExecutionPort; no GET; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.Q FULL_CORE_STEP_29P_RISK_ADMISSIBILITY_PRE_CONSTRUCTION | Navigation-only pointer to Full-Core STEP-29P risk-admissibility pre-construction persist (`STEP_29P_CAPITAL_RISK_ADMISSIBILITY_IMPLEMENTED=true`; `STEP_29P_RISK_ADMISSIBLE=false`; `EARLIEST_UNRESOLVED_FULL_CORE_DEPENDENCY=STEP_29P_EQUITY_DIMENSION_BINDING_MISSING` at that consumed GO; successor `11.2.1.R`; GET-only OKX-EEA evidence authorized; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.R FULL_CORE_STEP_29P_ACCOUNT_EQUITY_MAPPING_OWNER_RATIFICATION | Navigation-only pointer to Full-Core STEP-29P equity-mapping Owner-ratification persist (`MAPPING_PROVEN=false`; `IMPLEMENTATION_OF_VALUE_BINDING=false`; `ACCOUNT_EQUITY_AUTHORITY_OWNER=UNRESOLVED`; `EARLIEST_UNRESOLVED_FULL_CORE_DEPENDENCY=ACCOUNT_EQUITY_SOURCE_SEMANTIC_MAPPING_OWNER_RATIFICATION_REQUIRED` at that consumed GO; successor `11.2.1.S`; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.S FULL_CORE_STEP_29P_ACCOUNT_EQUITY_SOURCE_SEMANTIC_MAPPING_RATIFICATION | Navigation-only pointer to Full-Core STEP-29P equity source-semantic mapping ratification persist (`ADJUDICATION_RESULT=NO_CANONICALLY_VALID_MAPPING_AVAILABLE`; `MAPPING_PROVEN=false`; `IMPLEMENTATION_OF_VALUE_BINDING=false`; `ACCOUNT_EQUITY_AUTHORITY_OWNER=UNRESOLVED`; `EARLIEST_UNRESOLVED_FULL_CORE_DEPENDENCY=NO_CANONICALLY_VALID_ACCOUNT_EQUITY_SOURCE_MAPPING`; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.T FULL_CORE_RUNNING_EQUITY_POLICY_SEMANTICS_RATIFICATION | Navigation-only pointer to Full-Core running-equity policy-semantics ratification persist (`SEMANTIC_REQUIREMENTS_COMPLETE=true`; P01/U01–U09 `DECIDED`; `MAPPING_PROVEN=false`; `ACCOUNT_EQUITY_AUTHORITY_OWNER=UNRESOLVED`; `EARLIEST_UNRESOLVED_FULL_CORE_DEPENDENCY=NO_CANONICALLY_VALID_ACCOUNT_EQUITY_SOURCE_MAPPING`; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.U FULL_CORE_RUNNING_EQUITY_AUTHORITY_ARCHITECTURE_RATIFICATION | Navigation-only pointer to Full-Core running-equity future authority-architecture ratification persist (`ARCHITECTURE_RATIFIED=true`; future owner/source/producer classes; historical `ACCOUNT_EQUITY_AUTHORITY_OWNER=UNRESOLVED` at that persist; `SOURCE_SELECTED=false`; `MAPPING_PROVEN=false`; `EARLIEST_UNRESOLVED_FULL_CORE_DEPENDENCY=NO_CANONICALLY_VALID_ACCOUNT_EQUITY_SOURCE_MAPPING`; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.V FULL_CORE_ACCOUNT_EQUITY_AUTHORITY_OWNER_CONCRETE_ASSIGNMENT_RATIFICATION | Navigation-only pointer to Full-Core concrete account-equity authority-owner assignment persist (`OWNER_ASSIGNMENT_RATIFIED=true`; `ACCOUNT_EQUITY_AUTHORITY_OWNER=ops.governed_productive_account_equity_authority_producer_v1`; empty governed slot; `SOURCE_SELECTED=false`; `GOVERNED_PRODUCER_CREATED=false`; `MAPPING_PROVEN=false`; `EARLIEST_UNRESOLVED_FULL_CORE_DEPENDENCY=NO_CANONICALLY_VALID_ACCOUNT_EQUITY_SOURCE_MAPPING`; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.W FULL_CORE_GOVERNED_RUNNING_ACCOUNT_EQUITY_SAMPLE_SCHEMA | Navigation-only pointer to Full-Core typed `GOVERNED_RUNNING_ACCOUNT_EQUITY_SAMPLE_V1` schema persist (`GOVERNED_RUNNING_ACCOUNT_EQUITY_SAMPLE_SCHEMA_PRESENT=true`; `SOURCE_OBJECT_PRESENT=false`; `SOURCE_SELECTED=false`; `MAPPING_PROVEN=false`; `GOVERNED_PRODUCER_CREATED=false`; `SOURCE_SCHEMA_MISSING_CLOSED=true`; `EARLIEST_UNRESOLVED_FULL_CORE_DEPENDENCY=NO_CANONICALLY_VALID_ACCOUNT_EQUITY_SOURCE_MAPPING`; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.X FULL_CORE_TYPED_VENUE_WITNESS_OBSERVATION_CONTRACT | Navigation-only pointer to Full-Core typed Trading-Account venue-witness observation contract persist (`VENUE_WITNESS_SCHEMA_PRESENT=true`; `VENUE_WITNESS_RUNTIME_INSTANCE_PRESENT=false`; `VENUE_WITNESS_SELECTED=false`; `WITNESS_CONTRACT_MISSING_CLOSED=true`; `RAW_TO_WITNESS_PROVEN=false`; `SOURCE_SELECTED=false`; `MAPPING_PROVEN=false`; `GOVERNED_PRODUCER_CREATED=false`; `EARLIEST_UNRESOLVED_FULL_CORE_DEPENDENCY=NO_CANONICALLY_VALID_ACCOUNT_EQUITY_SOURCE_MAPPING`; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.Y FULL_CORE_TYPED_NORMALIZATION_INCLUSION_CONTRACT | Navigation-only pointer to Full-Core typed venue-witness normalization/inclusion adjudication contract persist (`NORMALIZATION_SCHEMA_PRESENT=true`; `NORMALIZATION_RUNTIME_INSTANCE_PRESENT=false`; `NORMALIZATION_CONTRACT_MISSING_CLOSED=true`; `SEMANTIC_MAPPING_PROVEN=false`; `INCLUSION_PROVEN=false`; `SOURCE_SELECTED=false`; `MAPPING_PROVEN=false`; `GOVERNED_PRODUCER_CREATED=false`; `EARLIEST_UNRESOLVED_FULL_CORE_DEPENDENCY=NO_CANONICALLY_VALID_ACCOUNT_EQUITY_SOURCE_MAPPING`; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.Z FULL_CORE_TYPED_INTERNAL_RECONSTRUCTION_CONTRACT | Navigation-only pointer to Full-Core typed internal reconstruction contract persist (`INTERNAL_RECONSTRUCTION_SCHEMA_PRESENT=true`; `INTERNAL_RECONSTRUCTION_RUNTIME_INSTANCE_PRESENT=false`; `INTERNAL_RECONSTRUCTION_PROVEN=false`; `RECONSTRUCTION_ALGEBRA_COMPLETE=false`; `SOURCE_SELECTED=false`; `MAPPING_PROVEN=false`; `GOVERNED_PRODUCER_CREATED=false`; `EARLIEST_UNRESOLVED_FULL_CORE_DEPENDENCY=NO_CANONICALLY_VALID_ACCOUNT_EQUITY_SOURCE_MAPPING`; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.AA FULL_CORE_TYPED_RECONSTRUCTION_ALGEBRA_CONTRACT | Navigation-only pointer to Full-Core typed reconstruction algebra contract persist (`RECONSTRUCTION_ALGEBRA_SCHEMA_PRESENT=true`; `RECONSTRUCTION_ALGEBRA_COMPLETE=false`; `RECONSTRUCTION_ALGEBRA_AUTHORITY_EFFECT=NONE`; `CANONICAL_FORMULA_PROVEN=false`; `SOURCE_SELECTED=false`; `MAPPING_PROVEN=false`; `GOVERNED_PRODUCER_CREATED=false`; `EARLIEST_UNRESOLVED_FULL_CORE_DEPENDENCY=NO_CANONICALLY_VALID_ACCOUNT_EQUITY_SOURCE_MAPPING`; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.AB FULL_CORE_TYPED_P01_HAIRCUT_RESERVE_DEPLETION_TERM_CONTRACT | Navigation-only pointer to Full-Core typed P01 haircut/reserve/depletion term contract persist (`P01_TERM_CONTRACT_SCHEMA_PRESENT=true`; `P01_TERM_SEMANTICS_RESOLVED=false`; `P01_HAIRCUT_RESERVE_DEPLETION_UNSPECIFIED_CLOSED=false`; `RECONSTRUCTION_ALGEBRA_COMPLETE=false`; `SOURCE_SELECTED=false`; `MAPPING_PROVEN=false`; `GOVERNED_PRODUCER_CREATED=false`; `EARLIEST_UNRESOLVED_FULL_CORE_DEPENDENCY=NO_CANONICALLY_VALID_ACCOUNT_EQUITY_SOURCE_MAPPING`; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.AC FULL_CORE_TYPED_P01_TERM_SET_AND_UNIT_CLASS_CONTRACT | Navigation-only pointer to Full-Core typed P01 term-set and unit-class adjudication persist (`P01_TERM_SET_AND_UNIT_CLASS_CONTRACT_SCHEMA_PRESENT=true`; `P01_TERM_SET_RESOLVED=false`; `P01_VALUE_UNIT_CLASS_RESOLVED=false`; `P01_TERM_SEMANTICS_RESOLVED=false`; `P01_HAIRCUT_RESERVE_DEPLETION_UNSPECIFIED_CLOSED=false`; `RECONSTRUCTION_ALGEBRA_COMPLETE=false`; `SOURCE_SELECTED=false`; `MAPPING_PROVEN=false`; `EARLIEST_UNRESOLVED_FULL_CORE_DEPENDENCY=NO_CANONICALLY_VALID_ACCOUNT_EQUITY_SOURCE_MAPPING`; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.AD FULL_CORE_TYPED_P01_APPLICABILITY_CONTRACT | Navigation-only pointer to Full-Core typed P01 applicability adjudication persist (`P01_APPLICABILITY_CONTRACT_SCHEMA_PRESENT=true`; `P01_APPLICABILITY_RESOLVED=false`; `P01_APPLICABILITY_STATUS=UNSPECIFIED_FAIL_CLOSED`; `P01_TERM_SET_RESOLVED=false`; `P01_VALUE_UNIT_CLASS_RESOLVED=false`; `P01_TERM_SEMANTICS_RESOLVED=false`; `P01_HAIRCUT_RESERVE_DEPLETION_UNSPECIFIED_CLOSED=false`; `RECONSTRUCTION_ALGEBRA_COMPLETE=false`; `SOURCE_SELECTED=false`; `MAPPING_PROVEN=false`; `EARLIEST_UNRESOLVED_FULL_CORE_DEPENDENCY=NO_CANONICALLY_VALID_ACCOUNT_EQUITY_SOURCE_MAPPING`; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.AE FULL_CORE_TYPED_P01_EQUITY_BASE_INCLUSION_CONTRACT | Navigation-only pointer to Full-Core typed P01 equity-base inclusion adjudication persist (`P01_EQUITY_BASE_INCLUSION_CONTRACT_SCHEMA_PRESENT=true`; `P01_EQUITY_BASE_INCLUSION_RESOLVED=false`; `P01_EQUITY_BASE_INCLUSION_STATUS=UNRESOLVED`; `P01_APPLICABILITY_RESOLVED=false`; `P01_TERM_SET_RESOLVED=false`; `P01_VALUE_UNIT_CLASS_RESOLVED=false`; `P01_TERM_SEMANTICS_RESOLVED=false`; `P01_HAIRCUT_RESERVE_DEPLETION_UNSPECIFIED_CLOSED=false`; `RECONSTRUCTION_ALGEBRA_COMPLETE=false`; `SOURCE_SELECTED=false`; `MAPPING_PROVEN=false`; `EARLIEST_UNRESOLVED_FULL_CORE_DEPENDENCY=NO_CANONICALLY_VALID_ACCOUNT_EQUITY_SOURCE_MAPPING`; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.AF FULL_CORE_TYPED_P01_EMBEDDING_STATE_CONTRACT | Navigation-only pointer to Full-Core typed P01 broader embedding-state adjudication persist (`P01_EMBEDDING_STATE_CONTRACT_SCHEMA_PRESENT=true`; `P01_EMBEDDED_STATE_RESOLVED=false`; `P01_EMBEDDED_STATE=UNRESOLVED`; `P01_EQUITY_BASE_INCLUSION_RESOLVED=false`; `P01_APPLICABILITY_RESOLVED=false`; `P01_TERM_SET_RESOLVED=false`; `P01_VALUE_UNIT_CLASS_RESOLVED=false`; `P01_TERM_SEMANTICS_RESOLVED=false`; `P01_HAIRCUT_RESERVE_DEPLETION_UNSPECIFIED_CLOSED=false`; `RECONSTRUCTION_ALGEBRA_COMPLETE=false`; `SOURCE_SELECTED=false`; `MAPPING_PROVEN=false`; `EARLIEST_UNRESOLVED_FULL_CORE_DEPENDENCY=NO_CANONICALLY_VALID_ACCOUNT_EQUITY_SOURCE_MAPPING`; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.AG FULL_CORE_TYPED_P01_OVERLAP_WITH_U04_U05_CONTRACT | Navigation-only pointer to Full-Core typed P01 overlap/equivalence adjudication persist versus U04 and U05 (`P01_OVERLAP_WITH_U04_U05_CONTRACT_SCHEMA_PRESENT=true`; `P01_U04_OVERLAP_RESOLVED=false`; `P01_U04_OVERLAP_STATE=UNRESOLVED`; `P01_U05_OVERLAP_RESOLVED=false`; `P01_U05_OVERLAP_STATE=UNRESOLVED`; `P01_EMBEDDED_STATE_RESOLVED=false`; `P01_TERM_SET_RESOLVED=false`; `P01_VALUE_UNIT_CLASS_RESOLVED=false`; `P01_TERM_SEMANTICS_RESOLVED=false`; `P01_HAIRCUT_RESERVE_DEPLETION_UNSPECIFIED_CLOSED=false`; `RECONSTRUCTION_ALGEBRA_COMPLETE=false`; `SOURCE_SELECTED=false`; `MAPPING_PROVEN=false`; `EARLIEST_UNRESOLVED_FULL_CORE_DEPENDENCY=NO_CANONICALLY_VALID_ACCOUNT_EQUITY_SOURCE_MAPPING`; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.AH FULL_CORE_TYPED_P01_NUMERIC_VALUE_PROVENANCE_CONTRACT | Navigation-only pointer to Full-Core typed P01 numeric value provenance adjudication persist (`P01_NUMERIC_VALUE_PROVENANCE_CONTRACT_SCHEMA_PRESENT=true`; `P01_NUMERIC_VALUE_PROVENANCE_RESOLVED=false`; `P01_NUMERIC_VALUE_PROVENANCE_STATUS=UNSPECIFIED`; `P01_NUMERIC_VALUE_SOURCE=UNSPECIFIED`; `P01_NUMERIC_VALUE_TRANSFORMATION=UNSPECIFIED`; `P01_TERM_SET_RESOLVED=false`; `P01_VALUE_UNIT_CLASS_RESOLVED=false`; `P01_TERM_SEMANTICS_RESOLVED=false`; `P01_HAIRCUT_RESERVE_DEPLETION_UNSPECIFIED_CLOSED=false`; `RECONSTRUCTION_ALGEBRA_COMPLETE=false`; `SOURCE_SELECTED=false`; `MAPPING_PROVEN=false`; `EARLIEST_UNRESOLVED_FULL_CORE_DEPENDENCY=NO_CANONICALLY_VALID_ACCOUNT_EQUITY_SOURCE_MAPPING`; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.AI FULL_CORE_TYPED_P01_MEMBER_FRESHNESS_INHERITANCE_CONTRACT | Navigation-only pointer to Full-Core typed P01 member freshness inheritance adjudication persist (`P01_MEMBER_FRESHNESS_INHERITANCE_CONTRACT_SCHEMA_PRESENT=true`; `P01_MEMBER_FRESHNESS_INHERITANCE_RESOLVED=false`; `P01_MEMBER_FRESHNESS_STATUS=UNPROVEN`; `P01_MEMBER_FRESHNESS_RULE=UNSPECIFIED`; `P01_U09_FRESHNESS_RELATION=UNSPECIFIED`; `P01_NUMERIC_VALUE_PROVENANCE_RESOLVED=false`; `P01_TERM_SET_RESOLVED=false`; `P01_VALUE_UNIT_CLASS_RESOLVED=false`; `P01_TERM_SEMANTICS_RESOLVED=false`; `P01_HAIRCUT_RESERVE_DEPLETION_UNSPECIFIED_CLOSED=false`; `RECONSTRUCTION_ALGEBRA_COMPLETE=false`; `SOURCE_SELECTED=false`; `MAPPING_PROVEN=false`; `EARLIEST_UNRESOLVED_FULL_CORE_DEPENDENCY=NO_CANONICALLY_VALID_ACCOUNT_EQUITY_SOURCE_MAPPING`; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.AJ FULL_CORE_TYPED_P01_HAIRCUT_RESERVE_DEPLETION_SEMANTICS_CONTRACT | Navigation-only pointer to Full-Core typed P01 haircut/reserve/depletion semantics adjudication persist (`P01_HAIRCUT_RESERVE_DEPLETION_SEMANTICS_CONTRACT_SCHEMA_PRESENT=true`; `P01_HAIRCUT_SEMANTICS_RESOLVED=false`; `P01_RESERVE_SEMANTICS_RESOLVED=false`; `P01_DEPLETION_SEMANTICS_RESOLVED=false`; `P01_HAIRCUT_ROLE=UNSPECIFIED`; `P01_RESERVE_ROLE=UNSPECIFIED`; `P01_DEPLETION_ROLE=UNSPECIFIED`; `P01_TERM_SEMANTICS_RESOLVED=false`; `P01_HAIRCUT_RESERVE_DEPLETION_UNSPECIFIED_CLOSED=false`; `RECONSTRUCTION_ALGEBRA_COMPLETE=false`; `SOURCE_SELECTED=false`; `MAPPING_PROVEN=false`; `EARLIEST_UNRESOLVED_FULL_CORE_DEPENDENCY=NO_CANONICALLY_VALID_ACCOUNT_EQUITY_SOURCE_MAPPING`; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.AK FULL_CORE_TYPED_P01_EXACT_MEMBER_IDENTITY_CONTRACT | Navigation-only pointer to Full-Core typed P01 exact member identity ratification persist (`P01_EXACT_MEMBER_IDENTITY_CONTRACT_SCHEMA_PRESENT=true`; `P01_TERM_SET_RESOLVED=true`; `P01_EXACT_MEMBER_IDENTITY_SET=P01M_GOVERNED_DEPLOYABILITY_CONSERVATISM_REDUCTION`; `P01_EXACT_MEMBER_COUNT=1`; `P01_VALUE_UNIT_CLASS_RESOLVED=false`; `P01_TERM_SEMANTICS_RESOLVED=false`; `P01_HAIRCUT_RESERVE_DEPLETION_UNSPECIFIED_CLOSED=false`; `RECONSTRUCTION_ALGEBRA_COMPLETE=false`; `SOURCE_SELECTED=false`; `MAPPING_PROVEN=false`; `EARLIEST_UNRESOLVED_FULL_CORE_DEPENDENCY=NO_CANONICALLY_VALID_ACCOUNT_EQUITY_SOURCE_MAPPING`; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.AL FULL_CORE_TYPED_P01_VALUE_UNIT_CLASS_CONTRACT | Navigation-only pointer to Full-Core typed P01 value unit class ratification persist (`P01_VALUE_UNIT_CLASS_CONTRACT_SCHEMA_PRESENT=true`; `P01_TERM_SET_RESOLVED=true`; `P01_VALUE_UNIT_CLASS_RESOLVED=true`; `P01_VALUE_UNIT_CLASS=ABSOLUTE_MONETARY_REDUCTION_AMOUNT`; `P01_SEMANTIC_DIMENSION=PARENT_EQUITY_DIMENSION_REDUCTION_AMOUNT`; `P01_TERM_SEMANTICS_RESOLVED=false`; `P01_HAIRCUT_RESERVE_DEPLETION_UNSPECIFIED_CLOSED=false`; `RECONSTRUCTION_ALGEBRA_COMPLETE=false`; `SOURCE_SELECTED=false`; `MAPPING_PROVEN=false`; `EARLIEST_UNRESOLVED_FULL_CORE_DEPENDENCY=NO_CANONICALLY_VALID_ACCOUNT_EQUITY_SOURCE_MAPPING`; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.AM FULL_CORE_TYPED_P01_APPLICABILITY_CLASS_CONTRACT | Navigation-only pointer to Full-Core typed P01 applicability class ratification persist (`P01_APPLICABILITY_CLASS_CONTRACT_SCHEMA_PRESENT=true`; `P01_APPLICABILITY_CLASS_RESOLVED=true`; `P01_APPLICABILITY_CLASS=GOVERNED_CONDITIONAL`; `P01_APPLICABILITY_STATE_MODEL=APPLIES_DOES_NOT_APPLY_UNKNOWN_FAIL_CLOSED`; `P01_APPLICATION_PREDICATE_RESOLVED=false`; `P01_APPLICATION_PREDICATE=UNSPECIFIED_FAIL_CLOSED`; `P01_APPLICABILITY_RESOLVED=false`; `P01_TERM_SET_RESOLVED=true`; `P01_VALUE_UNIT_CLASS_RESOLVED=true`; `P01_TERM_SEMANTICS_RESOLVED=false`; `P01_HAIRCUT_RESERVE_DEPLETION_UNSPECIFIED_CLOSED=false`; `RECONSTRUCTION_ALGEBRA_COMPLETE=false`; `SOURCE_SELECTED=false`; `MAPPING_PROVEN=false`; `EARLIEST_UNRESOLVED_FULL_CORE_DEPENDENCY=NO_CANONICALLY_VALID_ACCOUNT_EQUITY_SOURCE_MAPPING`; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.AN FULL_CORE_TYPED_P01_APPLICATION_PREDICATE_IDENTITY_CONTRACT | Navigation-only pointer to Full-Core typed P01 application-predicate identity and boundary ratification persist (`P01_APPLICATION_PREDICATE_IDENTITY_CONTRACT_SCHEMA_PRESENT=true`; `P01_APPLICATION_PREDICATE_IDENTITY_RESOLVED=true`; `P01_APPLICATION_PREDICATE_MODEL=TYPED_GOVERNED_APPLICABILITY_DECISION_V1`; `P01_APPLICABILITY_DECISION_STATE_MODEL=APPLIES_DOES_NOT_APPLY_UNKNOWN_FAIL_CLOSED`; `P01_APPLICATION_PREDICATE_RESOLVED=false`; `P01_APPLICATION_PREDICATE=UNSPECIFIED_FAIL_CLOSED`; `P01_APPLICATION_PREDICATE_INPUT_DOMAIN_RESOLVED=false`; `P01_APPLICATION_TRUE_RULE_RESOLVED=false`; `P01_APPLICATION_FALSE_RULE_RESOLVED=false`; `P01_APPLICABILITY_CLASS_RESOLVED=true`; `P01_TERM_SET_RESOLVED=true`; `P01_VALUE_UNIT_CLASS_RESOLVED=true`; `P01_TERM_SEMANTICS_RESOLVED=false`; `P01_HAIRCUT_RESERVE_DEPLETION_UNSPECIFIED_CLOSED=false`; `RECONSTRUCTION_ALGEBRA_COMPLETE=false`; `SOURCE_SELECTED=false`; `MAPPING_PROVEN=false`; `EARLIEST_UNRESOLVED_FULL_CORE_DEPENDENCY=NO_CANONICALLY_VALID_ACCOUNT_EQUITY_SOURCE_MAPPING`; `EARLIEST_NARROW_P01_DEPENDENCY=P01_APPLICATION_PREDICATE_INPUT_DOMAIN_UNSPECIFIED`; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.AO FULL_CORE_TYPED_P01_APPLICATION_PREDICATE_INPUT_DOMAIN_IDENTITY_CONTRACT | Navigation-only pointer to Full-Core typed P01 application-predicate input-domain identity and boundary ratification persist (`P01_APPLICATION_PREDICATE_INPUT_DOMAIN_IDENTITY_CONTRACT_SCHEMA_PRESENT=true`; `P01_PREDICATE_INPUT_DOMAIN_IDENTITY_RESOLVED=true`; `P01_PREDICATE_INPUT_DOMAIN_BOUNDARY_RESOLVED=true`; `P01_PREDICATE_INPUT_DOMAIN_CLASS=TYPED_GOVERNED_P01_RECONSTRUCTION_CONTEXT_V1`; `P01_APPLICATION_PREDICATE_INPUT_DOMAIN_RESOLVED=false`; `P01_PREDICATE_CONCRETE_INPUT_MEMBERS_RESOLVED=false`; `P01_APPLICATION_TRUE_RULE_RESOLVED=false`; `P01_APPLICATION_FALSE_RULE_RESOLVED=false`; `P01_TERM_SEMANTICS_RESOLVED=false`; `P01_HAIRCUT_RESERVE_DEPLETION_UNSPECIFIED_CLOSED=false`; `RECONSTRUCTION_ALGEBRA_COMPLETE=false`; `SOURCE_SELECTED=false`; `MAPPING_PROVEN=false`; `EARLIEST_UNRESOLVED_FULL_CORE_DEPENDENCY=NO_CANONICALLY_VALID_ACCOUNT_EQUITY_SOURCE_MAPPING`; `EARLIEST_NARROW_P01_DEPENDENCY=P01_PREDICATE_CONCRETE_INPUT_MEMBERS_UNSPECIFIED`; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.AP FULL_CORE_TYPED_P01_RECONSTRUCTION_SEMANTIC_AND_ALGEBRA_CLOSEOUT_CONTRACT | Navigation-only pointer to Full-Core typed P01 reconstruction semantic and algebra closeout persist (`P01_RECONSTRUCTION_SEMANTIC_AND_ALGEBRA_CLOSEOUT_CONTRACT_SCHEMA_PRESENT=true`; `P01_PREDICATE_INPUT_MEMBER=GOVERNED_P01_REDUCTION_DIRECTIVE_V1`; `P01_PREDICATE_CONCRETE_INPUT_MEMBERS_RESOLVED=true`; `P01_APPLICATION_TRUE_RULE_RESOLVED=true`; `P01_APPLICATION_FALSE_RULE_RESOLVED=true`; `P01_PRODUCT_SEMANTICS_COMPLETE=true`; `P01_RECONSTRUCTION_ALGEBRA_CONTRACT_COMPLETE=true`; `P01_PRODUCTIVE_EXTERNAL_SOURCE_MAPPING_RESOLVED=false`; `P01_INPUT_FRESHNESS_RULE_RESOLVED=false`; `RECONSTRUCTION_ALGEBRA_COMPLETE=false`; `SOURCE_SELECTED=false`; `MAPPING_PROVEN=false`; `EARLIEST_UNRESOLVED_FULL_CORE_DEPENDENCY=NO_CANONICALLY_VALID_ACCOUNT_EQUITY_SOURCE_MAPPING`; `EARLIEST_DECOMPOSED_CONTRACT_GAP=U04_PENDING_ORDER_RESERVATION_INCLUSION_UNRESOLVED`; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.AQ FULL_CORE_EQUITY_RECOVERY_PR1_GOVERNANCE_REOPEN_AND_CANDIDATE_CENSUS | Navigation-only pointer to Full-Core C17+ source-generation/reopen mechanism and read-only candidate census persist (`NEW_SOURCE_GENERATION_MECHANISM_RATIFIED=true`; `MAPPING_REOPEN_MECHANISM_EXISTS=true`; `MAPPING_BOUNDARY_CURRENTLY_OPEN=false`; `C01_C16_REJECTION_STILL_BINDING=true`; `C17_CREATED=false`; `SOURCE_SELECTED=false`; `MAPPING_PROVEN=false`; `EARLIEST_UNRESOLVED_FULL_CORE_DEPENDENCY=NO_CANONICALLY_VALID_ACCOUNT_EQUITY_SOURCE_MAPPING`; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.AR FULL_CORE_OPTION_D_SSOT_CHECKPOINT_EVENT_TAXONOMY_AND_EQ_RECONCILIATION_TARGET_CONTRACTS | Navigation-only pointer to Full-Core OPTION_D SSOT, checkpoint, event-taxonomy, and fresh-eq reconciliation-target contract persist (`OPTION_D_SSOT_PERSISTED=true`; `RAW_EQ_SOURCE_AUTHORITY=false`; `EQ_RECONCILIATION_TARGET_ONLY=true`; `CHECKPOINT_CAN_MINT_EQUITY=false`; `UNCLASSIFIED_EVENT_FAIL_CLOSED=true`; `C17_CREATED=false`; `EVENT_ACQUISITION_CREATED=false`; `RECONSTRUCTION_ENGINE_CREATED=false`; `EARLIEST_OPTION_D_DEPENDENCY=D4_BOUND_ACCOUNT_IDENTITY`; `EARLIEST_UNRESOLVED_FULL_CORE_DEPENDENCY=NO_CANONICALLY_VALID_ACCOUNT_EQUITY_SOURCE_MAPPING`; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.AS FULL_CORE_D4_BOUND_ACCOUNT_IDENTITY_CONTRACT | Navigation-only pointer to Full-Core D4 bound account-identity contract persist (`BOUND_ACCOUNT_IDENTITY_PROVEN=true`; `BOUND_ACCOUNT_IDENTITY_CONTRACT_SCHEMA_PRESENT=true`; `BOUND_ACCOUNT_IDENTITY_RUNTIME_INSTANCE_PRESENT=false`; `BOUND_ACCOUNT_CONCRETE_UID_OBSERVED=false`; `D4_BOUND_ACCOUNT_IDENTITY=CONTRACT_PRESENT_AND_REFERENCE_BOUND`; `EARLIEST_OPTION_D_DEPENDENCY=D5_CHECKPOINT_OBSERVATION_ACQUISITION`; `C17_CREATED=false`; `EVENT_ACQUISITION_CREATED=false`; `RECONSTRUCTION_ENGINE_CREATED=false`; `MAPPING_PROVEN=false`; `EARLIEST_UNRESOLVED_FULL_CORE_DEPENDENCY=NO_CANONICALLY_VALID_ACCOUNT_EQUITY_SOURCE_MAPPING`; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.AT FULL_CORE_D5_CHECKPOINT_OBSERVATION_ACQUISITION | Navigation-only pointer to Full-Core D5 checkpoint-observation acquisition persist (`CHECKPOINT_OBSERVATION_ACQUISITION_CREATED=true`; `CHECKPOINT_OBSERVATION_PROVEN=true`; `CHECKPOINT_OBSERVATION_RUNTIME_INSTANCE_PRESENT=false`; `CHECKPOINT_OBSERVATION_NETWORK_GET_AUTHORIZED=false`; `D5_CHECKPOINT_OBSERVATION_ACQUISITION=TYPED_ACQUISITION_CONTRACT_PRESENT_AND_CHECKPOINT_BOUND`; `EARLIEST_OPTION_D_DEPENDENCY=D6_COMPLETE_CLASSIFIED_EVENT_STREAM_ACQUISITION`; `CHECKPOINT_CAN_MINT_EQUITY=false`; `C17_CREATED=false`; `EVENT_ACQUISITION_CREATED=false`; `RECONSTRUCTION_ENGINE_CREATED=false`; `MAPPING_PROVEN=false`; `EARLIEST_UNRESOLVED_FULL_CORE_DEPENDENCY=NO_CANONICALLY_VALID_ACCOUNT_EQUITY_SOURCE_MAPPING`; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.AU FULL_CORE_D6_COMPLETE_CLASSIFIED_EVENT_STREAM_ACQUISITION | Navigation-only pointer to Full-Core D6 classified event-stream acquisition persist (`EVENT_ACQUISITION_CREATED=true`; `COMPLETE_EVENT_STREAM_PROVEN=false`; `EVENT_ACQUISITION_RUNTIME_INSTANCE_PRESENT=false`; `EVENT_ACQUISITION_NETWORK_GET_AUTHORIZED=false`; `D6_COMPLETE_CLASSIFIED_EVENT_STREAM_ACQUISITION=TYPED_ACQUISITION_CONTRACT_PRESENT_COMPLETENESS_UNPROVEN`; `EARLIEST_OPTION_D_DEPENDENCY=D6_COMPLETE_CLASSIFIED_EVENT_STREAM_ACQUISITION`; `C17_CREATED=false`; `RECONSTRUCTION_ENGINE_CREATED=false`; `MAPPING_PROVEN=false`; `EARLIEST_UNRESOLVED_FULL_CORE_DEPENDENCY=NO_CANONICALLY_VALID_ACCOUNT_EQUITY_SOURCE_MAPPING`; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.AV FULL_CORE_D6_CLASSIFIED_KIND_SET_AND_EVENT_SOURCE_SEAM | Navigation-only pointer to Full-Core D6 classified kind-set and event-source seam census persist (`KIND_SET_RESOLVED=false`; `RATIFIED_CLASSIFIED_EVENT_KIND_SET=EMPTY_FAIL_CLOSED`; `AUTHORIZED_PRODUCTIVE_EVENT_SOURCE_SEAM_PRESENT=false`; `D6_COMPLETENESS_PRECONDITIONS_PROVEN=false`; `COMPLETE_EVENT_STREAM_PROVEN=false`; `EVENT_KIND_SOURCE_SEAM_SELECTED=false`; `SOURCE_SELECTED=false`; `RAW_EQ_SOURCE_AUTHORITY=false`; `MAPPING_PROVEN=false`; `C17_CREATED=false`; `EARLIEST_OPTION_D_DEPENDENCY=D6_COMPLETE_CLASSIFIED_EVENT_STREAM_ACQUISITION`; `EARLIEST_D6_COMPLETENESS_DEPENDENCY=RATIFIED_CLASSIFIED_EVENT_KIND_SET_AND_AUTHORIZED_PRODUCTIVE_EVENT_SOURCE_SEAM`; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.AW FULL_CORE_D6_EQUITY_STOCK_NECESSARY_KIND_SET_CLOSEOUT | Navigation-only pointer to Full-Core D6 Mini-Slice 1 EQUITY_STOCK necessary kind-set closeout persist (`KIND_SET_CLOSEOUT_CREATED=true`; `KIND_SET_RESOLVED=false`; `MS1_KIND_SET_FULLY_CLOSED=false`; `MS2_AUTHORIZED=false`; `UNKNOWN_NECESSARY_CLASS_REMAINS=true`; `KIND_SET_CLOSEOUT_STATUS=FAIL_CLOSED_NAMED_REMAINING_UNKNOWN`; `AUTHORIZED_PRODUCTIVE_EVENT_SOURCE_SEAM_PRESENT=false`; `C17_CREATED=false`; `EARLIEST_D6_KIND_SET_DEPENDENCY=NAMED_REMAINING_UNKNOWN_NECESSARY_EQUITY_STOCK_KIND_SET`; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.AX FULL_CORE_D6_NAMED_REMAINING_UNKNOWN_KIND_SET_EVIDENCE_PERSIST | Navigation-only pointer to Full-Core D6 named remaining-unknown kind-set evidence persist (`KIND_SET_EVIDENCE_PERSIST_CREATED=true`; `U05_KIND_DECISION=REMAIN_UNKNOWN`; `U06_KIND_DECISION=REMAIN_UNKNOWN`; `RESIDUAL_KIND_DECISION=REMAIN_UNKNOWN`; `KIND_SET_RESOLVED=false`; `MS1_KIND_SET_FULLY_CLOSED=false`; `MS2_AUTHORIZED=false`; `RESIDUAL_COMPLETENESS_PROVEN=false`; `AUTHORIZED_PRODUCTIVE_EVENT_SOURCE_SEAM_PRESENT=false`; `C17_CREATED=false`; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.AY FULL_CORE_D6_SCOPED_READ_ONLY_OBSERVATION_BOUNDARY | Navigation-only pointer to Full-Core D6 scoped read-only observation-boundary contract persist (`OBSERVATION_BOUNDARY_CONTRACT_CREATED=true`; `OBSERVATION_EXECUTED=false`; `OBSERVATION_EXECUTION_AUTHORIZED=false`; `U05_KIND_DECISION=REMAIN_UNKNOWN`; `U06_KIND_DECISION=REMAIN_UNKNOWN`; `RESIDUAL_KIND_DECISION=REMAIN_UNKNOWN`; `KIND_SET_RESOLVED=false`; `MS1_KIND_SET_FULLY_CLOSED=false`; `MS2_AUTHORIZED=false`; `D6_FULLY_CLOSED=false`; `D7_AUTHORIZED=false`; `PATH_B=SELECTED_BUT_BLOCKED_ON_NEW_AUTHORIZATION`; `ATLAS_AUTHORITY=NONE`; `C17_CREATED=false`; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.AZ FULL_CORE_D6_PATH_B_CLASS_C_PACKAGE_1_TRADING_ACCOUNT_OBSERVATION_RULES | Navigation-only pointer to Full-Core D6 PATH_B CLASS_C PACKAGE_1 trading-account observation-rules persist (`PACKAGE_1_PERSISTED=true`; `PATH_B_PREAUTHORIZATION_READY=true`; `EXECUTION_READY=false`; `OBSERVATION_EXECUTED=false`; `D4_RULE_PERSISTED=true`; `BALANCE_RULE_PERSISTED=true`; `EMPTY_COVERAGE_RULE_PERSISTED=true`; `EMBEDDING_RULE_PERSISTED=true`; `KIND_SET_RESOLVED=false`; `MS2_AUTHORIZED=false`; `D6_FULLY_CLOSED=false`; `D7_AUTHORIZED=false`; `C01_REHABILITATION_FORBIDDEN=true`; `ATLAS_AUTHORITY=NONE`; `C17_CREATED=false`; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.BA FULL_CORE_D6_PATH_B_PACKAGE_1_D4_RUNTIME_BINDING_AND_D5_WINDOW_CONTRACT | Navigation-only pointer to Full-Core D6 PATH_B PACKAGE_1 D4 runtime binding and D5 window-contract persist (`D4_RUNTIME_BINDING_CONTRACT_PRESENT=true`; `BOUND_ACCOUNT_IDENTITY_RUNTIME_INSTANCE_PRESENT=false`; `D4_CONCRETE_UID_CORROBORATED=false`; `D5_WINDOW_BINDING_CONTRACT_PRESENT=true`; `CHECKPOINT_OBSERVATION_WINDOW_RUNTIME_INSTANCE_PRESENT=false`; `OBSERVATION_S0_RUNTIME_PAYLOADS_PRESENT=false`; `OBSERVATION_EXECUTED=false`; `C17_CREATED=false`; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.BB FULL_CORE_D6_PATH_B_D4_D5_GENESIS_REBASELINE | Navigation-only pointer to Full-Core D6 PATH_B D4/D5 genesis rebaseline persist (`GENESIS_REBASELINE_SELECTED_BY_OWNER=true`; `LEGACY_D4_D5_RUNTIME_CHAIN=NOT_RECONSTRUCTED`; `HISTORICAL_CONTINUITY_CLAIMED=false`; `HISTORICAL_COMPLETENESS_CLAIMED=false`; `D4_GENESIS_BOOTSTRAP_SOURCE=FRESH_AUTHENTICATED_ACCOUNT_CONFIG`; `D4_RUNTIME_INSTANCE_PRESENT=true`; `D5_RUNTIME_INSTANCE_PRESENT=true`; `BOUND_ACCOUNT_IDENTITY_RESOLVED=true`; `OBSERVATION_S0_PREREQUISITES_SATISFIED=true`; `OBSERVATION_EXECUTED=false`; `C17_CREATED=false`; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.BC FULL_CORE_D6_PATH_B_CLASS_C_PACKAGE_1_OBSERVATION_EXECUTION | Navigation-only pointer to Full-Core D6 PATH_B CLASS_C PACKAGE_1 Observation S1–S5 execution persist (`AUTHORIZED_GET_SURFACE_COUNT=5`; `D4_IDENTITY_MINTED=false`; `RAW_EQ_SOURCE_AUTHORITY=false`; `S6_EXECUTED=false`; `KIND_SET_RESOLVED=false`; `MS2_AUTHORIZED=false`; `D6_FULLY_CLOSED=false`; `D7_AUTHORIZED=false`; `ATLAS_AUTHORITY=NONE`; `C17_CREATED=false`; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.BD FULL_CORE_D6_PATH_B_PACKAGE_1_S6_MAPPING_CLASSIFICATION | Navigation-only pointer to Full-Core D6 PATH_B PACKAGE_1 S6 mapping/classification persist (`S6_EXECUTED=true`; `SEALED_INPUT_ONLY=true`; `OBSERVED_KIND_SET=EMPTY_FAIL_CLOSED`; `KIND_SET_RESOLVED=false`; `MAPPING_PERSISTED=false`; `MAPPING_COVERAGE_STATUS=FAIL_CLOSED_NO_RATIFIED_KIND`; `D4_IDENTITY_MINTED=false`; `RAW_EQ_SOURCE_AUTHORITY=false`; `MS2_AUTHORIZED=false`; `D6_FULLY_CLOSED=false`; `D7_AUTHORIZED=false`; `ATLAS_AUTHORITY=NONE`; `C17_CREATED=false`; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.BE FULL_CORE_D6_ACCOUNT_EQUITY_SOURCE_MAPPING_RATIFICATION | Navigation-only pointer to Full-Core D6 account-equity source-mapping ratification persist (`MAPPING_PERSISTED=true`; `MAPPING_COVERAGE_STATUS=PARTIAL_FAIL_CLOSED_NO_RATIFIED_SOURCE_KIND`; `RATIFIED_SOURCE_KINDS=NONE`; `KIND_SET_RESOLVED=false`; `RAW_EQ_SOURCE_AUTHORITY=false`; `U05_KIND_DECISION=REMAIN_UNKNOWN`; `U06_KIND_DECISION=REMAIN_UNKNOWN`; `RESIDUAL_KIND_DECISION=REMAIN_UNKNOWN`; `MS2_AUTHORIZED=false`; `D6_FULLY_CLOSED=false`; `D7_AUTHORIZED=false`; `ATLAS_AUTHORITY=NONE`; `C17_CREATED=false`; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.BF FULL_CORE_D6_SOURCE_MAPPING_AND_COMPLETE_CLASSIFIED_EVENT_STREAM_ACQUISITION | Navigation-only pointer to Full-Core D6 source-mapping and classified event-stream acquisition persist (`RATIFIED_SOURCE_KINDS=NONE`; `KIND_SET_RESOLVED=false`; `EARLIEST_REMAINING_D6_BLOCKER=NAMED_REMAINING_UNKNOWN_NECESSARY_EQUITY_STOCK_KIND_SET`; `RAW_EQ_SOURCE_AUTHORITY=false`; `COMPLETE_CLASSIFIED_EVENT_STREAM_PROVEN=false`; `MS2_AUTHORIZED=false`; `D6_FULLY_CLOSED=false`; `D7_AUTHORIZED=false`; `ATLAS_AUTHORITY=NONE`; `C17_CREATED=false`; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.BG FULL_CORE_D6_F12_F13_F16_F17_F18_NECESSARY_EQUITY_STOCK_KIND_RESOLUTION | Navigation-only pointer to Full-Core D6 F12/F13/F16/F17/F18 necessary EQUITY_STOCK kind-resolution persist (`F12_DECISION=REMAIN_UNKNOWN`; `F13_DECISION=REMAIN_UNKNOWN`; `F16_DECISION=REMAIN_UNKNOWN`; `F17_DECISION=REMAIN_UNKNOWN`; `F18_DECISION=REMAIN_UNKNOWN`; `KIND_SET_RESOLVED=false`; `EARLIEST_REMAINING_D6_BLOCKER=F12_F13_RESOLUTION_REQUIRES_NONZERO_LIABILITY_STOCK_PRIMARY_EVIDENCE_OR_RATIFIED_EQ_IDENTITY`; `RAW_EQ_SOURCE_AUTHORITY=false`; `COMPLETE_CLASSIFIED_EVENT_STREAM_PROVEN=false`; `MS2_AUTHORIZED=false`; `D6_FULLY_CLOSED=false`; `D7_AUTHORIZED=false`; `ATLAS_AUTHORITY=NONE`; `C17_CREATED=false`; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.BH FULL_CORE_D6_F12_F13_PRIMARY_LIABILITY_STOCK_OBSERVATION | Navigation-only pointer to Full-Core D6 F12/F13 primary liability-stock observation persist (`GET_COUNT=1`; `POST_COUNT=0`; `NONZERO_LIABILITY_OBSERVED=false`; `F12_DECISION=REMAIN_UNKNOWN`; `F13_DECISION=REMAIN_UNKNOWN`; `F16_DECISION=REMAIN_UNKNOWN`; `KIND_SET_RESOLVED=false`; `EARLIEST_REMAINING_D6_BLOCKER=F12_F13_REMAIN_UNKNOWN_AFTER_AUTHORIZED_FRESH_BALANCE_GET_EMPTY_OR_ZERO_DOES_NOT_PROVE_ABSENCE`; `RAW_EQ_SOURCE_AUTHORITY=false`; `COMPLETE_CLASSIFIED_EVENT_STREAM_PROVEN=false`; `MS2_AUTHORIZED=false`; `D6_FULLY_CLOSED=false`; `D7_AUTHORIZED=false`; `ATLAS_AUTHORITY=NONE`; `C17_CREATED=false`; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.BI FULL_CORE_D6_EQ_IDENTITY_AND_F12_F13_LIABILITY_STOCK_KIND_RATIFICATION | Navigation-only pointer to Full-Core D6 eq-identity and F12/F13/U05 liability-stock kind-ratification persist (`RATIFIED_EQ_IDENTITY=NONE`; `F12_DECISION=REMAIN_UNKNOWN`; `F13_DECISION=REMAIN_UNKNOWN`; `U05_KIND_DECISION=REMAIN_UNKNOWN`; `F16_DECISION=REMAIN_UNKNOWN`; `KIND_SET_RESOLVED=false`; `EARLIEST_REMAINING_D6_BLOCKER=F12_F13_REMAIN_UNKNOWN_AFTER_EQ_IDENTITY_NONE_AND_AUTHORIZED_FRESH_BALANCE_GET_EMPTY_OR_ZERO_DOES_NOT_PROVE_ABSENCE`; `RAW_EQ_SOURCE_AUTHORITY=false`; `LEGACY_STRUCTURE_RESTORED=false`; `SEMANTIC_SALVAGE_RULE_APPLIED=true`; `MS2_AUTHORIZED=false`; `D6_FULLY_CLOSED=false`; `D7_AUTHORIZED=false`; `ATLAS_AUTHORITY=NONE`; `C17_CREATED=false`; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.BJ FULL_CORE_D6_F12_F13_KIND_SET_REMAINING_UNKNOWN_PIN_AND_REOPEN_GATE | Navigation-only pointer to Full-Core D6 F12/F13 KIND_SET remaining-unknown pin and reopen-gate persist (`CURRENTLY_DECISION_CAPABLE_EVIDENCE_CLASSES_FOR_F12_F13=NONE`; `UNKNOWN_IS_DURABLE_BUT_NOT_D6_CLOSEOUT=true`; `GATE_A_EXECUTED=false`; `GATE_B_EXECUTED=false`; `F12_DECISION=REMAIN_UNKNOWN`; `F13_DECISION=REMAIN_UNKNOWN`; `U05_KIND_DECISION=REMAIN_UNKNOWN`; `KIND_SET_RESOLVED=false`; `EARLIEST_REMAINING_D6_BLOCKER=F12_F13_REMAIN_UNKNOWN_NO_CURRENTLY_DECISION_CAPABLE_EVIDENCE_CLASS_AFTER_BH_AND_BI`; `RAW_EQ_SOURCE_AUTHORITY=false`; `MS2_AUTHORIZED=false`; `D6_FULLY_CLOSED=false`; `D7_AUTHORIZED=false`; `ATLAS_AUTHORITY=NONE`; `C17_CREATED=false`; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.BK FULL_CORE_D6_BJ_SEMANTICS_BOUNDED_IMPLEMENTATION | Navigation-only pointer to Full-Core D6 BJ remaining-unknown kind semantics persist (`F12_STATUS=UNRESOLVED`; `F13_STATUS=UNRESOLVED`; `U05_STATUS=UNRESOLVED`; `F16_STATUS=UNRESOLVED`; `F17_STATUS=UNRESOLVED`; `F18_STATUS=UNRESOLVED`; `KIND_SET=EMPTY_FAIL_CLOSED`; `KIND_SET_RESOLVED=false`; `GATE_A_EXECUTED=false`; `GATE_B_EXECUTED=false`; `VENUE_GET_COUNT=0`; `UNKNOWN_SEMANTICS_INVENTED=false`; `MS2_AUTHORIZED=false`; `D6_FULLY_CLOSED=false`; `D7_AUTHORIZED=false`; `ATLAS_AUTHORITY=NONE`; `C17_CREATED=false`; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.BL FULL_CORE_D6_BK_BOUNDED_IMPLEMENTATION | Navigation-only pointer to Full-Core D6 BK consumption of sealed BJ remaining-unknown kind semantics persist (`F12_STATUS=UNRESOLVED`; `F13_STATUS=UNRESOLVED`; `U05_STATUS=UNRESOLVED`; `F16_STATUS=UNRESOLVED`; `F17_STATUS=UNRESOLVED`; `F18_STATUS=UNRESOLVED`; `CONSUMPTION_ADMITTED=false`; `KIND_SET=EMPTY_FAIL_CLOSED`; `KIND_SET_RESOLVED=false`; `GATE_A_EXECUTED=false`; `GATE_B_EXECUTED=false`; `VENUE_GET_COUNT=0`; `VENUE_POST_COUNT=0`; `UNKNOWN_SEMANTICS_INVENTED=false`; `BJ_CONTRACT_REUSED=true`; `MS2_AUTHORIZED=false`; `D6_FULLY_CLOSED=false`; `D7_AUTHORIZED=false`; `ATLAS_AUTHORITY=NONE`; `C17_CREATED=false`; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.BM FULL_CORE_LIVE_CRITICAL_PATH_NEXT_BLOCKER | Navigation-only pointer to Full-Core live-critical-path next-blocker persist (`LIVE_CRITICAL_DEFINITION_CLASS=NEW_CANONICAL_DEFINITION`; `LIVE_CRITICAL_KIND_SET=EMPTY_FAIL_CLOSED`; `LIVE_CRITICAL_KIND_SET_RESOLVED=false`; `HISTORICAL_UNKNOWN_ON_CRITICAL_PATH=false`; `EARLIEST_LIVE_CRITICAL_PATH_BLOCKER=NO_OWNER_RATIFIED_NEW_CANONICAL_LIVE_EQUITY_STOCK_SOURCE_KIND`; `KINDS_INVENTED_THIS_GO=false`; `GATE_A_EXECUTED=false`; `GATE_B_EXECUTED=false`; `VENUE_GET_COUNT=0`; `VENUE_POST_COUNT=0`; `MS2_AUTHORIZED=false`; `D6_FULLY_CLOSED=false`; `D7_AUTHORIZED=false`; `ATLAS_AUTHORITY=NONE`; `C17_CREATED=false`; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.BN FULL_CORE_LIVE_EQUITY_STOCK_KIND_SET_NEW_CANONICAL_DEFINITION | Navigation-only pointer to Full-Core live EQUITY_STOCK KIND_SET NEW_CANONICAL_DEFINITION persist (`NEW_CANONICAL_DEFINITION=true`; `LEGACY_SEMANTICS_RECONSTRUCTED=false`; `LIVE_EQUITY_STOCK_KIND_SET=EMPTY_FAIL_CLOSED`; `LIVE_EQUITY_STOCK_KIND_SET_RESOLVED=false`; `KIND_SET_MEMBERS=NONE`; `EARLIEST_LIVE_CRITICAL_PATH_BLOCKER=NO_ELIGIBLE_TODAY_LIVE_EQUITY_STOCK_SOURCE_KIND_AFTER_NEW_CANONICAL_DEFINITION`; `KINDS_INVENTED_THIS_GO=false`; `GATE_A_EXECUTED=false`; `GATE_B_EXECUTED=false`; `VENUE_GET_COUNT=0`; `VENUE_POST_COUNT=0`; `MS2_AUTHORIZED=false`; `D6_FULLY_CLOSED=false`; `D7_AUTHORIZED=false`; `ATLAS_AUTHORITY=NONE`; `C17_CREATED=false`; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.BO FULL_CORE_LIVE_EQUITY_STOCK_CHECKPOINT_STOCK_VALUE_CONTRACT | Navigation-only pointer to Full-Core live EQUITY_STOCK checkpoint stock-value contract persist (`NEW_CANONICAL_DEFINITION=true`; `LEGACY_SEMANTICS_RECONSTRUCTED=false`; `CHECKPOINT_MINTS_EQUITY=false`; `VENUE_EQ_SOURCE_AUTHORITY=false`; `STOCK_VALUE_CONTRACT_DEFINED=true`; `INITIAL_STOCK_ANCHOR_STATUS=ABSENT`; `LIVE_EQUITY_STOCK_KIND_SET=EMPTY_FAIL_CLOSED`; `EARLIEST_LIVE_CRITICAL_PATH_BLOCKER=BOOTSTRAP_STOCK_PROVENANCE_ABSENT`; `KINDS_INVENTED_THIS_GO=false`; `GATE_A_EXECUTED=false`; `GATE_B_EXECUTED=false`; `VENUE_GET_COUNT=0`; `VENUE_POST_COUNT=0`; `MS2_AUTHORIZED=false`; `D6_FULLY_CLOSED=false`; `D7_AUTHORIZED=false`; `ATLAS_AUTHORITY=NONE`; `C17_CREATED=false`; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.BP FULL_CORE_LIVE_EQUITY_STOCK_BOOTSTRAP_STOCK_PROVENANCE | Navigation-only pointer to Full-Core live EQUITY_STOCK bootstrap stock provenance persist (`NEW_CANONICAL_DEFINITION=true`; `LEGACY_SEMANTICS_RECONSTRUCTED=false`; `CHECKPOINT_MINTS_EQUITY=false`; `VENUE_EQ_SOURCE_AUTHORITY=false`; `BOOTSTRAP_PROVENANCE_CONTRACT_DEFINED=true`; `BOOTSTRAP_PROVENANCE_FINDING=NO_PROVABLE_INITIAL_STOCK_ANCHOR`; `ACQUISITION_SEAM_STATUS=SEAM_DEFINED_PROOF_ABSENT`; `INITIAL_STOCK_ANCHOR_STATUS=ABSENT`; `LIVE_EQUITY_STOCK_KIND_SET=EMPTY_FAIL_CLOSED`; `EARLIEST_LIVE_CRITICAL_PATH_BLOCKER=BOOTSTRAP_STOCK_EXTERNAL_FORENSIC_PROOF_ABSENT`; `KINDS_INVENTED_THIS_GO=false`; `GATE_A_EXECUTED=false`; `GATE_B_EXECUTED=false`; `VENUE_GET_COUNT=0`; `VENUE_POST_COUNT=0`; `MS2_AUTHORIZED=false`; `D6_FULLY_CLOSED=false`; `D7_AUTHORIZED=false`; `ATLAS_AUTHORITY=NONE`; `C17_CREATED=false`; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.BQ FULL_CORE_LIVE_EQUITY_STOCK_BOOTSTRAP_STOCK_ACQUISITION | Navigation-only pointer to Full-Core live EQUITY_STOCK bootstrap stock acquisition persist (`NEW_CANONICAL_DEFINITION=true`; `LEGACY_SEMANTICS_RECONSTRUCTED=false`; `CHECKPOINT_MINTS_EQUITY=false`; `VENUE_EQ_SOURCE_AUTHORITY=false`; `ACQUISITION_CONTRACT_DEFINED=true`; `ACQUISITION_CONTRACT_STATUS=DEFINED_FAIL_CLOSED`; `FORENSIC_ARTIFACT_PRESENT=false`; `CANDIDATE_VALIDATION_STATUS=NOT_ACQUIRED`; `INITIAL_STOCK_ANCHOR_STATUS=ABSENT`; `RATIFICATION_PERFORMED=false`; `LIVE_EQUITY_STOCK_KIND_SET=EMPTY_FAIL_CLOSED`; `EARLIEST_LIVE_CRITICAL_PATH_BLOCKER=EXTERNAL_FORENSIC_ARTIFACT_REQUIRED`; `KINDS_INVENTED_THIS_GO=false`; `GATE_A_EXECUTED=false`; `GATE_B_EXECUTED=false`; `VENUE_GET_COUNT=0`; `VENUE_POST_COUNT=0`; `MS2_AUTHORIZED=false`; `D6_FULLY_CLOSED=false`; `D7_AUTHORIZED=false`; `ATLAS_AUTHORITY=NONE`; `C17_CREATED=false`; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
| [`docs/runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md`](../runbooks/canonical/PEAK_TRADE_MASTER_RUNBOOK.md) §11.2.1.BR FULL_CORE_LIVE_EQUITY_STOCK_OWNER_SUPPLIED_BOOTSTRAP_ARTIFACT | Navigation-only pointer to Full-Core live EQUITY_STOCK owner-supplied bootstrap artifact ingest persist (`NEW_CANONICAL_DEFINITION=true`; `LEGACY_SEMANTICS_RECONSTRUCTED=false`; `CHECKPOINT_MINTS_EQUITY=false`; `VENUE_EQ_SOURCE_AUTHORITY=false`; `BQ_CONTRACT_REUSED=true`; `FORENSIC_ARTIFACT_PRESENT=false`; `CANDIDATE_VALIDATION_STATUS=INCOMPLETE`; `INITIAL_STOCK_CANDIDATE_STATUS=ABSENT`; `INITIAL_STOCK_ANCHOR_STATUS=ABSENT`; `RATIFICATION_STATUS=RATIFICATION_AUTHORITY_ABSENT`; `LIVE_EQUITY_STOCK_KIND_SET=EMPTY_FAIL_CLOSED`; `EARLIEST_LIVE_CRITICAL_PATH_BLOCKER=EXTERNAL_FORENSIC_ARTIFACT_REQUIRED`; `KINDS_INVENTED_THIS_GO=false`; `GATE_A_EXECUTED=false`; `GATE_B_EXECUTED=false`; `VENUE_GET_COUNT=0`; `VENUE_POST_COUNT=0`; `MS2_AUTHORIZED=false`; `D6_FULLY_CLOSED=false`; `D7_AUTHORIZED=false`; `ATLAS_AUTHORITY=NONE`; `C17_CREATED=false`; Cap 11.1 construction remains forbidden; no POST; MOT not SSOT) |
...
| [`docs/ops/specs/TREASURY_PHASE_1_OFFLINE_CONTRACTS_V1.md`](../ops/specs/TREASURY_PHASE_1_OFFLINE_CONTRACTS_V1.md) | Derived Treasury Phase-1 offline contract spec (non-SSOT; durable intent/lifecycle/idempotency; no productive Treasury path; no GET; no POST) |
| [`docs/ops/specs/FULL_CORE_LIVE_ENABLED_STANDING_ADMISSION_SEAM_V1.md`](../ops/specs/FULL_CORE_LIVE_ENABLED_STANDING_ADMISSION_SEAM_V1.md) | Derived Full-Core LIVE_ENABLED standing admission seam spec (non-SSOT; predicate conjunction; default false; true is not automatic admission; no GET; no POST) |
| [`docs/ops/specs/FULL_CORE_LIVE_ADMISSION_TO_PRE_WIRE_BOUNDARY_V1.md`](../ops/specs/FULL_CORE_LIVE_ADMISSION_TO_PRE_WIRE_BOUNDARY_V1.md) | Derived Full-Core pre-wire admission closure spec (non-SSOT; LIVE_ARMED and WIRE_SEND_PERMITTED standing predicates; construction-admission contract; Cap 11.1 construction remains forbidden; no GET; no POST) |
| [`docs/ops/specs/FULL_CORE_STEP_29P_RISK_ADMISSIBILITY_PRE_CONSTRUCTION_V1.md`](../ops/specs/FULL_CORE_STEP_29P_RISK_ADMISSIBILITY_PRE_CONSTRUCTION_V1.md) | Derived Full-Core STEP-29P risk-admissibility pre-construction spec (non-SSOT; fresh GET evidence; equity dimension unbound at that persist; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_STEP_29P_ACCOUNT_EQUITY_MAPPING_OWNER_RATIFICATION_V1.md`](../ops/specs/FULL_CORE_STEP_29P_ACCOUNT_EQUITY_MAPPING_OWNER_RATIFICATION_V1.md) | Derived Full-Core STEP-29P equity-mapping Owner-ratification spec (non-SSOT; `MAPPING_PROVEN=false`; no value binding; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_STEP_29P_ACCOUNT_EQUITY_SOURCE_SEMANTIC_MAPPING_RATIFICATION_V1.md`](../ops/specs/FULL_CORE_STEP_29P_ACCOUNT_EQUITY_SOURCE_SEMANTIC_MAPPING_RATIFICATION_V1.md) | Derived Full-Core STEP-29P equity source-semantic mapping ratification spec (non-SSOT; `ADJUDICATION_RESULT=NO_CANONICALLY_VALID_MAPPING_AVAILABLE`; no value binding; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_RUNNING_EQUITY_POLICY_SEMANTICS_RATIFICATION_V1.md`](../ops/specs/FULL_CORE_RUNNING_EQUITY_POLICY_SEMANTICS_RATIFICATION_V1.md) | Derived Full-Core running-equity policy-semantics ratification spec (non-SSOT; P01/U01–U09 `DECIDED`; `MAPPING_PROVEN=false`; no source; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_RUNNING_EQUITY_AUTHORITY_ARCHITECTURE_RATIFICATION_V1.md`](../ops/specs/FULL_CORE_RUNNING_EQUITY_AUTHORITY_ARCHITECTURE_RATIFICATION_V1.md) | Derived Full-Core running-equity future authority-architecture ratification spec (non-SSOT; `ARCHITECTURE_RATIFIED=true`; future classes only; `SOURCE_SELECTED=false`; Cap 11.1 construction remains forbidden) |
| [`docs/ops/specs/FULL_CORE_ACCOUNT_EQUITY_AUTHORITY_OWNER_CONCRETE_ASSIGNMENT_RATIFICATION_V1.md`](../ops/specs/FULL_CORE_ACCOUNT_EQUITY_AUTHORITY_OWNER_CONCRETE_ASSIGNMENT_RATIFICATION_V1.md) | Derived Full-Core concrete account-equity authority-owner assignment spec (non-SSOT; empty governed slot; `OWNER_ASSIGNMENT_RATIFIED=true`; `SOURCE_SELECTED=false`; Cap 11.1 construction remains forbidden) |
...
DDO_LEDGER_DURABILITY_HARDENING_AND_HOST_BINDING_PREP_NAV=docs/ops/specs/DDO_DURABLE_EVIDENCE_STORAGE_OWNER_CONTRACT_V1.md
DDO_LEDGER_DURABILITY_HARDENING_AND_HOST_BINDING_PREP_ROLE=NAVIGATION_POINTER_ONLY
DDO_PRODUCTIVE_HOST_SCOPE_INPUT_BINDING_NAV=docs/ops/specs/DDO_DURABLE_EVIDENCE_STORAGE_OWNER_CONTRACT_V1.md
...
DDO_A1_UNATTENDED_DURABILITY_RUNTIME_AUTHORIZATION_NAV=docs/ops/specs/DDO_DURABLE_EVIDENCE_STORAGE_OWNER_CONTRACT_V1.md
DDO_A1_UNATTENDED_DURABILITY_RUNTIME_AUTHORIZATION_ROLE=NAVIGATION_POINTER_ONLY
DDO_A1_CRASH_DURABILITY_ATOMIC_REPLACE_OR_EXPLICIT_NONREQUIREMENT_NAV=docs/ops/specs/DDO_DURABLE_EVIDENCE_STORAGE_OWNER_CONTRACT_V1.md
DDO_A1_CRASH_DURABILITY_ATOMIC_REPLACE_OR_EXPLICIT_NONREQUIREMENT_ROLE=NAVIGATION_POINTER_ONLY
DDO_A1_DURABILITY_FAILURE_POLICY_BINDING_NAV=docs/ops/specs/DDO_DURABLE_EVIDENCE_STORAGE_OWNER_CONTRACT_V1.md
DDO_A1_DURABILITY_FAILURE_POLICY_BINDING_ROLE=NAVIGATION_POINTER_ONLY
DDO_A1_DURABILITY_TO_ADMISSION_AND_REPLAY_BINDING_NAV=docs/ops/specs/DDO_DURABLE_EVIDENCE_STORAGE_OWNER_CONTRACT_V1.md
DDO_A1_DURABILITY_TO_ADMISSION_AND_REPLAY_BINDING_ROLE=NAVIGATION_POINTER_ONLY
DDO_A1_CRASH_DURABILITY_PROOF_OR_EXPLICIT_NONPROVABILITY_CLOSURE_NAV=docs/ops/specs/DDO_DURABLE_EVIDENCE_STORAGE_OWNER_CONTRACT_V1.md
DDO_A1_CRASH_DURABILITY_PROOF_OR_EXPLICIT_NONPROVABILITY_CLOSURE_ROLE=NAVIGATION_POINTER_ONLY
DDO_A1_MUTATION_CRITICAL_CONTROL_STATE_STORAGE_OWNER_CONTRACT_NAV=docs/ops/specs/DDO_A1_MUTATION_CRITICAL_CONTROL_STATE_STORAGE_OWNER_CONTRACT_V1.md
DDO_A1_MUTATION_CRITICAL_CONTROL_STATE_STORAGE_OWNER_CONTRACT_ROLE=NAVIGATION_POINTER_ONLY
DDO_A1_MUTATION_CRITICAL_CONTROL_STATE_DURABLE_STORAGE_IMPLEMENTATION_AND_CRASH_REPROOF_NAV=docs/ops/specs/DDO_A1_MUTATION_CRITICAL_CONTROL_STATE_DURABLE_STORAGE_IMPLEMENTATION_AND_CRASH_REPROOF_V1.md
...
DDO_EXISTING_OWNER_VALIDATION_EVIDENCE_INGEST_NAV=src/learning/deterministic_decision_outcome_v0/validation_producer_bindings_v0.py
DDO_EXISTING_OWNER_VALIDATION_EVIDENCE_INGEST_ROLE=NAVIGATION_POINTER_ONLY
DDO_VALIDATION_PACK_ENGINE_NAV=src/learning/deterministic_decision_outcome_v0/validation_pack_engine_v0.py
DDO_VALIDATION_PACK_ENGINE_ROLE=NAVIGATION_POINTER_ONLY
DDO_PROMOTION_ELIGIBILITY_DRY_RUN_NAV=src/learning/deterministic_decision_outcome_v0/promotion_controller_v0.py
DDO_PROMOTION_ELIGIBILITY_DRY_RUN_ROLE=NAVIGATION_POINTER_ONLY
DDO_SEMANTIC_REPLAY_PARITY_NAV=docs/ops/specs/DDO_SEMANTIC_REPLAY_PARITY_V1.md
...
T016_LEARNING_BLUEPRINT_FAMILY_ABSORPTION_AND_PROVENANCE_NAV=docs/ops/specs/PEAK_TRADE_T016_LEARNING_BLUEPRINT_FAMILY_ABSORPTION_AND_PROVENANCE_V1.md
T016_LEARNING_BLUEPRINT_FAMILY_ABSORPTION_AND_PROVENANCE_ROLE=NAVIGATION_POINTER_ONLY
