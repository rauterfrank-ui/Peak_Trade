# RSI-exhaustion MR eligibility — DEVELOPMENT evaluation v1
...
- Contract: `config/research/rsi_exhaustion_mr_eligibility_preregistered_economic_hypothesis_measurement_contract_v1.json`
- Preregistration module: `src/research/rsi_exhaustion_mr_eligibility_hypothesis_preregistration_v1.py`
...
- Does not reuse or retune the ATR(14) rolling-percentile mid-band filter from
...
`docs/evidence/evaluate_rsi_exhaustion_mr_eligibility_development_v1/` (populated by the runner)
