...
> **SUPERSEDED:** Canonical version is [docs/features/FEHLENDE_FEATURES_PEAK_TRADE.md](../features/FEHLENDE_FEATURES_PEAK_TRADE.md). This file is kept for reference only.
