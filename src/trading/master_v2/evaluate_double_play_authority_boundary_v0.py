...
LIVE_GATES_DOUBLE_PLAY_ANNOTATION_ROLE = "PROJECTION_DIAGNOSTIC_ONLY"
...
# Competing Ops SwitchGate authority is fail-closed (quarantine v1).
OPS_SWITCH_GATE_COMPETING_AUTHORITY_STATUS = "FAIL_CLOSED_DISABLED"

NEXT_REMEDIATION_SLICE = (
    "UNKNOWN_SCOPE_EVENT_POLICY_BINDING_CONTRACT_V1 (blocked; separate GO required)"
)
