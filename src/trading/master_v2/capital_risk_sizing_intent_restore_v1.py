...
"""Thin A06 composition adapter: A01–A05 evidence → STEP-29P → STEP-29Q.

Not a compute, risk, sizing, intent, or safety owner. Does not restore Safety
(A08). Does not claim full historical E2E completion.
"""
...
class MasterV2CapitalRiskSizingIntentCompositionV1:
    ...
    adapter_is_compute_owner: bool = A06_ADAPTER_COMPUTE_OWNER
    adapter_is_risk_owner: bool = A06_ADAPTER_RISK_OWNER
    adapter_is_sizing_owner: bool = A06_ADAPTER_SIZING_OWNER
    adapter_is_intent_owner: bool = A06_ADAPTER_INTENT_OWNER
    safety_restored: bool = SAFETY_RESTORED
    a08_started: bool = A08_STARTED
...
def compose_capital_risk_sizing_intent_from_core_evidence_v1(
    core: MasterV2DoublePlayCoreWiringResultV1,
    *,
    capital_context: Optional[CanonicalCoreRuntimeCapitalContextV0] = None,
) -> MasterV2CapitalRiskSizingIntentCompositionV1:
    """Compose STEP-29P then STEP-29Q from A01–A05 replay evidence.

    Safety is not evaluated. The resulting intent remains PLAN_ONLY / non-submittable.
    """
    ...
    return MasterV2CapitalRiskSizingIntentCompositionV1(
        core=core,
        chain=chain,
        intent=intent,
