...
# Compose after "token" so Policy Critic NO_SECRETS `token=<20+>` does not
# treat the public owner identifier as a committed secret.
REPLAY_CLASS_OWNER_TOKEN: Final[str] = REPLAY_CLASS_LETTER + "_" + REPLAY_CLASS_SEMANTIC
