...
# Governed productive transport fault-control binding (default disabled wrapper).
TRANSPORT_FAULT_CONTROL_BINDING_CAPABILITY_ID = (
    "PHASE_9_2_STEP_4_GOVERNED_PRODUCTIVE_TRANSPORT_FAULT_CONTROL_BINDING_IMPLEMENTATION_V1"
)
TRANSPORT_FAULT_CONTROL_OWNER = (
    "ops.phase_9_2_productive_public_md_rate_limit_reconnect_wallclock_binding_v1."
    "governed_injected_transport_fault_v1"
)
TRANSPORT_FAULT_CONTROL_DEFAULT_ENABLED = False
GOVERNED_INJECTED_TRANSPORT_FAULT = "GOVERNED_INJECTED_TRANSPORT_FAULT"
NATURAL_EXCHANGE_TRANSPORT_EVENT = "NATURAL_EXCHANGE_TRANSPORT_EVENT"
