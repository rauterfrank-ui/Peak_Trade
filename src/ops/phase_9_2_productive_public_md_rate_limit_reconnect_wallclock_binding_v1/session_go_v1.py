"""Step-4 Session-GO authority contract and gate (owned by this binding capability)."""
...
def evaluate_session_go_gate_v1(
    *,
    ...
    """Evaluate Session-GO before auth/lock/network/session/fault side effects."""
    notes = [
        ...
        "SESSION_GO_EVALUATION_BEFORE_FAULT_SESSION=true",
