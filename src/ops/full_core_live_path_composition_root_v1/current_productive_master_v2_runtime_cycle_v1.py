    ...
    *,
    ...
    if not instrument_id:
        return CurrentProductiveMasterV2CycleResultV1(
            ...
            decision_outcome="",
            replay_pass="false",
            fail_reasons=("BINDING_MISSING",),
            provenance=CURRENT_MASTER_V2_RUNTIME_CYCLE_ABSENT,
            input_digest="",
            input_blocker="BINDING_MISSING",
        )
    ...
    if len(closes) < FEATURE_WINDOW_MIN:
        return CurrentProductiveMasterV2CycleResultV1(
            ...
            decision_outcome="",
            replay_pass="false",
            fail_reasons=("MASTER_V2_PRICE_PATH_INSUFFICIENT",),
            provenance="MASTER_V2_PRICE_PATH_INSUFFICIENT",
            input_digest="",
            input_blocker="MASTER_V2_PRICE_PATH_INSUFFICIENT",
        )
    ...
    if spread <= 0:
        return CurrentProductiveMasterV2CycleResultV1(
            ...
            decision_outcome="",
            replay_pass="false",
            fail_reasons=("SPREAD_INVALID",),
            provenance="MASTER_V2_TICKER_SPREAD_INVALID",
            input_digest="",
            input_blocker="MASTER_V2_TICKER_SPREAD_INVALID",
        )
