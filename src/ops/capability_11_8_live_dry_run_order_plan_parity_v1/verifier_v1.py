"""Capability verifier for Cap 11.8 Live dry-run order-plan parity."""
...
def verify_capability_11_8_v1() -> dict[str, Any]:
    proofs = {
        "live_dry_run_order_plan": prove_live_dry_run_order_plan_contract_v1(),
        "live_order_plan_parity": prove_live_order_plan_parity_contract_v1(),
        "live_order_plan_evidence_ladder": prove_live_order_plan_evidence_ladder_contract_v1(),
    ...
    claims = {
        ...
        "LIVE_DRY_RUN_ORDER_PLAN_CONTRACT_BOUND": proofs["live_dry_run_order_plan"].get(
            "LIVE_DRY_RUN_ORDER_PLAN_CONTRACT_BOUND"
        ),
        "LIVE_DRY_RUN_ORDER_PLAN_CONTRACT_ACTIVATED": False,
        "LIVE_ORDER_PLAN_PARITY_CONTRACT_BOUND": proofs["live_order_plan_parity"].get(
            "LIVE_ORDER_PLAN_PARITY_CONTRACT_BOUND"
        ),
        "LIVE_ORDER_PLAN_PARITY_CONTRACT_ACTIVATED": False,
        "LIVE_ORDER_PLAN_EVIDENCE_LADDER_CONTRACT_BOUND": proofs[
            "live_order_plan_evidence_ladder"
        ].get("LIVE_ORDER_PLAN_EVIDENCE_LADDER_CONTRACT_BOUND"),
        "LIVE_ORDER_PLAN_EVIDENCE_LADDER_CONTRACT_ACTIVATED": False,
        "LIVE_DRY_RUN_ORDER_PLAN_FIXTURE_ONLY": True,
        ...
        "CAPABILITY_11_9_LIVE_CANARY_EXECUTION_STARTED": False,
