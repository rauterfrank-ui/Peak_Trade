"""Constants for CAPABILITY_11_8 Live dry-run order-plan parity."""

from __future__ import annotations

CAPABILITY_ID = "CAPABILITY_11_8_LIVE_DRY_RUN_ORDER_PLAN_PARITY_V1"
PACKAGE_MARKER = "CAPABILITY_11_8_LIVE_DRY_RUN_ORDER_PLAN_PARITY_V1=true"
OWNER = "ops.capability_11_8_live_dry_run_order_plan_parity_v1"
AUTHORITY_OWNER = OWNER
SCHEMA_VERSION = "capability_11_8_live_dry_run_order_plan_parity.v1"
PRODUCER_VERSION = "capability_11_8_live_dry_run_order_plan_parity.v1"
CONTRACT_VERSION = "v1"
...
# Cap 11.1–11.7 retention (must not be weakened / activated).
...
# Reachability claims for Cap 11.8 (contracts only — no real Live dry-run session).
...
# Cap 11.8 contract surface claims (bound, not activated, not observed/proven).
...
# Cap 11.8 does NOT claim Live evidence-ladder proven / observed fields (§11.14).
...
# Explicit Cap 11.9+ surfaces remain out of scope / unbound.
...
# Live progression: Cap 11.8 owns LIVE_DRY_RUN_ORDER_PLAN only (§11.13).
LIVE_PROGRESSION_STAGES_IN_SCOPE: tuple[str, ...] = ("LIVE_DRY_RUN_ORDER_PLAN",)
...
# Dry-run order-plan lifecycle stops before SUBMIT_PENDING (§11.4).
LIVE_DRY_RUN_LIFECYCLE_STATES: tuple[str, ...] = (
    "INTENT_CREATED",
    "ORDER_PLAN_CREATED",
    "RISK_RESERVED",
...
LIVE_DRY_RUN_FORBIDDEN_LIFECYCLE_STATES: tuple[str, ...] = (
    "SUBMIT_PENDING",
    "SUBMIT_ATTEMPTED",
    "ACKNOWLEDGED",
    "REJECTED",
...
LIVE_DRY_RUN_REQUIRED_FIELDS: tuple[str, ...] = (
    "intent_id",
    "order_plan_id",
    "client_order_id",
    "instrument_id",
...
LIVE_DRY_RUN_ALLOWED_EXECUTION_MODE = "LIVE_DRY_RUN"
...
# Cap 11.8 in-scope ladder focus (contract-bound only; observed=false).
LIVE_ORDER_PLAN_LADDER_FOCUS_FIELDS: tuple[str, ...] = ("LIVE_ORDER_PLAN_OBSERVED",)

# Cap 11.9+ ladder fields remain forbidden to claim from Cap 11.8.
LIVE_ORDER_PLAN_LADDER_FORBIDDEN_CLAIM_FIELDS: tuple[str, ...] = (
    "LIVE_SUBMIT_ACK_OBSERVED",
    "LIVE_FILL_OBSERVED",
    "LIVE_FEE_OBSERVED",
    "LIVE_POSITION_RECONCILED",
...
LIVE_DRY_RUN_ORDER_PLAN_OWNER = OWNER
LIVE_ORDER_PLAN_PARITY_OWNER = OWNER
LIVE_ORDER_PLAN_EVIDENCE_LADDER_OWNER = OWNER

EVIDENCE_DIRNAME = "capability_11_8_live_dry_run_order_plan_parity_v1"
