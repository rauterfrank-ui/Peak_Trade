...
instance-flag seam, and the bound session-arming seam. Does not flatten.
Does not POST. Does not invoke inner.send. Evaluator does not mint.
Constructive NO_SEND adapter semantics are unchanged. Session arming is
not send_permitted.
"""
