...
inner.send fail-closed receipt boundary. Does not flatten. Does not
POST. Does not mint a receipt. Evaluator does not mint. Constructive
NO_SEND adapter semantics are unchanged. Productive inner.send is not
HMAC, lease consume, HTTP POST, or wire-send.
"""
