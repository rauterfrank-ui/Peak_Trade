...
CONSERVATIVE_RATE_0_0003_STATUS = "PEAK_TRADE_POLICY_REUSE_OF_SAME_NUMERIC_VALUE"
...
def bind_qty_one_uninstantiated_formula_term_instances_v1(
    *,
    ...
    if reset_conservative_rate_to_0001:
        raise FormulaTermInstanceBindingError(
            "CANONICAL_EXPIRY_RATE_CANNOT_RESET_TO_HISTORICAL_0001"
        )
    if consume_0001_as_operative_fee_input:
        raise FormulaTermInstanceBindingError("HISTORICAL_SUPPORT_RATE_0_0001_IS_NOT_OPERATIVE")
