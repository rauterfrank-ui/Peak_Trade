...
ENDPOINT_ACCOUNT_BILLS = "/api/v5/account/bills"
ENDPOINT_ACCOUNT_BILLS_ARCHIVE = "/api/v5/account/bills-archive"
ENDPOINT_ACCOUNT_SUBTYPES = "/api/v5/account/subtypes"
