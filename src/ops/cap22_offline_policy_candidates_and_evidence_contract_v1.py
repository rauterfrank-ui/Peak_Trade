...
NEXT_CANONICAL_DECISION = "INPUT2_MAX_AGE_SECONDS_OWNER_RATIFICATION"
NEXT_CAP22_DEPENDENCY = "B05_B06_FAIL_CLOSED_IMPLEMENTATION_AFTER_B04_RANKING_FEATURE_CONTRACT"
...
def classify_preserved_program_invariants_v1() -> dict[str, Any]:
    return {
        "offline_mvr_final_score_formula_ratified": OFFLINE_MVR_FINAL_SCORE_FORMULA_RATIFIED,
