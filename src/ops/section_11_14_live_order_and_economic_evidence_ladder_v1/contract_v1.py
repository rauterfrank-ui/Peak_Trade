...
from src.ops.section_11_14_live_order_and_economic_evidence_ladder_v1.constants_v1 import (
    ...
    LIVE_RESTART_PROOF_CRITERION_BOUND,
    LIVE_RESTART_RECONSTRUCTED_PRODUCER_BOUND,
...
def assert_contract_invariants_v1(payload: Mapping[str, Any] | None = None) -> None:
    ...
    if CASE_ADJUDICATION != "CASE_LIVE_RESTART_RECONSTRUCTED_FAIL_CLOSED_MISSING_DURABLE_HANDOFF":
    ...
    if LIVE_RESTART_PROOF_CRITERION_BOUND is not True:
        raise Section1114OfflineSurfaceError("RESTART_PROOF_CRITERION_MUST_BE_BOUND")
    if LIVE_RESTART_RECONSTRUCTED_PRODUCER_BOUND is not True:
        raise Section1114OfflineSurfaceError("RESTART_PRODUCER_MUST_BE_BOUND")
