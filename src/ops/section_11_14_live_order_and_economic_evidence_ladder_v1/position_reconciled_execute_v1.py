"""Orchestrate position GET, adjudication, and evidence packaging. No POST."""
...
def execute_live_position_reconciled_v1(
    *,
    owner_go: str,
    origin_main_sha: str,
    repo_root: Path,
    ...
    adjudication = adjudicate_live_position_reconciled_v1(position_evidence=gets)
    ...
    summary = {
        ...
        "LIVE_POSITION_RECONCILED": adjudication.get("LIVE_POSITION_RECONCILED"),
        "LIVE_ACCOUNTING_RECONSTRUCTED": False,
        "SECTION_11_14_COMPLETE": False,
        "SECTION_11_14_AUTHORIZED": False,
        "CASE_ADJUDICATION": adjudication.get("CASE_ADJUDICATION"),
        "LIVE_POSITION_RECONCILIATION_REASON": adjudication.get(
            "LIVE_POSITION_RECONCILIATION_REASON"
        ),
        "UNRESOLVED_REASON": adjudication.get("UNRESOLVED_REASON"),
        "RAW_POSITION_QTY_IF_OBSERVED": adjudication.get("RAW_POSITION_QTY_IF_OBSERVED"),
        "RAW_POSITION_STATE_IF_OBSERVED": adjudication.get("RAW_POSITION_STATE_IF_OBSERVED"),
        "RAW_POS_ID_IF_OBSERVED": adjudication.get("RAW_POS_ID_IF_OBSERVED"),
        "RAW_POS_SIDE_IF_OBSERVED": adjudication.get("RAW_POS_SIDE_IF_OBSERVED"),
        "POSITION_IDENTITY_MATCH": adjudication.get("POSITION_IDENTITY_MATCH"),
        "POSITION_SEMANTICS_STATUS": adjudication.get("POSITION_SEMANTICS_STATUS"),
        "EMPTY_DATA_IS_ZERO": False,
        "SECRET_VALUES_INCLUDED": False,
        "GET_ERROR": gets.get("GET_ERROR"),
        "position_adjudication": adjudication,
        "get_pack": {
