...
LIVE_SUBMIT_ACK_OBSERVED, LIVE_FILL_OBSERVED, LIVE_FEE_OBSERVED, and
LIVE_POSITION_RECONCILED, and LIVE_ACCOUNTING_RECONSTRUCTED are bound
true. LIVE_RESTART_RECONSTRUCTED remains false. Exact-single live POST
remains consumed. This GO performs no GET, no POST, and no order
mutation. Atlas has no authority.
"""
