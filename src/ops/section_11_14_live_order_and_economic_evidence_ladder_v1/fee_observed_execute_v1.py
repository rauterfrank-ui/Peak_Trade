"""Orchestrate fee GETs, adjudication, and evidence packaging. No POST."""
...
def execute_live_fee_observed_v1(
    *,
    owner_go: str,
    origin_main_sha: str,
    repo_root: Path,
    ...
    gets = execute_fee_observed_gets_v1(
        owner_go=owner_go,
    ...
    adjudication = adjudicate_live_fee_observed_v1(fee_evidence=gets)
    ...
    summary = {
        ...
        "LIVE_FEE_OBSERVED": adjudication.get("LIVE_FEE_OBSERVED"),
        "LIVE_POSITION_RECONCILED": False,
        "SECTION_11_14_COMPLETE": False,
        "SECTION_11_14_AUTHORIZED": False,
        "CASE_ADJUDICATION": adjudication.get("CASE_ADJUDICATION"),
        "LIVE_FEE_ADJUDICATION_REASON": adjudication.get("LIVE_FEE_ADJUDICATION_REASON"),
        "UNRESOLVED_REASON": adjudication.get("UNRESOLVED_REASON"),
        "RAW_FEE_IF_OBSERVED": adjudication.get("RAW_FEE_IF_OBSERVED"),
        "RAW_FEE_CCY_IF_OBSERVED": adjudication.get("RAW_FEE_CCY_IF_OBSERVED"),
        "FEE_INFERRED_FROM_RATE": False,
        "FEE_INFERRED_FROM_PRICE_TIMES_QTY": False,
        "SECRET_VALUES_INCLUDED": False,
        "GET_ERROR": gets.get("GET_ERROR"),
        "fee_adjudication": adjudication,
        "get_pack": {
