...
from src.ops.section_11_14_live_order_and_economic_evidence_ladder_v1.constants_v1 import (
    ...
    LIVE_EXECUTION_CODE_EXISTS_DOES_NOT_IMPLY_AUTHORIZATION,
    ...
    return _record(
        payload={
            "canonical_definition": (
                ...
                "CURRENTLY_REACHABLE. LIVE_EXECUTION_CODE_EXISTS does not imply "
                "this field."
            ),
            "observed_repo_fact": (
                ...
                f"LIVE_AUTHORIZED={str(LIVE_AUTHORIZED).lower()}. Credential, venue, "
                "and runtime permit state are NOT_OBSERVED in this offline GO. "
                "LIVE_EXECUTION_CODE_EXISTS_DOES_NOT_IMPLY_PATH_REACHABLE="
            ...
            "admissibility_rule": (
                ...
                "Code-exists true is not path-reachable true."
            ),
            "evidence_paths": [
                SECTION_4_9_ANCHOR,
                CANONICAL_RUNBOOK_PATH,
            ...
            "contradiction_check": (
                "NO_CONTRADICTION. Constructible integrated code plus fail-closed "
                "gates is exactly the distinction this field must preserve. "
                "CURRENTLY_REACHABLE_IS_NOT_LIVE_EXECUTION_PATH_REACHABLE="
                f"{str(CURRENTLY_REACHABLE_IS_NOT_LIVE_EXECUTION_PATH_REACHABLE).lower()}. "
                "LIVE_EXECUTION_CODE_EXISTS_DOES_NOT_IMPLY_AUTHORIZATION="
                f"{str(LIVE_EXECUTION_CODE_EXISTS_DOES_NOT_IMPLY_AUTHORIZATION).lower()}."
            ),
            ...
            "reason": (
                ...
                "NOT_IMPLIED_BY_LIVE_EXECUTION_CODE_EXISTS;"
...
def adjudicate_static_fields_v1(*, repo_root: Path) -> dict[str, Any]:
    ...
    if (
        bool(code_exists["adjudicated_value"]) is True
        and bool(path_reachable["adjudicated_value"]) is True
    ):
        raise RuntimeError("PATH_REACHABLE_PROMOTED_BY_CODE_EXISTS_ADJUDICATION")
    return {
