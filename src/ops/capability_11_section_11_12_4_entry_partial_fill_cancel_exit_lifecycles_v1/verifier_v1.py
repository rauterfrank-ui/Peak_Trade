"""Verifier for Cap 11 §11.12.4 entry / partial fill / cancel / exit lifecycles."""
...
CALL_GRAPH_BEFORE: dict[str, Any] = {
    "nodes": [
        ...
        "Cap11_Section_11_12_3_SingleControlledOrderLifecycle",
        "Cap11_4_EntryPartialFillCancelExit_FixtureOnly",
        "SimulatedExecutionPort",
    ],
    "section_11_12_4": "forbidden_until_section_11_12_3_closed",
    "entry_partial_fill_cancel_exit_lifecycles": "cap_11_4_fixture_contract_only",
    "network_submit": "forbidden",
    "section_11_12_5": "not_started",
...
CALL_GRAPH_AFTER: dict[str, Any] = {
    ...
    "section_11_12_4": "productive_entry_partial_fill_cancel_exit_lifecycles_bound",
    "path_class": PATH_CLASS,
    "cap_11_4_entry_partial_fill_cancel_exit_contract": "reused_fixture_only",
    "paths_bound": list(ALLOWED_SECTION_11_12_4_PATHS),
...
def verify_capability_11_section_11_12_4_entry_partial_fill_cancel_exit_lifecycles_v1() -> dict[
    str, Any
]:
    ...
    claims = {
        ...
        "ENTRY_PARTIAL_FILL_CANCEL_EXIT_LIFECYCLES_PERFORMED": proof.get(
            "entry_partial_fill_cancel_exit_lifecycles_performed"
        ),
        "CAP_11_4_ENTRY_PARTIAL_FILL_CANCEL_EXIT_CONTRACT_REUSED": proof.get(
            "cap_11_4_entry_partial_fill_cancel_exit_contract_reused"
        ),
        "SECTION_11_12_3_PREDECESSOR_BOUND": proof.get("section_11_12_3_predecessor_bound"),
        ...
        "SECTION_11_12_4_PROOF_OK": proof.get("ok"),
        ...
        "SECTION_11_12_5_PATH_BLOCKED": proof.get("section_11_12_5_path_blocked"),
        "SINGLE_CONTROLLED_PATH_BLOCKED": proof.get("single_controlled_path_blocked"),
        ...
        "SECTION_11_12_5_BLOCKED": proof.get("section_11_12_5_blocked"),
