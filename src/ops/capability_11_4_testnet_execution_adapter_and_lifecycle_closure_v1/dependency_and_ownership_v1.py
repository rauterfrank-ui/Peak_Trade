"""Cap 11.1/11.2/11.3 dependency retention + Cap 11.4 ownership matrix."""
...
STATE_OWNERSHIP_MATRIX_V1: tuple[dict[str, str], ...] = (
    {
        "field": "testnet_execution_adapter",
        "classification": "DURABLE_CONTROL_STATE",
        "owner": TESTNET_EXECUTION_ADAPTER_OWNER,
        "mutable_by_adapter": "false",
    },
    {
        "field": "order_serialization_dry_run_records",
        "classification": "EPHEMERAL_FIXTURE_STATE",
        "owner": ORDER_SERIALIZATION_DRY_RUN_OWNER,
        "mutable_by_adapter": "false",
    },
    {
        "field": "testnet_lifecycle_closure_paths",
        "classification": "DURABLE_CONTROL_STATE",
        "owner": TESTNET_LIFECYCLE_CLOSURE_OWNER,
        "mutable_by_adapter": "false",
    },
    {
...
def prove_state_ownership_matrix_v1() -> dict[str, Any]:
    ...
    ok = all(
        [
            owners.get("testnet_execution_adapter") == TESTNET_EXECUTION_ADAPTER_OWNER,
            owners.get("order_serialization_dry_run_records") == ORDER_SERIALIZATION_DRY_RUN_OWNER,
            owners.get("testnet_lifecycle_closure_paths") == TESTNET_LIFECYCLE_CLOSURE_OWNER,
    ...
    return {
        ...
        "TESTNET_EXECUTION_ADAPTER_OWNER": TESTNET_EXECUTION_ADAPTER_OWNER,
        "ORDER_SERIALIZATION_DRY_RUN_OWNER": ORDER_SERIALIZATION_DRY_RUN_OWNER,
        "TESTNET_LIFECYCLE_CLOSURE_OWNER": TESTNET_LIFECYCLE_CLOSURE_OWNER,
