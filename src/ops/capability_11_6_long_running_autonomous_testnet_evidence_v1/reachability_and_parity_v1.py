"""Negative reachability and core-logic parity proofs for Cap 11.6."""
...
from src.ops.capability_11_5_testnet_restart_recovery_and_kill_switch_closure_v1.reachability_and_parity_v1 import (
    prove_core_logic_parity_v1 as prove_cap_11_5_core_logic_parity_v1,
    prove_negative_reachability_v1 as prove_cap_11_5_negative_reachability_v1,
)
...
from src.ops.capability_11_6_long_running_autonomous_testnet_evidence_v1.constants_v1 import (
    ...
    CORE_LOGIC_CHANGE,
    CREDENTIAL_LOAD_PERFORMED_IN_CAPABILITY_11_6,
    ...
    TESTNET_NETWORK_SESSION_STARTED_IN_CAPABILITY_11_6,
...
def prove_negative_reachability_v1() -> dict[str, Any]:
    predecessor = prove_cap_11_5_negative_reachability_v1()
    ...
    try:
        refuse_testnet_order_submit_v1(client_order_id="pt-coid-reach-11-6")
    except TestnetExecutionAdapterError:
        submit_blocked = True

    session_blocked = False
    try:
        refuse_testnet_network_session_start_v1(session_id="session-reach-11-6")
    except TestnetExecutionAdapterError:
        session_blocked = True

    campaign_activation_blocked = False
    try:
        refuse_long_running_campaign_activation_v1(campaign_id="campaign-reach")
    except LongRunningCampaignEvidenceError:
        campaign_activation_blocked = True

    campaign_session_blocked = False
    try:
        refuse_long_running_campaign_network_session_v1(session_id="session-campaign")
    except LongRunningCampaignEvidenceError:
        campaign_session_blocked = True

    evidence_activation_blocked = False
    try:
        refuse_testnet_evidence_activation_v1(claimed_action="activate_campaign")
    except TestnetEvidenceClosureError:
    ...
    ok = all(
        [
            ...
            submit_blocked,
            session_blocked,
            campaign_activation_blocked,
            campaign_session_blocked,
            ...
            TESTNET_NETWORK_SESSION_STARTED_IN_CAPABILITY_11_6 is False,
            TESTNET_AUTHORIZED is False,
            LIVE_AUTHORIZED is False,
            ACTIVATION_STATE == "not_activated",
            CREDENTIAL_PLAINTEXT_LOADED is False,
            CREDENTIAL_LOAD_PERFORMED_IN_CAPABILITY_11_6 is False,
    ...
    return {
        ...
        "campaign_network_session_blocked": campaign_session_blocked,
...
def prove_core_logic_parity_v1() -> dict[str, Any]:
    predecessor = prove_cap_11_5_core_logic_parity_v1()
...
CALL_GRAPH_BEFORE: dict[str, Any] = {
    ...
    "long_running_campaign_evidence": "absent_as_phase11_capability",
    "testnet_evidence_closure": "absent_as_phase11_capability",
    "observability_audit_evidence": "absent_as_phase11_capability",
...
CALL_GRAPH_AFTER: dict[str, Any] = {
    "path": [
        ...
        "LongRunningCampaignEvidenceRecordV1 (fixture-only; campaign activation forbidden)",
        "TestnetEvidenceClosureFieldRecordV1 (fixture-only; proven overclaim forbidden)",
        "ObservabilityDomainEvidenceRecordV1 (fixture-only; Cap 11.7 forbidden)",
        "Mode-Specific Execution Boundary (Simulated sole reachable)",
        "Accounting / Portfolio / Reconciliation / Evidence",
    ],
    "long_running_campaign_evidence": "bound_fixture_only_not_activated",
    "testnet_evidence_closure": "bound_fixture_only_not_activated",
    "observability_audit_evidence": "bound_fixture_only_not_activated",
    "network_session": "forbidden",
