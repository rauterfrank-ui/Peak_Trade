"""Verifier for Cap 11 §11.12.8 productive Testnet campaign run surface."""
...
CALL_GRAPH_BEFORE: dict[str, Any] = {
    ...
    "productive_testnet_campaign_run": "absent",
...
CALL_GRAPH_AFTER: dict[str, Any] = {
    ...
    "execution_predecessor": "preserved",
    "productive_testnet_campaign_run": "present",
    "productive_testnet_campaign_run_activation": "forbidden_until_separate_owner_go",
...
def verify_capability_11_section_11_12_8_productive_testnet_campaign_run_v1() -> dict[str, Any]:
    ...
    claims = {
        ...
        "EXECUTION_PREDECESSOR_PRESERVED": EXECUTION_PREDECESSOR_PRESERVED,
        "PRODUCTIVE_TESTNET_CAMPAIGN_RUN_SURFACE_PRESENT": (
            PRODUCTIVE_TESTNET_CAMPAIGN_RUN_SURFACE_PRESENT
        ),
        "PRODUCTIVE_TESTNET_CAMPAIGN_RUN_SURFACE_ABSENT": (
        ...
        "FUTURE_RUN_GO_CONSUMPTION_ALLOWED": FUTURE_RUN_GO_CONSUMPTION_ALLOWED,
        ...
        "FUTURE_RUN_GO_BLOCKED": proof.get("future_run_go_blocked"),
