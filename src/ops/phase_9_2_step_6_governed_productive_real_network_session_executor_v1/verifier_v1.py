"""Verifiers for Step-6 productive executor binding manifests."""
...
def verify_productive_executor_binding_manifest_v1(
    ...
    network_calls = claims.get("NETWORK_CALLS_DURING_BINDING_CAPABILITY")
    if network_calls is None or int(network_calls) != 0:
        blockers.append("NETWORK_CALLS_MUST_BE_ZERO_IN_BINDING")
    ...
    return {
        ...
        "claims": claims,
        "domain": "PRODUCTIVE_EXECUTOR_BINDING_PROOF",
    }
