"""Evidence materialization for Step-6 productive executor binding."""
...
from src.ops.phase_9_2_step_6_governed_productive_real_network_session_executor_v1.digest_v1 import (
    sha256_canonical_v1,
...
from src.ops.phase_9_2_step_6_governed_productive_real_network_session_executor_v1.verifier_v1 import (
    verify_productive_executor_binding_manifest_v1,
)


def materialize_productive_executor_binding_evidence_v1(
    *,
    repository_sha: str,
    config_digest: str,
    ...
    write_json_atomic_v1(fixtures / "productive_executor_binding_proof_v1.json", proof.to_dict())
    ...
    write_json_atomic_v1(out / "productive_executor_binding_manifest_v1.json", manifest)

    verifier = verify_productive_executor_binding_manifest_v1(manifest)
    write_json_atomic_v1(fixtures / "productive_executor_binding_verifier_v1.json", verifier)
    ...
    for rel in (
        "SUMMARY.json",
        "productive_executor_binding_manifest_v1.json",
        "fixtures/productive_executor_binding_proof_v1.json",
        "fixtures/failure_injection_results_v1.json",
        "fixtures/productive_executor_binding_verifier_v1.json",
    ):
        p = out / rel
