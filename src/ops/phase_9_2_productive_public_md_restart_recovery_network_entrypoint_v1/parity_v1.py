"""Core-logic parity revalidation for the productive restart network entrypoint."""
...
def prove_phase92_productive_entrypoint_parity_v1() -> dict[str, Any]:
    base = prove_phase92_restart_parity_v1()
    keys = (
    ...
    out: dict[str, Any] = {
        ...
        "phase92_restart_parity_reused": True,
    }
    all_ok = (
