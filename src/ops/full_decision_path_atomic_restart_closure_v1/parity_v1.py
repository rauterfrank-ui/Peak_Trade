"""Trading-logic parity proofs for Cap 6.4 (atomicity only; no numeric mutation)."""
...
def prove_trading_logic_parity_v1() -> dict[str, Any]:
    ...
    inserted = {CALL_GRAPH_ATOMIC_COMMIT_STEP, CALL_GRAPH_PENDING_EVIDENCE_STEP}
    ...
    values_unchanged = (
        ...
        and int(directional.confirmation_epochs) == 2
    )
