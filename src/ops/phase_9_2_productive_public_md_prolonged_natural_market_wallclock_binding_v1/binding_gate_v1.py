"""Fail-closed binding gate for prolonged natural-market wallclock path.
...
Env-alone never unlocks. This gate never starts network sessions.
"""
...
def evaluate_prolonged_natural_market_wallclock_binding_gate_v1(
    *,
    ...
    notes = [
        ...
        "NO_MARKET_PHASE_INJECTION=true",
        "NO_DECISION_INJECTION=true",
        "NO_INTENT_INJECTION=true",
        "NO_FILL_INJECTION=true",
        "NO_NETWORK_ERROR_INJECTION_IN_NATURAL_SESSION=true",
    ]
    blockers: list[str] = []
    ...
    if session_go_path is None:
        ...
        return BindingGateResultV1(
            ...
            prolonged_natural_market_path_bound=True,
...
def assert_no_parallel_productive_authority_v1() -> dict[str, Any]:
    """Reuse-before-new inventory against Step-3/Step-4/wallclock owners."""
    return {
        "ok": True,
        ...
        "reuses": {
            ...
            "session_lock": SESSION_LOCK_OWNER,
            "step4_binding": STEP4_BINDING_OWNER,
            "step3_binding": STEP3_BINDING_OWNER,
        },
        "reuse_proof": {
            "CODE_EXISTS": True,
            "PRODUCTIVE_CALLER_EXISTS": True,
            "STEP5_CONSUMER_IDENTIFIED": True,
            "AUTHORITY_UNAMBIGUOUS": True,
            "STATE_OWNER_UNAMBIGUOUS": True,
            "CONFIG_OWNER_UNAMBIGUOUS": True,
            "NO_PARALLEL_AUTHORITY": True,
            "NO_HIDDEN_FALLBACK": True,
            "STEP5_BINDING_EXPLICIT": True,
        },
        "notes": [
            "REUSES_WALLCLOCK_RUNNER",
            "REUSES_PACING_POLICY",
            "REUSES_EEA_TRANSPORT",
            "REUSES_SESSION_RUNTIME",
            "REUSES_STALENESS_TRACKER",
            "REUSES_STEP3_STEP4_BINDING_PATTERNS",
            "GENERIC_OR_STEP4_REACHABILITY_ALONE_IS_NOT_STEP5_BINDING",
