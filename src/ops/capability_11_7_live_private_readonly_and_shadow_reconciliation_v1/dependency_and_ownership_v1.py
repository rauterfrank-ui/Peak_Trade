"""Cap 11.1–11.6 dependency retention + Cap 11.7 ownership matrix."""
...
from src.ops.capability_11_7_live_private_readonly_and_shadow_reconciliation_v1.constants_v1 import (
    ...
    CAPABILITY_11_6_NO_NETWORK_SESSION_RETAINED,
    CAPABILITY_11_6_NO_ORDER_SUBMIT_RETAINED,
    CAPABILITY_11_6_NO_PROVEN_CLAIMS_RETAINED,
...
STATE_OWNERSHIP_MATRIX_V1: tuple[dict[str, str], ...] = (
    {
        "field": "live_private_readonly_port",
        "classification": "EVIDENCE_ONLY_STATE",
        "owner": LIVE_PRIVATE_READONLY_PORT_OWNER,
        "mutable_by_adapter": "false",
    },
    {
        "field": "live_shadow_reconciliation",
        "classification": "EVIDENCE_ONLY_STATE",
        "owner": LIVE_SHADOW_RECONCILIATION_OWNER,
        "mutable_by_adapter": "false",
    },
    {
        "field": "live_evidence_ladder",
        "classification": "EVIDENCE_ONLY_STATE",
        "owner": LIVE_EVIDENCE_LADDER_OWNER,
        "mutable_by_adapter": "false",
    },
    {
...
def prove_capability_11_6_dependency_retained_v1() -> dict[str, Any]:
    ...
    ok = all(
        [
            ...
            claims.get("TESTNET_AUTHORIZED") is False,
            claims.get("LIVE_AUTHORIZED") is False,
            claims.get("TESTNET_ORDER_SUBMIT_PERFORMED_IN_CAPABILITY_11_6") is False,
            claims.get("TESTNET_NETWORK_SESSION_STARTED_IN_CAPABILITY_11_6") is False,
            claims.get("TESTNET_EXECUTION_REACHABLE") is False,
            claims.get("EXCHANGE_ORDER_SUBMIT_REACHABLE") is False,
            claims.get("EXCHANGE_CREDENTIAL_ACCESS_REACHABLE") is False,
            claims.get("NETWORK_SESSION_STARTED") is False,
            claims.get("CAPABILITY_11_6_LONG_RUNNING_AUTONOMOUS_TESTNET_STARTED") is True,
            claims.get("LONG_RUNNING_AUTONOMOUS_TESTNET_CAMPAIGN_ACTIVATED") is False,
            claims.get("TESTNET_EVIDENCE_VERIFIED") is False,
            # Cap 11.6 package itself still refuses Cap 11.7 activation from within 11.6.
            claims.get("CAPABILITY_11_7_LIVE_PRIVATE_READONLY_STARTED") is False,
            claims.get("CAPABILITY_11_1_DEPENDENCY_SATISFIED") is True,
            claims.get("CAPABILITY_11_2_DEPENDENCY_SATISFIED") is True,
            claims.get("CAPABILITY_11_3_DEPENDENCY_SATISFIED") is True,
            claims.get("CAPABILITY_11_4_DEPENDENCY_SATISFIED") is True,
            claims.get("CAPABILITY_11_5_DEPENDENCY_SATISFIED") is True,
            CAPABILITY_11_6_LONG_RUNNING_EVIDENCE_RETAINED is True,
            CAPABILITY_11_6_NOT_ACTIVATED_RETAINED is True,
            CAPABILITY_11_6_NO_ORDER_SUBMIT_RETAINED is True,
            CAPABILITY_11_6_NO_NETWORK_SESSION_RETAINED is True,
            CAPABILITY_11_6_NO_PROVEN_CLAIMS_RETAINED is True,
        ]
    )
    return {
        "ok": ok,
        "PREDECESSOR_CAPABILITY_ID": PREDECESSOR_CAPABILITY_ID_11_6,
        "CAPABILITY_11_6_DEPENDENCY_SATISFIED": ok,
        "CAPABILITY_11_6_VERIFIER_RESULT": result.get("VERIFIER_RESULT"),
        "CAPABILITY_11_6_LONG_RUNNING_EVIDENCE_RETAINED": (
            CAPABILITY_11_6_LONG_RUNNING_EVIDENCE_RETAINED
        ),
        "CAPABILITY_11_6_NOT_ACTIVATED_RETAINED": CAPABILITY_11_6_NOT_ACTIVATED_RETAINED,
        "CAPABILITY_11_6_NO_ORDER_SUBMIT_RETAINED": CAPABILITY_11_6_NO_ORDER_SUBMIT_RETAINED,
        "CAPABILITY_11_6_NO_NETWORK_SESSION_RETAINED": CAPABILITY_11_6_NO_NETWORK_SESSION_RETAINED,
        "CAPABILITY_11_6_NO_PROVEN_CLAIMS_RETAINED": CAPABILITY_11_6_NO_PROVEN_CLAIMS_RETAINED,
    }
...
def prove_state_ownership_matrix_v1() -> dict[str, Any]:
    ...
    ok = all(
        [
            owners.get("live_private_readonly_port") == LIVE_PRIVATE_READONLY_PORT_OWNER,
            owners.get("live_shadow_reconciliation") == LIVE_SHADOW_RECONCILIATION_OWNER,
            owners.get("live_evidence_ladder") == LIVE_EVIDENCE_LADDER_OWNER,
    ...
    return {
        ...
        "LIVE_PRIVATE_READONLY_PORT_OWNER": LIVE_PRIVATE_READONLY_PORT_OWNER,
        "LIVE_SHADOW_RECONCILIATION_OWNER": LIVE_SHADOW_RECONCILIATION_OWNER,
        "LIVE_EVIDENCE_LADDER_OWNER": LIVE_EVIDENCE_LADDER_OWNER,
    }
