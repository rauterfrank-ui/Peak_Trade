...
BOUNDED_LONG_RUNNING_CAPABILITY_ID = (
    "CAPABILITY_11_SECTION_11_12_8_BOUNDED_LONG_RUNNING_AUTONOMOUS_PRODUCTIVE_TESTNET_CAMPAIGN_V1"
)
NEXT_CONSUMER_CAPABILITY_ID = BOUNDED_LONG_RUNNING_CAPABILITY_ID
NEXT_AFTER_UNLOCK_CONSUMER_CAPABILITY_ID = BOUNDED_LONG_RUNNING_CAPABILITY_ID
...
# Canonical execute authorization for LONG_RUNNING_TESTNET_PROVEN claim path
# (Owner decision EXECUTE_TOKEN_STRING; merge ≠ execute).
SCOPED_OWNER_GO_TOKEN = CAPABILITY_ID
SCOPED_OWNER_GO_SCOPE = "EXECUTE_BOUNDED_LONG_RUNNING_PRODUCTIVE_TESTNET_CAMPAIGN_NOW"
SCOPED_OWNER_GO_AUTHORIZATION = "EXECUTE_BOUNDED_LONG_RUNNING_PRODUCTIVE_TESTNET_CAMPAIGN_NOW"
# Legacy aliases (same OKX EEA Demo XPerp execute surface; does not reopen §11.12.8).
SCOPED_OWNER_GO_SCOPE_LEGACY_XPERP = "EXECUTE_BOUNDED_SECTION_11_12_8_OKX_EEA_DEMO_XPERP_CAMPAIGN"
SCOPED_OWNER_GO_SCOPE_LEGACY_ALIAS = "EXECUTE_PRODUCTIVE_TESTNET_CAMPAIGN_NOW"
# Back-compat import name: legacy long-running token is now the primary scope.
SCOPED_OWNER_GO_SCOPE_LEGACY_LONG_RUNNING = SCOPED_OWNER_GO_SCOPE
SCOPED_OWNER_GO_AUTHORIZATION_LEGACY_XPERP = SCOPED_OWNER_GO_SCOPE_LEGACY_XPERP
SCOPED_OWNER_GO_AUTHORIZATION_LEGACY_LONG_RUNNING = SCOPED_OWNER_GO_SCOPE
SCOPED_OWNER_GO_AUTHORIZATION_LEGACY_ALIAS = SCOPED_OWNER_GO_SCOPE_LEGACY_ALIAS
...
ACCEPTED_OWNER_GO_AUTHORIZATIONS: tuple[str, ...] = (
    SCOPED_OWNER_GO_AUTHORIZATION,
    SCOPED_OWNER_GO_AUTHORIZATION_LEGACY_XPERP,
    SCOPED_OWNER_GO_AUTHORIZATION_LEGACY_ALIAS,
)

# Master Runbook §11.12.8.1 Owner-ratified bounds (first-reached-wins).
...
# Offline/stub acceptance proves multi-cycle wiring without wallclock wait.
OFFLINE_PROOF_MAX_CYCLES = 3
OFFLINE_PROOF_CADENCE_SECONDS = 0
...
# Closed/deprecated historical path — never an active campaign instrument.
...
FORBIDDEN_SWAP_OWNER_GO_MARKERS: tuple[str, ...] = (
    "BTC-USDT-SWAP",
    "BTC_USDT_SWAP",
    "SWAP_WRITE",
    "SWAP_CAMPAIGN",
    "EXECUTE_BOUNDED_SECTION_11_12_8_OKX_EEA_DEMO_BTC_USDT_SWAP",
)
...
# Bound XPerp minSz/lotSz for this instrument (no dynamic sizing policy).
...
# State machine stages (durable campaign stages).
STATE_IDLE = "IDLE"
...
STATE_CYCLE_RUNNING = "CYCLE_RUNNING"
STATE_CYCLE_COMPLETE = "CYCLE_COMPLETE"
STATE_BOUND_REACHED = "BOUND_REACHED"
