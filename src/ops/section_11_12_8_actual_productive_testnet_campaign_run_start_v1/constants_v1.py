...
SCOPED_OWNER_GO_AUTHORIZATION = "EXECUTE_BOUNDED_SECTION_11_12_8_OKX_EEA_DEMO_XPERP_CAMPAIGN"
# Legacy unlock-era aliases (same bounded XPerp/EEA Demo execute authority only).
...
SCOPED_OWNER_GO_AUTHORIZATION_LEGACY_LONG_RUNNING = SCOPED_OWNER_GO_SCOPE_LEGACY_LONG_RUNNING
...
ACCEPTED_OWNER_GO_AUTHORIZATIONS: tuple[str, ...] = (
    ...
    SCOPED_OWNER_GO_AUTHORIZATION_LEGACY_LONG_RUNNING,
