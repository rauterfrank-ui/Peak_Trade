...
NEXT_AFTER_UNLOCK_CONSUMER_CAPABILITY_ID = (
    "SEPARATE_OWNER_GO_EXECUTE_PRODUCTIVE_TESTNET_CAMPAIGN_NOW"
)

# Exact productive OWNER_GO contract (accepted by this consumer).
...
# Superseded by REAL_PRODUCTIVE_TESTNET_EXECUTE_PATH_UNLOCK_V1: authorized
# MODE_PRODUCTIVE_REAL path is no longer classified implementation-only.
...
MODE_PRODUCTIVE_REAL = "PRODUCTIVE_REAL_NETWORK"
