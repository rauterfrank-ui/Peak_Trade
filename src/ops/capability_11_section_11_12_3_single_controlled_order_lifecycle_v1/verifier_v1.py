"""Verifier for Cap 11 §11.12.3 single controlled order lifecycle."""
...
CALL_GRAPH_BEFORE: dict[str, Any] = {
    "nodes": [
        ...
        "Cap11_4_SingleControlledOrderLifecycle_FixtureOnly",
        "SimulatedExecutionPort",
    ],
    "section_11_12_3": "forbidden_until_section_11_12_2_closed",
    "single_controlled_order_lifecycle": "cap_11_4_fixture_contract_only",
    "network_submit": "forbidden",
    "section_11_12_4": "not_started",
...
CALL_GRAPH_AFTER: dict[str, Any] = {
    ...
    "section_11_12_3": "productive_single_controlled_order_lifecycle_bound",
    "path_class": PATH_CLASS,
    "cap_11_4_single_controlled_lifecycle_contract": "reused_fixture_only",
...
def verify_capability_11_section_11_12_3_single_controlled_order_lifecycle_v1() -> dict[str, Any]:
    ...
    claims = {
        ...
        "SINGLE_CONTROLLED_ORDER_LIFECYCLE_ALLOWED": SINGLE_CONTROLLED_ORDER_LIFECYCLE_ALLOWED,
        "SINGLE_CONTROLLED_ORDER_LIFECYCLE_PERFORMED": proof.get(
            "single_controlled_order_lifecycle_performed"
        ),
        "CAP_11_4_SINGLE_CONTROLLED_LIFECYCLE_CONTRACT_REUSED": proof.get(
            "cap_11_4_single_controlled_lifecycle_contract_reused"
        ),
        "SECTION_11_12_2_PREDECESSOR_BOUND": proof.get("section_11_12_2_predecessor_bound"),
        ...
        "SECTION_11_12_3_PROOF_OK": proof.get("ok"),
        ...
        "SECTION_11_12_4_PATH_BLOCKED": proof.get("section_11_12_4_path_blocked"),
        ...
        "SECTION_11_12_4_BLOCKED": proof.get("section_11_12_4_blocked"),
