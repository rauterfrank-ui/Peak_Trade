...
def _validate_p01_overlap_with_u04_u05_contract_v1(
    ...
    if P01_U04_OVERLAP_RESOLVED is True:
        raise P01OverlapWithU04U05ContractError("P01_U04_OVERLAP_RESOLVED_PIN_FORBIDDEN")
    if P01_U05_OVERLAP_RESOLVED is True:
        raise P01OverlapWithU04U05ContractError("P01_U05_OVERLAP_RESOLVED_PIN_FORBIDDEN")
    ...
    if P01_EMBEDDED_STATE_RESOLVED is True:
        raise P01OverlapWithU04U05ContractError("P01_EMBEDDED_STATE_RESOLVED_PIN_FORBIDDEN")
    ...
    if P01_EQUITY_BASE_INCLUSION_RESOLVED is True:
        raise P01OverlapWithU04U05ContractError("P01_EQUITY_BASE_INCLUSION_RESOLVED_PIN_FORBIDDEN")
    ...
    if P01_APPLICABILITY_RESOLVED is True:
        raise P01OverlapWithU04U05ContractError("P01_APPLICABILITY_RESOLVED_PIN_FORBIDDEN")
    ...
    if P01_TERM_SET_RESOLVED is True:
        raise P01OverlapWithU04U05ContractError("P01_TERM_SET_RESOLVED_PIN_FORBIDDEN")
    if P01_VALUE_UNIT_CLASS_RESOLVED is True:
        raise P01OverlapWithU04U05ContractError("P01_VALUE_UNIT_CLASS_RESOLVED_PIN_FORBIDDEN")
    if P01_TERM_SEMANTICS_RESOLVED is True:
        raise P01OverlapWithU04U05ContractError("P01_TERM_SEMANTICS_RESOLVED_PIN_FORBIDDEN")
    ...
    if p01_term.embedded_term_state != "UNRESOLVED":
        raise P01OverlapWithU04U05ContractError("P01_ALGEBRA_EMBEDDED_MUST_REMAIN_UNRESOLVED")
    u04_term = next(
