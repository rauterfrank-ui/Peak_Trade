"""CURRENT_PRODUCTIVE one cycle after a new finalized 1m C1 observation V3.
...
when a confirm=1 1m candle has venue_event_time > 1789525080.0. Cap-23 is not
...
rewrite the consumed V1/V2 DV standing persist.
...
EXPECTED_ORIGIN_MAIN_SHA = "1d076b415d1da33e08d7bf2821d14ea25bdf0317"
...
PREVIOUS_CYCLE_ID = "dv-0G-USDT-SWAP-2026-09-16T02:19:56Z"
...
_OCCUPANCY_DECISION_ID = "dv-occupancy-reproof-after-c1-gate-v3"
    ...
    *,
    ...
    if c1_gate_override is not None:
        ...
        gate_result = gate_transport.get(
            ...
            auth_required=False,
            pretrade_decision_id="dv3-c1-gate-0g-usdt-swap",
        )
