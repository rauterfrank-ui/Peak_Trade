...
def _validate_p01_applicability_class_contract_v1(
    ...
    if P01_APPLICATION_PREDICATE_RESOLVED is True:
        raise P01ApplicabilityClassContractError("P01_APPLICATION_PREDICATE_RESOLVED_PIN_FORBIDDEN")
    if P01_APPLICABILITY_RESOLVED is True:
        raise P01ApplicabilityClassContractError("P01_APPLICABILITY_RESOLVED_PIN_FORBIDDEN")
    ...
    if P01_REQUIREDNESS_RESOLVED is True:
        raise P01ApplicabilityClassContractError("P01_REQUIREDNESS_RESOLVED_PIN_FORBIDDEN")
    if P01_OPTIONALITY_RESOLVED is True:
        raise P01ApplicabilityClassContractError("P01_OPTIONALITY_RESOLVED_PIN_FORBIDDEN")
    if P01_ZERO_SEMANTICS_RESOLVED is True:
        raise P01ApplicabilityClassContractError("P01_ZERO_SEMANTICS_RESOLVED_PIN_FORBIDDEN")
    if P01_ABSENCE_SEMANTICS_RESOLVED is True:
        raise P01ApplicabilityClassContractError("P01_ABSENCE_SEMANTICS_RESOLVED_PIN_FORBIDDEN")
    if P01_ZERO_ABSENCE_NA_RESOLVED is True:
        raise P01ApplicabilityClassContractError("P01_ZERO_ABSENCE_NA_RESOLVED_PIN_FORBIDDEN")
    if P01_INPUT_PRECONDITIONS_RESOLVED is True:
        raise P01ApplicabilityClassContractError("P01_INPUT_PRECONDITIONS_RESOLVED_PIN_FORBIDDEN")
    ...
    if P01_MEMBER_ROLE_SIGN_UNIT_RESOLVED is True:
        raise P01ApplicabilityClassContractError("P01_MEMBER_ROLE_SIGN_UNIT_RESOLVED_PIN_FORBIDDEN")
    ...
    if P01_TERM_SEMANTICS_RESOLVED is True:
        raise P01ApplicabilityClassContractError("P01_TERM_SEMANTICS_RESOLVED_PIN_FORBIDDEN")
