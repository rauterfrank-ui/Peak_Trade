"""CURRENT_PRODUCTIVE one cycle after a new finalized 1m C1 observation V2.
...
when a confirm=1 1m candle has venue_event_time > 1789523160.0. Cap-23 is not
...
rewrite the consumed V1 DV standing persist.
...
EXPECTED_ORIGIN_MAIN_SHA = "7eb4f04c3f5ffcb7397de40a15d95e0433e5b5a6"
...
PREVIOUS_CYCLE_ID = "dv-0G-USDT-SWAP-2026-09-16T01:47:03Z"
...
_OCCUPANCY_DECISION_ID = "dv-occupancy-reproof-after-c1-gate-v2"
    ...
    *,
    ...
    if c1_gate_override is not None:
        ...
        gate_result = gate_transport.get(
            ...
            auth_required=False,
            pretrade_decision_id="dv2-c1-gate-0g-usdt-swap",
        )
