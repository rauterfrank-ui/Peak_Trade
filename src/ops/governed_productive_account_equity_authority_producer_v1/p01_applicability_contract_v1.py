...
def _validate_p01_applicability_contract_v1(contract: P01ApplicabilityContractV1) -> None:
    ...
    if P01_TERM_SET_RESOLVED is True:
        raise P01ApplicabilityContractError("P01_TERM_SET_RESOLVED_PIN_FORBIDDEN")
    if P01_VALUE_UNIT_CLASS_RESOLVED is True:
        raise P01ApplicabilityContractError("P01_VALUE_UNIT_CLASS_RESOLVED_PIN_FORBIDDEN")
