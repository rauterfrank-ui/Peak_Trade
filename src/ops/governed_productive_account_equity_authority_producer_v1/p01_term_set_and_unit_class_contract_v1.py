...
def _validate_p01_term_set_and_unit_class_contract_v1(
    ...
    if P01_TERM_SET_RESOLVED is True:
        raise P01TermSetAndUnitClassContractError("P01_TERM_SET_RESOLVED_PIN_FORBIDDEN")
    if P01_VALUE_UNIT_CLASS_RESOLVED is True:
        raise P01TermSetAndUnitClassContractError("P01_VALUE_UNIT_CLASS_RESOLVED_PIN_FORBIDDEN")
