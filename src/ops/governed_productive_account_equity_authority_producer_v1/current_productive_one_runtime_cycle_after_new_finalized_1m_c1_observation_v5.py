"""CURRENT_PRODUCTIVE one cycle after a new finalized 1m C1 observation V5.
...
when a confirm=1 1m candle has venue_event_time > 1789527780.0. Cap-23 is not
...
CANONICAL_PACK_RELPATH = (
    ...
    "finalized_1m_c1_observation_v5"
)
DV_V4_PACK = (
    "evidence/ops/full_core_current_productive_one_runtime_cycle_after_new_"
...
PREVIOUS_CYCLE_ID = "dv-0G-USDT-SWAP-2026-09-16T03:04:22Z"
...
_OCCUPANCY_DECISION_ID = "dv-occupancy-reproof-after-c1-gate-v5"
...
def require_current_productive_v5_checkout_provenance_v1(
    *,
    origin_main_sha: str,
    ...
    *,
    ...
    if c1_gate_override is not None:
        ...
        gate_result = gate_transport.get(
            ...
            auth_required=False,
            pretrade_decision_id="dv5-c1-gate-0g-usdt-swap",
        )
    ...
    if c1_gate["CONDITION_GATE"] != "SATISFIED":
        ...
        lineage = {
            "OWNER_GO": OWNER_GO,
            "THIS_SLICE": THIS_SLICE,
            "DV_V4_PACK": DV_V4_PACK,
            "DV_V4_PACK_IS_NOT_CURRENT_AUTHORITY": TRUE_TOKEN,
...
def main() -> int:
    ...
    parser.add_argument("--origin-main-sha", default=CLI_ORIGIN_MAIN_SHA_DEFAULT)
