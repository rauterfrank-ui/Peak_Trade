"""CURRENT_PRODUCTIVE one cycle after a new finalized 1m C1 observation.
...
when a confirm=1 1m candle has venue_event_time > 1789522140.0. Cap-23 is not
forced. Cursor restore remains exact schema/native/instrument/lineage. Does
not POST. Does not mint an external-effect permit. Does not poll.
...
PREVIOUS_CYCLE_ID = "du-0G-USDT-SWAP-2026-09-16T01:30:45Z"
...
_OCCUPANCY_DECISION_ID = "dv-occupancy-reproof-after-c1-gate-v1"
    ...
    *,
    ...
    if gate_payload is None:
        ...
        gate_result = gate_transport.get(
            ...
            auth_required=False,
            pretrade_decision_id="dv-c1-gate-0g-usdt-swap",
        )
