...
STATUS_AUTHORITIES_RATIFIED = "OWNER_STA_AUTHORITIES_RATIFIED_INSTANCE_FIELDS_STILL_OPEN"
...
OWNER_RATIFIED_CANDLE_SOURCE_REF = PROPOSED_CANDLE_SOURCE_REF
OWNER_RATIFIED_MARK_SOURCE_REF = PROPOSED_MARK_SOURCE_REF
OWNER_RATIFIED_INSTRUMENT_BINDING: dict[str, str] = {
    "venue": "okx",
