"""Constants for CURRENT MF N=5 Full-Autonomy occupied-lane MV2/DP handoff join.

S2 implements identity-preserving per-lane composition of admitted
BoundInstrumentV1 values with existing IsolatedLaneSlotV1 objects.
"""
...
from src.ops.current_mf_n5_full_autonomy_occupied_lane_bound_ingest_join_v1.constants_v1 import (
    HOST_JOIN as INGEST_HOST_JOIN,
    OWNER as ADMITTED_MAP_PRODUCER_OWNER_VALUE,
...
OWNER = "ops.current_mf_n5_full_autonomy_occupied_lane_mv2_dp_handoff_join_v1"
CONTRACT_ID = "CURRENT_MF_N5_FULL_AUTONOMY_OCCUPIED_LANE_MV2_DP_HANDOFF_JOIN_CONTRACT_V1"
SCHEMA_VERSION = "current_mf_n5_full_autonomy_occupied_lane_mv2_dp_handoff_join.v1"
...
ADMITTED_MAP_PRODUCER_OWNER = ADMITTED_MAP_PRODUCER_OWNER_VALUE
HANDOFF_CONSUMER_OWNER = OWNER
FULL_AUTONOMY_HOST_OWNER = "stateful_no_order_host_join_v1"
FULL_CORE_LIVE_PATH_AUTHORITY = "full_core_live_path_authority_v1"

HANDOFF_ADMITTED_INPUT_PRODUCER = INGEST_S2_JOIN_SYMBOL
...
MV2_DP_INGRESS_TYPE = HANDOFF_FULL_CORE_INGEST_OBJECT
...
assert INGEST_HOST_JOIN is False
...
assert MV2_DP_INGRESS_TYPE == "BoundInstrumentV1"
assert HANDOFF_ADMITTED_INPUT_PRODUCER == "admit_occupied_lane_bound_instruments_v1"
assert HANDOFF_TOPOLOGY_INPUT_TYPE == "IsolatedLaneTopologyV1"
assert HANDOFF_SLOT_TYPE == "IsolatedLaneSlotV1"
...
assert ADMITTED_MAP_PRODUCER_OWNER == (
    "ops.current_mf_n5_full_autonomy_occupied_lane_bound_ingest_join_v1"
)
assert HANDOFF_CONSUMER_OWNER == OWNER
assert S2_JOIN_SYMBOL != HANDOFF_ADMITTED_INPUT_PRODUCER
...
FAILURE_AUTHORITY = "FULL_AUTONOMY_MV2_DP_HANDOFF_AUTHORITY_CLAIM_FORBIDDEN"
FAILURE_UNKNOWN_LANE_ID = "FULL_AUTONOMY_MV2_DP_HANDOFF_UNKNOWN_LANE_ID"
FAILURE_BOUND_TYPE = "FULL_AUTONOMY_MV2_DP_HANDOFF_BOUND_TYPE_MISMATCH"
FAILURE_TOPOLOGY_TYPE = "FULL_AUTONOMY_MV2_DP_HANDOFF_TOPOLOGY_TYPE_MISMATCH"
FAILURE_OCCUPANCY = "FULL_AUTONOMY_MV2_DP_HANDOFF_OCCUPANCY_MISMATCH"
FAILURE_IDENTITY_MISMATCH = "FULL_AUTONOMY_MV2_DP_HANDOFF_IDENTITY_MISMATCH"
FAILURE_STATE_ROOT_MISMATCH = "FULL_AUTONOMY_MV2_DP_HANDOFF_STATE_ROOT_MISMATCH"
