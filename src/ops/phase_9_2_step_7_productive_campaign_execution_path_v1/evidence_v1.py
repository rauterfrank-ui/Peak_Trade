"""Evidence materialization for Step-7 productive campaign execution path."""
...
from src.ops.phase_9_2_step_7_productive_campaign_execution_path_v1.digest_v1 import (
    sha256_canonical_v1,
...
from src.ops.phase_9_2_step_7_productive_campaign_execution_path_v1.verifier_v1 import (
    verify_productive_campaign_execution_path_manifest_v1,
)


def materialize_productive_campaign_execution_path_evidence_v1(
    *,
    repository_sha: str,
    config_digest: str,
    ...
    write_json_atomic_v1(
        fixtures / "productive_campaign_execution_path_proof_v1.json", proof.to_dict()
    )
    write_json_atomic_v1(
        fixtures / "binding_vs_productive_campaign_executor_contrast_v1.json", contrast
    )
    ...
    write_json_atomic_v1(out / "productive_campaign_execution_path_manifest_v1.json", manifest)

    verifier = verify_productive_campaign_execution_path_manifest_v1(manifest)
    write_json_atomic_v1(fixtures / "productive_campaign_execution_path_verifier_v1.json", verifier)
    ...
    for rel in (
        "SUMMARY.json",
        "productive_campaign_execution_path_manifest_v1.json",
        "fixtures/productive_campaign_execution_path_proof_v1.json",
        "fixtures/binding_vs_productive_campaign_executor_contrast_v1.json",
        "fixtures/failure_injection_results_v1.json",
        "fixtures/productive_campaign_execution_path_verifier_v1.json",
    ):
        p = out / rel
