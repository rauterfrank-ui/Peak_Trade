"""Public-MD GET-only network boundary for Step-5 execution (reuses Step-5 binding proof)."""
...
from src.ops.phase_9_2_productive_public_md_prolonged_natural_market_wallclock_binding_v1.network_boundary_v1 import (
    prove_public_md_network_boundary_v1 as prove_step5_binding_network_boundary_v1,
)
...
# Import surfaces that must remain unreachable from this execution package.
...
def prove_public_md_get_only_boundary_v1(
    *,
    ...
    base = prove_step5_binding_network_boundary_v1(environ=environ)
    ...
    root = (
        ...
        if package_root is not None
            ...
            repo_root_v1() / "src/ops/phase_9_2_step_5_governed_productive_real_network_"
    ...
    return {
        ...
        "binding_boundary": base,
        "notes": [
            "REUSES_STEP5_BINDING_NETWORK_BOUNDARY=true",
