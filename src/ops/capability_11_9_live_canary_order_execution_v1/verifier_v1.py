"""Capability verifier for Cap 11.9 Live canary order execution."""
...
def verify_capability_11_9_v1() -> dict[str, Any]:
    proofs = {
        "live_canary_minimum_exposure": prove_live_canary_minimum_exposure_contract_v1(),
        "live_canary_order_execution": prove_live_canary_order_execution_contract_v1(),
        "live_canary_evidence_ladder": prove_live_canary_evidence_ladder_contract_v1(),
    ...
    claims = {
        ...
        "LIVE_CANARY_MINIMUM_EXPOSURE_CONTRACT_BOUND": proofs["live_canary_minimum_exposure"].get(
            "LIVE_CANARY_MINIMUM_EXPOSURE_CONTRACT_BOUND"
        ),
        "LIVE_CANARY_MINIMUM_EXPOSURE_CONTRACT_ACTIVATED": False,
        "LIVE_CANARY_ORDER_EXECUTION_CONTRACT_BOUND": proofs["live_canary_order_execution"].get(
            "LIVE_CANARY_ORDER_EXECUTION_CONTRACT_BOUND"
        ),
        "LIVE_CANARY_ORDER_EXECUTION_CONTRACT_ACTIVATED": False,
        "LIVE_CANARY_EVIDENCE_LADDER_CONTRACT_BOUND": proofs["live_canary_evidence_ladder"].get(
            "LIVE_CANARY_EVIDENCE_LADDER_CONTRACT_BOUND"
        ),
        "LIVE_CANARY_EVIDENCE_LADDER_CONTRACT_ACTIVATED": False,
        "LIVE_CANARY_ORDER_EXECUTION_FIXTURE_ONLY": True,
        ...
        "CAPABILITY_11_10_LIVE_BOUNDED_SINGLE_FUTURE_STARTED": False,
