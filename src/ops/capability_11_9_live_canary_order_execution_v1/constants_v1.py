"""Constants for CAPABILITY_11_9 Live canary order execution."""

from __future__ import annotations

CAPABILITY_ID = "CAPABILITY_11_9_LIVE_CANARY_ORDER_EXECUTION_V1"
PACKAGE_MARKER = "CAPABILITY_11_9_LIVE_CANARY_ORDER_EXECUTION_V1=true"
OWNER = "ops.capability_11_9_live_canary_order_execution_v1"
AUTHORITY_OWNER = OWNER
SCHEMA_VERSION = "capability_11_9_live_canary_order_execution.v1"
PRODUCER_VERSION = "capability_11_9_live_canary_order_execution.v1"
CONTRACT_VERSION = "v1"
...
# Cap 11.1–11.8 retention (must not be weakened / activated).
...
# Reachability claims for Cap 11.9 (contracts only — no real Live canary session).
...
# Cap 11.9 contract surface claims (bound, not activated, not observed/proven).
...
# Cap 11.9 does NOT claim Live evidence-ladder proven / observed fields (§11.14).
...
# Explicit Cap 11.10+ surfaces remain out of scope / unbound.
...
# Live progression: Cap 11.9 owns LIVE_CANARY_MINIMUM_EXPOSURE only (§11.13 / §11.19).
LIVE_PROGRESSION_STAGES_IN_SCOPE: tuple[str, ...] = ("LIVE_CANARY_MINIMUM_EXPOSURE",)
...
# Canary lifecycle schema states (fixture-only; no real submit side-effect).
LIVE_CANARY_LIFECYCLE_STATES: tuple[str, ...] = (
    "INTENT_CREATED",
    "ORDER_PLAN_CREATED",
    "RISK_RESERVED",
...
LIVE_CANARY_FORBIDDEN_LIFECYCLE_STATES: tuple[str, ...] = (
    "PARTIALLY_FILLED",
    "FILLED",
    "CANCEL_PENDING",
    "AMEND_PENDING",
...
LIVE_CANARY_REQUIRED_FIELDS: tuple[str, ...] = (
    "intent_id",
    "order_plan_id",
    "client_order_id",
    "instrument_id",
...
LIVE_CANARY_ALLOWED_EXECUTION_MODE = "LIVE_CANARY"
...
# Cap 11.9 in-scope ladder focus (contract-bound only; observed=false).
LIVE_CANARY_LADDER_FOCUS_FIELDS: tuple[str, ...] = ("LIVE_SUBMIT_ACK_OBSERVED",)

# Cap 11.10+ ladder fields remain forbidden to claim from Cap 11.9.
LIVE_CANARY_LADDER_FORBIDDEN_CLAIM_FIELDS: tuple[str, ...] = (
    "LIVE_FILL_OBSERVED",
    "LIVE_FEE_OBSERVED",
    "LIVE_POSITION_RECONCILED",
    "LIVE_ACCOUNTING_RECONSTRUCTED",
...
LIVE_CANARY_MINIMUM_EXPOSURE_OWNER = OWNER
LIVE_CANARY_ORDER_EXECUTION_OWNER = OWNER
LIVE_CANARY_EVIDENCE_LADDER_OWNER = OWNER

EVIDENCE_DIRNAME = "capability_11_9_live_canary_order_execution_v1"
