"""Core-logic parity proof for post-unlock runtime invocation (no trading-core mutation)."""
...
def prove_phase92_post_unlock_invocation_parity_v1() -> dict[str, Any]:
    base = prove_phase92_session_go_parity_v1()
    claims = {
        ...
        "phase92_session_go_parity_reused": True,
    }
