"""Verifier for Phase 11 §11.17 SIMULATED_LIFECYCLE_PROVEN evidence closure."""
...
def verify_phase_11_section_11_17_simulated_lifecycle_proven_v1() -> dict[str, Any]:
    try:
        binding = bind_simulated_lifecycle_proven_from_cap71_v1()
    except SimulatedLifecycleProvenBindingError as exc:
        return {
            "ok": False,
    ...
    residual_ok = all(
        [
            ...
            binding.get("SIMULATED_LIFECYCLE_PROVEN") is True,
