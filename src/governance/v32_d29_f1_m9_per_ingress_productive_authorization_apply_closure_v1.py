    ...
    *, repo_root: Path | None = None
    ...
    return (
        ...
        PerIngressClosureGraphEdgeV1(
            ...
            target=("V32_D29_F1_M9_EXPLICIT_OWNER_PRODUCTIVE_APPLY_POLICY_AND_AUTHORITY_EDGE_V1"),
            kind=ClosureEdgeKindV1.OWNER_POLICY_BOUNDARY,
            evidence_ref=POLICY_EDGE_DECISION,
        ),
        PerIngressClosureGraphEdgeV1(
            source=("V32_D29_F1_M9_EXPLICIT_OWNER_PRODUCTIVE_APPLY_POLICY_AND_AUTHORITY_EDGE_V1"),
            target=BLOCKER_EDGE,
            kind=ClosureEdgeKindV1.OWNER_POLICY_BOUNDARY,
            evidence_ref=POLICY_EDGE_DECISION,
        ),
