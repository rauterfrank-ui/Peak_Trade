...
def present_market_landscape_v2(
    ...
    *,
    ...
    from .universe_rail_presentation_v1 import build_universe_rail_presentation_v1

    universe_rail_ctx = build_universe_rail_presentation_v1(page.universe_ranking)
    universe_rail = universe_rail_ctx.to_template_dict()
