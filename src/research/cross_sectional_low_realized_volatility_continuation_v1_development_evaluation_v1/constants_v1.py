"""Frozen constants for CSLRVC v1 DEVELOPMENT evaluation entry point.

Development evaluation is authorized on the three authority surfaces under a
separate operator GO for exactly one bounded DEVELOPMENT run. Measurement-contract
thresholds and strategy/baseline semantics remain unchanged. Holdout/runtime remain
closed.
"""

from __future__ import annotations

PACKAGE_MARKER = "CROSS_SECTIONAL_LOW_REALIZED_VOLATILITY_CONTINUATION_V1_DEVELOPMENT_EVALUATION_ENTRY_POINT_V1=true"

SCOPE_ID = "cross_sectional_low_realized_volatility_continuation_v1_development_evaluation_v1"
OWNER_SURFACE = (
    "CROSS_SECTIONAL_LOW_REALIZED_VOLATILITY_CONTINUATION_V1_DEVELOPMENT_EVALUATION_ENTRY_POINT_V1"
)
EVALUATION_RUN_ID = "evaluate_cross_sectional_low_realized_volatility_continuation_development_v1"
STRATEGY_ID = "cross_sectional_low_realized_volatility_continuation"
...
FROZEN_MEASUREMENT_CONTRACT_DIGEST = (
    "e5bea387a3898142f25e593b3d5f88b749fd12d3302e1be6e0f7b1cfb72381f3"
)
...
IMPLEMENTATION_BINDING_REL_PATH = "config/research/cross_sectional_low_realized_volatility_continuation_v1_strategy_implementation_binding_v1.json"
ENTRY_POINT_BINDING_REL_PATH = (
    "config/research/"
    "cross_sectional_low_realized_volatility_continuation_v1_development_evaluation_entry_point_binding_v1.json"
)
...
GOVERNANCE_REL_PATH = "docs/governance/CROSS_SECTIONAL_LOW_REALIZED_VOLATILITY_CONTINUATION_V1_DEVELOPMENT_EVALUATION_ENTRY_POINT_V1.md"
CLI_REL_PATH = "scripts/research/run_evaluate_cross_sectional_low_realized_volatility_continuation_development_v1.py"

SHARED_CHANNEL_CORE_REL_PATH = "src/research/price_channel_breakout_core_v1.py"
STRATEGY_IMPL_REL_PATH = (
    "src/research/cross_sectional_low_realized_volatility_continuation_v1_strategy_v1.py"
)
BASELINE_IMPL_REL_PATH = "src/research/unconditional_20_bar_price_channel_breakout_v1.py"
VOL_STATE_REL_PATH = (
    "src/research/cross_sectional_low_realized_volatility_continuation_v1_vol_state_v1.py"
)
