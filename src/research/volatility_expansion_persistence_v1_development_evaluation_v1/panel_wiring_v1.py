"""Panel wiring: bind VEP treatment + unconditional baseline to panel series.
...
def wire_treatment_and_baseline_panel_events_v1(
    ...
    *,
    ...
    for series in panel_series:
        ...
        treatment_rows = generate_volatility_expansion_persistence_events_v1(frame)
        ...
        treatment_arms.append(
            ArmEventSeriesV1(
                ...
                entry_event_mask=tuple(
                    r.event is VolatilityExpansionPersistenceEventV1.ENTRY_EVENT
