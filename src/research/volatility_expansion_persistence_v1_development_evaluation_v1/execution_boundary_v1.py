"""Execution boundary for VEP v1 development evaluation.
...
PnL realization reuses the productive VCB exit evaluator (no second PnL truth).
"""
...
class RealExecutionBoundaryV1:
    ...
    def load_development_panel(
        ...
        *,
        ...
        from src.research.volatility_expansion_persistence_v1_development_evaluation_v1.panel_loader_v1 import (
