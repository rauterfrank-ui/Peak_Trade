"""Evidence and registry contracts for VEP v1 development evaluation."""
...
def build_run_slot_claim_v1(
    *,
    ...
    return {
        "schema_version": "evaluate_volatility_expansion_persistence_run_slot_claim.v1",
...
def build_registry_metadata_v1(
    *,
    ...
    return {
        "schema_version": "evaluate_volatility_expansion_persistence_registry.v1",
        "evaluation_run_id": EVALUATION_RUN_ID,
        "hypothesis_id": HYPOTHESIS_ID,
        "strategy_identity": STRATEGY_IDENTITY,
