"""Deterministic binding/digest resolution for VEP v1 eval entry point."""
...
def resolve_strategy_params(contract: Mapping[str, Any] | None = None) -> dict[str, Any]:
    ...
    if not frozen:
        frozen = {
            ...
            "expansion_confirmation_threshold": 0.8,
            "expansion_event_consumption": "SINGLE_USE",
            "expansion_rearm_requires_percentile_below_threshold": True,
            "initial_stop_atr_multiple": 1.5,
            "max_entries_per_expansion_event": 1,
            ...
            "persistence_window_end_offset": 6,
            "persistence_window_start_offset": 1,
            "regime_exit_percentile_lt": 0.5,
            "signal_lag_bars": 1,
...
def assert_shared_channel_core_bound() -> None:
    ...
    from src.research import volatility_expansion_persistence_v1_strategy_v1 as strategy
...
def materialize_entry_point_binding_payload(repo_root: Path) -> dict[str, Any]:
    ...
    return {
        "artifact_kind": (
            "volatility_expansion_persistence_v1_development_evaluation_entry_point_binding"
        ),
        "artifact_version": "v1",
        ...
        "evidence_ref": "docs/evidence/evaluate_volatility_expansion_persistence_development_v1/",
        ...
        "schema_version": (
            "volatility_expansion_persistence_v1_development_evaluation_entry_point_binding.v1"
        ),
