...
RE_RUN_GO_TOKEN = (
    "GO_BOUNDED_CROSS_SECTIONAL_FUNDING_RATE_CARRY_V0_OFFLINE_ECONOMIC_EVALUATION_RE_RUN_V0"
)
...
ALLOWED_EXECUTION_GO_TOKENS: frozenset[str] = frozenset({GO_TOKEN, RE_RUN_GO_TOKEN})
EXPECTED_ORIGIN_MAIN_SHA = "ef43a86696b4e479112448136a3aa90951144a98"
...
def materialize_economic_viability_evidence(
    *,
    ...
    """Persist cross-sectional funding-carry EconomicViabilityEvidenceV1-shaped payload."""
    envelope = dict(versioned_binding)
    ...
    body: dict[str, Any] = {
        "schema_version": "economic_viability_evidence_cross_sectional_funding_carry_v0",
        "strategy_id": STRATEGY_ID,
        "strategy_version": STRATEGY_VERSION,
