"""Cross-sectional funding-rate dispersion-zscore-reversion v0 versioned research binding materializer."""
...
from src.research.cross_sectional_funding_rate_dispersion_zscore_reversion_ranking_semantics_binding_v0 import (
    ...
    materialize_versioned_funding_rate_dispersion_zscore_reversion_ranking_semantics_binding_v0,
...
PACKAGE_MARKER = (
    "CROSS_SECTIONAL_FUNDING_RATE_DISPERSION_ZSCORE_REVERSION_V0_VERSIONED_RESEARCH_BINDING_V0=true"
)
BINDING_ARTIFACT_VERSION = "v0"
BINDING_SCHEMA_VERSION = (
    "cross_sectional_funding_rate_dispersion_zscore_reversion_v0_versioned_research_binding.v0"
)
CONFIG_REL_PATH = "config/research/cross_sectional_funding_rate_dispersion_zscore_reversion_v0_versioned_research_binding_v0.json"
...
MATERIAL_DIFFERENCE_BASIS = (
    "panel_dispersion_gated_zscore_mean_reversion_not_rank_delta_persistence_or_dual_leg_spread"
)
...
def compute_implementation_digest_v0() -> str:
    return _stable_digest(
        {
            "module": "cross_sectional_funding_rate_dispersion_zscore_reversion_v0_versioned_research_binding_v0",
    ...
    return _stable_digest(
        {
            ...
            "dispersion_zscore_reversion_signal": True,
...
def build_panel_dataset_binding_v0() -> dict[str, Any]:
    return {
        ...
        "funding_usage": "funding_rate_for_zscore_computation",
        "narrow_adapter": "pit_okx_pt1h_panel_funding_field_materialization.v0",
...
def materialize_versioned_research_binding_v0() -> dict[str, Any]:
    base = materialize_funding_rate_dispersion_zscore_reversion_ranking_semantics_binding_v0()
    ...
    return {
        "artifact_kind": "cross_sectional_funding_rate_dispersion_zscore_reversion_v0_versioned_research_binding",
...
def write_versioned_research_binding_artifacts_v0(repo_root: Path) -> tuple[Path, Path]:
    envelope = materialize_versioned_research_binding_v0()
    ranking_envelope = materialize_versioned_funding_rate_dispersion_zscore_reversion_ranking_semantics_binding_v0()
