"""RV(24) + percentile-rank and ATR14 helpers for VEPC v1.

Reuses the frozen VCEB RV/percentile/ATR helpers (identical estimator contract).
Authority remains the VEPC preregistered measurement contract.
"""
...
VOL_STATE_OWNER = "research.volatility_expansion_pullback_continuation_v1_vol_state_v1"
