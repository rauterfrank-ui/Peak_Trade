"""Funding-rate rank-delta cross-sectional ranking semantics declarative binding schema (v0)."""
...
PACKAGE_MARKER = "CROSS_SECTIONAL_FUNDING_RATE_RANK_DELTA_RANKING_SEMANTICS_BINDING_V0=true"
SCHEMA_VERSION = "cross_sectional_funding_rate_rank_delta_ranking_semantics_binding.v0"
HYPOTHESIS_ID = "CROSS_SECTIONAL_FUNDING_RATE_RANK_DELTA_NON_BITCOIN_PERPETUALS_V0"

SCORE_FAMILY_POLICY = "cross_sectional_funding_rate_rank_delta_v0"
DIRECTION_POLICY = "symmetric_funding_rank_delta_extremum_single_leg_rotation_v0"
SELECTION_MODE = "funding_rank_delta_extremes_single_leg_rotation_v0"
...
TIE_BREAK_POLICY = "rank_delta_asc_then_instrument_id_asc_for_long_leg"
THRESHOLD_POLICY = "rank_delta_magnitude_threshold_no_continuous_tuning"

ORCHESTRATOR_OWNER = "cross_sectional_funding_rate_rank_delta_single_slot_research_orchestrator_v0"
...
VERSIONED_BINDING_CONFIG_REL_PATH = (
    "config/research/cross_sectional_funding_rate_rank_delta_v0_ranking_semantics_binding_v0.json"
)
...
RATIFIED_OPERATOR_RATIONALES: dict[str, str] = {
    "rank_lookback_k": (
        "Frozen K=4 PT1H bars for cross-sectional rank delta lookback; no post-hoc tuning."
    ),
    "rebalance_interval_bars": (
    ...
    "min_rank_delta_for_entry": (
        "At least one rank-position change required; no threshold rescue via weakening."
    ),
    "switch_entry_delay_epochs": (
...
def materialize_funding_rate_rank_delta_ranking_semantics_binding_v0() -> dict[str, Any]:
    numeric_bindings = {
    ...
    return {
        ...
        "tie_break_semantics": {
            "long_leg_order": "rank_delta_asc_then_instrument_id_asc",
            "short_leg_order": "rank_delta_desc_then_instrument_id_asc",
            "tie_break_policy": TIE_BREAK_POLICY,
            "abs_rank_delta_tie_leg_order": "instrument_id_asc",
        },
        "threshold_semantics": {
            "threshold_policy": THRESHOLD_POLICY,
            "min_rank_delta_for_entry_required": True,
        },
        "orchestrator": {
...
def materialize_versioned_funding_rate_rank_delta_ranking_semantics_binding_v0() -> dict[str, Any]:
    binding = apply_ratified_operator_bindings_v0(
        materialize_funding_rate_rank_delta_ranking_semantics_binding_v0()
    )
    return {
        "artifact_kind": "cross_sectional_funding_rate_rank_delta_ranking_semantics_versioned_binding",
        "artifact_version": "v0",
        "binding": binding,
