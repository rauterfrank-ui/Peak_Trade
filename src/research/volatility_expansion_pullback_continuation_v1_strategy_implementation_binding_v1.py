"""Validator for VOLATILITY_EXPANSION_PULLBACK_CONTINUATION_V1 strategy-implementation binding."""
...
PACKAGE_MARKER = (
    "VOLATILITY_EXPANSION_PULLBACK_CONTINUATION_V1_STRATEGY_IMPLEMENTATION_BINDING=true"
)
BINDING_REL_PATH = (
    "config/research/volatility_expansion_pullback_continuation_v1_"
    "strategy_implementation_binding_v1.json"
)
REQUIRED_DIGEST = "e4bd724549670e434aa95c4b3703ceaa012bda777b005f08ae11441b7ecea03a"
...
def validate_implementation_binding(
    ...
    _require(
        "NO_VOLATILITY_CONTRACTION_EXPANSION_BREAKOUT_V1_RETRY" in non_actions,
