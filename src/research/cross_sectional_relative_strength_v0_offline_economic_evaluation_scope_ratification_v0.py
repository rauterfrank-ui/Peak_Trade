"""Cross-sectional relative-strength v0 offline economic evaluation scope ratification v0.

Deterministic, fail-closed ratification of bounded offline-only economic evaluation
scope for cross_sectional_relative_strength/v0. Does not execute evaluation.
"""
...
def materialize_cross_sectional_offline_economic_evaluation_scope_ratification_v0(
    *,
    ...
    semantic_payload = {
        ...
        "allowed_evaluation_stages": body["allowed_evaluation_stages"],
