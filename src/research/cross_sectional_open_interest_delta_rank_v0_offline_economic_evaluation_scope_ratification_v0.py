"""Cross-sectional open-interest delta rank v0 offline economic evaluation scope ratification v0.

Deterministic, fail-closed ratification of bounded offline-only economic evaluation
scope for cross_sectional_open_interest_delta_rank/v0. Does not execute evaluation.
"""
...
PACKAGE_MARKER = (
    "CROSS_SECTIONAL_OPEN_INTEREST_DELTA_RANK_V0_OFFLINE_ECONOMIC_EVALUATION_"
    "SCOPE_RATIFICATION_V0=true"
)

SCHEMA_VERSION = (
    "cross_sectional_open_interest_delta_rank_v0_offline_economic_evaluation_scope_ratification.v0"
)
RATIFICATION_ID = (
    "cross_sectional_open_interest_delta_rank_v0_offline_economic_evaluation_scope_ratification_v0"
)
...
RECOMMENDED_SCOPE_ID = (
    "CROSS_SECTIONAL_OPEN_INTEREST_DELTA_RANK_V0_OFFLINE_ECONOMIC_EVALUATION_RATIFICATION_PREP"
)
...
OPERATOR_SCOPE_RATIFICATION_REF = (
    "bounded_cs_open_interest_delta_rank_scope_binding_ratification_v0"
)
CONFIG_REL_PATH = (
    "config/research/"
    "cross_sectional_open_interest_delta_rank_v0_offline_economic_evaluation_scope_ratification_v0.json"
)
RUNNER_BINDING_REF = (
    "scripts/ops/"
    "run_cross_sectional_open_interest_delta_rank_v0_offline_economic_evaluation_execution_v0.py"
)
HARNESS_BINDING_REF = (
    "src/research/"
    "cross_sectional_open_interest_delta_rank_v0_offline_economic_evaluation_execution_v0.py"
)
...
def materialize_open_interest_delta_rank_offline_economic_evaluation_scope_ratification_v0(
    *,
    ...
    body: dict[str, Any] = {
        ...
        "material_difference_basis": (
            "open_interest_delta_rank_extremes_panel_rotation_not_funding_carry_or_price_signal"
        ),
...
def validate_open_interest_delta_rank_offline_economic_evaluation_scope_ratification_v0(
