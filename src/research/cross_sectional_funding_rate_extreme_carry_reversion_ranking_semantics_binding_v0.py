"""Funding-rate dispersion z-score reversion cross-sectional ranking semantics binding (v0)."""
...
PACKAGE_MARKER = (
    "CROSS_SECTIONAL_FUNDING_RATE_EXTREME_CARRY_REVERSION_RANKING_SEMANTICS_BINDING_V0=true"
)
SCHEMA_VERSION = "cross_sectional_funding_rate_extreme_carry_reversion_ranking_semantics_binding.v0"
HYPOTHESIS_ID = "CROSS_SECTIONAL_FUNDING_RATE_EXTREME_CARRY_REVERSION_NON_BITCOIN_PERPETUALS_V0"

SCORE_FAMILY_POLICY = "cross_sectional_funding_rate_extreme_carry_reversion_v0"
DIRECTION_POLICY = "symmetric_funding_extreme_carry_reversion_single_leg_rotation_v0"
SELECTION_MODE = "funding_extreme_carry_reversion_single_leg_rotation_v0"
LONG_LEG_MEANS = "LONG_LOW_EXTREME"
SHORT_LEG_MEANS = "SHORT_HIGH_EXTREME"
...
TIE_BREAK_POLICY = "zscore_asc_then_instrument_id_asc_for_long_leg"
THRESHOLD_POLICY = "absolute_funding_extreme_percentile_dislocation_threshold_no_continuous_tuning"

ORCHESTRATOR_OWNER = (
    "cross_sectional_funding_rate_extreme_carry_reversion_single_slot_research_orchestrator_v0"
)
...
VERSIONED_BINDING_CONFIG_REL_PATH = (
    "config/research/"
    "cross_sectional_funding_rate_extreme_carry_reversion_v0_ranking_semantics_binding_v0.json"
)
...
RATIFIED_OPERATOR_RATIONALES: dict[str, str] = {
    ...
    "funding_smoothing_window_bars": (
        "Single-bar smoothing for absolute funding extremeness; no parameter search."
    ),
    "min_eligible_members": (
        "At least five simultaneously eligible panel members for cross-sectional dislocation."
    ),
    "min_panel_funding_dispersion": (
        "Panel funding std must exceed 1e-5; dispersion gate blocks low-disagreement regimes."
    ),
    "min_abs_zscore_for_entry": (
        "At least |z|>=1.0 required for entry; no threshold rescue via weakening."
    ),
    "switch_entry_delay_epochs": (
...
def materialize_funding_rate_extreme_carry_reversion_ranking_semantics_binding_v0() -> dict[
    str, Any
]:
    numeric_bindings = {
    ...
    return {
        ...
        "direction_semantics": {
            ...
            "insufficient_panel_dispersion_target": "FLAT",
        },
        "timing_semantics": {
        ...
        "panel_semantics": {
            ...
            "panel_dispersion_gate_required": True,
        },
        "tie_break_semantics": {
            "long_leg_order": "zscore_asc_then_instrument_id_asc",
            "short_leg_order": "zscore_desc_then_instrument_id_asc",
            "tie_break_policy": TIE_BREAK_POLICY,
            "abs_zscore_tie_leg_order": "instrument_id_asc",
        },
        "threshold_semantics": {
            "threshold_policy": THRESHOLD_POLICY,
            "min_panel_funding_dispersion_required": True,
            "min_abs_zscore_for_entry_required": True,
        },
        "orchestrator": {
...
def materialize_versioned_funding_rate_extreme_carry_reversion_ranking_semantics_binding_v0() -> (
    dict[str, Any]
):
    binding = apply_ratified_operator_bindings_v0(
        materialize_funding_rate_extreme_carry_reversion_ranking_semantics_binding_v0()
    )
    return {
        "artifact_kind": (
            "cross_sectional_funding_rate_extreme_carry_reversion_ranking_semantics_versioned_binding"
        ),
        "artifact_version": "v0",
        "binding": binding,
