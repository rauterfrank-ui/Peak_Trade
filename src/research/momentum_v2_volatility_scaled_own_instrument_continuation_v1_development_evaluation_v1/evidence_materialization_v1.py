"""Evidence and registry contracts for MOMENTUM_V2_VOL_SCALED v1 development evaluation."""
...
def build_run_slot_claim_v1(
    *,
    ...
    return {
        "schema_version": "evaluate_momentum_v2_volatility_scaled_own_instrument_continuation_run_slot_claim.v1",
...
def build_registry_metadata_v1(
    *,
    ...
    return {
        "schema_version": "evaluate_momentum_v2_volatility_scaled_own_instrument_continuation_registry.v1",
        "evaluation_run_id": EVALUATION_RUN_ID,
        "hypothesis_id": HYPOTHESIS_ID,
        "strategy_identity": STRATEGY_IDENTITY,
