"""Executable development-evaluation path for MOMENTUM_V2_VOL_SCALED v1 (orchestration surface).
...
from src.research.momentum_v2_volatility_scaled_own_instrument_continuation_v1_development_evaluation_v1.admission_gates_v1 import (
    evaluate_admission_gates_v1,
    evaluate_segment_local_result_v1,
)
from src.research.momentum_v2_volatility_scaled_own_instrument_continuation_v1_development_evaluation_v1.authorization_v1 import (
...
from src.research.momentum_v2_volatility_scaled_own_instrument_continuation_v1_development_evaluation_v1.evidence_materialization_v1 import (
    build_registry_metadata_v1,
    build_run_slot_claim_v1,
    validate_evidence_and_registry_contracts_v1,
    write_evidence_bundle_v1,
)
from src.research.momentum_v2_volatility_scaled_own_instrument_continuation_v1_development_evaluation_v1.evidence_schema_v1 import (
    empty_evidence_surface_template,
)
from src.research.momentum_v2_volatility_scaled_own_instrument_continuation_v1_development_evaluation_v1.execution_boundary_v1 import (
    BacktestMetricsBundleV1,
    ExecutionBoundaryV1,
    RealExecutionBoundaryV1,
)
from src.research.momentum_v2_volatility_scaled_own_instrument_continuation_v1_development_evaluation_v1.guards_v1 import (
    GuardError,
...
from src.research.momentum_v2_volatility_scaled_own_instrument_continuation_v1_development_evaluation_v1.time_segments_v1 import (
...
class EvaluatePathResultV1:
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            ...
            "min_executed_treatment_trades": MIN_EXECUTED_TREATMENT_TRADES,
...
def dry_validate_evaluate_path_v1(repo_root: Path) -> EvaluatePathResultV1:
    ...
    demo_gates = evaluate_admission_gates_v1(
        ...
        max_single_instrument_positive_gross_pnl_share=0.0,
        segment_results=[
            {
                "segment_id": s["segment_id"],
...
def run_authorized_development_evaluation_v1(
    ...
    *,
    ...
    gates = evaluate_admission_gates_v1(
        ...
        baseline_net_return=float(canonical.extras.get("baseline_net_return") or 0.0),
        baseline_max_drawdown=float(canonical.extras.get("baseline_max_drawdown") or 0.0),
        ...
        max_single_instrument_positive_gross_pnl_share=float(
            canonical.extras.get("max_single_instrument_positive_gross_pnl_share") or 0.0
        ),
    ...
    strategy_params_digest = compute_strategy_params_digest(contract)
    evidence = {
        "schema_version": "evaluate_momentum_v2_volatility_scaled_own_instrument_continuation_development_summary.v1",
        ...
        "baseline_max_drawdown": canonical.extras.get("baseline_max_drawdown"),
        "sharpe": canonical.sharpe,
        "fees": canonical.extras.get("fee_drag"),
        "slippage": canonical.extras.get("slippage_drag"),
        "total_cost_drag": canonical.extras.get("total_cost_drag"),
        "instrument_coverage": canonical.extras.get("instrument_coverage"),
        ...
        "long_short_distribution": {
            "long": canonical.extras.get("long_trade_count"),
            "short": canonical.extras.get("short_trade_count"),
        },
        ...
        "strategy_emitted_exits_used_for_baseline": canonical.extras.get(
            "strategy_emitted_exits_used_for_baseline"
        ),
