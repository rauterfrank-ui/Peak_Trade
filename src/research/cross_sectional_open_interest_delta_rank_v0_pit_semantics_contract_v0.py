"""Point-in-time semantics contract for OKX historical open interest observations v0.

Registers machine-readable PIT binding for cross_sectional_open_interest_delta_rank/v0.
...
PACKAGE_MARKER = "CROSS_SECTIONAL_OPEN_INTEREST_DELTA_RANK_V0_PIT_SEMANTICS_CONTRACT_V0=true"
CONTRACT_VERSION = "cross_sectional_open_interest_delta_rank_v0_pit_semantics_contract.v0"
...
class PitOpenInterestSemanticsContractV0:
...
def build_pit_open_interest_semantics_contract_v0() -> PitOpenInterestSemanticsContractV0:
    payload = {
    ...
    return PitOpenInterestSemanticsContractV0(semantic_digest=digest, **payload)


def pit_semantics_contract_to_dict(
    contract: PitOpenInterestSemanticsContractV0,
) -> dict[str, object]:
    return {
        ...
        "lookback_k": contract.lookback_k,
