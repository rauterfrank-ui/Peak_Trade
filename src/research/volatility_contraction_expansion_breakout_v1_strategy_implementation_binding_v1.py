"""Validator for VOLATILITY_CONTRACTION_EXPANSION_BREAKOUT_V1 strategy-implementation binding."""
...
PACKAGE_MARKER = "VOLATILITY_CONTRACTION_EXPANSION_BREAKOUT_V1_STRATEGY_IMPLEMENTATION_BINDING=true"
BINDING_REL_PATH = (
    "config/research/volatility_contraction_expansion_breakout_v1_"
    "strategy_implementation_binding_v1.json"
)
REQUIRED_DIGEST = "e2e5414041c04ed756fe1315938eb49a8196caf416d33feb58055d641c7f5784"
...
def validate_implementation_binding(
    ...
    _require(
        "NO_VOLATILITY_DECAY_BREAKOUT_V1_RETRY" in non_actions,
        "VDB_RETRY_NOT_FORBIDDEN",
    )
    _require(
        "NO_VOLATILITY_DECAY_BREAKOUT_WITH_EXPLICIT_DECAY_EXIT_V1_RETRY" in non_actions,
        "VDBX_RETRY_NOT_FORBIDDEN",
    )
