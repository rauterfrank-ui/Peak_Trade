"""Validator for VOLATILITY_TERM_STRUCTURE_REVERSION_V1 strategy-implementation binding."""
...
PACKAGE_MARKER = "VOLATILITY_TERM_STRUCTURE_REVERSION_V1_STRATEGY_IMPLEMENTATION_BINDING=true"
BINDING_REL_PATH = (
    "config/research/volatility_term_structure_reversion_v1_strategy_implementation_binding_v1.json"
)
REQUIRED_DIGEST = "48ee1c1f128cf613a2fbdc414909eb812bd54f1528ede1563b022cc7c254c8c5"
...
REQUIRED_IMPL_FILES = (
    "src/research/volatility_term_structure_reversion_v1_vol_state_v1.py",
    "src/research/volatility_term_structure_reversion_v1_exit_state_machine_v1.py",
    "src/research/volatility_term_structure_reversion_v1_strategy_v1.py",
...
def validate_implementation_binding(
    ...
    _require(
        "NO_VOLATILITY_EXPANSION_FAILED_CONTINUATION_FADE_V1_RETRY" in non_actions,
        "VEFCF_RETRY_NOT_FORBIDDEN",
    )
