"""Fail-closed validator for cross_sectional_funding_rate_rank_delta_ranking_semantics_binding.v0."""
...
PACKAGE_MARKER = (
    "CROSS_SECTIONAL_FUNDING_RATE_RANK_DELTA_RANKING_SEMANTICS_BINDING_VALIDATOR_V0=true"
)
...
class FundingRankDeltaRankingSemanticsBindingValidationResult:
...
def validate_funding_rate_rank_delta_ranking_semantics_binding_v0(
    binding: Mapping[str, Any],
) -> FundingRankDeltaRankingSemanticsBindingValidationResult:
    ...
    if direction.get("absolute_funding_delta_forbidden") is not True:
        fail_reasons.append("ABSOLUTE_FUNDING_DELTA_MUST_BE_FORBIDDEN")
    ...
    if fail_reasons:
        return FundingRankDeltaRankingSemanticsBindingValidationResult(
