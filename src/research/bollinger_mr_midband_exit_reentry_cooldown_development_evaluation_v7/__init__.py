"""DEVELOPMENT evaluation surfaces for Bollinger/MR midband reentry-cooldown v7.
...
PACKAGE_MARKER = "BOLLINGER_MR_MIDBAND_EXIT_REENTRY_COOLDOWN_DEVELOPMENT_EVALUATION_V7=true"
