"""Validator for VOLATILITY_EXPANSION_FAILED_CONTINUATION_FADE_V1 strategy-implementation binding."""
...
PACKAGE_MARKER = (
    "VOLATILITY_EXPANSION_FAILED_CONTINUATION_FADE_V1_STRATEGY_IMPLEMENTATION_BINDING=true"
)
BINDING_REL_PATH = (
    "config/research/volatility_expansion_failed_continuation_fade_v1_"
    "strategy_implementation_binding_v1.json"
)
REQUIRED_DIGEST = "744c74727043edc35613f58274d28b80c6a065f56dbc75ac0af204689678a92c"
...
REQUIRED_IMPL_FILES = (
    ...
    "src/research/volatility_expansion_failed_continuation_fade_v1_vol_state_v1.py",
    "src/research/volatility_expansion_failed_continuation_fade_v1_exit_state_machine_v1.py",
...
def validate_implementation_binding(
    ...
    _require(notes.get("realized_volatility_period") == 24, "RV_PERIOD_NOT_24")
    ...
    _require(
        "NO_VOLATILITY_EXPANSION_PULLBACK_CONTINUATION_V1_RETRY" in non_actions,
