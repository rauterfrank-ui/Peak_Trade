"""Validator for VOLATILITY_DECAY_BREAKOUT_V1 strategy-implementation binding."""
...
PACKAGE_MARKER = "VOLATILITY_DECAY_BREAKOUT_V1_STRATEGY_IMPLEMENTATION_BINDING=true"
BINDING_REL_PATH = (
...
def validate_implementation_binding(
    ...
    _require(
        "NO_VOLATILITY_EXPANSION_PERSISTENCE_V1_RETRY" in non_actions,
    ...
    if repo_root is not None:
        ...
        _require(
            frozen.get("decay_confirmation_threshold_exclusive_max") == 0.40,
            "MEASUREMENT_DECAY_THR",
        )
        _require(
            frozen.get("high_vol_prior_threshold_inclusive_min") == 0.70,
            "MEASUREMENT_HIGH_VOL",
        )
        _require(
