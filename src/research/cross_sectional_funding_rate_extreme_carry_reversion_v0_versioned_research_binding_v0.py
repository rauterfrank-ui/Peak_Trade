"""Cross-sectional funding-rate extreme-carry-reversion v0 versioned research binding materializer."""
...
from src.research.cross_sectional_funding_rate_extreme_carry_reversion_ranking_semantics_binding_v0 import (
    ...
    materialize_versioned_funding_rate_extreme_carry_reversion_ranking_semantics_binding_v0,
...
from src.research.cross_sectional_funding_rate_extreme_carry_reversion_scoring_v0 import (
    FUNDING_SIGNAL_LAG,
...
PACKAGE_MARKER = (
    "CROSS_SECTIONAL_FUNDING_RATE_EXTREME_CARRY_REVERSION_V0_VERSIONED_RESEARCH_BINDING_V0=true"
)
BINDING_ARTIFACT_VERSION = "v0"
BINDING_SCHEMA_VERSION = (
    "cross_sectional_funding_rate_extreme_carry_reversion_v0_versioned_research_binding.v0"
)
CONFIG_REL_PATH = "config/research/cross_sectional_funding_rate_extreme_carry_reversion_v0_versioned_research_binding_v0.json"
...
PANEL_WARMUP_BARS = FUNDING_SIGNAL_LAG + 1
...
def compute_implementation_digest_v0() -> str:
    return _stable_digest(
        {
            "module": "cross_sectional_funding_rate_extreme_carry_reversion_v0_versioned_research_binding_v0",
    ...
    return _stable_digest(
        {
            ...
            "extreme_carry_reversion_signal": True,
...
def build_panel_dataset_binding_v0() -> dict[str, Any]:
    return {
        ...
        "funding_usage": "funding_rate_for_extreme_carry_reversion_computation",
        "narrow_adapter": "pit_okx_pt1h_panel_funding_field_materialization.v0",
...
def materialize_versioned_research_binding_v0() -> dict[str, Any]:
    base = materialize_funding_rate_extreme_carry_reversion_ranking_semantics_binding_v0()
    ...
    return {
        "artifact_kind": "cross_sectional_funding_rate_extreme_carry_reversion_v0_versioned_research_binding",
