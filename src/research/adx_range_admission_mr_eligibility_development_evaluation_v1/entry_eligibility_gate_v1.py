"""Research-only RSI-exhaustion entry eligibility gate (no Master-V2 mutation).

Reuses the generic mapped-signal gate helper from the prior entry-effective
evaluation package (read-only); the eligibility mask itself comes from the
frozen RSI filter in this package.
"""
