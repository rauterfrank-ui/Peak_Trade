"""Single-run DEVELOPMENT panel evaluation: baseline vs ADX range-admission eligibility gate."""
...
EVALUATION_RUN_ID = "evaluate_adx_range_admission_mr_eligibility_development_v1"
...
def _extract_member_economics(
    ...
    *,
    ...
    # ADX range-admission eligibility attribution on the decision segment.
...
def run_development_evaluation(
    *,
    ...
    # (ADX range-admission eligibility gated) — two arms, one run.
    baseline = run_arm(
        arm="baseline",
        cfg=cfg,
        archive_root=root,
    ...
    config_snapshot = {
        "schema_version": "evaluate_adx_range_admission_mr_eligibility_development_config_snapshot.v1",
    ...
    code_hashes = {
        "adx_range_admission_eligibility_filter_v1.py": _sha256_file(
            repo
            / "src/research/adx_range_admission_mr_eligibility_development_evaluation_v1"
            / "adx_range_admission_eligibility_filter_v1.py"
        ),
    ...
    command = (
        ...
        "run_evaluate_adx_range_admission_mr_eligibility_development_v1.py "
        f"--output-dir {output_dir}"
    )
    base_sha = _git_base_sha(repo)
    summary = {
        "schema_version": "evaluate_adx_range_admission_mr_eligibility_development_summary.v1",
