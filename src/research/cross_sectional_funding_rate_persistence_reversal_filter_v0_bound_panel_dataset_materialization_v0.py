"""Bound funding panel dataset materialization for cross-sectional funding-rate persistence reversal filter v0."""
...
PACKAGE_MARKER = "CROSS_SECTIONAL_FUNDING_RATE_PERSISTENCE_REVERSAL_FILTER_V0_BOUND_PANEL_DATASET_MATERIALIZATION_V0=true"
MATERIALIZATION_VERSION = "cross_sectional_funding_rate_persistence_reversal_filter_v0_bound_panel_dataset_materialization.v0"
