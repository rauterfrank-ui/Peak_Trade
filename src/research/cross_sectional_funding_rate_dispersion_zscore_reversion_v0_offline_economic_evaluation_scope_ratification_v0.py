"""Cross-sectional funding-rate dispersion z-score reversion v0 offline economic evaluation scope ratification v0.

Deterministic, fail-closed ratification of bounded offline-only economic evaluation
scope for cross_sectional_funding_rate_dispersion_zscore_reversion/v0. Does not execute evaluation.
"""
...
from src.research.cross_sectional_funding_rate_dispersion_zscore_reversion_v0_offline_economic_evaluation_infrastructure_readiness_v0 import (
    evaluate_dispersion_zscore_reversion_offline_evaluation_infrastructure_readiness_v0,
)
...
SCHEMA_VERSION = "cross_sectional_funding_rate_dispersion_zscore_reversion_v0_offline_economic_evaluation_scope_ratification.v0"
RATIFICATION_ID = "cross_sectional_funding_rate_dispersion_zscore_reversion_v0_offline_economic_evaluation_scope_ratification_v0"
...
RECOMMENDED_SCOPE_ID = "CROSS_SECTIONAL_FUNDING_RATE_DISPERSION_ZSCORE_REVERSION_V0_OFFLINE_ECONOMIC_EVALUATION_RATIFICATION"
...
OPERATOR_SCOPE_RATIFICATION_REF = (
    "bounded_cs_funding_rate_dispersion_zscore_reversion_v0_scope_binding_ratification_v0"
)
CONFIG_REL_PATH = (
    "config/research/"
    "cross_sectional_funding_rate_dispersion_zscore_reversion_v0_offline_economic_evaluation_scope_ratification_v0.json"
)
...
PARENT_SCOPE_RATIFICATION_EVIDENCE = str(
    located_runtime_evidence_20260520()
    / "research/funding_dispersion_zscore_reversion_v0_scope_ratification_20260706T164741Z"
)
PARENT_PR4935_CLOSEOUT_BUNDLE = str(
    located_runtime_evidence_20260520()
    / "implementation/pr4935_dispersion_zscore_reversion_v0_scope_ratification_merge_closeout_20260706T165747Z"
)
...
MATERIAL_DIFFERENCE_VS_PERSISTENCE_REVERSAL_FILTER_V0_CONFIRMED = True
...
def materialize_dispersion_zscore_reversion_offline_economic_evaluation_scope_ratification_v0(
    *,
    ...
    body_without_readiness: dict[str, Any] = {
        ...
        "material_difference_basis": (
            "panel_dispersion_gated_zscore_reversion_not_rank_delta_persistence_or_dual_leg_spread"
        ),
        ...
        "parent_scope_ratification_evidence": PARENT_SCOPE_RATIFICATION_EVIDENCE,
        "parent_pr4935_closeout_bundle": PARENT_PR4935_CLOSEOUT_BUNDLE,
    ...
    readiness = evaluate_dispersion_zscore_reversion_offline_evaluation_infrastructure_readiness_v0(
...
def validate_dispersion_zscore_reversion_offline_economic_evaluation_scope_ratification_v0(
    ...
    *,
    ...
    if (
        ratification.get("material_difference_vs_persistence_reversal_filter_v0_confirmed")
        is not True
    ):
        reasons.append("MATERIAL_DIFFERENCE_VS_PERSISTENCE_REVERSAL_FILTER_V0_NOT_CONFIRMED")
