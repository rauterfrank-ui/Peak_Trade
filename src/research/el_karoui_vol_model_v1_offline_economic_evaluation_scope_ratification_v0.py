"""El Karoui vol model v1 versioned research binding and scope ratification v0.
...
from src.backtest.step29m_el_karoui_vol_model_v1_economic_evaluation_admissibility_contract_v1 import (
    DEFAULT_EVALUATION_CONFIG_PATH,
    EL_KAROUI_VOL_MODEL_V1_CANONICAL_PARAMS,
    EL_KAROUI_VOL_MODEL_V1_REQUIRED_WARMUP_ROWS,
    EL_KAROUI_VOL_MODEL_V1_STRATEGY_ID,
    EL_KAROUI_VOL_MODEL_V1_STRATEGY_OWNER,
    EL_KAROUI_VOL_MODEL_V1_STRATEGY_VERSION,
...
PACKAGE_MARKER = "EL_KAROUI_VOL_MODEL_V1_OFFLINE_ECONOMIC_EVALUATION_SCOPE_RATIFICATION_V0=true"
...
EVIDENCE_CLASS_ID = "EL_KAROUI_VOL_MODEL_V1_FULL_CANONICAL_OFFLINE_BASELINE_ECONOMIC_EVALUATION_V0"
...
PR5087_CLOSEOUT_DIR = (
    ...
    "registration_and_distinct_scope_decision_v0_20260710T124722Z"
)
    ...
    return _stable_digest(
        {
            ...
            "entry_semantics": "regime_threshold_exposure_mapping",
            "exit_semantics": "regime_threshold_exposure_mapping",
            "hold_semantics": "bar_close_point_in_time",
            "state_semantics": "LOW_MEDIUM_HIGH_VOL_REGIME",
        }
    )
    ...
    *, strategy_params_digest: str, config_digest: str
    ...
    return {
        ...
        "economic_evaluation_v1": {
            ...
            "strategy_params": dict(EL_KAROUI_VOL_MODEL_V1_CANONICAL_PARAMS),
        ...
        "step29m_policy_ratification_v1": {
            ...
            "operator_policy_derivation_ref": (
                "operator_policy_decision:STEP29M_EL_KAROUI_VOL_MODEL_V1"
            ),
...
def materialize_evaluation_config_v1(repo_root: Path) -> dict[str, Any]:
    _, strategy_params_digest = resolve_effective_strategy_params_v1(
        STRATEGY_ID,
        project_strategy_params_for_binding_v1(
            STRATEGY_ID, EL_KAROUI_VOL_MODEL_V1_CANONICAL_PARAMS
        ),
    )
...
def materialize_material_difference_contract_v0() -> dict[str, Any]:
    body = {
        "artifact_kind": "el_karoui_vol_model_v1_material_difference_and_non_claim_contract",
        "artifact_version": "v0",
        "baseline_scope": "ehlers_cycle_filter/v1",
        "explicit_non_claims": [
        ...
        "material_difference_axes": [
            "SIGNAL_FAMILY=STOCHASTIC_VOL_REGIME_NOT_DSP_CYCLE_BANDPASS",
            ...
            "PORTFOLIO_AGGREGATION=DIRECT_SINGLE_SLOT_VOL_REGIME_EXPOSURE",
        ],
        "material_difference_basis": (
            "STOCHASTIC_VOL_REGIME_SINGLE_INSTRUMENT_EXPOSURE_NOT_DSP_CYCLE_BANDPASS"
        ),
        ...
        "schema_version": "el_karoui_vol_model_v1_material_difference_and_non_claim_contract.v0",
        "signal_family": SIGNAL_FAMILY,
        ...
        "source_classification_evidence_ref": str(CLASSIFICATION_EVIDENCE_DIR),
    }
...
def materialize_versioned_research_binding_v0(
    ...
    *,
    ...
    return {
        ...
        "artifact_kind": "el_karoui_vol_model_v1_versioned_research_binding",
        "artifact_version": "v0",
        ...
        "binding": {
            ...
            "candidate_binding": {
                ...
                "canonical_owner": "src/strategies/el_karoui/el_karoui_vol_model_strategy.py",
                "engine_signal_source": "configured_strategy_signal",
                "hypothesis_id": HYPOTHESIS_ID,
                "implementation_ref": EL_KAROUI_VOL_MODEL_V1_STRATEGY_OWNER,
            ...
            "numeric_bindings": {
                ...
                "lookback_window": 252,
                "low_threshold": 0.30,
                "required_warmup_rows": EL_KAROUI_VOL_MODEL_V1_REQUIRED_WARMUP_ROWS,
                "risk_per_trade": 0.005,
                "roundtrip_cost_bps": 40.0,
            ...
            "parameter_binding": {
                ...
                "parameters": dict(EL_KAROUI_VOL_MODEL_V1_CANONICAL_PARAMS),
            },
            "period_binding": {
                "binding_version": "v1",
                "out_of_sample_period": OUT_OF_SAMPLE_PERIOD,
            ...
            "prior_evidence_exclusion": {
                "excluded_terminal_inconclusive_bindings": ["ehlers_cycle_filter/v1"],
            ...
            "signal_semantics_binding": {
                ...
                "state_semantics": "LOW_MEDIUM_HIGH_VOL_REGIME",
                "use_ewm_fixed": True,
                "use_vol_scaling_fixed": False,
            },
            "warmup_binding": {
                "derivation": "lookback_window",
                "required_warmup_rows": EL_KAROUI_VOL_MODEL_V1_REQUIRED_WARMUP_ROWS,
                "warmup_bars_before_train_start_required": True,
            },
        },
        ...
        "durable_evidence_refs": (
            f"{PR5087_CLOSEOUT_DIR} (MANIFEST_VERIFY_RC=0); "
            f"{EHLERS_TERMINAL_SCOPE_DEFINITION_DIR} (MANIFEST_VERIFY_RC=0); "
            f"{CLASSIFICATION_EVIDENCE_DIR} (MANIFEST_VERIFY_RC=0); "
            f"{DISCOVERY_EVIDENCE_DIR} (MANIFEST_VERIFY_RC=0)"
        ),
        ...
        "schema_version": "el_karoui_vol_model_v1_versioned_research_binding.v0",
        "source_ratification_evidence_ref": str(PR5087_CLOSEOUT_DIR),
        "strategy_id": STRATEGY_ID,
        "strategy_version": STRATEGY_VERSION,
...
def materialize_scope_ratification_v0(
    ...
    return {
        ...
        "runtime_effect": RUNTIME_EFFECT,
        "schema_version": (
            "el_karoui_vol_model_v1_offline_economic_evaluation_scope_ratification.v0"
        ),
...
def validate_ratification_preconditions(repo_root: Path) -> tuple[ManifestVerification, ...]:
    ...
    admissibility = evaluate_el_karoui_vol_model_v1_admissibility_contract_v1(repo_root=repo_root)
