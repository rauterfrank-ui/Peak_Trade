"""Cross-sectional funding-rate delta momentum v0 offline economic evaluation execution v0.

Deterministic, fail-closed execution infrastructure for the bounded funding-rate delta momentum
...
from src.research.cross_sectional_funding_rate_delta_momentum_single_slot_research_orchestrator_v0 import (
    default_funding_delta_momentum_operator_binding_v0,
    run_cross_sectional_funding_rate_delta_momentum_orchestrator_v0,
)
...
EXPECTED_ORIGIN_MAIN_SHA = "0179009507d0841e155adc60fa347a3208329670"
...
RUNNER_SCRIPT = "scripts/ops/run_cross_sectional_funding_rate_delta_momentum_v0_offline_economic_evaluation_execution_v0.py"
...
def run_contract_smoke_evaluation_v0(
    *,
    ...
    binding = default_funding_delta_momentum_operator_binding_v0()
    ...
    orchestrator = run_cross_sectional_funding_rate_delta_momentum_orchestrator_v0(
        binding=binding,
...
def materialize_economic_viability_evidence(
    *,
    ...
    """Persist cross-sectional funding-rate delta momentum EconomicViabilityEvidenceV1-shaped payload."""
    envelope = dict(versioned_binding)
    ...
    body: dict[str, Any] = {
        "schema_version": "economic_viability_evidence_cross_sectional_funding_delta_momentum_v0",
        "strategy_id": STRATEGY_ID,
        "strategy_version": STRATEGY_VERSION,
