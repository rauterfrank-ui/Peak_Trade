"""Cross-sectional funding-rate persistence reversal filter v0 offline economic evaluation scope ratification v0.

Deterministic, fail-closed ratification of bounded offline-only economic evaluation
scope for cross_sectional_funding_rate_persistence_reversal_filter/v0. Does not execute evaluation.
"""
...
from src.research.cross_sectional_funding_rate_persistence_reversal_filter_v0_offline_economic_evaluation_infrastructure_readiness_v0 import (
...
PACKAGE_MARKER = (
    "CROSS_SECTIONAL_FUNDING_RATE_PERSISTENCE_REVERSAL_FILTER_V0_OFFLINE_ECONOMIC_EVALUATION_"
    "SCOPE_RATIFICATION_V0=true"
)

SCHEMA_VERSION = "cross_sectional_funding_rate_persistence_reversal_filter_v0_offline_economic_evaluation_scope_ratification.v0"
RATIFICATION_ID = "cross_sectional_funding_rate_persistence_reversal_filter_v0_offline_economic_evaluation_scope_ratification_v0"
...
RECOMMENDED_SCOPE_ID = "CROSS_SECTIONAL_FUNDING_RATE_PERSISTENCE_REVERSAL_FILTER_V0_OFFLINE_ECONOMIC_EVALUATION_BINDING_RATIFICATION_PREP"
...
OPERATOR_SCOPE_RATIFICATION_REF = (
    "bounded_cs_funding_rate_persistence_reversal_filter_v0_scope_binding_ratification_v0"
)
CONFIG_REL_PATH = (
    "config/research/"
    "cross_sectional_funding_rate_persistence_reversal_filter_v0_offline_economic_evaluation_scope_ratification_v0.json"
)
FUTURE_RUNNER_BINDING_REF = (
    "scripts/ops/"
    "run_cross_sectional_funding_rate_persistence_reversal_filter_v0_offline_economic_evaluation_execution_v0.py"
)
...
def materialize_persistence_reversal_filter_offline_economic_evaluation_scope_ratification_v0(
    *,
    ...
    binding = envelope["binding"]
    validation = validate_funding_persistence_reversal_filter_ranking_semantics_binding_v0(binding)
    ...
    body_without_readiness: dict[str, Any] = {
        ...
        "material_difference_basis": (
            "funding_persistence_duration_decay_stability_reversal_risk_gate_not_rank_delta"
        ),
        ...
        "parent_scope_ratification": PARENT_SCOPE_RATIFICATION,
...
def validate_persistence_reversal_filter_offline_economic_evaluation_scope_ratification_v0(
