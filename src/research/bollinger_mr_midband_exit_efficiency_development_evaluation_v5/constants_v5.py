"""Frozen constants for Bollinger/MR midband exit-efficiency DEVELOPMENT evaluation v5.

Identical fees/params/hashes/seeds to v1/v2/v3/v4. Only scope/run/hypothesis/path identity
is versioned. V5 is a new independently preregistered measurement; not a V1/V2/V3/V4 rerun.
"""

from __future__ import annotations

SCOPE_ID = "bollinger_mr_midband_exit_efficiency_development_evaluation_v5"
EVALUATION_RUN_ID = "evaluate_bollinger_mr_midband_exit_efficiency_development_v5"
...
EVIDENCE_REL_PATH = "docs/evidence/evaluate_bollinger_mr_midband_exit_efficiency_development_v5/"
GOVERNANCE_REL_PATH = (
