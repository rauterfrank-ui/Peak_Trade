...
PACKAGE_MARKER = (
    "CROSS_SECTIONAL_FUNDING_RATE_DISPERSION_ZSCORE_REVERSION_RANKING_SEMANTICS_BINDING_V0=true"
)
SCHEMA_VERSION = (
    "cross_sectional_funding_rate_dispersion_zscore_reversion_ranking_semantics_binding.v0"
)
HYPOTHESIS_ID = "CROSS_SECTIONAL_FUNDING_RATE_DISPERSION_ZSCORE_REVERSION_NON_BITCOIN_PERPETUALS_V0"

SCORE_FAMILY_POLICY = "cross_sectional_funding_rate_dispersion_zscore_reversion_v0"
DIRECTION_POLICY = "symmetric_funding_zscore_extremum_mean_reversion_single_leg_rotation_v0"
SELECTION_MODE = "funding_zscore_extremes_single_leg_rotation_v0"
...
THRESHOLD_POLICY = "panel_dispersion_and_abs_zscore_threshold_no_continuous_tuning"

ORCHESTRATOR_OWNER = (
    "cross_sectional_funding_rate_dispersion_zscore_reversion_single_slot_research_orchestrator_v0"
)
...
VERSIONED_BINDING_CONFIG_REL_PATH = (
    "config/research/"
    "cross_sectional_funding_rate_dispersion_zscore_reversion_v0_ranking_semantics_binding_v0.json"
)
...
RATIFIED_OPERATOR_RATIONALES: dict[str, str] = {
    ...
    "min_eligible_members": (
        "At least five simultaneously eligible panel members for cross-sectional z-score."
    ),
    "min_panel_funding_dispersion": (
...
def materialize_funding_rate_dispersion_zscore_reversion_ranking_semantics_binding_v0() -> dict[
    str, Any
]:
    numeric_bindings = {
...
def materialize_versioned_funding_rate_dispersion_zscore_reversion_ranking_semantics_binding_v0() -> (
    dict[str, Any]
):
    ...
    return {
        "artifact_kind": (
            "cross_sectional_funding_rate_dispersion_zscore_reversion_ranking_semantics_versioned_binding"
        ),
        "artifact_version": "v0",
        "binding": binding,
