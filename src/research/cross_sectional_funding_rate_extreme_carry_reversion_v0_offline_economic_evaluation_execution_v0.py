"""Cross-sectional funding-rate extreme-carry-reversion v0 offline economic evaluation execution v0.

Deterministic, fail-closed execution infrastructure for the bounded extreme-carry-reversion
...
from src.research.cross_sectional_funding_rate_extreme_carry_reversion_single_slot_research_orchestrator_v0 import (
    default_funding_extreme_carry_reversion_operator_binding_v0,
    run_cross_sectional_funding_rate_extreme_carry_reversion_orchestrator_v0,
)
...
from src.research.cross_sectional_funding_rate_extreme_carry_reversion_v0_offline_economic_evaluation_scope_ratification_v0 import (
    ...
    validate_extreme_carry_reversion_offline_economic_evaluation_scope_ratification_v0,
)
...
PACKAGE_MARKER = "CROSS_SECTIONAL_FUNDING_RATE_EXTREME_CARRY_REVERSION_V0_OFFLINE_ECONOMIC_EVALUATION_EXECUTION_V0=true"

SCHEMA_VERSION = "cross_sectional_funding_rate_extreme_carry_reversion_v0_offline_economic_evaluation_execution.v0"
EXECUTION_ID = "cross_sectional_funding_rate_extreme_carry_reversion_v0_offline_economic_evaluation_execution_v0"
EXECUTION_VERSION = "v0"
CANONICAL_SERIALIZATION_VERSION = "cross_sectional_execution_canonical_json_v1"

GO_TOKEN = (
    "GO_CROSS_SECTIONAL_FUNDING_RATE_EXTREME_CARRY_REVERSION_V0_OFFLINE_ECONOMIC_EVALUATION_EXECUTION_"
...
LEGACY_EXECUTION_CONFIRM_GO = "GO_BOUNDED_CROSS_SECTIONAL_FUNDING_RATE_EXTREME_CARRY_REVERSION_V0_OFFLINE_ECONOMIC_EVALUATION_EXECUTION_V0"
INFRASTRUCTURE_GO_TOKEN = (
    "GO_BOUNDED_CROSS_SECTIONAL_FUNDING_RATE_EXTREME_CARRY_REVERSION_V0_OFFLINE_ECONOMIC_EVALUATION_"
    "INFRASTRUCTURE_COMPLETION_V0"
)
COMBINED_RATIFY_AND_EXECUTE_GO_TOKEN = (
    "GO_RATIFY_AND_EXECUTE_CROSS_SECTIONAL_FUNDING_RATE_EXTREME_CARRY_REVERSION_V0_"
...
RUNNER_OWNER = "scripts.ops.run_cross_sectional_funding_rate_extreme_carry_reversion_v0_offline_economic_evaluation_execution_v0"
RUNNER_SCRIPT = "scripts/ops/run_cross_sectional_funding_rate_extreme_carry_reversion_v0_offline_economic_evaluation_execution_v0.py"
...
def verify_execution_start_state_v0(
    *,
    ...
    orchestrator_path = (
        ...
        / "src/research"
        / (
            "cross_sectional_funding_rate_extreme_carry_reversion_single_slot_research_orchestrator_v0.py"
        )
    )
...
def run_contract_smoke_evaluation_v0(
    *,
    ...
    binding = default_funding_extreme_carry_reversion_operator_binding_v0()
    ...
    orchestrator = run_cross_sectional_funding_rate_extreme_carry_reversion_orchestrator_v0(
        binding=binding,
...
def materialize_economic_viability_evidence(
    *,
    ...
    """Persist cross-sectional funding-rate extreme-carry-reversion EconomicViabilityEvidenceV1-shaped payload."""
    envelope = dict(versioned_binding)
    ...
    body: dict[str, Any] = {
        "schema_version": "economic_viability_evidence_cross_sectional_funding_extreme_carry_reversion_v0",
        "strategy_id": STRATEGY_ID,
        "strategy_version": STRATEGY_VERSION,
