...
scope for cross_sectional_funding_rate_extreme_carry_reversion/v0. Does not execute evaluation.
"""
...
SCHEMA_VERSION = "cross_sectional_funding_rate_extreme_carry_reversion_v0_offline_economic_evaluation_scope_ratification.v0"
RATIFICATION_ID = "cross_sectional_funding_rate_extreme_carry_reversion_v0_offline_economic_evaluation_scope_ratification_v0"
...
RECOMMENDED_SCOPE_ID = "CROSS_SECTIONAL_FUNDING_RATE_EXTREME_CARRY_REVERSION_V0_OFFLINE_ECONOMIC_EVALUATION_RATIFICATION"
...
OPERATOR_SCOPE_RATIFICATION_REF = (
    "bounded_cs_funding_rate_extreme_carry_reversion_v0_scope_binding_ratification_v0"
)
CONFIG_REL_PATH = (
    "config/research/"
...
def materialize_extreme_carry_reversion_offline_economic_evaluation_scope_ratification_v0(
    *,
    ...
    binding = envelope["binding"]
    validation = validate_funding_rate_extreme_carry_reversion_ranking_semantics_binding_v0(binding)
    ...
    body_without_readiness: dict[str, Any] = {
        ...
        "material_difference_basis": (
            "absolute_funding_extreme_carry_reversion_not_rank_delta_persistence_or_dual_leg_spread"
        ),
...
def validate_extreme_carry_reversion_offline_economic_evaluation_scope_ratification_v0(
