"""Executable development-evaluation path for CS open-gap pressure fade v1.
...
from src.research.cross_sectional_open_gap_pressure_fade_v1_development_evaluation_v1.admission_gates_v1 import (
...
from src.research.cross_sectional_open_gap_pressure_fade_v1_development_evaluation_v1.evidence_materialization_v1 import (
    build_registry_metadata_v1,
    build_run_slot_claim_v1,
    validate_evidence_and_registry_contracts_v1,
    write_evidence_bundle_v1,
)
from src.research.cross_sectional_open_gap_pressure_fade_v1_development_evaluation_v1.evidence_schema_v1 import (
...
from src.research.cross_sectional_open_gap_pressure_fade_v1_development_evaluation_v1.time_segments_v1 import (
...
def run_authorized_development_evaluation_v1(
    ...
    *,
    ...
    # Run-slot claim + terminal counter mutation happen after the single authorized path
    # completes (retry blocked by evidence-dir slot claim if a second start is attempted).
    ...
    from src.research.cross_sectional_open_gap_pressure_fade_v1_development_evaluation_v1.rebalance_observations_v1 import (
    ...
    panel_by_id = {
        s.instrument_id: {
            "open": tuple(float(b.open) for b in s.bars),
    ...
    evidence = {
        "schema_version": (
            "evaluate_cross_sectional_open_gap_pressure_fade_development_summary.v1"
        ),
