...
PACKAGE_MARKER = "VOLATILITY_COMPRESSION_BREAKOUT_V1_DEVELOPMENT_EVALUATION_ENTRY_POINT_V1=true"

SCOPE_ID = "volatility_compression_breakout_v1_development_evaluation_v1"
OWNER_SURFACE = "VOLATILITY_COMPRESSION_BREAKOUT_V1_DEVELOPMENT_EVALUATION_ENTRY_POINT_V1"
EVALUATION_RUN_ID = "evaluate_volatility_compression_breakout_development_v1"
...
HYPOTHESIS_ID = "VOLATILITY_COMPRESSION_BREAKOUT_NON_BITCOIN_PERPETUALS_V1"
...
# Preregistered admission thresholds (measurement contract; not mutated here).
...
EVIDENCE_REL_PATH = "docs/evidence/evaluate_volatility_compression_breakout_development_v1/"
GOVERNANCE_REL_PATH = (
    "docs/governance/VOLATILITY_COMPRESSION_BREAKOUT_V1_DEVELOPMENT_EVALUATION_ENTRY_POINT_V1.md"
)
CLI_REL_PATH = "scripts/research/run_evaluate_volatility_compression_breakout_development_v1.py"

SHARED_CHANNEL_CORE_REL_PATH = "src/research/price_channel_breakout_core_v1.py"
STRATEGY_IMPL_REL_PATH = "src/research/volatility_compression_breakout_v1_strategy_v1.py"
BASELINE_IMPL_REL_PATH = "src/research/unconditional_20_bar_price_channel_breakout_v1.py"
VOL_STATE_REL_PATH = "src/research/volatility_compression_breakout_v1_vol_state_v1.py"
