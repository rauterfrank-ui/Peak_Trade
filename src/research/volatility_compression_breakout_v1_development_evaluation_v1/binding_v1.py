"""Deterministic binding/digest resolution for VCB v1 eval entry point."""
...
def resolve_strategy_params(contract: Mapping[str, Any] | None = None) -> dict[str, Any]:
    ...
    # Prefer live contract frozen params when provided; otherwise bind known preregistered keys.
    if not frozen:
        frozen = {
            ...
            "compression_percentile_max": 0.2,
            "expansion_percentile_min": 0.75,
            "max_bars_compression_to_expansion": 6,
            "max_expansion_triggers_per_release_cycle": 1,
            "min_compression_duration_bars": 12,
            "percentile_lookback_bars": 120,
            "percentile_tie_method": "WEAK_LESS_THAN_OR_EQUAL_EMPIRICAL_CDF",
            "release_window_end_offset_after_last_compression_bar": 6,
            "release_window_start_offset_after_last_compression_bar": 1,
            "signal_lag_bars": 1,
        }
    return {
...
def assert_shared_channel_core_bound() -> None:
    ...
    from src.research import volatility_compression_breakout_v1_strategy_v1 as strategy
...
def materialize_entry_point_binding_payload(repo_root: Path) -> dict[str, Any]:
    ...
    return {
        "artifact_kind": (
            "volatility_compression_breakout_v1_development_evaluation_entry_point_binding"
        ),
        "artifact_version": "v1",
        ...
        "evidence_ref": "docs/evidence/evaluate_volatility_compression_breakout_development_v1/",
        ...
        "schema_version": (
            "volatility_compression_breakout_v1_development_evaluation_entry_point_binding.v1"
        ),
