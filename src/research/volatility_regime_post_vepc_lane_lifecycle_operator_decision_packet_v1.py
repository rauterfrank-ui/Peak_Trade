...
REQUIRED_STATUS = "OPERATOR_DECISION_APPLIED_CREATE_SUCCESSOR_VEFCF_DEVELOPMENT_FAIL_SLOT_CONSUMED"
...
REQUIRED_NEXT_SCOPE = (
    "VOLATILITY_REGIME_POST_VEFCF_DEVELOPMENT_FAIL_LANE_LIFECYCLE_OPERATOR_DECISION_V1"
)
