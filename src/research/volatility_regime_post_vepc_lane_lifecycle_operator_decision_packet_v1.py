...
REQUIRED_STATUS = "OPERATOR_DECISION_APPLIED_CREATE_SUCCESSOR_VTDC_STRATEGY_IMPLEMENTATION_PRESENT"
...
REQUIRED_NEXT_SCOPE = "VOLATILITY_TERM_STRUCTURE_DEPRESSED_CONTINUATION_V1_BOUNDED_DEVELOPMENT_EVALUATION_EXECUTION_V1"
