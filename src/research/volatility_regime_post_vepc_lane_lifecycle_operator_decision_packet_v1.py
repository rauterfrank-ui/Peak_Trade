...
REQUIRED_STATUS = "OPERATOR_DECISION_APPLIED_CREATE_SUCCESSOR_CSHRVF_DEFINITION_ONLY"
...
REQUIRED_SUCCESSOR_STRATEGY = "CROSS_SECTIONAL_HIGH_REALIZED_VOLATILITY_FADE_V1"
REQUIRED_PREDECESSOR_STRATEGY = "VOLATILITY_TERM_STRUCTURE_DEPRESSED_CONTINUATION_V1"
...
def validate_decision_packet_contract(
    ...
    for required in (
        ...
        "VTSR_RETRY",
        "VTDC_RETRY",
        "CSHRVF_EVALUATION_IN_THIS_SLICE",
        "HOLDOUT_ACCESS",
        "LIVE_ORDERS",
    ...
    if repo_root is not None:
        ...
        _require(
            program.get("strategy_id") == "cross_sectional_high_realized_volatility_fade",
