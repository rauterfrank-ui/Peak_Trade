...
REQUIRED_STATUS = "OPERATOR_DECISION_APPLIED_CREATE_SUCCESSOR_VTSR_STRATEGY_IMPLEMENTATION_PRESENT"
...
REQUIRED_NEXT_SCOPE = (
    "VOLATILITY_TERM_STRUCTURE_REVERSION_V1_BOUNDED_DEVELOPMENT_EVALUATION_EXECUTION_V1"
)
