...
REQUIRED_STATUS = (
    "OPERATOR_DECISION_APPLIED_CREATE_SUCCESSOR_CSLRVC_STRATEGY_IMPLEMENTATION_PRESENT"
)
...
REQUIRED_NEXT_SCOPE = "CROSS_SECTIONAL_LOW_REALIZED_VOLATILITY_CONTINUATION_V1_BOUNDED_DEVELOPMENT_EVALUATION_EXECUTION_V1"
