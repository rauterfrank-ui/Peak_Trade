"""Definition-only SSOT validator for CS intrabar close-location pressure continuation program v1."""
...
PACKAGE_MARKER = (
    "CROSS_SECTIONAL_INTRABAR_CLOSE_LOCATION_PRESSURE_CONTINUATION_RESEARCH_PROGRAM_V1=true"
)
PROGRAM_REL_PATH = "config/research/cross_sectional_intrabar_close_location_pressure_continuation_research_program_v1.json"
GOVERNANCE_REL_PATH = "docs/governance/CROSS_SECTIONAL_INTRABAR_CLOSE_LOCATION_PRESSURE_CONTINUATION_RESEARCH_PROGRAM_V1.md"
REQUIRED_PROGRAM_ID = (
...
REQUIRED_SIGNAL_FAMILY = "CROSS_SECTIONAL_INTRABAR_CLOSE_LOCATION_PRESSURE"
REQUIRED_TARGET = "CROSS_SECTIONAL_INTRABAR_CLOSE_LOCATION_PRESSURE_CONTINUATION"
...
REQUIRED_TREATMENT = (
    "OWN_INSTRUMENT_CROSS_SECTIONAL_INTRABAR_CLOSE_LOCATION_PRESSURE_CONTINUATION_ADMISSION"
)
...
def validate_program_contract(
    ...
    # executed flag validated by post-exec posture; allow False pre-exec / True post-exec
    _require(
