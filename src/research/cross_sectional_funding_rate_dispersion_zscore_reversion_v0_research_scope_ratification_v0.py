"""Cross-sectional funding-rate dispersion z-score reversion v0 research scope ratification v0.

Deterministic, fail-closed ratification of bounded offline-only research scope definition
for cross_sectional_funding_rate_dispersion_zscore_reversion/v0. Does not execute evaluation,
...
PACKAGE_MARKER = (
    "CROSS_SECTIONAL_FUNDING_RATE_DISPERSION_ZSCORE_REVERSION_V0_"
    "RESEARCH_SCOPE_RATIFICATION_V0=true"
)

SCHEMA_VERSION = (
    "cross_sectional_funding_rate_dispersion_zscore_reversion_v0_research_scope_ratification.v0"
)
RATIFICATION_ID = (
    "cross_sectional_funding_rate_dispersion_zscore_reversion_v0_research_scope_ratification_v0"
)
...
RECOMMENDED_SCOPE_ID = (
    "CROSS_SECTIONAL_FUNDING_RATE_DISPERSION_ZSCORE_REVERSION_V0_RESEARCH_SCOPE_RATIFICATION"
)
...
OPERATOR_SCOPE_RATIFICATION_REF = (
    "bounded_cs_funding_rate_dispersion_zscore_reversion_v0_research_scope_ratification_v0"
)
CONFIG_REL_PATH = (
    "config/research/"
    "cross_sectional_funding_rate_dispersion_zscore_reversion_v0_research_scope_ratification_v0.json"
)
...
TERMINALIZED_PARENT_BINDING_DIGEST = (
    "4355f213e0325c7e5ec87013693c91ea693b1bee5325959c1380888b7a31a533"
)
...
PROHIBITED_ACTIONS: tuple[str, ...] = (
    ...
    "UNCHANGED_PERSISTENCE_REVERSAL_FILTER_V0_BINDING_RETRY",
...
def _material_difference_digest_v0() -> str:
    return _stable_digest(
        {
            "primary_signal_axis": "panel_dispersion_gated_funding_zscore_mean_reversion",
            "entry_gate": "min_panel_funding_dispersion_plus_min_abs_zscore_for_entry",
            "crowding_model": "panel_disagreement_regime_extreme_zscore_reversion",
            "terminal_parent": TERMINALIZED_PARENT_STRATEGY,
            "persistence_reversal_reuse_forbidden": True,
            "rank_delta_reuse_forbidden": True,
            "dual_leg_spread_reuse_forbidden": True,
        }
    )


def materialize_dispersion_zscore_reversion_research_scope_ratification_v0(
    *,
    ...
    body: dict[str, Any] = {
        ...
        "terminalized_parent_binding_digest": TERMINALIZED_PARENT_BINDING_DIGEST,
...
def validate_dispersion_zscore_reversion_research_scope_ratification_v0(
    ...
    if ratification.get("terminalized_parent_binding_digest_unchanged_retry_forbidden") is not True:
        reasons.append("TERMINALIZED_PARENT_BINDING_DIGEST_UNCHANGED_RETRY_FORBIDDEN_MUST_BE_TRUE")
