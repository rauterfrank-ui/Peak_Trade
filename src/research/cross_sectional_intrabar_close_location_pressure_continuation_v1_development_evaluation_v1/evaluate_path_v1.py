"""Executable development-evaluation path for CS intrabar CLV pressure continuation v1.
...
from src.research.cross_sectional_intrabar_close_location_pressure_continuation_v1_development_evaluation_v1.admission_gates_v1 import (
    evaluate_admission_gates_v1,
    evaluate_segment_local_result_v1,
)
from src.research.cross_sectional_intrabar_close_location_pressure_continuation_v1_development_evaluation_v1.authorization_v1 import (
...
from src.research.cross_sectional_intrabar_close_location_pressure_continuation_v1_development_evaluation_v1.evidence_materialization_v1 import (
    build_registry_metadata_v1,
    build_run_slot_claim_v1,
    validate_evidence_and_registry_contracts_v1,
    write_evidence_bundle_v1,
)
from src.research.cross_sectional_intrabar_close_location_pressure_continuation_v1_development_evaluation_v1.evidence_schema_v1 import (
    empty_evidence_surface_template,
)
from src.research.cross_sectional_intrabar_close_location_pressure_continuation_v1_development_evaluation_v1.execution_boundary_v1 import (
...
from src.research.cross_sectional_intrabar_close_location_pressure_continuation_v1_development_evaluation_v1.time_segments_v1 import (
...
def run_authorized_development_evaluation_v1(
    ...
    *,
    ...
    from src.research.cross_sectional_intrabar_close_location_pressure_continuation_v1_development_evaluation_v1.rebalance_observations_v1 import (
    ...
    ohlc = {
        s.instrument_id: {
            "high": tuple(float(b.high) for b in s.bars),
            "low": tuple(float(b.low) for b in s.bars),
            "close": tuple(float(b.close) for b in s.bars),
        }
        for s in panel.panel_series
    }
