"""Frozen constants for CS intrabar CLV pressure continuation v1 DEVELOPMENT evaluation.
...
PACKAGE_SCOPE_ID = (
    "cross_sectional_intrabar_close_location_pressure_continuation_v1_development_evaluation_v1"
)
OWNER_SURFACE = (
    "CROSS_SECTIONAL_INTRABAR_CLOSE_LOCATION_PRESSURE_CONTINUATION_V1_"
...
EVALUATION_RUN_ID = (
    "evaluate_cross_sectional_intrabar_close_location_pressure_continuation_development_v1"
)
...
# Updated to live contract digest after authorization/execution mutation in this slice.
FROZEN_MEASUREMENT_CONTRACT_DIGEST = (
    "5ad3210f8b02151122aff1846f08003fcdf62f662be372a425184a4b76734cb4"
)
PREREGISTRATION_ORIGINAL_DIGEST = "5ad3210f8b02151122aff1846f08003fcdf62f662be372a425184a4b76734cb4"
...
ENTRY_POINT_BINDING_REL_PATH = (
    "config/research/"
    "cross_sectional_intrabar_close_location_pressure_continuation_v1_development_"
    "evaluation_entry_point_binding_v1.json"
)
LIFECYCLE_AUTHORITY_REL_PATH = (
    "config/research/"
    "cross_sectional_intrabar_close_location_pressure_continuation_hypothesis_backlog_v1.json"
)
PROGRAM_REL_PATH = (
    "config/research/"
    "cross_sectional_intrabar_close_location_pressure_continuation_research_program_v1.json"
)
EVIDENCE_REL_PATH = (
    "docs/evidence/"
    "evaluate_cross_sectional_intrabar_close_location_pressure_continuation_development_v1/"
...
CLI_REL_PATH = (
    "scripts/research/"
    "run_evaluate_cross_sectional_intrabar_close_location_pressure_continuation_"
    "development_v1.py"
)
SCORE_REL_PATH = (
