"""Deterministic binding/digest resolution for CS intrabar CLV pressure continuation v1 eval entry point."""
...
def materialize_entry_point_binding_payload(repo_root: Path) -> dict[str, Any]:
    ...
    return {
        "artifact_kind": "cross_sectional_intrabar_close_location_pressure_continuation_v1_development_evaluation_entry_point_binding",
        "artifact_version": "v1",
        "authority_effect": "NONE",
        "canonical_ssot": True,
        "cli_ref": (
            "scripts/research/"
            "run_evaluate_cross_sectional_intrabar_close_location_pressure_continuation_development_v1.py"
        ),
        ...
        "governance_ref": (
            "docs/governance/"
            "CROSS_SECTIONAL_INTRABAR_CLOSE_LOCATION_PRESSURE_CONTINUATION_V1_DEVELOPMENT_EVALUATION_ENTRY_POINT_V1.md"
        ),
        ...
        "owner_surface": (
            "CROSS_SECTIONAL_INTRABAR_CLOSE_LOCATION_PRESSURE_CONTINUATION_V1_DEVELOPMENT_EVALUATION_ENTRY_POINT_V1"
        ),
        ...
        "reused_canonical_owners": {
            ...
            "score": "src.research.cross_sectional_intrabar_close_location_pressure_continuation_v1_score_v1",
            "selection": "src.research.cross_sectional_intrabar_close_location_pressure_continuation_v1_selection_v1",
        ...
        "schema_version": (
            "cross_sectional_intrabar_close_location_pressure_continuation_v1_development_evaluation_"
