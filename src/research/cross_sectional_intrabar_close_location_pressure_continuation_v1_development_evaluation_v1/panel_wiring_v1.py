"""Panel wiring: bind CLV score/selection into canonical single-slot backtest owner.
...
This module is infrastructure wiring only; production evaluation remains unauthorized
until operator GO flips authorization flags.
"""
...
def wire_selection_intents_to_orchestrator_result_v1(
    ...
    *,
    ...
    """Deterministic wiring from CS intrabar CLV v1 selection into orchestrator epochs."""
    if not panel_series:
    ...
    ohlc_by_id = _ohlc_by_instrument(panel_series, bar_count=bar_count)
