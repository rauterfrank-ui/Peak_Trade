"""Frozen constants for VTDC v1 DEVELOPMENT evaluation entry point.
...
PACKAGE_MARKER = (
    "VOLATILITY_TERM_STRUCTURE_DEPRESSED_CONTINUATION_V1_DEVELOPMENT_EVALUATION_ENTRY_POINT_V1=true"
)

SCOPE_ID = "volatility_term_structure_depressed_continuation_v1_development_evaluation_v1"
OWNER_SURFACE = (
    "VOLATILITY_TERM_STRUCTURE_DEPRESSED_CONTINUATION_V1_DEVELOPMENT_EVALUATION_ENTRY_POINT_V1"
)
EVALUATION_RUN_ID = "evaluate_volatility_term_structure_depressed_continuation_development_v1"
STRATEGY_ID = "volatility_term_structure_depressed_continuation"
STRATEGY_IDENTITY = "VOLATILITY_TERM_STRUCTURE_DEPRESSED_CONTINUATION_V1"
STRATEGY_VERSION = "v1"
...
IMPLEMENTATION_BINDING_REL_PATH = "config/research/volatility_term_structure_depressed_continuation_v1_strategy_implementation_binding_v1.json"
ENTRY_POINT_BINDING_REL_PATH = (
    "config/research/"
    "volatility_term_structure_depressed_continuation_v1_development_evaluation_entry_point_binding_v1.json"
)
...
GOVERNANCE_REL_PATH = "docs/governance/VOLATILITY_TERM_STRUCTURE_DEPRESSED_CONTINUATION_V1_DEVELOPMENT_EVALUATION_ENTRY_POINT_V1.md"
CLI_REL_PATH = "scripts/research/run_evaluate_volatility_term_structure_depressed_continuation_development_v1.py"
