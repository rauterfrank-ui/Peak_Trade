"""Execution boundary for VEPC v1 development evaluation.
...
class RealExecutionBoundaryV1:
    ...
    def load_development_panel(
        ...
        *,
        ...
        from src.research.volatility_expansion_pullback_continuation_v1_development_evaluation_v1.panel_loader_v1 import (
...
class FakeExecutionBoundaryV1:
    ...
    wiring_handoff: VepcTreatmentBaselineWiringHandoffV1 | None = None
