"""Thin offline economic evaluation adapter for cross_sectional_open_interest_zscore_reversion/v0.
...
PACKAGE_MARKER = (
    "CROSS_SECTIONAL_OPEN_INTEREST_ZSCORE_REVERSION_V0_OFFLINE_ECONOMIC_EVALUATION_ADAPTER_V0=true"
)

SCHEMA_VERSION = (
    "cross_sectional_open_interest_zscore_reversion_v0_offline_economic_evaluation_adapter.v0"
)
ADAPTER_ID = (
    "cross_sectional_open_interest_zscore_reversion_v0_offline_economic_evaluation_adapter_v0"
)
ADAPTER_VERSION = "v0"
CONFIG_REL_PATH = (
    "config/research/"
    "cross_sectional_open_interest_zscore_reversion_v0_offline_economic_evaluation_adapter_v0.json"
)
...
def run_cross_sectional_open_interest_zscore_reversion_v0_offline_economic_evaluation_adapter_v0(
    *,
    repo_root: Path,
