"""Definition-only preregistration validator for entry-effective MR eligibility v1.
...
PACKAGE_MARKER = "ENTRY_EFFECTIVE_MR_ELIGIBILITY_HYPOTHESIS_PREREGISTRATION_V1=true"
CONTRACT_REL_PATH = (
    "config/research/"
    "entry_effective_mr_eligibility_preregistered_economic_hypothesis_measurement_contract_v1.json"
)
...
REQUIRED_HYPOTHESIS_ID = "ENTRY_EFFECTIVE_MR_ELIGIBILITY_MEAN_REVERSION_NON_BITCOIN_PERPETUALS_V1"
...
REQUIRED_FILTER_ID = "canonical_vol_regime_filter_atr_percentile_midband_v1"
