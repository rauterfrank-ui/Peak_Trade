...
GO_TOKEN = (
    "GO_CROSS_SECTIONAL_FUNDING_RATE_RANK_DELTA_V0_OFFLINE_ECONOMIC_EVALUATION_EXECUTION_"
...
ALLOWED_EXECUTION_GO_TOKENS: frozenset[str] = frozenset(
    {GO_TOKEN, BOUNDED_EXECUTION_GO_TOKEN, LEGACY_EXECUTION_GO_TOKEN}
)
...
def materialize_economic_viability_evidence(
    *,
    ...
    """Persist cross-sectional funding-rate rank-delta EconomicViabilityEvidenceV1-shaped payload."""
    envelope = dict(versioned_binding)
    ...
    body: dict[str, Any] = {
        "schema_version": "economic_viability_evidence_cross_sectional_funding_rank_delta_v0",
        "strategy_id": STRATEGY_ID,
        "strategy_version": STRATEGY_VERSION,
