"""Cross-sectional funding-rate dispersion-zscore-reversion v0 offline economic evaluation execution v0.

Deterministic, fail-closed execution infrastructure for the bounded dispersion-zscore-reversion
...
from src.research.cross_sectional_funding_rate_dispersion_zscore_reversion_single_slot_research_orchestrator_v0 import (
    default_funding_dispersion_zscore_reversion_operator_binding_v0,
    run_cross_sectional_funding_rate_dispersion_zscore_reversion_orchestrator_v0,
)
from src.research.cross_sectional_funding_rate_dispersion_zscore_reversion_v0_bound_panel_dataset_materialization_v0 import (
...
from src.research.cross_sectional_funding_rate_dispersion_zscore_reversion_v0_offline_economic_evaluation_scope_ratification_v0 import (
    ValidationVerdictEnum,
    validate_dispersion_zscore_reversion_offline_economic_evaluation_scope_ratification_v0,
)
...
PACKAGE_MARKER = "CROSS_SECTIONAL_FUNDING_RATE_DISPERSION_ZSCORE_REVERSION_V0_OFFLINE_ECONOMIC_EVALUATION_EXECUTION_V0=true"

SCHEMA_VERSION = "cross_sectional_funding_rate_dispersion_zscore_reversion_v0_offline_economic_evaluation_execution.v0"
EXECUTION_ID = "cross_sectional_funding_rate_dispersion_zscore_reversion_v0_offline_economic_evaluation_execution_v0"
EXECUTION_VERSION = "v0"
CANONICAL_SERIALIZATION_VERSION = "cross_sectional_execution_canonical_json_v1"

GO_TOKEN = (
    "GO_CROSS_SECTIONAL_FUNDING_RATE_DISPERSION_ZSCORE_REVERSION_V0_OFFLINE_ECONOMIC_EVALUATION_EXECUTION_"
...
COMBINED_RATIFY_AND_EXECUTE_GO_TOKEN = (
    "GO_RATIFY_AND_EXECUTE_CROSS_SECTIONAL_FUNDING_RATE_DISPERSION_ZSCORE_REVERSION_V0_"
    "VERSIONED_BINDINGS_AND_OFFLINE_ECONOMIC_EVALUATION_NO_RUNTIME_AUTHORITY_V0"
)
_DEFAULT_INFRASTRUCTURE_GO = INFRASTRUCTURE_GO_TOKEN
ALLOWED_INFRASTRUCTURE_GO_TOKENS: frozenset[str] = frozenset(
...
RUNNER_OWNER = "scripts.ops.run_cross_sectional_funding_rate_dispersion_zscore_reversion_v0_offline_economic_evaluation_execution_v0"
RUNNER_SCRIPT = "scripts/ops/run_cross_sectional_funding_rate_dispersion_zscore_reversion_v0_offline_economic_evaluation_execution_v0.py"
...
def verify_execution_start_state_v0(
    *,
    ...
    orchestrator_path = (
        ...
        / "src/research"
        / (
            "cross_sectional_funding_rate_dispersion_zscore_reversion_single_slot_research_orchestrator_v0.py"
        )
    )
...
def run_contract_smoke_evaluation_v0(
    *,
    ...
    binding = default_funding_dispersion_zscore_reversion_operator_binding_v0()
    ...
    orchestrator = run_cross_sectional_funding_rate_dispersion_zscore_reversion_orchestrator_v0(
        binding=binding,
...
def materialize_economic_viability_evidence(
    *,
    ...
    """Persist cross-sectional funding-rate dispersion-zscore-reversion EconomicViabilityEvidenceV1-shaped payload."""
    envelope = dict(versioned_binding)
    ...
    body: dict[str, Any] = {
        "schema_version": "economic_viability_evidence_cross_sectional_funding_dispersion_zscore_reversion_v0",
        "strategy_id": STRATEGY_ID,
        "strategy_version": STRATEGY_VERSION,
