"""Cross-sectional funding-rate rank-delta v0 versioned research binding materializer."""
...
from src.research.cross_sectional_funding_rate_rank_delta_ranking_semantics_binding_v0 import (
    ...
    materialize_versioned_funding_rate_rank_delta_ranking_semantics_binding_v0,
...
PACKAGE_MARKER = "CROSS_SECTIONAL_FUNDING_RATE_RANK_DELTA_V0_VERSIONED_RESEARCH_BINDING_V0=true"
BINDING_ARTIFACT_VERSION = "v0"
BINDING_SCHEMA_VERSION = "cross_sectional_funding_rate_rank_delta_v0_versioned_research_binding.v0"
CONFIG_REL_PATH = (
    "config/research/cross_sectional_funding_rate_rank_delta_v0_versioned_research_binding_v0.json"
)
...
PANEL_WARMUP_BARS = RANK_LOOKBACK_K + FUNDING_SIGNAL_LAG + 1
...
MATERIAL_DIFFERENCE_BASIS = (
    "cross_sectional_rank_migration_not_absolute_level_spread_or_absolute_funding_delta"
)
...
def compute_implementation_digest_v0() -> str:
    return _stable_digest(
        {
            "module": "cross_sectional_funding_rate_rank_delta_v0_versioned_research_binding_v0",
...
def build_parameter_binding_v0() -> dict[str, Any]:
    ...
    return {
        ...
        "rank_lookback_k": RANK_LOOKBACK_K,
...
def materialize_versioned_research_binding_v0() -> dict[str, Any]:
    base = materialize_funding_rate_rank_delta_ranking_semantics_binding_v0()
    ...
    validation = validate_funding_rate_rank_delta_ranking_semantics_binding_v0(complete_binding)
    return {
        "artifact_kind": "cross_sectional_funding_rate_rank_delta_v0_versioned_research_binding",
...
def write_versioned_research_binding_artifacts_v0(repo_root: Path) -> tuple[Path, Path]:
    envelope = materialize_versioned_research_binding_v0()
    ranking_envelope = materialize_versioned_funding_rate_rank_delta_ranking_semantics_binding_v0()
