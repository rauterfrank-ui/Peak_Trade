"""Frozen constants for CS path-efficiency continuation v1 DEVELOPMENT evaluation.
...
PACKAGE_MARKER = (
    "CROSS_SECTIONAL_PATH_EFFICIENCY_CONTINUATION_V1_DEVELOPMENT_EVALUATION_ENTRY_POINT_V1=true"
)

SCOPE_ID = (
    "CROSS_SECTIONAL_PATH_EFFICIENCY_CONTINUATION_V1_BOUNDED_DEVELOPMENT_EVALUATION_EXECUTION_V1"
)
PACKAGE_SCOPE_ID = "cross_sectional_path_efficiency_continuation_v1_development_evaluation_v1"
OWNER_SURFACE = (
    "CROSS_SECTIONAL_PATH_EFFICIENCY_CONTINUATION_V1_DEVELOPMENT_EVALUATION_ENTRY_POINT_V1"
)
EVALUATION_RUN_ID = "evaluate_cross_sectional_path_efficiency_continuation_development_v1"
...
FROZEN_MEASUREMENT_CONTRACT_DIGEST = (
    "cf6168556a7ae36c15381ab78bc57f2c46d49e17257556ea5198dd3adf4aaec7"
)
...
IMPLEMENTATION_BINDING_REL_PATH = (
    "config/research/"
    "cross_sectional_path_efficiency_continuation_v1_strategy_implementation_binding_v1.json"
)
ENTRY_POINT_BINDING_REL_PATH = (
    "config/research/"
    "cross_sectional_path_efficiency_continuation_v1_development_evaluation_"
    "entry_point_binding_v1.json"
)
LIFECYCLE_AUTHORITY_REL_PATH = (
    "config/research/cross_sectional_path_efficiency_continuation_hypothesis_backlog_v1.json"
)
PROGRAM_REL_PATH = (
    "config/research/cross_sectional_path_efficiency_continuation_research_program_v1.json"
)
EVIDENCE_REL_PATH = (
    "docs/evidence/evaluate_cross_sectional_path_efficiency_continuation_development_v1/"
)
GOVERNANCE_REL_PATH = (
    "docs/governance/"
    "CROSS_SECTIONAL_PATH_EFFICIENCY_CONTINUATION_V1_DEVELOPMENT_EVALUATION_ENTRY_POINT_V1.md"
)
CLI_REL_PATH = (
    "scripts/research/run_evaluate_cross_sectional_path_efficiency_continuation_development_v1.py"
)
SCORE_REL_PATH = "src/research/cross_sectional_path_efficiency_continuation_v1_score_v1.py"
SELECTION_REL_PATH = "src/research/cross_sectional_path_efficiency_continuation_v1_selection_v1.py"
