...
def is_valid_evaluable_rebalance_observation(
    intent: CrossSectionalPathEfficiencyRankIntentV1,
) -> bool:
...
def classify_rebalance_observation(
    intent: CrossSectionalPathEfficiencyRankIntentV1, *, timestamp_utc: str
...
def collect_valid_evaluable_rebalance_observations(
    ...
    *,
    ...
    prior: CrossSectionalPathEfficiencyRankIntentV1 | None = None
