"""Panel wiring: bind merged score/selection into canonical single-slot backtest owner.
...
def wire_selection_intents_to_orchestrator_result_v1(
    ...
    *,
    ...
    """Deterministic wiring from CS RS momentum v1 selection into orchestrator epochs."""
    if not panel_series:
    ...
    for iid, series in series_by_id.items():
        closes: list[float] = []
