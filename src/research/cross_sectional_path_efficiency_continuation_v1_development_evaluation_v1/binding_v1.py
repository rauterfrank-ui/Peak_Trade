"""Deterministic binding/digest resolution for CS RS momentum v1 eval entry point."""
...
def materialize_entry_point_binding_payload(repo_root: Path) -> dict[str, Any]:
    ...
    return {
        "artifact_kind": "cross_sectional_path_efficiency_continuation_v1_development_evaluation_entry_point_binding",
        "artifact_version": "v1",
        "authority_effect": "NONE",
        "canonical_ssot": True,
        "cli_ref": (
            "scripts/research/"
            "run_evaluate_cross_sectional_path_efficiency_continuation_development_v1.py"
        ),
        ...
        "reused_canonical_owners": {
            ...
            "score": "src.research.cross_sectional_path_efficiency_continuation_v1_score_v1",
            "selection": "src.research.cross_sectional_path_efficiency_continuation_v1_selection_v1",
        ...
        "operator_go_token": (
            "GO_CROSS_SECTIONAL_PATH_EFFICIENCY_CONTINUATION_V1_"
            "BOUNDED_DEVELOPMENT_EVALUATION_EXECUTION_V1"
        ),
        "scope_id": (
            "CROSS_SECTIONAL_PATH_EFFICIENCY_CONTINUATION_V1_"
            "BOUNDED_DEVELOPMENT_EVALUATION_EXECUTION_V1"
        ),
    }
