"""Point-in-time semantics contract for OKX open-interest level observations v0.

Registers machine-readable PIT binding for cross_sectional_open_interest_level_rank/v0.
...
PACKAGE_MARKER = "CROSS_SECTIONAL_OPEN_INTEREST_LEVEL_RANK_V0_PIT_SEMANTICS_CONTRACT_V0=true"
CONTRACT_VERSION = "cross_sectional_open_interest_level_rank_v0_pit_semantics_contract.v0"
...
class PitOpenInterestLevelSemanticsContractV0:
...
def build_pit_open_interest_level_semantics_contract_v0() -> (
    PitOpenInterestLevelSemanticsContractV0
):
    payload = {
    ...
    return PitOpenInterestLevelSemanticsContractV0(semantic_digest=digest, **payload)


def pit_semantics_contract_to_dict(
    contract: PitOpenInterestLevelSemanticsContractV0,
) -> dict[str, object]:
    return {
