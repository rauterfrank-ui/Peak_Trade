"""Load DEVELOPMENT-only panel into InstrumentPanelSeriesV1 for VDBX v1 eval.

Reuses the sealed DEVELOPMENT panel loader owner (identical dataset binding as
VCB/VEP/VDB). Holdout paths are rejected. BTC/spot exclusion is enforced by sealed
panel membership.
"""
