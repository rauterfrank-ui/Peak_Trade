"""Frozen constants for VDBX v1 DEVELOPMENT evaluation entry point.
...
exit semantics remain unchanged. Cloned from the VEP development-evaluation package
(NOT from VDB corrective paths), adapted for strategy-emitted exits.
"""
...
SCOPE_ID = "volatility_decay_breakout_with_explicit_decay_exit_v1_development_evaluation_v1"
OWNER_SURFACE = (
    "VOLATILITY_DECAY_BREAKOUT_WITH_EXPLICIT_DECAY_EXIT_V1_DEVELOPMENT_EVALUATION_ENTRY_POINT_V1"
)
EVALUATION_RUN_ID = "evaluate_volatility_decay_breakout_with_explicit_decay_exit_development_v1"
STRATEGY_ID = "volatility_decay_breakout_with_explicit_decay_exit"
STRATEGY_IDENTITY = "VOLATILITY_DECAY_BREAKOUT_WITH_EXPLICIT_DECAY_EXIT_V1"
STRATEGY_VERSION = "v1"
SIGNAL_FAMILY = "VOLATILITY_REGIME"
HYPOTHESIS_ID = "VOLATILITY_DECAY_BREAKOUT_WITH_EXPLICIT_DECAY_EXIT_NON_BITCOIN_PERPETUALS_V1"
...
BAR_FREQUENCY = "PT1H"
# Bound from measurement-contract time_segment_definition.development_period (identical
# to VDB/VEP: same sealed DEVELOPMENT_ONLY dataset/panel bounds).
...
IMPLEMENTATION_BINDING_REL_PATH = (
    "config/research/"
    "volatility_decay_breakout_with_explicit_decay_exit_v1_strategy_implementation_binding_v1.json"
)
ENTRY_POINT_BINDING_REL_PATH = (
    "config/research/"
    "volatility_decay_breakout_with_explicit_decay_exit_v1_development_evaluation_entry_point_"
    "binding_v1.json"
)
...
GOVERNANCE_REL_PATH = (
    "docs/governance/"
    "VOLATILITY_DECAY_BREAKOUT_WITH_EXPLICIT_DECAY_EXIT_V1_DEVELOPMENT_EVALUATION_ENTRY_POINT_V1.md"
)
CLI_REL_PATH = (
    "scripts/research/"
    "run_evaluate_volatility_decay_breakout_with_explicit_decay_exit_development_v1.py"
)
...
# Predecessor VDB vol-state module: reused unchanged by VDBX (ATR14/close + percentile rank).
