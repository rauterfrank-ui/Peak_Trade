"""Fail-closed validator for cross_sectional_funding_rate_extreme_carry_reversion_ranking_semantics_binding.v0."""
...
PACKAGE_MARKER = "CROSS_SECTIONAL_FUNDING_RATE_EXTREME_CARRY_REVERSION_RANKING_SEMANTICS_BINDING_VALIDATOR_V0=true"
...
class FundingExtremeCarryReversionRankingSemanticsBindingValidationResult:
...
def validate_funding_rate_extreme_carry_reversion_ranking_semantics_binding_v0(
    binding: Mapping[str, Any],
) -> FundingExtremeCarryReversionRankingSemanticsBindingValidationResult:
    ...
    if direction.get("rank_delta_reuse_forbidden") is not True:
        fail_reasons.append("RANK_DELTA_REUSE_MUST_BE_FORBIDDEN")
    ...
    if fail_reasons:
        return FundingExtremeCarryReversionRankingSemanticsBindingValidationResult(
