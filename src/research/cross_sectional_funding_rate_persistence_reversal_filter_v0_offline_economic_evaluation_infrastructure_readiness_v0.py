"""Cross-sectional funding-rate persistence reversal filter v0 offline evaluation infrastructure readiness v0.
...
READINESS_SCHEMA_VERSION = "cross_sectional_funding_rate_persistence_reversal_filter_v0_offline_evaluation_infrastructure_readiness.v0"
READINESS_ID = "cross_sectional_funding_rate_persistence_reversal_filter_v0_offline_evaluation_infrastructure_readiness_v0"
...
ORCHESTRATOR_REL_PATH = "src/research/cross_sectional_funding_rate_persistence_reversal_filter_single_slot_research_orchestrator_v0.py"
...
def evaluate_persistence_reversal_filter_offline_evaluation_infrastructure_readiness_v0(
    *,
    repo_root: Path,
