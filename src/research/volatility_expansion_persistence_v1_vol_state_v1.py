"""ATR14/close and percentile-rank vol-state helpers for VEP v1.
...
ATR period is frozen at 14 by the VEP measurement contract — not a VCB retry.
"""
...
VOL_STATE_OWNER = "research.volatility_expansion_persistence_v1_vol_state_v1"
