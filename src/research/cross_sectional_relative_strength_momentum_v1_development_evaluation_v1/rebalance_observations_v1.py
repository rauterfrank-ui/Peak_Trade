"""Valid evaluable rebalance-observation semantics for CS RS momentum v1.
...
def is_valid_evaluable_rebalance_observation(intent: CrossSectionalMomentumRankIntentV1) -> bool:
...
def classify_rebalance_observation(
    intent: CrossSectionalMomentumRankIntentV1, *, timestamp_utc: str
...
def collect_valid_evaluable_rebalance_observations(
    ...
    *,
    ...
    prior: CrossSectionalMomentumRankIntentV1 | None = None
