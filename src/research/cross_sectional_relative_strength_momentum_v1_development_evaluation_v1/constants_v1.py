"""Frozen constants for CS RS momentum v1 DEVELOPMENT evaluation entry point.
...
PACKAGE_MARKER = (
    "CROSS_SECTIONAL_RELATIVE_STRENGTH_MOMENTUM_V1_DEVELOPMENT_EVALUATION_ENTRY_POINT_V1=true"
)

SCOPE_ID = "cross_sectional_relative_strength_momentum_v1_development_evaluation_v1"
OWNER_SURFACE = (
    "CROSS_SECTIONAL_RELATIVE_STRENGTH_MOMENTUM_V1_DEVELOPMENT_EVALUATION_ENTRY_POINT_V1"
)
EVALUATION_RUN_ID = "evaluate_cross_sectional_relative_strength_momentum_development_v1"
...
HYPOTHESIS_ID = "CROSS_SECTIONAL_RELATIVE_STRENGTH_MOMENTUM_NON_BITCOIN_PERPETUALS_V1"
PROGRAM_ID = "MATERIAL_DIFFERENT_CROSS_SECTIONAL_MOMENTUM_PROGRAM_V1"
...
ENTRY_POINT_BINDING_REL_PATH = (
    "config/research/"
    "cross_sectional_relative_strength_momentum_v1_development_evaluation_"
...
GOVERNANCE_REL_PATH = (
    "docs/governance/"
    "CROSS_SECTIONAL_RELATIVE_STRENGTH_MOMENTUM_V1_DEVELOPMENT_EVALUATION_ENTRY_POINT_V1.md"
)
CLI_REL_PATH = (
    "scripts/research/run_evaluate_cross_sectional_relative_strength_momentum_development_v1.py"
)
SCORE_REL_PATH = "src/research/cross_sectional_relative_strength_momentum_v1_score_v1.py"
SELECTION_REL_PATH = "src/research/cross_sectional_relative_strength_momentum_v1_selection_v1.py"
