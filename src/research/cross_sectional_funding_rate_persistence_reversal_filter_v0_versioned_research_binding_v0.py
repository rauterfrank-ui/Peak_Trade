"""Cross-sectional funding-rate persistence reversal filter v0 versioned research binding materializer."""
...
from src.research.cross_sectional_funding_rate_persistence_reversal_filter_ranking_semantics_binding_v0 import (
    ...
    materialize_versioned_funding_persistence_reversal_filter_ranking_semantics_binding_v0,
...
PACKAGE_MARKER = (
    "CROSS_SECTIONAL_FUNDING_RATE_PERSISTENCE_REVERSAL_FILTER_V0_VERSIONED_RESEARCH_BINDING_V0=true"
)
BINDING_ARTIFACT_VERSION = "v0"
BINDING_SCHEMA_VERSION = (
    "cross_sectional_funding_rate_persistence_reversal_filter_v0_versioned_research_binding.v0"
)
CONFIG_REL_PATH = "config/research/cross_sectional_funding_rate_persistence_reversal_filter_v0_versioned_research_binding_v0.json"
...
PANEL_WARMUP_BARS = PERSISTENCE_LOOKBACK_K + FUNDING_SIGNAL_LAG + REVERSAL_RISK_LOOKBACK_K + 1
...
def compute_implementation_digest_v0() -> str:
    return _stable_digest(
        {
            "module": "cross_sectional_funding_rate_persistence_reversal_filter_v0_versioned_research_binding_v0",
    ...
    return _stable_digest(
        {
            ...
            "excluded_near_duplicates": [
                ...
                "funding_level_spread_dual_leg_simultaneous_v1",
                "funding_delta_extremes_single_leg_rotation_v0",
            ],
            "persistence_reversal_filter_signal": True,
...
def build_panel_dataset_binding_v0() -> dict[str, Any]:
    return {
        ...
        "funding_usage": "funding_rate_for_persistence_reversal_computation",
        "narrow_adapter": "pit_okx_pt1h_panel_funding_field_materialization.v0",
...
def materialize_versioned_research_binding_v0() -> dict[str, Any]:
    base = materialize_funding_persistence_reversal_filter_ranking_semantics_binding_v0()
    ...
    return {
        "artifact_kind": "cross_sectional_funding_rate_persistence_reversal_filter_v0_versioned_research_binding",
