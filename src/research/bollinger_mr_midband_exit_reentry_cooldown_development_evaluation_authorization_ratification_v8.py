...
SCHEMA_VERSION = (
    "bollinger_mr_midband_exit_reentry_cooldown_development_evaluation_"
    "authorization_ratification.v8"
)
RATIFICATION_ID = (
    "bollinger_mr_midband_exit_reentry_cooldown_development_evaluation_"
    "authorization_ratification_v8"
)
RATIFICATION_REL_PATH = (
    "config/research/"
    "bollinger_mr_midband_exit_reentry_cooldown_development_evaluation_"
    "authorization_ratification_v8.json"
)
EVIDENCE_REL_PATH = (
...
GO_TOKEN = "GO_BOLLINGER_MR_MIDBAND_EXIT_REENTRY_COOLDOWN_V8_DEVELOPMENT_EVALUATION_AUTHORIZATION"
NEXT_OPERATOR_GO = "GO_BOLLINGER_MR_MIDBAND_EXIT_REENTRY_COOLDOWN_V8_DEVELOPMENT_EVALUATION_RUN"
NEXT_CANONICAL_STEP = "AWAIT_SEPARATE_OPERATOR_GO_FOR_V8_DEVELOPMENT_EVALUATION_RUN"
POST_EXEC_NEXT_CANONICAL_STEP = "OPERATOR_GO_REQUIRED_FOR_ANY_NEW_DEFINITION_ONLY_PREREGISTRATION"
RUN_LIMIT = 1
READY_AUTHORITY_DIGEST = "11dbd8168ac75789f52434e84e3276065d7b5ac3f27568b738307c7d73e7b2ff"
EVAL_EVIDENCE_REL = (
...
def validate_ratification(
    ...
    *,
    ...
    if executed:
        ...
        if ratification.get("v8_reopen_allowed") is not False:
            raise EvaluationAuthorizationRatificationError("POST_EXEC_V8_REOPEN_ALLOWED")
        allowed_results = {
            "PASS",
            "FAIL",
        ...
        if str(ratification.get("result_class") or "") not in allowed_results:
    ...
    # Pre-authorization parity MUST pass before ratification can be considered valid.
    contract_for_preauth = json.loads(
        (
            repo
            / "config/research/"
    ...
    try:
        validate_pre_authorization_frozen_parameter_parity(contract_for_preauth)
    except Exception as exc:  # noqa: BLE001
        raise EvaluationAuthorizationRatificationError(f"PRE_AUTHORIZATION_PARITY:{exc}") from exc
    ...
    return {
        ...
        "rerun_allowed": False,
        "v8_reopen_allowed": False if executed else None,
    }
