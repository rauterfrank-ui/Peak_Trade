"""Cross-sectional open-interest level-rank v0 offline economic evaluation execution v0.

Deterministic, fail-closed execution infrastructure for the bounded open-interest level-rank
...
from src.research.cross_sectional_open_interest_level_rank_single_slot_research_orchestrator_v0 import (
    default_open_interest_level_rank_operator_binding_v0,
    run_cross_sectional_open_interest_level_rank_orchestrator_v0,
)
from src.research.cross_sectional_open_interest_level_rank_v0_offline_economic_evaluation_scope_ratification_v0 import (
...
SCHEMA_VERSION = (
    "cross_sectional_open_interest_level_rank_v0_offline_economic_evaluation_execution.v0"
)
EXECUTION_ID = (
...
GO_TOKEN = (
    "GO_CROSS_SECTIONAL_OPEN_INTEREST_LEVEL_RANK_V0_OFFLINE_ECONOMIC_EVALUATION_"
    "REEVALUATION_NO_RUNTIME_AUTHORITY_V0"
)
ADAPTER_GO_TOKEN = (
    "GO_CROSS_SECTIONAL_OPEN_INTEREST_LEVEL_RANK_V0_OFFLINE_ECONOMIC_EVALUATION_"
...
CONFIG_REL_PATH_OPS = (
    "config/ops/cross_sectional_open_interest_level_rank_v0_economic_evaluation_v1.json"
)
...
RUNNER_OWNER = (
    "scripts.ops.run_cross_sectional_open_interest_level_rank_v0_offline_economic_"
...
def materialize_ops_evaluation_config_v0(
    ...
    return {
        ...
        "config_schema_version": (
            "cross_sectional_open_interest_level_rank_v0_economic_evaluation_admissibility_v1"
        ),
        "config_version": "v1",
...
def run_contract_smoke_evaluation_v0(
    *,
    ...
    binding = default_open_interest_level_rank_operator_binding_v0()
    ...
    orchestrator = run_cross_sectional_open_interest_level_rank_orchestrator_v0(
        binding=binding,
