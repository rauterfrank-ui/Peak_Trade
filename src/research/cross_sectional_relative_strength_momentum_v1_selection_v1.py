"""Deterministic single-top1 rank-intent selection for CS RS momentum v1.
...
from src.research.cross_sectional_relative_strength_momentum_v1_score_v1 import (
    ...
    STRATEGY_ID,
    SIGNAL_FAMILY,
    CrossSectionalMomentumScoreResultV1,
...
PACKAGE_MARKER = "CROSS_SECTIONAL_RELATIVE_STRENGTH_MOMENTUM_V1_SELECTION_V1=true"
...
class CrossSectionalMomentumRankIntentV1:
    strategy_id: str
...
def select_single_top1_rank_intent_v1(
    ...
    *,
    ...
    prior_intent: CrossSectionalMomentumRankIntentV1 | None = None,
) -> CrossSectionalMomentumRankIntentV1:
    ...
    scores: list[CrossSectionalMomentumScoreResultV1] = []
