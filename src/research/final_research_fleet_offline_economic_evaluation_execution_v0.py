...
GO_TOKEN_RATIFIED_PR4917 = (
    "GO_EXECUTE_RATIFIED_FINAL_FLEET_VERSIONED_OFFLINE_ECONOMIC_EVALUATION_V0"
)
ACCEPTED_GO_TOKENS: frozenset[str] = frozenset(
    {GO_TOKEN, GO_TOKEN_OPERATOR_ALIAS, GO_TOKEN_CLASS_D_FINAL, GO_TOKEN_RATIFIED_PR4917}
)
PR4917_MERGE_COMMIT = "400b6e9d8cbbf1ade46f36e8fda797808b6db47a"
...
# Post-PR4991 origin/main after the Non-Class-D allowlist follow-up merge.
ORIGIN_MAIN_AFTER_PR4991_NON_CLASS_D_ORIGIN_MAIN_ALLOWLIST_FIX_SHA = (
    "0d8ae131a0ec1817638d91a233ede0b4ad8355da"
)
# Post-PR4992 origin/main after the Non-Class-D allowlist follow-up merge.
ORIGIN_MAIN_AFTER_PR4992_NON_CLASS_D_ORIGIN_MAIN_ALLOWLIST_FIX_SHA = (
    "6e91c95eceae9ec5fbe94f058ea6403a50e9c47e"
)
