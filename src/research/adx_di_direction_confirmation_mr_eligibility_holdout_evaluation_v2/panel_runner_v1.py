...
EVALUATION_RUN_ID = "evaluate_adx_di_direction_confirmation_mr_eligibility_holdout_v2"
...
def run_holdout_evaluation(
    *,
    ...
    config_snapshot = {
        "schema_version": "evaluate_adx_di_direction_confirmation_mr_eligibility_holdout_config_snapshot.v2",
    ...
    command = (
        "PYTHONPATH=src:. PEAK_TRADE_ADX_DI_HOLDOUT_V2_EXECUTION_GO=true python3 scripts/research/"
        "run_evaluate_adx_di_direction_confirmation_mr_eligibility_holdout_v2.py "
        f"--output-dir {output_dir}"
    )
    base_sha = _git_base_sha(repo)
    holdout_run_count_after = holdout_run_count_before + 1
    summary = {
        "schema_version": "evaluate_adx_di_direction_confirmation_mr_eligibility_holdout_summary.v2",
        ...
        "predecessor_holdout_v1_hypothesis_id": contract["predecessor_holdout_v1"]["hypothesis_id"],
        "primary_decision_metric": contract["primary_decision_metric"],
        "sealed_holdout_id": contract["sealed_holdout_id"],
        "base_sha": base_sha,
