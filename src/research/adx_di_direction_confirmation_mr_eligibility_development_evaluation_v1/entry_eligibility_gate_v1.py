"""Research-only ADX DI direction-confirmation entry eligibility gate (no Master-V2 mutation).
...
comes from the frozen ADX DI filter in this package (``is_entry_eligible``).
"""
