...
RECOMMENDED_SCOPE_ID = (
    "CROSS_SECTIONAL_FUNDING_RATE_DELTA_MOMENTUM_V0_OFFLINE_ECONOMIC_EVALUATION_RATIFICATION_PREP"
)
...
OPERATOR_SCOPE_RATIFICATION_REF = (
    "bounded_cs_funding_rate_delta_momentum_scope_binding_ratification_v0"
)
CONFIG_REL_PATH = (
    "config/research/"
    "cross_sectional_funding_rate_delta_momentum_v0_offline_economic_evaluation_scope_ratification_v0.json"
)
RUNNER_BINDING_REF = (
    "scripts/ops/"
    "run_cross_sectional_funding_rate_delta_momentum_v0_offline_economic_evaluation_execution_v0.py"
)
HARNESS_BINDING_REF = (
    "src/research/"
    ...
    *,
    ...
    body: dict[str, Any] = {
        ...
        "material_difference_basis": (
            "funding_rate_delta_rank_extremes_panel_rotation_not_single_instrument_price_signal"
        ),
