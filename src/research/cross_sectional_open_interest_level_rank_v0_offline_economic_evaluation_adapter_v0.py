"""Thin offline economic evaluation adapter for cross_sectional_open_interest_level_rank/v0.
...
SCHEMA_VERSION = (
    "cross_sectional_open_interest_level_rank_v0_offline_economic_evaluation_adapter.v0"
)
ADAPTER_ID = "cross_sectional_open_interest_level_rank_v0_offline_economic_evaluation_adapter_v0"
ADAPTER_VERSION = "v0"
CONFIG_REL_PATH = (
    "config/research/"
    "cross_sectional_open_interest_level_rank_v0_offline_economic_evaluation_adapter_v0.json"
)

GO_TOKEN = ADAPTER_GO_TOKEN
EXECUTION_OWNER = (
    "src.research.cross_sectional_open_interest_level_rank_v0_offline_economic_evaluation_"
    "execution_v0"
)
...
def run_cross_sectional_open_interest_level_rank_v0_offline_economic_evaluation_adapter_v0(
    *,
    repo_root: Path,
