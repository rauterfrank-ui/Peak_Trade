"""Deterministic binding/digest resolution for VTSR v1 eval entry point."""
...
from src.research.volatility_term_structure_reversion_v1_development_evaluation_v1.constants_v1 import (
    ALLOWED_DATASET_IDS,
    BASELINE_ID,
...
def assert_shared_channel_core_bound() -> None:
    """Baseline reuses shared channel core; VTSR treatment has no channel prerequisite."""
...
def assert_exit_state_machine_bound() -> None:
    """The strategy producer must import the frozen VTSR exit state machine (no local reimpl)."""
    from src.research import (
        volatility_term_structure_reversion_v1_exit_state_machine_v1 as exit_sm,
    )
    from src.research import (
        volatility_term_structure_reversion_v1_strategy_v1 as strategy,
    )
...
def materialize_entry_point_binding_payload(repo_root: Path) -> dict[str, Any]:
    ...
    return {
        "artifact_kind": (
            "volatility_term_structure_reversion_v1_development_evaluation_entry_point_binding"
        ),
        "artifact_version": "v1",
        ...
        "evidence_ref": "docs/evidence/evaluate_volatility_term_structure_reversion_development_v1/",
        ...
        "schema_version": (
            "volatility_term_structure_reversion_v1_development_evaluation_entry_point_binding.v1"
        ),
