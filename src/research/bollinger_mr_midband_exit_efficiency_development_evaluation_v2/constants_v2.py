"""Frozen constants for Bollinger/MR midband exit-efficiency DEVELOPMENT evaluation v2.

Identical fees/params/hashes/seeds to v1. Only scope/run/hypothesis/path identity
is versioned. V2 is a new independently preregistered measurement; not a V1 rerun.
"""

from __future__ import annotations

SCOPE_ID = "bollinger_mr_midband_exit_efficiency_development_evaluation_v2"
EVALUATION_RUN_ID = "evaluate_bollinger_mr_midband_exit_efficiency_development_v2"
...
EVIDENCE_REL_PATH = "docs/evidence/evaluate_bollinger_mr_midband_exit_efficiency_development_v2/"
GOVERNANCE_REL_PATH = (
