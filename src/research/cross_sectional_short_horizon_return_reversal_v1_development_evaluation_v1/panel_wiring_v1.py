"""Panel wiring: bind short-horizon return-reversal score/selection into canonical single-slot backtest owner.
...
def wire_selection_intents_to_orchestrator_result_v1(
    ...
    *,
    ...
    """Deterministic wiring from CSRHR v1 close-series selection into orchestrator epochs."""
    if not panel_series:
