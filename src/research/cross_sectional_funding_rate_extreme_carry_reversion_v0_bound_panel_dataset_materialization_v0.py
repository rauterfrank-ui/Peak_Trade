"""Bound funding panel dataset materialization for cross-sectional funding-rate extreme-carry-reversion v0."""
...
PACKAGE_MARKER = "CROSS_SECTIONAL_FUNDING_RATE_EXTREME_CARRY_REVERSION_V0_BOUND_PANEL_DATASET_MATERIALIZATION_V0=true"
MATERIALIZATION_VERSION = (
    "cross_sectional_funding_rate_extreme_carry_reversion_v0_bound_panel_dataset_materialization.v0"
)
