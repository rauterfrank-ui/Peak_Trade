"""Trend-following v2 versioned research binding materializer v0.

Deterministic materialization of immutable versioned bindings for trend_following/v2
as the first admissible post-discovery research generation. Reuses canonical sparse-signal
...
PACKAGE_MARKER = "TREND_FOLLOWING_V2_VERSIONED_RESEARCH_BINDING_V0=true"

SCHEMA_VERSION = "trend_following_v2_versioned_research_binding.v0"
BINDING_ARTIFACT_VERSION = "v0"
CONFIG_REL_PATH = "config/research/trend_following_v2_versioned_research_binding_v0.json"
GOVERNANCE_REL_PATH = (
    "docs/governance/TREND_FOLLOWING_V2_OFFLINE_ECONOMIC_EVALUATION_AUTHORIZATION_V0.md"
)
...
def compute_module_implementation_digest_v0() -> str:
    return _stable_digest(
        {
            "module": "trend_following_v2_versioned_research_binding_v0",
...
def materialize_versioned_research_binding_v0(
    *,
    ...
    binding_body: dict[str, Any] = {
        "artifact_kind": "trend_following_v2_versioned_research_binding",
        ...
        "material_difference_basis": (
            "TREND_CONTINUATION_V2 replaces terminal trend_following/v1 with panel-sequential "
            "signal-density research binding; distinct from pairwise spillover graph lineage."
        ),
