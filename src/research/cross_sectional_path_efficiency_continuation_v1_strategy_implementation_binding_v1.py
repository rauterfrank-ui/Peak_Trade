"""Validator for CS path-efficiency continuation v1 strategy-implementation binding."""
...
PACKAGE_MARKER = (
    "CROSS_SECTIONAL_PATH_EFFICIENCY_CONTINUATION_V1_STRATEGY_IMPLEMENTATION_BINDING=true"
)
BINDING_REL_PATH = (
    "config/research/"
...
def validate_implementation_binding(
    ...
    _require(params.get("lookback_n") == 48, "LOOKBACK_N")
    _require(params.get("rebalance_interval_bars") == 8, "REBALANCE_INTERVAL")
