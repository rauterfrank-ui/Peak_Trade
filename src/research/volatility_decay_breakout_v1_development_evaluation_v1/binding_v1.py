"""Deterministic binding/digest resolution for VDB v1 eval entry point."""
...
def assert_shared_channel_core_bound() -> None:
    ...
    from src.research import volatility_decay_breakout_v1_strategy_v1 as strategy
...
def materialize_entry_point_binding_payload(repo_root: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "schema_version": (
            "volatility_decay_breakout_v1_development_evaluation_entry_point_binding.v1"
        ),
