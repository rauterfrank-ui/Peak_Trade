"""Deterministic binding/digest resolution for VEFCF v1 eval entry point."""
...
def assert_shared_channel_core_bound() -> None:
    ...
    from src.research import (
        volatility_expansion_failed_continuation_fade_v1_strategy_v1 as strategy,
    )
...
def assert_exit_state_machine_bound() -> None:
    """The strategy producer must import the frozen VEFCF exit state machine (no local reimpl)."""
    from src.research import (
        volatility_expansion_failed_continuation_fade_v1_exit_state_machine_v1 as exit_sm,
    )
    from src.research import (
        volatility_expansion_failed_continuation_fade_v1_strategy_v1 as strategy,
    )
...
def materialize_entry_point_binding_payload(repo_root: Path) -> dict[str, Any]:
    ...
    return {
        "artifact_kind": (
            "volatility_expansion_failed_continuation_fade_v1_development_evaluation_entry_point_binding"
        ),
        "artifact_version": "v1",
        ...
        "evidence_ref": "docs/evidence/evaluate_volatility_expansion_failed_continuation_fade_development_v1/",
        ...
        "schema_version": (
            "volatility_expansion_failed_continuation_fade_v1_development_evaluation_entry_point_binding.v1"
        ),
