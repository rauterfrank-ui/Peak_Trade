"""Frozen constants for VEFCF v1 DEVELOPMENT evaluation entry point.
...
PACKAGE_MARKER = (
    "VOLATILITY_EXPANSION_FAILED_CONTINUATION_FADE_V1_DEVELOPMENT_EVALUATION_ENTRY_POINT_V1=true"
)

SCOPE_ID = "volatility_expansion_failed_continuation_fade_v1_development_evaluation_v1"
OWNER_SURFACE = (
    "VOLATILITY_EXPANSION_FAILED_CONTINUATION_FADE_V1_DEVELOPMENT_EVALUATION_ENTRY_POINT_V1"
)
EVALUATION_RUN_ID = "evaluate_volatility_expansion_failed_continuation_fade_development_v1"
STRATEGY_ID = "volatility_expansion_failed_continuation_fade"
STRATEGY_IDENTITY = "VOLATILITY_EXPANSION_FAILED_CONTINUATION_FADE_V1"
STRATEGY_VERSION = "v1"
...
FROZEN_MEASUREMENT_CONTRACT_DIGEST = (
    "744c74727043edc35613f58274d28b80c6a065f56dbc75ac0af204689678a92c"
)
...
IMPLEMENTATION_BINDING_REL_PATH = "config/research/volatility_expansion_failed_continuation_fade_v1_strategy_implementation_binding_v1.json"
ENTRY_POINT_BINDING_REL_PATH = (
    "config/research/"
    "volatility_expansion_failed_continuation_fade_v1_development_evaluation_entry_point_binding_v1.json"
)
...
EVIDENCE_REL_PATH = (
    "docs/evidence/evaluate_volatility_expansion_failed_continuation_fade_development_v1/"
)
GOVERNANCE_REL_PATH = "docs/governance/VOLATILITY_EXPANSION_FAILED_CONTINUATION_FADE_V1_DEVELOPMENT_EVALUATION_ENTRY_POINT_V1.md"
CLI_REL_PATH = (
...
STRATEGY_IMPL_REL_PATH = (
    "src/research/volatility_expansion_failed_continuation_fade_v1_strategy_v1.py"
)
BASELINE_IMPL_REL_PATH = "src/research/unconditional_20_bar_price_channel_breakout_v1.py"
VOL_STATE_REL_PATH = "src/research/volatility_expansion_failed_continuation_fade_v1_vol_state_v1.py"
