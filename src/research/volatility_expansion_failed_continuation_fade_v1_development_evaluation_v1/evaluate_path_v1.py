"""Executable development-evaluation path for VEFCF v1 (orchestration surface).
...
from src.research.volatility_expansion_failed_continuation_fade_v1_development_evaluation_v1.admission_gates_v1 import (
    evaluate_admission_gates_v1,
    evaluate_segment_local_result_v1,
)
from src.research.volatility_expansion_failed_continuation_fade_v1_development_evaluation_v1.authorization_v1 import (
...
from src.research.volatility_expansion_failed_continuation_fade_v1_development_evaluation_v1.evidence_materialization_v1 import (
    build_registry_metadata_v1,
    build_run_slot_claim_v1,
    validate_evidence_and_registry_contracts_v1,
    write_evidence_bundle_v1,
)
from src.research.volatility_expansion_failed_continuation_fade_v1_development_evaluation_v1.evidence_schema_v1 import (
    empty_evidence_surface_template,
)
from src.research.volatility_expansion_failed_continuation_fade_v1_development_evaluation_v1.execution_boundary_v1 import (
    BacktestMetricsBundleV1,
    ExecutionBoundaryV1,
    RealExecutionBoundaryV1,
)
from src.research.volatility_expansion_failed_continuation_fade_v1_development_evaluation_v1.guards_v1 import (
    GuardError,
...
from src.research.volatility_expansion_failed_continuation_fade_v1_development_evaluation_v1.time_segments_v1 import (
...
def run_authorized_development_evaluation_v1(
    ...
    *,
    ...
    strategy_params_digest = compute_strategy_params_digest(contract)
    evidence = {
        "schema_version": "evaluate_volatility_expansion_failed_continuation_fade_development_summary.v1",
