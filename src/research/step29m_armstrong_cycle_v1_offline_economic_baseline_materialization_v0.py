"""STEP29M armstrong_cycle/v1 offline economic baseline materialization v0.
...
MATERIALIZATION_OWNER = (
    "research.step29m_armstrong_cycle_v1_offline_economic_baseline_materialization_v0"
)
MATERIALIZATION_VERSION = "v0"
SCHEMA_VERSION = "step29m_armstrong_cycle_v1_offline_economic_baseline_materialization.v0"
...
def compute_step29m_armstrong_implementation_digest_v0(
    repo_root: Path,
) -> str:
...
def compute_step29m_armstrong_binding_digest_v0(
    *,
    config_digest: str,
    data_digest: str,
